...
public final class zzii implements zzih {
    ...
    private final Map zzb = t.R(new f(2, Context.ACTIVITY_SERVICE), new f(3, Context.TELEPHONY_SERVICE), new f(4, Context.INPUT_METHOD_SERVICE), new f(5, Context.AUDIO_SERVICE));
