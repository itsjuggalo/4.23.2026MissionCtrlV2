...
public final class zzew {
    ...
    public final zzoi zza(zzoi zzoiVar) throws IOException, zzbd {
        try {
            ...
            try {
                Object objZzb = zzoiVar.zzD().zzb(bArrF);
                j.c(objZzb, "null cannot be cast to non-null type T of com.google.android.libraries.abuse.recaptcha.network.CaptchaFeConnection.getResponse");
                return (zzoi) objZzb;
            } catch (Exception e) {
