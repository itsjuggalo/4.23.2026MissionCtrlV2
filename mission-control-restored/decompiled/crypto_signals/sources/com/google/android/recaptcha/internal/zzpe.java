...
class zzpe extends AbstractMap {
    ...
    private final int zzl(Comparable comparable) {
        ...
        int i7 = 0;
        if (i6 >= 0) {
            int iCompareTo = comparable.compareTo(((zzpa) this.zza[i6]).zza());
            if (iCompareTo > 0) {
                return -(i + 1);
            }
            if (iCompareTo == 0) {
        ...
        while (i7 <= i6) {
            int i8 = (i7 + i6) / 2;
            int iCompareTo2 = comparable.compareTo(((zzpa) this.zza[i8]).zza());
            if (iCompareTo2 < 0) {
                i6 = i8 - 1;
            } else {
                if (iCompareTo2 <= 0) {
    ...
    public final Object zzm(int i) {
        ...
        if (!this.zzc.isEmpty()) {
            ...
            objArr2[i6] = new zzpa(this, (Comparable) entry.getKey(), entry.getValue());
            this.zzb++;
            it.remove();
        }
        return value;
    ...
    public final boolean equals(Object obj) {
        ...
        for (int i6 = 0; i6 < i; i6++) {
            if (!zzg(i6).equals(zzpeVar.zzg(i6))) {
                return false;
            }
        }
        if (i != size) {
