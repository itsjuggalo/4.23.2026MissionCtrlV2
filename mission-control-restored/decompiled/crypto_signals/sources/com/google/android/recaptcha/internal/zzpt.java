...
final class zzpt {
    public static /* bridge */ /* synthetic */ void zza(byte b3, byte b6, byte b7, byte b8, char[] cArr, int i) throws zznn {
        if (!zze(b6)) {
    ...
    */
    ...
    public static /* bridge */ /* synthetic */ void zzc(byte b3, byte b6, char[] cArr, int i) throws zznn {
        if (b3 < -62 || zze(b6)) {
            throw new zznn("Protocol message had invalid UTF-8.");
        }
