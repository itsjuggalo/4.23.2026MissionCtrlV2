...
public final class zbg extends AbstractC0433k {
    private final Bundle zba;

    public zbg(Context context, Looper looper, q qVar, C0430h c0430h, InterfaceC0403f interfaceC0403f, InterfaceC0413p interfaceC0413p) {
        super(context, looper, 219, c0430h, interfaceC0403f, interfaceC0413p);
        qVar.getClass();
        Bundle bundle = new Bundle();
        bundle.putString("session_id", qVar.f8672a);
        this.zba = bundle;
    }
