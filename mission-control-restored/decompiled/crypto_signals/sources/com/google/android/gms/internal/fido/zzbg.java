...
public final class zzbg extends zzbh implements NavigableMap {
    ...
    private final zzbg zzl(int i, int i6) {
        if (i == 0) {
            if (i6 == this.zzf.size()) {
                return this;
            }
        ...
        return i == i6 ? zzg(((zzbi) this.zze).zza) : new zzbg(this.zze.zzu(i, i6), this.zzf.subList(i, i6), null);
    }
    ...
    */
    ...
    public final zzbg headMap(Object obj, boolean z6) {
        zzbu zzbuVar = this.zze;
        obj.getClass();
        return zzl(0, zzbuVar.zzs(obj, z6));
    }

    @Override // java.util.NavigableMap
    /* JADX INFO: renamed from: zzi, reason: merged with bridge method [inline-methods] */
    public final zzbg subMap(Object obj, boolean z6, Object obj2, boolean z7) {
        obj.getClass();
        obj2.getClass();
    ...
    public final zzbg tailMap(Object obj, boolean z6) {
        zzbu zzbuVar = this.zze;
        obj.getClass();
        return zzl(zzbuVar.zzt(obj, z6), this.zzf.size());
    }
}
