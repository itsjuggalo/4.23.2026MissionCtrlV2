...
public final class zzgr {
    ...
    public static AlgorithmParameterSpec zza(byte[] bArr, int i, int i6) {
        Integer numZzb = zzqn.zzb();
        return (numZzb == null || numZzb.intValue() > 19) ? new GCMParameterSpec(128, bArr, i, i6) : new IvParameterSpec(bArr, i, i6);
    }
