...
import z.AbstractC1447e;

/* JADX INFO: renamed from: com.google.android.gms.common.internal.x, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes.dex */
public abstract class AbstractC0445x {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final q.k f5290a = new q.k();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static Locale f5291b;

    public static String a(Context context) {
        String packageName = context.getPackageName();
        try {
            Context context2 = D1.d.a(context).f276a;
    ...
    public static String b(Context context, int i) {
        ...
        if (i == 2) {
            return B1.c.f(context) ? resources.getString(R.string.common_google_play_services_wear_update_text) : resources.getString(R.string.common_google_play_services_update_text, strA);
        }
        if (i == 3) {
    ...
    public static String e(Context context, String str) {
        ...
        synchronized (kVar) {
            try {
                Locale locale = AbstractC1447e.a(context.getResources().getConfiguration()).get(0);
                if (!locale.equals(f5291b)) {
                    kVar.clear();
                    f5291b = locale;
                }
