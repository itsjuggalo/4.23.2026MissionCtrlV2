...
final class zzakl implements zzanc {
    ...
    public final int zzc() {
        ...
        int i6 = this.zzb;
        return (i6 == 0 || i6 == this.zzc) ? f.API_PRIORITY_OTHER : i6 >>> 3;
    }
    ...
    private final <T> void zzd(T t6, zzanb<T> zzanbVar, zzaku zzakuVar) throws zzall {
        int iZzj = this.zza.zzj();
        this.zza.zzt();
        int iZzb = this.zza.zzb(iZzj);
        this.zza.zza++;
        zzanbVar.zza(t6, this, zzakuVar);
        this.zza.zzc(0);
        r4.zza--;
        this.zza.zzd(iZzb);
    }
    ...
    private final <T> void zzc(T t6, zzanb<T> zzanbVar, zzaku zzakuVar) {
        int i = this.zzc;
    ...
    @Override // com.google.android.gms.internal.p002firebaseauthapi.zzanc
    public final <T> void zzb(T t6, zzanb<T> zzanbVar, zzaku zzakuVar) throws zzall {
        zzb(2);
        zzd(t6, zzanbVar, zzakuVar);
    }
    ...
    @Override // com.google.android.gms.internal.p002firebaseauthapi.zzanc
    public final <T> void zza(T t6, zzanb<T> zzanbVar, zzaku zzakuVar) throws zzalo {
        zzb(3);
        zzc(t6, zzanbVar, zzakuVar);
    }
    ...
    */
    ...
    private final void zza(List<String> list, boolean z6) throws zzalo {
        int iZzi;
        int iZzi2;
        if ((this.zzb & 7) == 2) {
            if ((list instanceof zzalt) && !z6) {
