...
class zzakg extends zzakd {
    ...
    @Override // com.google.android.gms.internal.p002firebaseauthapi.zzajv
    public final zzajv zza(int i, int i6) {
        int iZza = zzajv.zza(0, i6, zzb());
        return iZza == 0 ? zzajv.zza : new zzajz(this.zzb, zze(), iZza);
    }

    @Override // com.google.android.gms.internal.p002firebaseauthapi.zzajv
    public final int zzb(int i, int i6, int i7) {
        return zzalh.zza(i, this.zzb, zze(), i7);
    }
    ...
    @Override // com.google.android.gms.internal.p002firebaseauthapi.zzajv
    public void zza(byte[] bArr, int i, int i6, int i7) {
    ...
    public final boolean zza(zzajv zzajvVar, int i, int i6) {
        if (i6 <= zzajvVar.zzb()) {
            if (i6 <= zzajvVar.zzb()) {
                ...
                return zzajvVar.zza(0, i6).equals(zza(0, i6));
            }
            throw new IllegalArgumentException(d.h("Ran off end of other: 0, ", i6, zzajvVar.zzb(), ", "));
        }
