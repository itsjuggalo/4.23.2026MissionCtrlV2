...
abstract class zzhu {
    ...
    public final ByteBuffer zza(byte[] bArr, int i) {
        ...
        zzhp.zza(iArr);
        for (int i6 = 0; i6 < iArrZza.length; i6++) {
            iArrZza[i6] = iArrZza[i6] + iArr[i6];
        }
    ...
    private final void zza(byte[] bArr, ByteBuffer byteBuffer, ByteBuffer byteBuffer2) throws GeneralSecurityException {
        if (bArr.length == zza()) {
            ...
            for (int i7 = 0; i7 < i6; i7++) {
                ByteBuffer byteBufferZza = zza(bArr, this.zzb + i7);
                if (i7 == i) {
        ...
        throw new GeneralSecurityException(d.f(zza(), "The nonce length (in bytes) must be "));
    }
