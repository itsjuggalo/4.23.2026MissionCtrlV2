...
class zzcw extends zzcv {
    ...
    public final boolean equals(Object obj) {
        ...
        if (iZzd > zzcwVar.zzd()) {
            throw new IllegalArgumentException(d.h("Ran off end of other: 0, ", iZzd, zzcwVar.zzd(), ", "));
        }
        byte[] bArr = this.zza;
    ...
    @Override // com.google.android.gms.internal.fido.zzcz
    public final zzcz zzg(int i, int i6) {
        int iZzj = zzcz.zzj(i, i6, zzd());
