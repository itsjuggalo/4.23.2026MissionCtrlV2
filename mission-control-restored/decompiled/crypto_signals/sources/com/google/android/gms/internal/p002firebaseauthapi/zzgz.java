...
public final class zzgz implements zzba {
    ...
    public final byte[] zzb(byte[] bArr, byte[] bArr2) throws GeneralSecurityException {
        ...
        throw new GeneralSecurityException(d.i("encryption failed; AES-GCM-SIV tag must be 16 bytes, but got only ", iDoFinal - bArr.length, " bytes"));
    }

    private static AlgorithmParameterSpec zza(byte[] bArr, int i, int i6) {
        return new GCMParameterSpec(128, bArr, i, i6);
    }
