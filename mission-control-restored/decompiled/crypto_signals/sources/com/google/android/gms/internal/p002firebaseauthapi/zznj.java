            ...
            if (bigInteger.compareTo(eCParameterSpec.getOrder()) < 0) {
                ...
                for (int iBitLength = bigInteger.bitLength(); iBitLength >= 0; iBitLength--) {
                    if (bigInteger.testBit(iBitLength)) {
                        zzniVarZza = zza(zzniVarZza, zzniVarZza2, a6, bigIntegerZza);
                        zzniVarZza2 = zza(zzniVarZza2, a6, bigIntegerZza);
                    } else {
                        zzniVarZza2 = zza(zzniVarZza, zzniVarZza2, a6, bigIntegerZza);
                        zzniVarZza = zza(zzniVarZza, a6, bigIntegerZza);
                    }
                }
                if (zzniVarZza.zza()) {
