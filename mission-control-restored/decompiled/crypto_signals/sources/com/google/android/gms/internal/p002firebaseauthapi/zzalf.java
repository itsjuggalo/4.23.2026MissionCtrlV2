...
public abstract class zzalf<MessageType extends zzalf<MessageType, BuilderType>, BuilderType extends zzb<MessageType, BuilderType>> extends zzajm<MessageType, BuilderType> {
    ...
    public static /* synthetic */ boolean zza(zzalf zzalfVar, boolean z6) {
    ...
    private static <T extends zzalf<T, ?>> T zzb(T t6, zzajv zzajvVar, zzaku zzakuVar) {
        zzakh zzakhVarZzc = zzajvVar.zzc();
        T t7 = (T) zza(t6, zzakhVarZzc, zzakuVar);
        zzakhVarZzc.zzc(0);
        return t7;
    }
    ...
    public final int zza(zzanb zzanbVar) {
        if (zzw()) {
            ...
            throw new IllegalStateException(d.f(iZzb, "serialized size must be non-negative, was "));
        }
    ...
    private static final <T extends zzalf<T, ?>> boolean zzb(T t6, boolean z6) {
        byte bByteValue = ((Byte) t6.zza(zze.zza, null, null)).byteValue();
        if (bByteValue == 1) {
            return true;
        }
        if (bByteValue == 0) {
        ...
        boolean zZze = zzamx.zza().zza(t6).zze(t6);
        if (z6) {
            t6.zza(zze.zzb, zZze ? t6 : null, null);
        }
        return zZze;
    }

    private static <T extends zzalf<T, ?>> T zza(T t6) throws zzall {
        if (t6 == null || zzb(t6, true)) {
            return t6;
        }
        zzall zzallVarZza = new zzanv(t6).zza();
    ...
    public static <T extends zzalf<?, ?>> T zza(Class<T> cls) {
        ...
        T t7 = (T) ((zzalf) zzanz.zza(cls)).zza(zze.zzf, (Object) null, (Object) null);
        if (t7 != null) {
            zzc.put((Class<?>) cls, t7);
            return t7;
        }
        throw new IllegalStateException();
    }

    public static <T extends zzalf<T, ?>> T zza(T t6, zzajv zzajvVar, zzaku zzakuVar) {
        return (T) zza(zzb(t6, zzajvVar, zzakuVar));
    }

    public static <T extends zzalf<T, ?>> T zza(T t6, InputStream inputStream, zzaku zzakuVar) {
        zzakh zzakjVar;
        if (inputStream == null) {
            byte[] bArr = zzalh.zzb;
        ...
        return (T) zza(zza(t6, zzakjVar, zzakuVar));
    }

    public static <T extends zzalf<T, ?>> T zza(T t6, byte[] bArr, zzaku zzakuVar) {
        return (T) zza(zza(t6, bArr, 0, bArr.length, zzakuVar));
    }

    private static <T extends zzalf<T, ?>> T zza(T t6, zzakh zzakhVar, zzaku zzakuVar) throws zzall {
        T t7 = (T) t6.zzo();
        try {
            zzanb zzanbVarZza = zzamx.zza().zza(t7);
            zzanbVarZza.zza(t7, zzakl.zza(zzakhVar), zzakuVar);
            zzanbVarZza.zzd(t7);
            return t7;
        } catch (zzall e) {
            if (e.zzl()) {
    ...
    private static <T extends zzalf<T, ?>> T zza(T t6, byte[] bArr, int i, int i6, zzaku zzakuVar) throws zzall {
        if (i6 == 0) {
            return t6;
        }
        T t7 = (T) t6.zzo();
        try {
            zzanb zzanbVarZza = zzamx.zza().zza(t7);
            zzanbVarZza.zza(t7, bArr, 0, i6, new zzaju(zzakuVar));
            zzanbVarZza.zzd(t7);
            return t7;
        } catch (zzall e) {
            if (e.zzl()) {
    ...
    public static <T extends zzalf<?, ?>> void zza(Class<T> cls, T t6) {
        t6.zzu();
        zzc.put(cls, t6);
    }
