...
public final class zzzf {
    ...
    private static BigInteger zza(BigInteger bigInteger, boolean z6, EllipticCurve ellipticCurve) throws GeneralSecurityException {
        ...
        if (bigIntegerZza.signum() == 1) {
            ...
            return z6 != bigIntegerAdd.testBit(0) ? bigIntegerZza.subtract(bigIntegerAdd).mod(bigIntegerZza) : bigIntegerAdd;
        }
    ...
    public static ECPoint zza(EllipticCurve ellipticCurve, zzzh zzzhVar, byte[] bArr) throws GeneralSecurityException {
        ...
        if (bArr.length == iZza + 1) {
            ...
            if (bigInteger.signum() != -1 && bigInteger.compareTo(bigIntegerZza) < 0) {
                return new ECPoint(bigInteger, zza(bigInteger, z6, ellipticCurve));
            }
