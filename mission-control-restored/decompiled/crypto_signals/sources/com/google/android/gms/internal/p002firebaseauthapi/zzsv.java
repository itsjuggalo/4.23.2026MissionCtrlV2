...
public final class zzsv implements zzsq {
    ...
    private static void zza(byte[] bArr, byte[] bArr2, int i, byte[] bArr3) {
        for (int i6 = 0; i6 < 16; i6++) {
            bArr3[i6] = (byte) (bArr[i6] ^ bArr2[i6 + i]);
        }
    }
    ...
    public final byte[] zza(byte[] bArr, int i) throws GeneralSecurityException {
        ...
        if (i <= 16) {
            ...
            int i6 = length == 0 ? 1 : ((length - 1) / 16) + 1;
            if ((i6 << 4) == bArr.length) {
                bArrZza = zzyz.zza(bArr, (i6 - 1) << 4, this.zzd, 0, 16);
            } else {
                bArrZza = zzyz.zza(zzsf.zza(Arrays.copyOfRange(bArr, (i6 - 1) << 4, bArr.length)), this.zze);
            }
            byte[] bArr2 = new byte[16];
            byte[] bArr3 = new byte[16];
            for (int i7 = 0; i7 < i6 - 1; i7++) {
                zza(bArr2, bArr, i7 << 4, bArr3);
