...
public class zzmb<MessageType extends zzmf<MessageType, BuilderType>, BuilderType extends zzmb<MessageType, BuilderType>> extends zzkr<MessageType, BuilderType> {
    ...
    public final /* bridge */ /* synthetic */ zzkr zzaS(byte[] bArr, int i, int i6) throws zzmr {
        int i7 = zzlr.zzb;
        int i8 = zznu.zza;
    ...
    @Override // com.google.android.gms.internal.measurement.zzkr
    public final /* bridge */ /* synthetic */ zzkr zzaT(byte[] bArr, int i, int i6, zzlr zzlrVar) throws zzmr {
    ...
    public final zzmb zzbe(byte[] bArr, int i, int i6, zzlr zzlrVar) throws zzmr {
        if (!this.zza.zzcf()) {
            zzaY();
        }
        try {
