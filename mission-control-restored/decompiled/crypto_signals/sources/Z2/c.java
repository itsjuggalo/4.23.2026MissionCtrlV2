...
public final class c {
    ...
    public static final String[] f3998c = {"*", "FCM", "GCM", ""};
    ...
    */
    public c(Z1.h r4) {
        /*
            ...
            r1 = 0
            android.content.Context r2 = r4.f3962a
        ...
        L48:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: Z2.c.<init>(Z1.h):void");
    }
    ...
    public final String a() {
        ...
        synchronized (this.f3999a) {
            ...
            String string = this.f3999a.getString("|S||P|", null);
            if (string == null) {
                return null;
            }
            try {
