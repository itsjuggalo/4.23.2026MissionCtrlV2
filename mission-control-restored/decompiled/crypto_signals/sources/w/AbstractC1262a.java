...
public abstract class AbstractC1262a {
    ...
    public static int a(double d4, double d6, double d7) {
        double d8 = (((-0.4986d) * d7) + (((-1.5372d) * d6) + (3.2406d * d4))) / 100.0d;
        double d9 = ((0.0415d * d7) + ((1.8758d * d6) + ((-0.9689d) * d4))) / 100.0d;
        double d10 = ((1.057d * d7) + (((-0.204d) * d6) + (0.0557d * d4))) / 100.0d;
    ...
    public static int b(int i, int i6) {
        ...
        return Color.argb(i7, c(Color.red(i), iAlpha2, Color.red(i6), iAlpha, i7), c(Color.green(i), iAlpha2, Color.green(i6), iAlpha, i7), c(Color.blue(i), iAlpha2, Color.blue(i6), iAlpha, i7));
    }

    public static int c(int i, int i6, int i7, int i8, int i9) {
        if (i9 == 0) {
            return 0;
        }
        return (((255 - i6) * (i7 * i8)) + ((i * 255) * i6)) / (i9 * 255);
    }
}
