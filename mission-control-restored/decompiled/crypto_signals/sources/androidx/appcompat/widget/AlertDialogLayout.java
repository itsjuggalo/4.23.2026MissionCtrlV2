    ...
    */
    public final void onLayout(boolean r11, int r12, int r13, int r14, int r15) {
        ...
        L51:
            ...
            r8 = r3
        L74:
            java.lang.reflect.Field r9 = D.C.f194a
    ...
    public final void onMeasure(int i, int i6) {
        ...
        if (view3 != null && i8 > 0) {
            view3.measure(i, View.MeasureSpec.makeMeasureSpec(measuredHeight2 + i8, mode));
        ...
        int i11 = i6;
        alertDialogLayout.setMeasuredDimension(View.resolveSizeAndState(alertDialogLayout.getPaddingRight() + alertDialogLayout.getPaddingLeft() + iMax, i, iCombineMeasuredStates), View.resolveSizeAndState(paddingBottom, i11, 0));
        if (mode2 != 1073741824) {
            ...
            while (i12 < childCount) {
                ...
                if (childAt3.getVisibility() != 8) {
                    ...
                    if (((LinearLayout.LayoutParams) x6).width == -1) {
                        int i13 = ((LinearLayout.LayoutParams) x6).height;
                        ((LinearLayout.LayoutParams) x6).height = childAt3.getMeasuredHeight();
                        alertDialogLayout.measureChildWithMargins(childAt3, iMakeMeasureSpec, 0, i11, 0);
                        ((LinearLayout.LayoutParams) x6).height = i13;
                    }
                }
                i12++;
