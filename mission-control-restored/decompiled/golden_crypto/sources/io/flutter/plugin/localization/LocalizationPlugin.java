    ...
    public Locale resolveNativeLocale(List<Locale> list) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                arrayList.add(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m2287m(language));
                PathTreeWalk$$ExternalSyntheticApiModelOutline0.m2288m();
                arrayList.add(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m2287m(locale.getLanguage()));
                PathTreeWalk$$ExternalSyntheticApiModelOutline0.m2288m();
                arrayList.add(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m2287m(locale.getLanguage() + "-*"));
            }
