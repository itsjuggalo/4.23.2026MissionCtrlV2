...
public final class Status {
    ...
    private Status(Code code, @Nullable String str, @Nullable Throwable th) {
        this.code = (Code) Preconditions.checkNotNull(code, Constant.PARAM_ERROR_CODE);
    ...
    public String toString() {
        MoreObjects.ToStringHelper toStringHelperAdd = MoreObjects.toStringHelper(this).add(Constant.PARAM_ERROR_CODE, this.code.name()).add(b.c, this.description);
