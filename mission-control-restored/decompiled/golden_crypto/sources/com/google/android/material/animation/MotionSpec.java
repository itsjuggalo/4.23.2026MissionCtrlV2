...
public class MotionSpec {
    ...
    public String toString() {
        return IOUtils.LINE_SEPARATOR_UNIX + getClass().getName() + AbstractJsonLexerKt.BEGIN_OBJ + Integer.toHexString(System.identityHashCode(this)) + " timings: " + this.timings + "}\n";
    }
}
