...
public class ReLinker {
    ...
    public static void loadLibrary(final Context context, final String library) throws Throwable {
        loadLibrary(context, library, null, null);
    }

    public static void loadLibrary(final Context context, final String library, final String version) throws Throwable {
        loadLibrary(context, library, version, null);
    }

    public static void loadLibrary(final Context context, final String library, final LoadListener listener) throws Throwable {
        loadLibrary(context, library, null, listener);
    }

    public static void loadLibrary(final Context context, final String library, final String version, final LoadListener listener) throws Throwable {
