...
public class ApiHelperForP {
    ...
    public static void start(TracingController tracingController, TracingConfig tracingConfig) {
        tracingController.start(CanvasUtils$$ExternalSyntheticApiModelOutline0.m285m().addCategories(tracingConfig.getPredefinedCategories()).addCategories((Collection<String>) tracingConfig.getCustomIncludedCategories()).setTracingMode(tracingConfig.getTracingMode()).build());
    }
