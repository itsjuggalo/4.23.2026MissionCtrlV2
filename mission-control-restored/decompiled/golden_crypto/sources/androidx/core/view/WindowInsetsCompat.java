...
public class WindowInsetsCompat {
    ...
    private static class BuilderImpl29 extends BuilderImpl {
        ...
        BuilderImpl29() {
            this.mPlatBuilder = HalfKt$$ExternalSyntheticApiModelOutline0.m91m();
        }

        BuilderImpl29(WindowInsetsCompat windowInsetsCompat) {
            WindowInsets.Builder builderM91m;
            super(windowInsetsCompat);
            WindowInsets windowInsets = windowInsetsCompat.toWindowInsets();
            if (windowInsets != null) {
                builderM91m = WindowInsetsCompat$Impl28$$ExternalSyntheticApiModelOutline0.m110m(windowInsets);
            } else {
                builderM91m = HalfKt$$ExternalSyntheticApiModelOutline0.m91m();
            }
            this.mPlatBuilder = builderM91m;
        }
