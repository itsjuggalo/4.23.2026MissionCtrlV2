...
public abstract class AbstractC2334C {
    ...
    public static final int[] f21159a = {R.attr.state_checked};

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static final int[] f21160b = new int[0];

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public static final Rect f21161c = new Rect();
    ...
    public static class a {
        ...
        /* JADX INFO: renamed from: b, reason: collision with root package name */
        public static final Method f21163b;

        /* JADX INFO: renamed from: c, reason: collision with root package name */
        public static final Field f21164c;

        /* JADX INFO: renamed from: d, reason: collision with root package name */
        public static final Field f21165d;

        /* JADX INFO: renamed from: e, reason: collision with root package name */
        public static final Field f21166e;

        /* JADX INFO: renamed from: f, reason: collision with root package name */
        public static final Field f21167f;
        ...
        static {
            ...
            L48:
                if (r8 == 0) goto L57
                p.AbstractC2334C.a.f21163b = r4
                p.AbstractC2334C.a.f21164c = r5
                p.AbstractC2334C.a.f21165d = r6
                p.AbstractC2334C.a.f21166e = r7
                p.AbstractC2334C.a.f21167f = r3
                p.AbstractC2334C.a.f21162a = r0
                goto L63
            L57:
                p.AbstractC2334C.a.f21163b = r1
                p.AbstractC2334C.a.f21164c = r1
                p.AbstractC2334C.a.f21165d = r1
                p.AbstractC2334C.a.f21166e = r1
                p.AbstractC2334C.a.f21167f = r1
                p.AbstractC2334C.a.f21162a = r2
            L63:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p.AbstractC2334C.a.<clinit>():void");
        }

        public static Rect a(Drawable drawable) {
            if (Build.VERSION.SDK_INT < 29 && f21162a) {
                try {
                    Object objInvoke = f21163b.invoke(drawable, null);
                    if (objInvoke != null) {
                        return new Rect(f21164c.getInt(objInvoke), f21165d.getInt(objInvoke), f21166e.getInt(objInvoke), f21167f.getInt(objInvoke));
                    }
                } catch (IllegalAccessException | InvocationTargetException unused) {
                }
            }
            return AbstractC2334C.f21161c;
        }
    }
    ...
    public static void c(Drawable drawable) {
        ...
        if (state == null || state.length == 0) {
            drawable.setState(f21159a);
        } else {
            drawable.setState(f21160b);
        }
