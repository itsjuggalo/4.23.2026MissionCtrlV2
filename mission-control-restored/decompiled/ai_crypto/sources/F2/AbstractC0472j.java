...
public abstract class AbstractC0472j {
    ...
    public static final G f1926a = new G("PhoneskyVerificationUtils");
    ...
    public static boolean c(Signature[] signatureArr) {
        if (signatureArr == null || (signatureArr.length) == 0) {
            f1926a.e("Phonesky package is not signed -- possibly self-built package. Could not verify.", new Object[0]);
            return false;
        }
        for (Signature signature : signatureArr) {
            String strA = AbstractC0471i.a(signature.toByteArray());
