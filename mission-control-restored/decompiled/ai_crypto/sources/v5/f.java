...
public final class f implements HostnameVerifier {
    ...
    public static final Pattern f24888b = Pattern.compile("([0-9a-fA-F]*:[0-9a-fA-F:.]*)|([\\d.]+)");
    ...
    public static boolean c(String str) {
        return f24888b.matcher(str).matches();
    }
    ...
    public final boolean d(String str, String str2) {
        if (str != null && str.length() != 0 && !str.startsWith(".") && !str.endsWith("..") && str2 != null && str2.length() != 0 && !str2.startsWith(".") && !str2.endsWith("..")) {
            if (!str.endsWith(".")) {
                str = str + com.amazon.a.a.o.c.a.b.f10001a;
            }
            if (!str2.endsWith(".")) {
                str2 = str2 + com.amazon.a.a.o.c.a.b.f10001a;
            }
