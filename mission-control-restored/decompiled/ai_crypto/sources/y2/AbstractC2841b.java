...
public abstract class AbstractC2841b {
    ...
    public static final ThreadLocal f25603a = new ThreadLocal();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static final ThreadLocal f25604b = new ThreadLocal();
    ...
    public static void c(ViewGroup viewGroup, View view, Rect rect) {
        ThreadLocal threadLocal = f25603a;
        ...
        ThreadLocal threadLocal2 = f25604b;
