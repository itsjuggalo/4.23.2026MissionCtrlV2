...
public class f {
    ...
    public static class a {
        ...
        public static final long f12253d = TimeUnit.DAYS.toMillis(7);
        ...
        public boolean b(String str) {
            return System.currentTimeMillis() > this.f12256c + f12253d || !str.equals(this.f12255b);
        }
    }

    public f(Context context) {
        this.f12252a = context.getSharedPreferences("com.google.android.gms.appid", 0);
        a(context, "com.google.android.gms.appid-no-backup");
    }

    public final void a(Context context, String str) {
        File file = new File(G.a.getNoBackupFilesDir(context), str);
        if (file.exists()) {
            return;
        }
        try {
    ...
    public final String b(String str, String str2) {
        return str + "|T|" + str2 + com.amazon.a.a.o.b.f.f9991c + "*";
    }

    public synchronized void c() {
        this.f12252a.edit().clear().commit();
    }

    public synchronized void d(String str, String str2) {
        String strB = b(str, str2);
        SharedPreferences.Editor editorEdit = this.f12252a.edit();
        editorEdit.remove(strB);
        editorEdit.commit();
    }

    public synchronized a e(String str, String str2) {
        return a.c(this.f12252a.getString(b(str, str2), null));
    }

    public synchronized boolean f() {
        return this.f12252a.getAll().isEmpty();
    }
