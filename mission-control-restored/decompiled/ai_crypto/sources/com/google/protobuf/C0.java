...
public interface C0 {
    ...
    void C(int i7, List list, boolean z7);
    ...
    void J(int i7, List list, n0 n0Var);

    void K(int i7, List list, n0 n0Var);

    void L(int i7, Object obj, n0 n0Var);

    void M(int i7, Object obj, n0 n0Var);

    void N(int i7, AbstractC1240i abstractC1240i);

    void O(int i7, N.a aVar, Map map);
    ...
    void v(int i7, List list, boolean z7);

    void w(int i7, List list, boolean z7);

    void x(int i7, List list, boolean z7);
