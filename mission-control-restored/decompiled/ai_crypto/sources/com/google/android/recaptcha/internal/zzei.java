...
public final class zzei extends SQLiteOpenHelper {
    ...
    public /* synthetic */ zzei(Context context, AbstractC2148j abstractC2148j) {
    ...
    public final int zza(List list) {
        ...
        return getWritableDatabase().delete("ce", "id IN ".concat(String.valueOf(v.R(list, ", ", "(", ")", 0, null, zzeh.zza, 24, null))), null);
    }
    ...
    public final boolean zzf(zzej zzejVar) {
        return zza(AbstractC0555m.b(zzejVar)) == 1;
    }
}
