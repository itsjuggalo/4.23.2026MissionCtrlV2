...
final class zzpt {
    public static /* bridge */ /* synthetic */ void zza(byte b7, byte b8, byte b9, byte b10, char[] cArr, int i7) throws zznn {
    ...
    */
    ...
    public static /* bridge */ /* synthetic */ void zzc(byte b7, byte b8, char[] cArr, int i7) throws zznn {
        if (b7 < -62 || zze(b8)) {
            throw new zznn("Protocol message had invalid UTF-8.");
        }
