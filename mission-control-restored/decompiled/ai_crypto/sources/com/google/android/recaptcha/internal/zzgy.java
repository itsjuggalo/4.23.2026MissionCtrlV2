...
public final class zzgy implements zzgx {
    ...
    private static final List zzc(Object obj) {
        if (obj instanceof byte[]) {
            return AbstractC0552j.d0((byte[]) obj);
        }
        if (obj instanceof short[]) {
            return AbstractC0552j.j0((short[]) obj);
        }
        if (obj instanceof int[]) {
            return AbstractC0552j.g0((int[]) obj);
        }
        if (obj instanceof long[]) {
            return AbstractC0552j.h0((long[]) obj);
        }
        if (obj instanceof float[]) {
            return AbstractC0552j.f0((float[]) obj);
        }
        if (obj instanceof double[]) {
            return AbstractC0552j.e0((double[]) obj);
        }
        return null;
    }
    ...
    public final Object zzb(Object obj, Object obj2) throws zzce {
        ...
        if (obj instanceof Number) {
            ...
            if (listZzc2 != null) {
                ArrayList arrayList = new ArrayList(AbstractC0557o.q(listZzc2, 10));
        ...
        if (listZzc != null && (obj2 instanceof Number)) {
            ArrayList arrayList2 = new ArrayList(AbstractC0557o.q(listZzc, 10));
