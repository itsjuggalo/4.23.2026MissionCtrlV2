...
public final class zze {
    ...
    public static Bundle zzc(Bundle bundle, String str, long j7) {
        bundle.putString("playBillingLibraryVersion", str);
        bundle.putLong("billingClientSessionId", j7);
        return bundle;
    }

    public static Bundle zzd(boolean z7, boolean z8, boolean z9, boolean z10, String str, long j7) {
    ...
    public static Bundle zze(String str, long j7) {
        Bundle bundle = new Bundle();
        zzc(bundle, str, j7);
        return bundle;
    }
    ...
    public static C0730k zzg(Bundle bundle, String str) {
        return bundle == null ? new C0730k(0, null) : new C0730k(zzp(bundle, "BillingClient"), bundle.getString("IN_APP_MESSAGE_PURCHASE_TOKEN"));
    }
    ...
    public static Bundle zzn(d dVar, int i7) {
        Bundle bundle = new Bundle();
    ...
    public static Bundle zzo(d dVar, int i7, String str) {
    ...
    private static Purchase zzq(String str, String str2) {
        ...
        try {
            ...
            zzl("BillingHelper", "Got JSONException while parsing purchase data: ".concat(e7.toString()));
            return null;
        }
    }
}
