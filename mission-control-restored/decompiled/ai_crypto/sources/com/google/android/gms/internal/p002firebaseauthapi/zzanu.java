...
final class zzanu extends zzanv {
    ...
    @Override // com.google.android.gms.internal.p002firebaseauthapi.zzanv
    public final String zza(byte[] bArr, int i7, int i8) throws zzalf {
        if ((i7 | i8 | ((bArr.length - i7) - i8)) >= 0) {
            ...
            while (i7 < i9) {
                ...
                if (b8 >= 0) {
                    ...
                    if (i12 < i9) {
                        i7 += 2;
                        zzans.zza(b8, bArr[i12], cArr, i11);
                        i11++;
                    } else {
                        throw zzalf.zzd();
                    }
                    ...
                    if (i12 < i9 - 1) {
                        int i14 = i7 + 2;
                        i7 += 3;
                        zzans.zza(b8, bArr[i12], bArr[i14], cArr, i11);
                        i11++;
                    } else {
                        throw zzalf.zzd();
                    }
                    ...
                    byte b11 = bArr[i7 + 2];
                    i7 += 4;
                    zzans.zza(b8, b10, b11, bArr[i15], cArr, i11);
                    i11 += 2;
                } else {
                    throw zzalf.zzd();
                }
