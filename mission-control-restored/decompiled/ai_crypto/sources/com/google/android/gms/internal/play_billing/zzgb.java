...
final class zzgb extends zzfx implements RandomAccess, zzho, zzit {
    ...
    public final int hashCode() {
        int iZza = 1;
        for (int i7 = 0; i7 < this.zzc; i7++) {
            iZza = (iZza * 31) + zzhp.zza(this.zzb[i7]);
        }
        return iZza;
    }
    ...
    public final /* bridge */ /* synthetic */ zzho zzd(int i7) {
        if (i7 >= this.zzc) {
            return new zzgb(i7 == 0 ? zza : Arrays.copyOf(this.zzb, i7), this.zzc, true);
        }
    ...
    private zzgb(boolean[] zArr, int i7, boolean z7) {
        super(z7);
        this.zzb = zArr;
        this.zzc = i7;
    }
