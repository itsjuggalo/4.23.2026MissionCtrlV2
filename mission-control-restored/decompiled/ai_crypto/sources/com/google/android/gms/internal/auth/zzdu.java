...
final class zzdu {
    ...
    public static int zzg(int i7, byte[] bArr, int i8, int i9, zzha zzhaVar, zzdt zzdtVar) {
        ...
        while (true) {
            ...
            int iZzg = zzg(i13, bArr, iZzh2, i9, zzhaVarZzd, zzdtVar);
            i13 = i14;
            i8 = iZzg;
        }
        if (i8 > i9 || i13 != i12) {
