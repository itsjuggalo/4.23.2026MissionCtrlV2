            ...
            if (bigInteger.compareTo(eCParameterSpec.getOrder()) < 0) {
                ...
                for (int iBitLength = bigInteger.bitLength(); iBitLength >= 0; iBitLength--) {
                    if (bigInteger.testBit(iBitLength)) {
                        zznlVarZza = zza(zznlVarZza, zznlVarZza2, a7, bigIntegerZza);
                        zznlVarZza2 = zza(zznlVarZza2, a7, bigIntegerZza);
                    } else {
                        zznlVarZza2 = zza(zznlVarZza, zznlVarZza2, a7, bigIntegerZza);
                        zznlVarZza = zza(zznlVarZza, a7, bigIntegerZza);
                    }
                }
                if (zznlVarZza.zza()) {
