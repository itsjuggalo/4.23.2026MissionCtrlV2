...
final class zzakd extends zzakb {
    ...
    public final zzajp zzq() throws IOException {
        ...
        if (iZzaa <= i7 - i8 && iZzaa > 0) {
            zzajp zzajpVarZza = zzajp.zza(this.zze, i8, iZzaa);
            this.zzh += iZzaa;
            return zzajpVarZza;
        }
        if (iZzaa == 0) {
    ...
    public final String zzr() throws zzalf {
        ...
        if (iZzaa > 0) {
            ...
            int i8 = this.zzh;
            if (iZzaa <= i7 - i8) {
                String str = new String(this.zze, i8, iZzaa, zzalb.zza);
                this.zzh += iZzaa;
                return str;
            }
        }
    ...
    public final String zzs() throws IOException {
        ...
        return zzant.zzb(bArrZza, i7, iZzaa);
    }
    ...
    private final void zzg(int i7) throws zzalf {
        if (zzi(i7)) {
            return;
        }
    ...
    private final void zzh(int i7) throws zzalf {
        int i8 = this.zzf;
        int i9 = this.zzh;
        if (i7 <= i8 - i9 && i7 >= 0) {
            this.zzh = i9 + i7;
    ...
    private final byte[] zzj(int i7) throws zzalf {
        if (i7 == 0) {
            return zzalb.zzb;
        }
        if (i7 < 0) {
    ...
    @Override // com.google.android.gms.internal.p002firebaseauthapi.zzakb
    public final void zzb(int i7) throws zzalf {
        if (this.zzi != i7) {
            throw zzalf.zzb();
        }
    }
    ...
    @Override // com.google.android.gms.internal.p002firebaseauthapi.zzakb
    public final boolean zzd(int i7) throws zzalf {
        int i8 = i7 & 7;
        int i9 = 0;
        if (i8 == 0) {
    ...
    private final boolean zzi(int i7) throws zzalf {
        do {
            int i8 = this.zzh;
            int i9 = i8 + i7;
            int i10 = this.zzf;
    ...
    @Override // com.google.android.gms.internal.p002firebaseauthapi.zzakb
    public final int zza(int i7) throws zzalf {
        if (i7 >= 0) {
    ...
    private static int zza(InputStream inputStream, byte[] bArr, int i7, int i8) throws zzalf {
        try {
    ...
    private static long zza(InputStream inputStream, long j7) throws zzalf {
        try {
