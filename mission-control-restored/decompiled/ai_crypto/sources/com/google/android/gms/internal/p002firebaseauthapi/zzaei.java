...
public final class zzaei {
    ...
    */
    public static Q2.m zza(com.google.android.gms.common.api.Status r3) {
        /*
            Method dump skipped, instruction units count: 556
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p002firebaseauthapi.zzaei.zza(com.google.android.gms.common.api.Status):Q2.m");
    }
    ...
    public static boolean zzc(Exception exc) {
        if (exc instanceof C0772q) {
            return ((C0772q) exc).a().endsWith("INVALID_RECAPTCHA_TOKEN");
        }
        return false;
    }
    ...
    public static boolean zzd(Exception exc) {
        if (exc instanceof C0772q) {
            return ((C0772q) exc).a().endsWith("MISSING_RECAPTCHA_TOKEN");
        }
        return false;
    }
    ...
    public static boolean zzb(Exception exc) {
        if (exc instanceof C0772q) {
            return ((C0772q) exc).a().endsWith("APP_NOT_AUTHORIZED");
        }
        return false;
    }

    public static m zza(Status status, AbstractC0759h abstractC0759h, String str, String str2) {
        int iB = status.B();
        if (iB != 17012 && iB != 17007 && iB != 17025) {
            return zza(status);
        }
        return new C0778x(zza(iB), zza(zzb(iB), status)).d(abstractC0759h).e(str);
    }

    public static C0775u zza(FirebaseAuth firebaseAuth, zzaaj zzaajVar, A a7) {
        zzw.zza(firebaseAuth);
        zzw.zza(zzaajVar);
        Pair<String, String> pair = zza.get(17078);
        return new C0775u((String) pair.first, (String) pair.second, C0867o.F(zzaajVar, firebaseAuth, a7));
    }
    ...
    private static String zza(String str, Status status) {
        ...
        return String.format(str + " [ %s ]", status.C());
    }

    public static boolean zza(Exception exc) {
        if (exc instanceof C0772q) {
            return ((C0772q) exc).a().endsWith("ALTERNATE_CLIENT_IDENTIFIER_REQUIRED");
        }
        return false;
    }
}
