...
final class zzlv {
    ...
    public static int zzj(zzlu zzluVar, Object obj) {
        ...
        if (!zzluVar.zze()) {
            int iZzh = 0;
            while (i7 < size) {
                iZzh += zzh(zzosVarZzb, iZza, list.get(i7));
                i7++;
            }
            return iZzh;
        }
        ...
        int iZzi = 0;
        while (i7 < size) {
            iZzi += zzi(zzosVarZzb, list.get(i7));
            i7++;
        }
    ...
    */
    ...
    public final /* bridge */ /* synthetic */ Object clone() {
        ...
        for (int i7 = 0; i7 < iZzc; i7++) {
            Map.Entry entryZzd = zzodVar.zzd(i7);
