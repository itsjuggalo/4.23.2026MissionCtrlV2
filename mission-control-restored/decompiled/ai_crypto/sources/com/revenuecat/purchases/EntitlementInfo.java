...
public final class EntitlementInfo implements Parcelable, RawDataContainer<JSONObject> {
    ...
    public /* synthetic */ EntitlementInfo(String str, boolean z7, boolean z8, PeriodType periodType, Date date, Date date2, Date date3, Store store, String str2, String str3, boolean z9, Date date4, Date date5, OwnershipType ownershipType, JSONObject jSONObject, VerificationResult verificationResult, int i7, AbstractC2148j abstractC2148j) {
