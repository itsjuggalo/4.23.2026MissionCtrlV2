...
public abstract class OfferingParser {
    public final Offering createOffering(JSONObject offeringJson, Map<String, ? extends List<? extends StoreProduct>> productsById, UiConfig uiConfig) throws JSONException {
        ...
        if (jSONObjectOptJSONObject2 != null) {
            try {
                s6.a json = JsonTools.INSTANCE.getJson();
        ...
        if (jSONObjectOptJSONObject3 != null) {
            try {
                s6.a json2 = JsonTools.INSTANCE.getJson();
                ...
                LogUtilsKt.errorLog("Error deserializing paywall components data", th);
        ...
        String string3 = offeringJson.getString(com.amazon.a.a.o.b.f9940c);
        r.e(string3, "offeringJson.getString(\"description\")");
        return new Offering(offeringIdentifier, string3, map, arrayList, paywallData2, paywallComponents);
    }
    ...
    */
    public final com.revenuecat.purchases.Offerings createOfferings(org.json.JSONObject r13, java.util.Map<java.lang.String, ? extends java.util.List<? extends com.revenuecat.purchases.models.StoreProduct>> r14) throws org.json.JSONException {
        /*
