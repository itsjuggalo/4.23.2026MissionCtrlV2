...
public final class SubscriptionOptions implements List<SubscriptionOption>, a {
    ...
    public boolean equals(Object obj) {
        ...
        if (r.b(SubscriptionOptions.class, obj != null ? obj.getClass() : null)) {
            return (obj instanceof SubscriptionOptions ? (SubscriptionOptions) obj : null) != null && r.b(AbstractC0555m.b(this.subscriptionOptions), AbstractC0555m.b(((SubscriptionOptions) obj).subscriptionOptions));
        }
        return false;
    }
    ...
    @Override // java.util.List, java.util.Collection
    public int hashCode() {
        return AbstractC0555m.b(this.subscriptionOptions).hashCode();
    }
    ...
    public <T> T[] toArray(T[] array) {
        r.f(array, "array");
        return (T[]) AbstractC2147i.b(this, array);
    }
