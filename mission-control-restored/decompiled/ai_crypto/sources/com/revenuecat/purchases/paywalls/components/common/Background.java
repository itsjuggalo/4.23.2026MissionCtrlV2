...
public interface Background {
    ...
    public static final class Color implements Background {
        ...
        public /* synthetic */ Color(int i7, ColorScheme colorScheme, k0 k0Var) {
            if (1 != (i7 & 1)) {
                AbstractC2611a0.a(i7, 1, Background$Color$$serializer.INSTANCE.getDescriptor());
            }
    ...
    public static final class Unknown implements Background {
        ...
        public /* synthetic */ Unknown(int i7, String str, k0 k0Var) {
            if (1 != (i7 & 1)) {
                AbstractC2611a0.a(i7, 1, Background$Unknown$$serializer.INSTANCE.getDescriptor());
            }
            this.type = str;
        }
    ...
    public static final class Image implements Background {
        ...
        public /* synthetic */ Image(int i7, ThemeImageUrls themeImageUrls, FitMode fitMode, ColorScheme colorScheme, k0 k0Var) {
            if (1 != (i7 & 1)) {
                AbstractC2611a0.a(i7, 1, Background$Image$$serializer.INSTANCE.getDescriptor());
            }
        ...
        public static final /* synthetic */ void write$Self(Image image, d dVar, e eVar) {
            dVar.x(eVar, 0, ThemeImageUrls$$serializer.INSTANCE, image.value);
            if (dVar.C(eVar, 1) || image.fitMode != FitMode.FILL) {
                dVar.x(eVar, 1, FitModeDeserializer.INSTANCE, image.fitMode);
            }
            if (!dVar.C(eVar, 2) && image.colorOverlay == null) {
                return;
            }
            dVar.r(eVar, 2, ColorScheme$$serializer.INSTANCE, image.colorOverlay);
        }
        ...
        public /* synthetic */ Image(ThemeImageUrls themeImageUrls, FitMode fitMode, ColorScheme colorScheme, int i7, AbstractC2148j abstractC2148j) {
