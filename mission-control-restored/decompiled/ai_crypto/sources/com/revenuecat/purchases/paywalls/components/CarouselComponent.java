...
public final class CarouselComponent implements PaywallComponent {
    ...
    private static final b[] $childSerializers = {new C2618e(StackComponent$$serializer.INSTANCE), null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, new C2618e(ComponentOverride.Companion.serializer(PartialCarouselComponent$$serializer.INSTANCE))};
    ...
    public static final class AutoAdvancePages {
        ...
        public /* synthetic */ AutoAdvancePages(int i7, int i8, int i9, TransitionType transitionType, k0 k0Var) {
            if (7 != (i7 & 7)) {
                AbstractC2611a0.a(i7, 7, CarouselComponent$AutoAdvancePages$$serializer.INSTANCE.getDescriptor());
            }
        ...
        public static final /* synthetic */ void write$Self(AutoAdvancePages autoAdvancePages, d dVar, e eVar) {
            dVar.t(eVar, 0, autoAdvancePages.msTimePerPage);
            dVar.t(eVar, 1, autoAdvancePages.msTransitionTime);
            dVar.r(eVar, 2, CarouselTransitionTypeDeserializer.INSTANCE, autoAdvancePages.transitionType);
        }
    ...
    public /* synthetic */ CarouselComponent(int i7, List list, Boolean bool, Integer num, VerticalAlignment verticalAlignment, Size size, Integer num2, Float f7, ColorScheme colorScheme, Background background, Padding padding, Padding padding2, Shape shape, Border border, Shadow shadow, PageControl pageControl, Boolean bool2, AutoAdvancePages autoAdvancePages, List list2, k0 k0Var) {
        Size size2;
        if (9 != (i7 & 9)) {
            AbstractC2611a0.a(i7, 9, CarouselComponent$$serializer.INSTANCE.getDescriptor());
        }
        this.pages = list;
        if ((i7 & 2) == 0) {
            this.visible = null;
        ...
        this.padding = (i7 & 512) == 0 ? Padding.Companion.getZero() : padding;
        this.margin = (i7 & 1024) == 0 ? Padding.Companion.getZero() : padding2;
        if ((i7 & 2048) == 0) {
            this.shape = null;
        } else {
            this.shape = shape;
        ...
        this.overrides = (i7 & 131072) == 0 ? AbstractC0556n.g() : list2;
    }
    ...
    */
    public static final /* synthetic */ void write$Self(com.revenuecat.purchases.paywalls.components.CarouselComponent r5, q6.d r6, p6.e r7) {
        /*
            Method dump skipped, instruction units count: 372
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.revenuecat.purchases.paywalls.components.CarouselComponent.write$Self(com.revenuecat.purchases.paywalls.components.CarouselComponent, q6.d, p6.e):void");
    }
    ...
    public static final class PageControl {
        ...
        public static final class Indicator {
            ...
            public /* synthetic */ Indicator(int i7, int i8, ColorScheme colorScheme, ColorScheme colorScheme2, w wVar, AbstractC2148j abstractC2148j) {
                this(i7, i8, colorScheme, colorScheme2, wVar);
            }
            ...
            public static /* synthetic */ void m116getStrokeWidth0hXNFcg$annotations() {
            }

            public static final /* synthetic */ void write$Self(Indicator indicator, d dVar, e eVar) {
                w0 w0Var = w0.f22947a;
                dVar.x(eVar, 0, w0Var, w.a(indicator.width));
                dVar.x(eVar, 1, w0Var, w.a(indicator.height));
                ColorScheme$$serializer colorScheme$$serializer = ColorScheme$$serializer.INSTANCE;
                dVar.x(eVar, 2, colorScheme$$serializer, indicator.color);
                if (dVar.C(eVar, 3) || indicator.strokeColor != null) {
                    dVar.r(eVar, 3, colorScheme$$serializer, indicator.strokeColor);
                }
                if (!dVar.C(eVar, 4) && indicator.strokeWidth == null) {
                    return;
                }
                dVar.r(eVar, 4, w0Var, indicator.strokeWidth);
            }
            ...
            public final /* synthetic */ int m117getHeightpVg5ArA() {
                return this.height;
            }
            ...
            public final /* synthetic */ w m118getStrokeWidth0hXNFcg() {
                return this.strokeWidth;
            }

            /* JADX INFO: renamed from: getWidth-pVg5ArA, reason: not valid java name */
            public final /* synthetic */ int m119getWidthpVg5ArA() {
                return this.width;
            }
            ...
            public int hashCode() {
                ...
                return iHashCode + (wVar != null ? w.h(wVar.j()) : 0);
            }
            ...
            public /* synthetic */ Indicator(int i7, w wVar, w wVar2, ColorScheme colorScheme, ColorScheme colorScheme2, w wVar3, k0 k0Var, AbstractC2148j abstractC2148j) {
                this(i7, wVar, wVar2, colorScheme, colorScheme2, wVar3, k0Var);
            }

            private Indicator(int i7, int i8, ColorScheme color, ColorScheme colorScheme, w wVar) {
                r.f(color, "color");
                this.width = i7;
                this.height = i8;
                this.color = color;
            ...
            private Indicator(int i7, w wVar, w wVar2, ColorScheme colorScheme, ColorScheme colorScheme2, w wVar3, k0 k0Var) {
                if (7 != (i7 & 7)) {
                    AbstractC2611a0.a(i7, 7, CarouselComponent$PageControl$Indicator$$serializer.INSTANCE.getDescriptor());
                }
                this.width = wVar.j();
                this.height = wVar2.j();
            ...
            public /* synthetic */ Indicator(int i7, int i8, ColorScheme colorScheme, ColorScheme colorScheme2, w wVar, int i9, AbstractC2148j abstractC2148j) {
                this(i7, i8, colorScheme, (i9 & 8) != 0 ? null : colorScheme2, (i9 & 16) != 0 ? null : wVar, null);
            }
        }
        ...
        public /* synthetic */ PageControl(int i7, Position position, Integer num, Padding padding, Padding padding2, ColorScheme colorScheme, Shape shape, Border border, Shadow shadow, Indicator indicator, Indicator indicator2, k0 k0Var) {
            if (769 != (i7 & 769)) {
                AbstractC2611a0.a(i7, 769, CarouselComponent$PageControl$$serializer.INSTANCE.getDescriptor());
            }
        ...
        public static final /* synthetic */ void write$Self(PageControl pageControl, d dVar, e eVar) {
            dVar.x(eVar, 0, CarouselPageControlPositionDeserializer.INSTANCE, pageControl.position);
            if (dVar.C(eVar, 1) || pageControl.spacing != null) {
                dVar.r(eVar, 1, H.f22831a, pageControl.spacing);
            }
            if (dVar.C(eVar, 2) || !r.b(pageControl.padding, Padding.Companion.getZero())) {
                dVar.x(eVar, 2, Padding$$serializer.INSTANCE, pageControl.padding);
            }
            if (dVar.C(eVar, 3) || !r.b(pageControl.margin, Padding.Companion.getZero())) {
                dVar.x(eVar, 3, Padding$$serializer.INSTANCE, pageControl.margin);
            }
            if (dVar.C(eVar, 4) || pageControl.backgroundColor != null) {
                dVar.r(eVar, 4, ColorScheme$$serializer.INSTANCE, pageControl.backgroundColor);
            }
            if (dVar.C(eVar, 5) || pageControl.shape != null) {
                dVar.r(eVar, 5, ShapeDeserializer.INSTANCE, pageControl.shape);
            }
            if (dVar.C(eVar, 6) || pageControl.border != null) {
                dVar.r(eVar, 6, Border$$serializer.INSTANCE, pageControl.border);
            }
            if (dVar.C(eVar, 7) || pageControl.shadow != null) {
                dVar.r(eVar, 7, Shadow$$serializer.INSTANCE, pageControl.shadow);
            }
            ...
            dVar.x(eVar, 8, carouselComponent$PageControl$Indicator$$serializer, pageControl.active);
            dVar.x(eVar, 9, carouselComponent$PageControl$Indicator$$serializer, pageControl.f0default);
        }
        ...
        public /* synthetic */ PageControl(Position position, Integer num, Padding padding, Padding padding2, ColorScheme colorScheme, Shape shape, Border border, Shadow shadow, Indicator indicator, Indicator indicator2, int i7, AbstractC2148j abstractC2148j) {
            this(position, (i7 & 2) != 0 ? null : num, (i7 & 4) != 0 ? Padding.Companion.getZero() : padding, (i7 & 8) != 0 ? Padding.Companion.getZero() : padding2, (i7 & 16) != 0 ? null : colorScheme, (i7 & 32) != 0 ? null : shape, (i7 & 64) != 0 ? null : border, (i7 & 128) != 0 ? null : shadow, indicator, indicator2);
        }
    }
    ...
    public /* synthetic */ CarouselComponent(List list, Boolean bool, Integer num, VerticalAlignment verticalAlignment, Size size, Integer num2, Float f7, ColorScheme colorScheme, Background background, Padding padding, Padding padding2, Shape shape, Border border, Shadow shadow, PageControl pageControl, Boolean bool2, AutoAdvancePages autoAdvancePages, List list2, int i7, AbstractC2148j abstractC2148j) {
        Size size2;
        ...
        this(list, bool3, num3, verticalAlignment, size2, (i7 & 32) != 0 ? null : num2, (i7 & 64) != 0 ? null : f7, (i7 & 128) != 0 ? null : colorScheme, (i7 & 256) != 0 ? null : background, (i7 & 512) != 0 ? Padding.Companion.getZero() : padding, (i7 & 1024) != 0 ? Padding.Companion.getZero() : padding2, (i7 & 2048) != 0 ? null : shape, (i7 & 4096) != 0 ? null : border, (i7 & 8192) != 0 ? null : shadow, (i7 & 16384) != 0 ? null : pageControl, (32768 & i7) != 0 ? null : bool2, (65536 & i7) != 0 ? null : autoAdvancePages, (i7 & 131072) != 0 ? AbstractC0556n.g() : list2);
    }
}
