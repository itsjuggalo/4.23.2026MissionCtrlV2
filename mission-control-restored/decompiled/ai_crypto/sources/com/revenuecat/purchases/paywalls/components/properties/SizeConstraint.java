...
public interface SizeConstraint {
    ...
    public static final class Fixed implements SizeConstraint {
        ...
        public /* synthetic */ Fixed(int i7, w wVar, k0 k0Var, AbstractC2148j abstractC2148j) {
            this(i7, wVar, k0Var);
        }
        ...
        public final /* synthetic */ int m174getValuepVg5ArA() {
            return this.value;
        }
        ...
        public /* synthetic */ Fixed(int i7, AbstractC2148j abstractC2148j) {
            this(i7);
        }
        ...
        private Fixed(int i7, w wVar, k0 k0Var) {
            if (1 != (i7 & 1)) {
                AbstractC2611a0.a(i7, 1, SizeConstraint$Fixed$$serializer.INSTANCE.getDescriptor());
            }
            this.value = wVar.j();
        }
    }
