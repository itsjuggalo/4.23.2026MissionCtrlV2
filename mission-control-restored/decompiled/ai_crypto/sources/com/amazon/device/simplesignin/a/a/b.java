...
public class b implements com.amazon.device.simplesignin.a.b {
    ...
    private static final String f10482a = "b";
    ...
    public void a(Context context, Intent intent) {
        String stringExtra = intent.getStringExtra(a.f10466n);
        if (stringExtra == null) {
            com.amazon.device.simplesignin.a.d.a.b(f10482a, "Invalid response type: null");
            return;
        }
        com.amazon.device.simplesignin.a.d.a.a(f10482a, "Found response type: " + stringExtra);
        if (a.f10475w.equals(stringExtra)) {
            new com.amazon.device.simplesignin.a.a.b.a.b(new RequestId(intent.getStringExtra(com.amazon.a.a.o.b.f9913B))).d();
        }
        if (a.f10476x.equals(stringExtra)) {
            new com.amazon.device.simplesignin.a.a.d.a.a(new RequestId(intent.getStringExtra(com.amazon.a.a.o.b.f9913B))).d();
        }
    }
}
