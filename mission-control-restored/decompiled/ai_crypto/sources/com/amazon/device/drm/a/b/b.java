...
public class b extends com.amazon.a.a.j.a {
    ...
    private static final String f10247c = "b";

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private final RequestId f10248d;

    public b(RequestId requestId) {
        this.f10248d = requestId;
    }
                ...
                public void run() {
                    try {
                        ...
                        if (obj2 instanceof LicenseResponse) {
                            ...
                            com.amazon.device.drm.a.e.b.b(b.f10247c, "Unknown response type:" + obj.getClass().getName());
                        }
                    } catch (Throwable th) {
                        com.amazon.device.drm.a.e.b.b(b.f10247c, "Error in sendResponse: " + th);
                    }
                }
            });
            return;
        }
        com.amazon.device.drm.a.e.b.a(f10247c, "LicensingListener is not set. Dropping response: " + obj);
    }
