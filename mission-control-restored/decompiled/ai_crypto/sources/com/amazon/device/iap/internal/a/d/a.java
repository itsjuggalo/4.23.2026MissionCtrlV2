...
public final class a extends c {
    ...
    private final FulfillmentResult f10309d;
    ...
    public a(RequestId requestId, String str, FulfillmentResult fulfillmentResult) {
        ...
        hashSet.add(str);
        this.f10308c = str;
        this.f10309d = fulfillmentResult;
    ...
    public void c() {
        ...
        FulfillmentResult fulfillmentResult2 = this.f10309d;
        if ((fulfillmentResult == fulfillmentResult2 || FulfillmentResult.UNAVAILABLE == fulfillmentResult2) && (strC = d.a().c(this.f10308c)) != null) {
