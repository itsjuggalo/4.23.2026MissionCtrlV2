...
public class c {
    ...
    private static final String f10430a = "c";
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f10431a[d.LEGACY.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f10431a[d.V2.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f10431a[d.V3.ordinal()] = 4;
    ...
    public static Receipt a(JSONObject jSONObject, String str, String str2) {
        int i7 = AnonymousClass1.f10431a[b(jSONObject).ordinal()];
    ...
    private static Receipt b(JSONObject jSONObject, String str, String str2) {
        ...
        if (f.a(strOptString)) {
            b.b(f10430a, "a signature was not found in the receipt for request ID " + str2);
        ...
        try {
            ...
            b.a(f10430a, "stringToVerify/legacy:\n" + str3 + "\nsignature:\n" + strOptString);
            if (zA) {
                return receiptA;
            }
    ...
    private static Receipt c(JSONObject jSONObject, String str, String str2) {
        String strOptString = jSONObject.optString(com.amazon.a.a.o.b.f9937Z);
    ...
    private static Receipt d(JSONObject jSONObject, String str, String str2) {
        ...
        try {
            String string = jSONObject.getString(com.amazon.a.a.o.b.f9916E);
    ...
    private static Receipt e(JSONObject jSONObject, String str, String str2) {
        ...
        try {
            String string = jSONObject.getString(com.amazon.a.a.o.b.f9916E);
            String string2 = jSONObject.getString("sku");
            String strOptString3 = jSONObject.optString(com.amazon.a.a.o.b.f9923L, null);
            String strOptString4 = jSONObject.optString(com.amazon.a.a.o.b.f9924M, null);
            ProductType productTypeValueOf = ProductType.valueOf(jSONObject.getString(com.amazon.a.a.o.b.f9948k).toUpperCase());
            String strOptString5 = jSONObject.optString(com.amazon.a.a.o.b.f9928Q);
            Date dateB2 = a(strOptString5) ? null : b(strOptString5);
            String strOptString6 = jSONObject.optString(com.amazon.a.a.o.b.f9942e);
            Date dateB3 = a(strOptString6) ? null : b(strOptString6);
            String strOptString7 = jSONObject.optString(com.amazon.a.a.o.b.f9929R);
            if (!a(strOptString7)) {
    ...
    private static Receipt a(JSONObject jSONObject) throws JSONException {
        ...
        ProductType productTypeValueOf = ProductType.valueOf(jSONObject.getString(com.amazon.a.a.o.b.f9948k).toUpperCase());
        String strOptString2 = jSONObject.optString(com.amazon.a.a.o.b.f9927P);
        Date dateB = a(strOptString2) ? null : b(strOptString2);
        String strOptString3 = jSONObject.optString(com.amazon.a.a.o.b.f9941d);
    ...
    private static d b(JSONObject jSONObject) {
        String strOptString = jSONObject.optString(com.amazon.a.a.o.b.f9937Z);
        String strOptString2 = jSONObject.optString(com.amazon.a.a.o.b.f9916E);
        String strOptString3 = jSONObject.optString(com.amazon.a.a.o.b.f9925N);
    ...
    public static JSONObject a(Receipt receipt, String str) {
        ...
        if (receipt != null && !f.a(str)) {
            try {
                jSONObject.put(com.amazon.a.a.o.b.f9916E, receipt.getReceiptId());
                jSONObject.put("sku", receipt.getSku());
                jSONObject.put(com.amazon.a.a.o.b.f9948k, receipt.getProductType());
                jSONObject.put(com.amazon.a.a.o.b.f9928Q, receipt.getPurchaseDate());
                jSONObject.put(com.amazon.a.a.o.b.f9941d, receipt.getCancelDate());
                jSONObject.put("signature", str);
            } catch (JSONException unused) {
                b.b(f10430a, "Failure during toJsonInternal: " + receipt + ", signature:" + str);
            }
        }
        return jSONObject;
    }
    ...
    public static List<Receipt> a(String str, String str2, String str3) {
        ...
        for (int i7 = 0; i7 < jSONArray.length(); i7++) {
            try {
                ...
                b.b(f10430a, "fail to parse receipt, requestId:" + e7.a());
                throw e7;
            } catch (com.amazon.device.iap.internal.a.f e8) {
                b.b(f10430a, "fail to verify receipt, requestId:" + e8.a());
                throw e8;
            } catch (Throwable th) {
                b.b(f10430a, "fail to verify receipt, requestId:" + th.getMessage());
                throw th;
            }
        }
        return arrayList;
