...
public class c implements b {
    ...
    public static final com.amazon.a.a.o.c f9738a = new com.amazon.a.a.o.c("ResourceManagerImpl");

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private List<Object> f9739b = new ArrayList();
    ...
    public void a(Object obj) {
        if (com.amazon.a.a.o.c.f9994a) {
            f9738a.a("Registering resource: " + obj);
        }
    ...
    public void b(Object obj) {
        ...
        if (com.amazon.a.a.o.c.f9994a) {
            f9738a.a("Populating: " + obj);
        }
        if (!d(obj)) {
            f9738a.a("Ignoring: " + obj + ", not a kiwi class");
            return;
        }
    ...
    @Override // com.amazon.a.a.k.b
    public void a() {
        Iterator<Object> it = this.f9739b.iterator();
        while (it.hasNext()) {
            b(it.next());
        }
    }
