...
public class a {
                ...
                for (X509Certificate x509Certificate : acceptedIssuers) {
                    if (a(x509Certificate)) {
                        if (com.amazon.a.a.o.c.f9994a) {
                            f9964a.a("Trusted Cert: " + x509Certificate.getSubjectX500Principal().getName());
                        }
                        this.f9970e.add(new TrustAnchor(x509Certificate, null));
                        i7++;
                    }
                }
                if (com.amazon.a.a.o.c.f9994a) {
                    f9964a.a(String.format("loaded %d certs\n", Integer.valueOf(i7)));
                }
            }
        }
        if (this.f9970e.isEmpty()) {
            f9964a.b("TrustManager did not return valid accepted issuers, likely 3P custom TrustManager implementation issue.");
        }
        PKIXParameters pKIXParameters = new PKIXParameters(this.f9970e);
        this.f9968c = pKIXParameters;
        pKIXParameters.setRevocationEnabled(false);
        this.f9969d = CertPathValidator.getInstance(f9965b);
    }
    ...
    public static boolean a(X509Certificate x509Certificate) {
        try {
            ...
            if (!a(f9966f, bArrDigest)) {
                if (!a(f9967g, bArrDigest)) {
                    return false;
                }
            }
            return true;
        } catch (NoSuchAlgorithmException e7) {
            f9964a.b("Signature algorithm unrecognized", e7);
            return false;
        } catch (CertificateEncodingException e8) {
            f9964a.b("Cant get fingerprint", e8);
            return false;
        }
    }
    ...
    public boolean a(CertPath certPath) {
        try {
            ...
            f9964a.a("Verifying CertPath with " + notBefore);
            this.f9968c.setDate(notBefore);
            this.f9969d.validate(certPath, this.f9968c);
            return true;
        } catch (Exception e7) {
            if (!com.amazon.a.a.o.c.f9994a) {
                return false;
            }
            f9964a.b("Failed to verify cert path: " + e7, e7);
            return false;
        }
    }
}
