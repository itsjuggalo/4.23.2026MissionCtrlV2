...
public abstract class a extends com.amazon.a.a.n.c.a {
    ...
    private static final com.amazon.a.a.o.c f9774b = new com.amazon.a.a.o.c("AbstractCommandTask");

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    @com.amazon.a.a.k.a
    protected com.amazon.a.a.l.b f9775a;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    @com.amazon.a.a.k.a
    private Application f9776c;
    ...
    @com.amazon.a.a.k.a
    private com.amazon.a.a.i.e f9778e;

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    @com.amazon.a.a.k.a
    private com.amazon.a.a.h.c f9779f;
    ...
    private void b(j jVar) {
        if (com.amazon.a.a.o.c.f9994a) {
            f9774b.a("Command executed successfully");
        }
        a(jVar);
    }
    ...
    private com.amazon.d.a.c i() {
        return new c.a() { // from class: com.amazon.a.a.n.a.a.1
            ...
            @Override // com.amazon.d.a.c
            public String d() {
                return a.this.f9776c.getPackageName();
            }
        };
    }
    ...
    public final void a() {
        try {
            if (com.amazon.a.a.o.c.f9994a) {
                com.amazon.a.a.o.c cVar = f9774b;
                cVar.a("----------------------------------------------");
                cVar.a("Executing: " + a_());
                cVar.a("----------------------------------------------");
            }
        ...
        if (!d()) {
            if (com.amazon.a.a.o.c.f9994a) {
                f9774b.a("Execution not needed, quitting");
            }
            return;
        }
        if (com.amazon.a.a.o.c.f9994a) {
            f9774b.a("Executing Command: " + a_());
        }
        a(this.f9777d.a(i()));
        if (com.amazon.a.a.o.c.f9994a) {
            f9774b.a("Task finished");
    ...
    private void b(com.amazon.d.a.h hVar) {
        if (com.amazon.a.a.o.c.f9994a) {
            f9774b.a("Command failed execution: " + hVar.b());
        }
        a(hVar);
    }
    ...
    public void b(com.amazon.a.a.d.b bVar) {
        f9774b.b("On Exception!!!!: " + bVar);
    }

    private void a(c cVar) throws RemoteException, com.amazon.a.a.n.a.a.a, com.amazon.a.a.n.a.a.f {
        if (com.amazon.a.a.o.c.f9994a) {
            f9774b.a("Received result from CommandService: " + cVar);
        }
        if (cVar == null) {
            if (com.amazon.a.a.o.c.f9994a) {
                f9774b.a("Received null result from command service, exiting task");
            }
        } else {
            if (cVar.e() != null) {
                a(cVar.e());
            ...
            this.f9780g.a(cVar.a(), this.f9777d.a());
            if (cVar.b() != null) {
                b(cVar.b());
            } else if (cVar.c() != null) {
                b(cVar.c());
    ...
    private void a(com.amazon.d.a.f fVar) throws RemoteException, com.amazon.a.a.n.a.a.a, com.amazon.a.a.n.a.a.f {
        if (com.amazon.a.a.o.c.f9994a) {
            f9774b.a("Handling Decision");
        }
        try {
            f fVar2 = new f(fVar);
            this.f9778e.a((com.amazon.a.a.i.b) fVar2);
            com.amazon.d.a.a aVarI = fVar2.i();
            if (aVarI == null) {
                if (com.amazon.a.a.o.c.f9994a) {
                    f9774b.a("DecisionChooser returned null!!, expiring");
                }
    ...
    private void a(com.amazon.d.a.f fVar, com.amazon.d.a.a aVar) throws RemoteException, com.amazon.a.a.n.a.a.a, com.amazon.a.a.n.a.a.f {
        if (com.amazon.a.a.o.c.f9994a) {
            f9774b.a("Handling customer choice: " + aVar);
        }
        Intent intentB = aVar.b();
        if (intentB != null) {
            if (com.amazon.a.a.o.c.f9994a) {
                f9774b.a("Choice has intent, scheduling it to be fired!!");
            }
            com.amazon.a.a.l.a aVarA = this.f9775a.a(intentB);
            if (aVarA == null) {
                if (com.amazon.a.a.o.c.f9994a) {
                    f9774b.a("No result recived, expiring decision");
                }
                a(fVar, e.EXPIRATION_DURATION_ELAPSED);
                return;
            } else if (aVarA.d() == 0) {
                if (com.amazon.a.a.o.c.f9994a) {
                    f9774b.a("Result canceled, expiring decision");
                }
                a(fVar, e.ACTION_CANCELED);
                return;
            } else {
                if (com.amazon.a.a.o.c.f9994a) {
                    f9774b.a("Result received!!!, notifying service");
                }
                a(this.f9777d.a(aVar));
                return;
            }
        }
        if (com.amazon.a.a.o.c.f9994a) {
            f9774b.a("No intent given, choosing now");
        }
        a(this.f9777d.a(aVar));
    }
    ...
    private void a(com.amazon.d.a.f fVar, e eVar) throws RemoteException, com.amazon.a.a.n.a.a.a, com.amazon.a.a.n.a.a.f {
        if (com.amazon.a.a.o.c.f9994a) {
            f9774b.a("Expiring Decision: " + fVar + ", reason: " + eVar);
        }
        a(this.f9777d.a(fVar, eVar));
    }

    private void a(Throwable th) {
        if (com.amazon.a.a.o.c.f9994a) {
            f9774b.a("Exception occurred while processing task: " + th, th);
        }
        com.amazon.a.a.d.b bVarB = b(th);
        b(bVarB);
        this.f9779f.a(a(bVarB));
    }
