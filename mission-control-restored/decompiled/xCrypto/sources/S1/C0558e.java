...
public final class C0558e extends M6 {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:404:0x0966, code lost:
        ...
        r0.c("Invalid property filter ID. appId, id", r2, java.lang.String.valueOf(r8));
     */
    ...
    /* JADX WARN: Removed duplicated region for block: B:276:0x067b A[PHI: r0 r7 r20 r22
      ...
      0x067b: PHI (r22v12 S1.F) = (r22v13 S1.F), (r22v15 S1.F) binds: [B:291:0x06b2, B:275:0x0679] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    public final java.util.List m(java.lang.String r37, java.util.List r38, java.util.List r39, java.lang.Long r40, java.lang.Long r41, boolean r42) throws java.lang.Throwable {
        /*
            Method dump skipped, instruction units count: 2607
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: S1.C0558e.m(java.lang.String, java.util.List, java.util.List, java.lang.Long, java.lang.Long, boolean):java.util.List");
    }

    public final u7 n(Integer num) {
        if (this.f4465f.containsKey(num)) {
            return (u7) this.f4465f.get(num);
        }
        u7 u7Var = new u7(this, this.f4463d, null);
        this.f4465f.put(num, u7Var);
        return u7Var;
    }

    public final boolean o(int i4, int i5) {
        u7 u7Var = (u7) this.f4465f.get(Integer.valueOf(i4));
        if (u7Var == null) {
            return false;
        }
        return u7Var.c().get(i5);
    }
}
