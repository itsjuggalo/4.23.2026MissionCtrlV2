...
abstract class JobIntentService extends Service {
    ...
    public static class ComponentNameWithWakeful {
        ...
        public ComponentNameWithWakeful(ComponentName componentName, boolean z4) {
            this.componentName = componentName;
            this.useWakefulService = z4;
        }
    }
                ...
                synchronized (JobServiceEngineImpl.this.mLock) {
                    ...
                    if (jobParameters != null) {
                        try {
                            ...
                            Log.e(JobServiceEngineImpl.TAG, "IllegalArgumentException: Failed to run mParams.completeWork(mJobWork)!", e4);
                        } catch (SecurityException e5) {
                            Log.e(JobServiceEngineImpl.TAG, "SecurityException: Failed to run mParams.completeWork(mJobWork)!", e5);
                        }
                    }
                }
            }
        ...
        public GenericWorkItem dequeueWork() {
            synchronized (this.mLock) {
                ...
                try {
                    ...
                    Log.e(TAG, "Failed to run mParams.dequeueWork()!", e4);
                    return null;
                }
            }
        }
    ...
    public static void enqueueWork(Context context, Class cls, int i4, Intent intent, boolean z4) {
        enqueueWork(context, new ComponentName(context, (Class<?>) cls), i4, intent, z4);
    }

    public static WorkEnqueuer getWorkEnqueuer(Context context, ComponentName componentName, boolean z4, int i4, boolean z5) {
        WorkEnqueuer compatWorkEnqueuer;
        ComponentNameWithWakeful componentNameWithWakeful = new ComponentNameWithWakeful(componentName, z5);
    ...
    public static void enqueueWork(Context context, ComponentName componentName, int i4, Intent intent, boolean z4) {
        if (intent == null) {
            throw new IllegalArgumentException("work must not be null");
        }
        synchronized (sLock) {
            WorkEnqueuer workEnqueuer = getWorkEnqueuer(context, componentName, true, i4, z4);
            ...
            try {
                ...
                getWorkEnqueuer(context, componentName, true, i4, false).enqueueWork(intent);
            }
        }
    }
}
