...
public class FlutterFirebaseMessagingBackgroundService extends JobIntentService {
    ...
    public static void enqueueMessageProcessing(Context context, Intent intent, boolean z4) {
        JobIntentService.enqueueWork(context, FlutterFirebaseMessagingBackgroundService.class, 2020, intent, z4);
    }
    ...
    public static void setCallbackDispatcher(long j4) {
        FlutterFirebaseMessagingBackgroundExecutor.setCallbackDispatcher(j4);
    }

    public static void setUserCallbackHandle(long j4) {
        FlutterFirebaseMessagingBackgroundExecutor.setUserCallbackHandle(j4);
    }

    public static void startBackgroundIsolate(long j4, FlutterShellArgs flutterShellArgs) {
        ...
        flutterFirebaseMessagingBackgroundExecutor.startBackgroundIsolate(j4, flutterShellArgs);
    }
        ...
        synchronized (list) {
            try {
                ...
                try {
                    ...
                    Log.i(TAG, "Exception waiting to execute Dart callback", e4);
                }
            } catch (Throwable th) {
                throw th;
            }
