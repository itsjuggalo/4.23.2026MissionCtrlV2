...
public abstract class PigeonApiCertificate {
    ...
    public static final class Companion {
        ...
        public static final void setUpMessageHandlers$lambda$1$lambda$0(PigeonApiCertificate pigeonApiCertificate, Object obj, BasicMessageChannel.Reply reply) {
            ...
            try {
                listWrapError = AbstractC0768o.b(pigeonApiCertificate.getEncoded((Certificate) obj2));
            } catch (Throwable th) {
        ...
        public final void setUpMessageHandlers(BinaryMessenger binaryMessenger, final PigeonApiCertificate pigeonApiCertificate) {
            ...
            if (pigeonApiCertificate != null) {
                basicMessageChannel.setMessageHandler(new BasicMessageChannel.MessageHandler() { // from class: io.flutter.plugins.webviewflutter.S
                    ...
                    public final void onMessage(Object obj, BasicMessageChannel.Reply reply) {
                        PigeonApiCertificate.Companion.setUpMessageHandlers$lambda$1$lambda$0(pigeonApiCertificate, obj, reply);
                    }
                });
            } else {
    ...
    public final void pigeon_newInstance(Certificate pigeon_instanceArg, final i3.k callback) {
        ...
        if (getPigeonRegistrar().getIgnoreCallsToDart()) {
            ...
            new BasicMessageChannel(getPigeonRegistrar().getBinaryMessenger(), "dev.flutter.pigeon.webview_flutter_android.Certificate.pigeon_newInstance", getPigeonRegistrar().getCodec()).send(AbstractC0768o.b(Long.valueOf(getPigeonRegistrar().getInstanceManager().addHostCreatedInstance(pigeon_instanceArg))), new BasicMessageChannel.Reply() { // from class: io.flutter.plugins.webviewflutter.Q
