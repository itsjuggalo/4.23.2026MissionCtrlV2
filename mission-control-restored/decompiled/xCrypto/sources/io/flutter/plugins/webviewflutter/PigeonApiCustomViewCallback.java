...
public abstract class PigeonApiCustomViewCallback {
    ...
    public static final class Companion {
        ...
        public final void setUpMessageHandlers(BinaryMessenger binaryMessenger, final PigeonApiCustomViewCallback pigeonApiCustomViewCallback) {
            ...
            if (pigeonApiCustomViewCallback != null) {
                basicMessageChannel.setMessageHandler(new BasicMessageChannel.MessageHandler() { // from class: io.flutter.plugins.webviewflutter.f0
                    @Override // io.flutter.plugin.common.BasicMessageChannel.MessageHandler
                    public final void onMessage(Object obj, BasicMessageChannel.Reply reply) {
                        PigeonApiCustomViewCallback.Companion.setUpMessageHandlers$lambda$1$lambda$0(pigeonApiCustomViewCallback, obj, reply);
                    }
                });
            } else {
    ...
    public final void pigeon_newInstance(WebChromeClient.CustomViewCallback pigeon_instanceArg, final i3.k callback) {
        ...
        if (getPigeonRegistrar().getIgnoreCallsToDart()) {
            ...
            new BasicMessageChannel(getPigeonRegistrar().getBinaryMessenger(), "dev.flutter.pigeon.webview_flutter_android.CustomViewCallback.pigeon_newInstance", getPigeonRegistrar().getCodec()).send(AbstractC0768o.b(Long.valueOf(getPigeonRegistrar().getInstanceManager().addHostCreatedInstance(pigeon_instanceArg))), new BasicMessageChannel.Reply() { // from class: io.flutter.plugins.webviewflutter.e0
