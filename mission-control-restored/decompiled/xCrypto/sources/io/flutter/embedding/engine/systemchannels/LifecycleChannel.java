...
public class LifecycleChannel {
    ...
    private void sendState(AppLifecycleState appLifecycleState, boolean z4) {
        ...
        int i4 = AnonymousClass1.$SwitchMap$io$flutter$embedding$engine$systemchannels$LifecycleChannel$AppLifecycleState[appLifecycleState.ordinal()];
        AppLifecycleState appLifecycleState3 = i4 != 1 ? (i4 == 2 || i4 == 3 || i4 == 4 || i4 == 5) ? appLifecycleState : null : z4 ? AppLifecycleState.RESUMED : AppLifecycleState.INACTIVE;
