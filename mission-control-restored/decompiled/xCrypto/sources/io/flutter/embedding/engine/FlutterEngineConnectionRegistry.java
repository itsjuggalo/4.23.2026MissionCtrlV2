...
class FlutterEngineConnectionRegistry implements PluginRegistry, ActivityControlSurface, ServiceControlSurface, BroadcastReceiverControlSurface, ContentProviderControlSurface {
    ...
    public static class FlutterEngineActivityPluginBinding implements ActivityPluginBinding {
        ...
        public FlutterEngineActivityPluginBinding(Activity activity, AbstractC0846i abstractC0846i) {
            this.activity = activity;
            this.hiddenLifecycleReference = new HiddenLifecycleReference(abstractC0846i);
        }
        ...
        public boolean onActivityResult(int i4, int i5, Intent intent) {
            ...
            while (true) {
                boolean z4 = false;
                while (it.hasNext()) {
                    if (((PluginRegistry.ActivityResultListener) it.next()).onActivityResult(i4, i5, intent) || z4) {
                        z4 = true;
                    }
                }
                return z4;
    ...
    public static class FlutterEngineServicePluginBinding implements ServicePluginBinding {
        ...
        public FlutterEngineServicePluginBinding(Service service, AbstractC0846i abstractC0846i) {
            this.service = service;
            this.hiddenLifecycleReference = abstractC0846i != null ? new HiddenLifecycleReference(abstractC0846i) : null;
        }
    ...
    private void attachToActivityInternal(Activity activity, AbstractC0846i abstractC0846i) {
        this.activityPluginBinding = new FlutterEngineActivityPluginBinding(activity, abstractC0846i);
    ...
    public void attachToActivity(ExclusiveAppComponent<Activity> exclusiveAppComponent, AbstractC0846i abstractC0846i) {
        ...
        try {
            ...
            attachToActivityInternal(exclusiveAppComponent.getAppComponent(), abstractC0846i);
            if (traceSectionScoped != null) {
                traceSectionScoped.close();
            }
        } catch (Throwable th) {
    ...
    public void attachToBroadcastReceiver(BroadcastReceiver broadcastReceiver, AbstractC0846i abstractC0846i) {
    ...
    public void attachToContentProvider(ContentProvider contentProvider, AbstractC0846i abstractC0846i) {
    ...
    public void attachToService(Service service, AbstractC0846i abstractC0846i, boolean z4) {
        TraceSection traceSectionScoped = TraceSection.scoped("FlutterEngineConnectionRegistry#attachToService");
        try {
            detachFromAppComponent();
            this.service = service;
            this.servicePluginBinding = new FlutterEngineServicePluginBinding(service, abstractC0846i);
    ...
    public boolean onActivityResult(int i4, int i5, Intent intent) {
        ...
        try {
            boolean zOnActivityResult = this.activityPluginBinding.onActivityResult(i4, i5, intent);
            if (traceSectionScoped != null) {
                traceSectionScoped.close();
            }
    ...
    public boolean onRequestPermissionsResult(int i4, String[] strArr, int[] iArr) {
        ...
        try {
            boolean zOnRequestPermissionsResult = this.activityPluginBinding.onRequestPermissionsResult(i4, strArr, iArr);
            if (traceSectionScoped != null) {
                traceSectionScoped.close();
            }
