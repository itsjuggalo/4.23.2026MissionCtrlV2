...
public class FlutterEngine implements ViewUtils.DisplayUpdater {
    ...
    public FlutterEngine spawn(Context context, DartExecutor.DartEntrypoint dartEntrypoint, String str, List<String> list, PlatformViewsController platformViewsController, boolean z4, boolean z5) {
        if (isAttachedToJni()) {
            return new FlutterEngine(context, null, this.flutterJNI.spawn(dartEntrypoint.dartEntrypointFunctionName, dartEntrypoint.dartEntrypointLibrary, str, list, nextEngineId), platformViewsController, null, z4, z5);
        }
    ...
    public FlutterEngine(Context context, String[] strArr, boolean z4) {
        this(context, null, null, strArr, z4);
    }

    public FlutterEngine(Context context, String[] strArr, boolean z4, boolean z5) {
    ...
    public FlutterEngine(Context context, FlutterLoader flutterLoader, FlutterJNI flutterJNI, String[] strArr, boolean z4) {
        this(context, flutterLoader, flutterJNI, new PlatformViewsController(), strArr, z4);
    }

    public FlutterEngine(Context context, FlutterLoader flutterLoader, FlutterJNI flutterJNI, PlatformViewsController platformViewsController, String[] strArr, boolean z4) {
        this(context, flutterLoader, flutterJNI, platformViewsController, strArr, z4, false);
    }

    public FlutterEngine(Context context, FlutterLoader flutterLoader, FlutterJNI flutterJNI, PlatformViewsController platformViewsController, String[] strArr, boolean z4, boolean z5) {
        this(context, flutterLoader, flutterJNI, platformViewsController, strArr, z4, z5, null);
    }

    public FlutterEngine(Context context, FlutterLoader flutterLoader, FlutterJNI flutterJNI, PlatformViewsController platformViewsController, String[] strArr, boolean z4, boolean z5, FlutterEngineGroup flutterEngineGroup) {
        AssetManager assets;
