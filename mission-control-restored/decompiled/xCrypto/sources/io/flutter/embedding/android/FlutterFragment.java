...
public class FlutterFragment extends AbstractComponentCallbacksC0828p implements FlutterActivityAndFragmentDelegate.Host, ComponentCallbacks2, FlutterActivityAndFragmentDelegate.DelegateFactory {
    ...
    final androidx.activity.p onBackPressedCallback = new androidx.activity.p(true) { // from class: io.flutter.embedding.android.FlutterFragment.2
    ...
    public static class CachedEngineFragmentBuilder {
        ...
        public <T extends FlutterFragment> T build() {
            try {
                T t4 = (T) this.fragmentClass.getDeclaredConstructor(new Class[0]).newInstance(new Object[0]);
                if (t4 != null) {
    ...
    public boolean popSystemNavigator() {
        AbstractActivityC0832u activity;
