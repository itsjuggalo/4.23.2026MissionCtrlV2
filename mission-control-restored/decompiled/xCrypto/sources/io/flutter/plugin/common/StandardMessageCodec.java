...
public class StandardMessageCodec implements MessageCodec<Object> {
    ...
    public static final void readAlignment(ByteBuffer byteBuffer, int i4) {
    ...
    public static final void writeAlignment(ByteArrayOutputStream byteArrayOutputStream, int i4) {
    ...
    public static final void writeChar(ByteArrayOutputStream byteArrayOutputStream, int i4) {
        if (LITTLE_ENDIAN) {
    ...
    public static final void writeDouble(ByteArrayOutputStream byteArrayOutputStream, double d4) {
        writeLong(byteArrayOutputStream, Double.doubleToLongBits(d4));
    }
    ...
    public static final void writeInt(ByteArrayOutputStream byteArrayOutputStream, int i4) {
        if (LITTLE_ENDIAN) {
            byteArrayOutputStream.write(i4);
            byteArrayOutputStream.write(i4 >>> 8);
    ...
    public static final void writeLong(ByteArrayOutputStream byteArrayOutputStream, long j4) {
        if (LITTLE_ENDIAN) {
    ...
    public static final void writeSize(ByteArrayOutputStream byteArrayOutputStream, int i4) {
        if (i4 < 254) {
            byteArrayOutputStream.write(i4);
        } else if (i4 <= 65535) {
            byteArrayOutputStream.write(254);
            writeChar(byteArrayOutputStream, i4);
        } else {
    ...
    public void writeValue(ByteArrayOutputStream byteArrayOutputStream, Object obj) {
        ...
        if (obj instanceof int[]) {
            ...
            while (i4 < length) {
                writeInt(byteArrayOutputStream, iArr[i4]);
                i4++;
            }
            return;
        }
        if (obj instanceof long[]) {
            ...
            while (i4 < length2) {
                writeLong(byteArrayOutputStream, jArr[i4]);
                i4++;
            }
            return;
        }
        if (obj instanceof double[]) {
            ...
            while (i4 < length3) {
                writeDouble(byteArrayOutputStream, dArr[i4]);
                i4++;
            }
            return;
        }
        ...
        while (i4 < length4) {
            writeFloat(byteArrayOutputStream, fArr[i4]);
            i4++;
        }
    }
}
