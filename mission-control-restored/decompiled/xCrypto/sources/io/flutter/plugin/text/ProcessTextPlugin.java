...
public class ProcessTextPlugin implements FlutterPlugin, ActivityAware, PluginRegistry.ActivityResultListener, ProcessTextChannel.ProcessTextMethodHandler {
    ...
    private void cacheResolveInfos() {
        ...
        for (ResolveInfo resolveInfo : i4 >= 33 ? this.packageManager.queryIntentActivities(type, PackageManager.ResolveInfoFlags.of(0L)) : this.packageManager.queryIntentActivities(type, 0)) {
    ...
    public void processTextAction(String str, String str2, boolean z4, MethodChannel.Result result) {
