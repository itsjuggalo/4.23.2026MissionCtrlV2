...
public interface i extends IInterface {
    ...
    public static abstract class a extends Binder implements i {
        ...
        private static final String f9021a = "com.amazon.venezia.command.ResultCallback";

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        static final int f9022b = 1;

        /* JADX INFO: renamed from: c, reason: collision with root package name */
        static final int f9023c = 2;

        /* JADX INFO: renamed from: d, reason: collision with root package name */
        static final int f9024d = 3;

        /* JADX INFO: renamed from: e, reason: collision with root package name */
        static final int f9025e = 4;
        ...
        public static class C0139a implements i {
            ...
            public void a(j jVar) {
                ...
                try {
                    parcelObtain.writeInterfaceToken(a.f9021a);
                    parcelObtain.writeStrongBinder(jVar != null ? jVar.asBinder() : null);
                    this.f9026a.transact(1, parcelObtain, parcelObtain2, 0);
            ...
            public void a(h hVar) {
                ...
                try {
                    ...
                    this.f9026a.transact(2, parcelObtain, parcelObtain2, 0);
                    parcelObtain2.readException();
                    parcelObtain2.recycle();
                    parcelObtain.recycle();
                } catch (Throwable th) {
            ...
            public void a(f fVar) {
                ...
                try {
                    ...
                    this.f9026a.transact(3, parcelObtain, parcelObtain2, 0);
                    parcelObtain2.readException();
                    parcelObtain2.recycle();
                    parcelObtain.recycle();
                } catch (Throwable th) {
            ...
            public void a(g gVar) {
                ...
                try {
                    ...
                    this.f9026a.transact(4, parcelObtain, parcelObtain2, 0);
                    parcelObtain2.readException();
                    parcelObtain2.recycle();
                    parcelObtain.recycle();
                } catch (Throwable th) {
        ...
        public static i a(IBinder iBinder) {
            ...
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface(f9021a);
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof i)) ? new C0139a(iBinder) : (i) iInterfaceQueryLocalInterface;
        }
