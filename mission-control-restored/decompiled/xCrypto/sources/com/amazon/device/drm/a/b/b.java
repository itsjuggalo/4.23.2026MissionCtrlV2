...
public class b extends com.amazon.a.a.j.a {
    ...
    private static final String f9062c = "b";

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private final RequestId f9063d;

    public b(RequestId requestId) {
        this.f9063d = requestId;
    }
            ...
            new Handler(contextC.getMainLooper()).post(new Runnable() { // from class: com.amazon.device.drm.a.b.b.1
                ...
                public void run() {
                    try {
                        ...
                        com.amazon.device.drm.a.e.b.b(b.f9062c, "Unknown response type:" + obj.getClass().getName());
                    } catch (Throwable th) {
                        com.amazon.device.drm.a.e.b.b(b.f9062c, "Error in sendResponse: " + th);
                    }
                }
            });
            return;
        }
        com.amazon.device.drm.a.e.b.a(f9062c, "LicensingListener is not set. Dropping response: " + obj);
    }
