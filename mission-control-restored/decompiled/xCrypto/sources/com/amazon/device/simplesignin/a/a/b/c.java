...
public abstract class c extends com.amazon.device.simplesignin.a.a.c {
    ...
    public boolean a(Map map) {
        if (!map.containsKey(com.amazon.device.simplesignin.a.a.a.f9280m)) {
            a(RequestStatus.FAILURE);
            return false;
        }
        String str = (String) map.get(com.amazon.device.simplesignin.a.a.a.f9280m);
        if (str == null) {
            a(RequestStatus.FAILURE);
            return false;
        }
        String strA = (!map.containsKey(com.amazon.device.simplesignin.a.a.a.f9278k) || map.get(com.amazon.device.simplesignin.a.a.a.f9278k) == null) ? null : (String) map.get(com.amazon.device.simplesignin.a.a.a.f9278k);
        if (map.containsKey(com.amazon.device.simplesignin.a.a.a.f9279l) && map.get(com.amazon.device.simplesignin.a.a.a.f9279l) != null) {
            strA = com.amazon.device.simplesignin.a.d.b.a((String) map.get(com.amazon.device.simplesignin.a.a.a.f9279l));
        }
