...
public final class PromotionPlan implements Parcelable {
    public static final Parcelable.Creator<PromotionPlan> CREATOR = new Parcelable.Creator<PromotionPlan>() { // from class: com.amazon.device.iap.model.PromotionPlan.1
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public PromotionPlan[] newArray(int i4) {
            return new PromotionPlan[i4];
        }
    };
    ...
    public JSONObject toJSON() throws JSONException {
        ...
        jSONObject.put(b.f8772t, getPromotionPricePeriod());
        jSONObject.put(b.f8774v, getPromotionPrice());
        jSONObject.put(b.f8773u, getPromotionPriceCycles());
        return jSONObject;
    }
    ...
    public PromotionPlan(String str, String str2, int i4) {
        this.promotionPricePeriod = str;
        this.promotionPrice = str2;
        this.promotionPriceCycles = i4;
    }
