...
public class f extends ObjectInputStream {
    ...
    private void b(String str) throws InvalidClassException {
        Iterator<a> it = this.f8833b.iterator();
        while (it.hasNext()) {
            if (it.next().a(str)) {
                a(str);
            }
        }
        Iterator<a> it2 = this.f8832a.iterator();
        while (it2.hasNext()) {
            if (it2.next().a(str)) {
                return;
            }
    ...
    public f a(Class<?>... clsArr) {
        for (Class<?> cls : clsArr) {
            this.f8832a.add(new c(cls.getName()));
        }
        return this;
    }
    ...
    public f a(String... strArr) {
        for (String str : strArr) {
            this.f8832a.add(new g(str));
        }
        return this;
    }

    public f a(Pattern pattern) {
        this.f8832a.add(new e(pattern));
        return this;
    }
    ...
    public f b(Class<?>... clsArr) {
        for (Class<?> cls : clsArr) {
            this.f8833b.add(new c(cls.getName()));
        }
        return this;
    }
    ...
    public f b(String... strArr) {
        for (String str : strArr) {
            this.f8833b.add(new g(str));
        }
        return this;
    }

    public f b(Pattern pattern) {
        this.f8833b.add(new e(pattern));
        return this;
    }
