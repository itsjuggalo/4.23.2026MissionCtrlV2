...
public class a {
                ...
                for (X509Certificate x509Certificate : acceptedIssuers) {
                    if (a(x509Certificate)) {
                        if (com.amazon.a.a.o.c.f8809a) {
                            f8779a.a("Trusted Cert: " + x509Certificate.getSubjectX500Principal().getName());
                        }
                        this.f8785e.add(new TrustAnchor(x509Certificate, null));
                        i4++;
                    }
                }
                if (com.amazon.a.a.o.c.f8809a) {
                    f8779a.a(String.format("loaded %d certs\n", Integer.valueOf(i4)));
                }
            }
        }
        if (this.f8785e.isEmpty()) {
            f8779a.b("TrustManager did not return valid accepted issuers, likely 3P custom TrustManager implementation issue.");
        }
        PKIXParameters pKIXParameters = new PKIXParameters(this.f8785e);
        this.f8783c = pKIXParameters;
        pKIXParameters.setRevocationEnabled(false);
        this.f8784d = CertPathValidator.getInstance(f8780b);
    }
    ...
    public static boolean a(X509Certificate x509Certificate) {
        try {
            ...
            if (a(f8781f, bArrDigest)) {
                return true;
            }
            return a(f8782g, bArrDigest);
        } catch (NoSuchAlgorithmException e4) {
            f8779a.b("Signature algorithm unrecognized", e4);
            return false;
        } catch (CertificateEncodingException e5) {
            f8779a.b("Cant get fingerprint", e5);
            return false;
        }
    }
    ...
    public boolean a(CertPath certPath) {
        try {
            ...
            f8779a.a("Verifying CertPath with " + notBefore);
            this.f8783c.setDate(notBefore);
            this.f8784d.validate(certPath, this.f8783c);
            return true;
        } catch (Exception e4) {
            if (com.amazon.a.a.o.c.f8809a) {
                f8779a.b("Failed to verify cert path: " + e4, e4);
            }
            return false;
        }
    }
