...
public final class StoreTransaction implements Parcelable {
    ...
    public final StoreTransaction copy(String str, List<String> productIds, ProductType type, long j4, String purchaseToken, PurchaseState purchaseState, Boolean bool, String str2, JSONObject originalJson, PresentedOfferingContext presentedOfferingContext, String str3, PurchaseType purchaseType, String str4, String str5, ReplacementMode replacementMode) {
        ...
        r.f(originalJson, "originalJson");
        r.f(purchaseType, "purchaseType");
        return new StoreTransaction(str, productIds, type, j4, purchaseToken, purchaseState, bool, str2, originalJson, presentedOfferingContext, str3, purchaseType, str4, str5, replacementMode);
    }
    ...
    public void writeToParcel(Parcel out, int i4) {
        ...
        JSONObjectParceler.INSTANCE.write(this.originalJson, out, i4);
        PresentedOfferingContext presentedOfferingContext = this.presentedOfferingContext;
        if (presentedOfferingContext == null) {
            out.writeInt(0);
        } else {
            out.writeInt(1);
            presentedOfferingContext.writeToParcel(out, i4);
        }
        ...
        out.writeParcelable(this.replacementMode, i4);
    }

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public StoreTransaction(String str, List<String> productIds, ProductType type, long j4, String purchaseToken, PurchaseState purchaseState, Boolean bool, String str2, JSONObject originalJson, String str3, String str4, PurchaseType purchaseType, String str5, String str6, ReplacementMode replacementMode) {
        this(str, productIds, type, j4, purchaseToken, purchaseState, bool, str2, originalJson, str3 != null ? new PresentedOfferingContext(str3) : null, str4, purchaseType, str5, str6, replacementMode);
        r.f(productIds, "productIds");
        r.f(type, "type");
        r.f(purchaseToken, "purchaseToken");
        r.f(purchaseState, "purchaseState");
