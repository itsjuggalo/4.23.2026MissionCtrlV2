...
public final class CustomerCenterConfigData$Localization$$serializer implements C {
    ...
    static {
        ...
        C0327b0 c0327b0 = new C0327b0("com.revenuecat.purchases.customercenter.CustomerCenterConfigData.Localization", customerCenterConfigData$Localization$$serializer, 2);
    ...
    public b[] childSerializers() {
        return new b[]{o0.f952a, CustomerCenterConfigData.Localization.$childSerializers[1]};
    }
    ...
    public CustomerCenterConfigData.Localization deserialize(e decoder) {
        ...
        cVarD.c(descriptor2);
        return new CustomerCenterConfigData.Localization(i4, strV, (Map) objM, null);
    }
    ...
    public void serialize(f encoder, CustomerCenterConfigData.Localization value) {
        ...
        CustomerCenterConfigData.Localization.write$Self(value, dVarD, descriptor2);
        dVarD.c(descriptor2);
    }
