...
public final class CustomerCenterImpressionEvent implements FeatureEvent {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public /* synthetic */ CustomerCenterImpressionEvent(CreationData creationData, Data data, int i4, AbstractC1585j abstractC1585j) {
        if ((i4 & 1) != 0) {
    ...
    public static final class Data {
        ...
        public Data(Date timestamp, boolean z4, String locale, int i4, int i5, CustomerCenterDisplayMode displayMode) {
        ...
        public /* synthetic */ Data(Date date, boolean z4, String str, int i4, int i5, CustomerCenterDisplayMode customerCenterDisplayMode, int i6, AbstractC1585j abstractC1585j) {
            this(date, z4, str, (i6 & 8) != 0 ? 1 : i4, (i6 & 16) != 0 ? 1 : i5, (i6 & 32) != 0 ? CustomerCenterDisplayMode.FULL_SCREEN : customerCenterDisplayMode);
        }
    }
}
