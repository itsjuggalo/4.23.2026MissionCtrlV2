...
final class CustomerInfoDataResult {
    ...
    public static /* synthetic */ CustomerInfoDataResult copy$default(CustomerInfoDataResult customerInfoDataResult, Result result, Boolean bool, int i4, Object obj) {
        if ((i4 & 1) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        return r.b(this.result, customerInfoDataResult.result) && r.b(this.hadUnsyncedPurchasesBefore, customerInfoDataResult.hadUnsyncedPurchasesBefore);
    }
    ...
    public /* synthetic */ CustomerInfoDataResult(Result result, Boolean bool, int i4, AbstractC1585j abstractC1585j) {
        this(result, (i4 & 2) != 0 ? null : bool);
    }
}
