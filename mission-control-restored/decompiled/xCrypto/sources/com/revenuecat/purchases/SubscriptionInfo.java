...
public final class SubscriptionInfo {
    ...
    public SubscriptionInfo(String productIdentifier, Date purchaseDate, Date date, Date date2, Store store, Date date3, boolean z4, Date date4, Date date5, OwnershipType ownershipType, PeriodType periodType, Date date6, String str, Date date7, String str2, Price price, String str3, Uri uri, Date requestDate) {
        ...
        this.isActive = DateHelper.Companion.m215isDateActiveSxA4cEA$default(DateHelper.Companion, date2, requestDate, 0L, 4, null).isActive();
    ...
    public /* synthetic */ SubscriptionInfo(String str, Date date, Date date2, Date date3, Store store, Date date4, boolean z4, Date date5, Date date6, OwnershipType ownershipType, PeriodType periodType, Date date7, String str2, Date date8, String str3, Price price, String str4, Uri uri, Date date9, int i4, AbstractC1585j abstractC1585j) {
        this(str, date, date2, date3, store, date4, z4, date5, date6, (i4 & 512) != 0 ? OwnershipType.UNKNOWN : ownershipType, periodType, date7, str2, date8, str3, price, str4, uri, date9);
    }

    public /* synthetic */ SubscriptionInfo(String str, Date date, Date date2, Date date3, Store store, Date date4, boolean z4, Date date5, Date date6, OwnershipType ownershipType, PeriodType periodType, Date date7, String str2, Date date8, int i4, AbstractC1585j abstractC1585j) {
        this(str, date, date2, date3, store, date4, z4, date5, date6, (i4 & 512) != 0 ? OwnershipType.UNKNOWN : ownershipType, periodType, date7, str2, date8);
    }

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public SubscriptionInfo(String productIdentifier, Date purchaseDate, Date date, Date date2, Store store, Date date3, boolean z4, Date date4, Date date5, OwnershipType ownershipType, PeriodType periodType, Date date6, String str, Date requestDate) {
        this(productIdentifier, purchaseDate, date, date2, store, date3, z4, date4, date5, ownershipType, periodType, date6, str, null, null, null, null, null, requestDate);
        r.f(productIdentifier, "productIdentifier");
        r.f(purchaseDate, "purchaseDate");
        r.f(store, "store");
        r.f(ownershipType, "ownershipType");
    ...
    public /* synthetic */ SubscriptionInfo(String str, Date date, Date date2, Date date3, Store store, Date date4, boolean z4, Date date5, Date date6, OwnershipType ownershipType, PeriodType periodType, Date date7, String str2, Date date8, String str3, Price price, String str4, Date date9, int i4, AbstractC1585j abstractC1585j) {
        this(str, date, date2, date3, store, date4, z4, date5, date6, (i4 & 512) != 0 ? OwnershipType.UNKNOWN : ownershipType, periodType, date7, str2, date8, str3, price, str4, date9);
    }

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public SubscriptionInfo(String productIdentifier, Date purchaseDate, Date date, Date date2, Store store, Date date3, boolean z4, Date date4, Date date5, OwnershipType ownershipType, PeriodType periodType, Date date6, String str, Date date7, String str2, Price price, String str3, Date requestDate) {
        this(productIdentifier, purchaseDate, date, date2, store, date3, z4, date4, date5, ownershipType, periodType, date6, str, date7, str2, price, str3, null, requestDate);
        r.f(productIdentifier, "productIdentifier");
        r.f(purchaseDate, "purchaseDate");
        r.f(store, "store");
        r.f(ownershipType, "ownershipType");
    ...
    public /* synthetic */ SubscriptionInfo(String str, Date date, SubscriptionInfoResponse subscriptionInfoResponse, Locale locale, int i4, AbstractC1585j abstractC1585j) {
        if ((i4 & 8) != 0) {
