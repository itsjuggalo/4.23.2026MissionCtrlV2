...
public final class SyncPurchasesHelper$syncPurchases$2$1$2 extends s implements k {
    ...
    public SyncPurchasesHelper$syncPurchases$2$1$2(List<PurchasesError> list, StoreTransaction storeTransaction, StoreTransaction storeTransaction2, SyncPurchasesHelper syncPurchasesHelper, String str, boolean z4, boolean z5, k kVar, k kVar2) {
        super(1);
        this.$errors = list;
