...
public final class ButtonComponent$Destination$PrivacyPolicy$$serializer implements C {
    ...
    static {
        ...
        C0327b0 c0327b0 = new C0327b0("com.revenuecat.purchases.paywalls.components.ButtonComponent.Destination.PrivacyPolicy", buttonComponent$Destination$PrivacyPolicy$$serializer, 2);
    ...
    public ButtonComponent.Destination.PrivacyPolicy deserialize(e decoder) {
        ...
        return new ButtonComponent.Destination.PrivacyPolicy(i4, localizationKey != null ? localizationKey.m199unboximpl() : null, (ButtonComponent.UrlMethod) objM2, null, null);
    }
    ...
    public void serialize(f encoder, ButtonComponent.Destination.PrivacyPolicy value) {
        ...
        ButtonComponent.Destination.PrivacyPolicy.write$Self(value, dVarD, descriptor2);
        dVarD.c(descriptor2);
    }
