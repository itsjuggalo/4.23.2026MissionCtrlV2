...
public final class ThemeImageUrls$$serializer implements C {
    ...
    static {
        ...
        C0327b0 c0327b0 = new C0327b0("com.revenuecat.purchases.paywalls.components.properties.ThemeImageUrls", themeImageUrls$$serializer, 2);
    ...
    public ThemeImageUrls deserialize(e decoder) {
        ...
        if (cVarD.w()) {
            ImageUrls$$serializer imageUrls$$serializer = ImageUrls$$serializer.INSTANCE;
            objM = cVarD.m(descriptor2, 0, imageUrls$$serializer, null);
            objY = cVarD.y(descriptor2, 1, imageUrls$$serializer, null);
            i4 = 3;
        } else {
            boolean z4 = true;
            int i5 = 0;
            ...
            while (z4) {
                ...
                if (i6 == -1) {
                    ...
                    objM2 = cVarD.m(descriptor2, 0, ImageUrls$$serializer.INSTANCE, objM2);
                    i5 |= 1;
                } else {
                    if (i6 != 1) {
                        throw new j(i6);
                    }
                    objY = cVarD.y(descriptor2, 1, ImageUrls$$serializer.INSTANCE, objY);
                    i5 |= 2;
                }
            }
            i4 = i5;
        ...
        cVarD.c(descriptor2);
        return new ThemeImageUrls(i4, (ImageUrls) objM, (ImageUrls) objY, (k0) null);
    }
    ...
    public void serialize(f encoder, ThemeImageUrls value) {
        ...
        ThemeImageUrls.write$Self(value, dVarD, descriptor2);
        dVarD.c(descriptor2);
    }
