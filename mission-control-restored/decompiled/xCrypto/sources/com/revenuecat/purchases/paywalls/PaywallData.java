...
public final class PaywallData {
    ...
    public /* synthetic */ PaywallData(int i4, String str, Configuration configuration, URL url, int i5, Map map, Map map2, List list, String str2, k0 k0Var) {
        if (23 != (i4 & 23)) {
            AbstractC0325a0.a(i4, 23, PaywallData$$serializer.INSTANCE.getDescriptor());
        }
    ...
    public static /* synthetic */ PaywallData copy$default(PaywallData paywallData, String str, Configuration configuration, URL url, int i4, Map map, Map map2, List list, String str2, int i5, Object obj) {
        if ((i5 & 1) != 0) {
        ...
        Map map3 = map;
        Map map4 = map2;
        return paywallData.copy(str, configuration, url, i4, map3, map4, list2, str3);
    }
    ...
    private final o tieredConfigForLocales(List<Locale> list) {
        ...
        Map.Entry entry2 = (Map.Entry) x.G(this.localizationByTier.entrySet());
    ...
    public static final /* synthetic */ void write$Self(PaywallData paywallData, d dVar, e eVar) {
        ...
        dVar.u(eVar, 1, PaywallData$Configuration$$serializer.INSTANCE, paywallData.config);
        dVar.u(eVar, 2, URLSerializer.INSTANCE, paywallData.assetBaseURL);
        if (dVar.j(eVar, 3) || paywallData.revision != 0) {
            dVar.k(eVar, 3, paywallData.revision);
        }
        dVar.u(eVar, 4, bVarArr[4], paywallData.localization);
        if (dVar.j(eVar, 5) || !r.b(paywallData.localizationByTier, L.e())) {
            dVar.u(eVar, 5, bVarArr[5], paywallData.localizationByTier);
        }
        if (dVar.j(eVar, 6) || !r.b(paywallData.zeroDecimalPlaceCountries, AbstractC0769p.g())) {
            dVar.u(eVar, 6, GoogleListSerializer.INSTANCE, paywallData.zeroDecimalPlaceCountries);
        }
        if (!dVar.j(eVar, 7) && paywallData.defaultLocale == null) {
            return;
        }
        dVar.E(eVar, 7, o0.f952a, paywallData.defaultLocale);
    }
    ...
    public final PaywallData copy(String templateName, Configuration config, URL assetBaseURL, int i4, Map<String, LocalizedConfiguration> localization, Map<String, ? extends Map<String, LocalizedConfiguration>> localizationByTier, List<String> zeroDecimalPlaceCountries, String str) {
        ...
        return new PaywallData(templateName, config, assetBaseURL, i4, localization, localizationByTier, zeroDecimalPlaceCountries, str);
    }
    ...
    public final o localizedConfiguration(List<Locale> locales) {
        ...
        Map.Entry entry2 = (Map.Entry) x.G(this.localization.entrySet());
        return t.a(LocaleExtensionsKt.toLocale((String) entry2.getKey()), entry2.getValue());
    }
    ...
    public static final class Configuration {
        ...
        public static final class ColorInformation {
            ...
            public /* synthetic */ ColorInformation(int i4, Colors colors, Colors colors2, k0 k0Var) {
                if (1 != (i4 & 1)) {
                    AbstractC0325a0.a(i4, 1, PaywallData$Configuration$ColorInformation$$serializer.INSTANCE.getDescriptor());
                }
                this.light = colors;
                if ((i4 & 2) == 0) {
                    this.dark = null;
            ...
            public static /* synthetic */ ColorInformation copy$default(ColorInformation colorInformation, Colors colors, Colors colors2, int i4, Object obj) {
                if ((i4 & 1) != 0) {
            ...
            public static final /* synthetic */ void write$Self(ColorInformation colorInformation, d dVar, e eVar) {
                ...
                dVar.u(eVar, 0, paywallData$Configuration$Colors$$serializer, colorInformation.light);
                if (!dVar.j(eVar, 1) && colorInformation.dark == null) {
                    return;
                }
                dVar.E(eVar, 1, paywallData$Configuration$Colors$$serializer, colorInformation.dark);
            }
            ...
            public /* synthetic */ ColorInformation(Colors colors, Colors colors2, int i4, AbstractC1585j abstractC1585j) {
                this(colors, (i4 & 2) != 0 ? null : colors2);
            }
        }
        ...
        public static final class Colors {
            ...
            public static final /* synthetic */ void write$Self(Colors colors, d dVar, e eVar) {
                ...
                dVar.u(eVar, 0, serializer, colors.background);
                dVar.u(eVar, 1, serializer, colors.text1);
                if (dVar.j(eVar, 2) || colors.text2 != null) {
                    dVar.E(eVar, 2, serializer, colors.text2);
                }
                if (dVar.j(eVar, 3) || colors.text3 != null) {
                    dVar.E(eVar, 3, serializer, colors.text3);
                }
                dVar.u(eVar, 4, serializer, colors.callToActionBackground);
                dVar.u(eVar, 5, serializer, colors.callToActionForeground);
                if (dVar.j(eVar, 6) || colors.callToActionSecondaryBackground != null) {
                    dVar.E(eVar, 6, serializer, colors.callToActionSecondaryBackground);
                }
                if (dVar.j(eVar, 7) || colors.accent1 != null) {
                    dVar.E(eVar, 7, serializer, colors.accent1);
                }
                if (dVar.j(eVar, 8) || colors.accent2 != null) {
                    dVar.E(eVar, 8, serializer, colors.accent2);
                }
                if (dVar.j(eVar, 9) || colors.accent3 != null) {
                    dVar.E(eVar, 9, serializer, colors.accent3);
                }
                if (dVar.j(eVar, 10) || colors.closeButton != null) {
                    dVar.E(eVar, 10, serializer, colors.closeButton);
                }
                if (dVar.j(eVar, 11) || colors.tierControlBackground != null) {
                    dVar.E(eVar, 11, serializer, colors.tierControlBackground);
                }
                if (dVar.j(eVar, 12) || colors.tierControlForeground != null) {
                    dVar.E(eVar, 12, serializer, colors.tierControlForeground);
                }
                if (dVar.j(eVar, 13) || colors.tierControlSelectedBackground != null) {
                    dVar.E(eVar, 13, serializer, colors.tierControlSelectedBackground);
                }
                if (!dVar.j(eVar, 14) && colors.tierControlSelectedForeground == null) {
                    return;
                }
                dVar.E(eVar, 14, serializer, colors.tierControlSelectedForeground);
            }
            ...
            public /* synthetic */ Colors(PaywallColor paywallColor, PaywallColor paywallColor2, PaywallColor paywallColor3, PaywallColor paywallColor4, PaywallColor paywallColor5, PaywallColor paywallColor6, PaywallColor paywallColor7, PaywallColor paywallColor8, PaywallColor paywallColor9, PaywallColor paywallColor10, PaywallColor paywallColor11, PaywallColor paywallColor12, PaywallColor paywallColor13, PaywallColor paywallColor14, PaywallColor paywallColor15, int i4, AbstractC1585j abstractC1585j) {
                this(paywallColor, paywallColor2, (i4 & 4) != 0 ? null : paywallColor3, (i4 & 8) != 0 ? null : paywallColor4, paywallColor5, paywallColor6, (i4 & 64) != 0 ? null : paywallColor7, (i4 & UserMetadata.MAX_ROLLOUT_ASSIGNMENTS) != 0 ? null : paywallColor8, (i4 & 256) != 0 ? null : paywallColor9, (i4 & 512) != 0 ? null : paywallColor10, (i4 & UserMetadata.MAX_ATTRIBUTE_SIZE) != 0 ? null : paywallColor11, (i4 & 2048) != 0 ? null : paywallColor12, (i4 & 4096) != 0 ? null : paywallColor13, (i4 & UserMetadata.MAX_INTERNAL_KEY_SIZE) != 0 ? null : paywallColor14, (i4 & 16384) != 0 ? null : paywallColor15);
            }
        }
        ...
        public static final class Images {
            ...
            public Images() {
                this((String) null, (String) null, (String) null, 7, (AbstractC1585j) null);
            }

            public static /* synthetic */ Images copy$default(Images images, String str, String str2, String str3, int i4, Object obj) {
                if ((i4 & 1) != 0) {
                    str = images.header;
                }
                if ((i4 & 2) != 0) {
            ...
            public static final /* synthetic */ void write$Self(Images images, d dVar, e eVar) {
                if (dVar.j(eVar, 0) || images.header != null) {
                    dVar.E(eVar, 0, EmptyStringToNullSerializer.INSTANCE, images.header);
                }
                if (dVar.j(eVar, 1) || images.background != null) {
                    dVar.E(eVar, 1, EmptyStringToNullSerializer.INSTANCE, images.background);
                }
                if (!dVar.j(eVar, 2) && images.icon == null) {
                    return;
                }
                dVar.E(eVar, 2, EmptyStringToNullSerializer.INSTANCE, images.icon);
            }
            ...
            public final List<String> getAll$purchases_defaultsRelease() {
                return AbstractC0769p.l(this.header, this.background, this.icon);
            }
            ...
            public /* synthetic */ Images(int i4, String str, String str2, String str3, k0 k0Var) {
                if ((i4 & 1) == 0) {
                    this.header = null;
                } else {
                    this.header = str;
            ...
            public /* synthetic */ Images(String str, String str2, String str3, int i4, AbstractC1585j abstractC1585j) {
        ...
        public static final class Tier {
            ...
            private final List<String> packageIds;
            public static final Companion Companion = new Companion(null);
            private static final b[] $childSerializers = {null, new C0332e(o0.f952a), null};
            ...
            public /* synthetic */ Tier(int i4, String str, List list, String str2, k0 k0Var) {
                if (7 != (i4 & 7)) {
                    AbstractC0325a0.a(i4, 7, PaywallData$Configuration$Tier$$serializer.INSTANCE.getDescriptor());
                }
                this.id = str;
            ...
            /* JADX WARN: Multi-variable type inference failed */
            public static /* synthetic */ Tier copy$default(Tier tier, String str, List list, String str2, int i4, Object obj) {
                if ((i4 & 1) != 0) {
                    str = tier.id;
                }
                if ((i4 & 2) != 0) {
            ...
            public static final /* synthetic */ void write$Self(Tier tier, d dVar, e eVar) {
                ...
                dVar.u(eVar, 1, bVarArr[1], tier.packageIds);
        ...
        static {
            o0 o0Var = o0.f952a;
            $childSerializers = new b[]{new C0332e(o0Var), null, null, null, new K(o0Var, PaywallData$Configuration$Images$$serializer.INSTANCE), null, null, null, null, null, new K(o0Var, PaywallData$Configuration$ColorInformation$$serializer.INSTANCE), new C0332e(PaywallData$Configuration$Tier$$serializer.INSTANCE), null};
        }

        public /* synthetic */ Configuration(int i4, List list, String str, Images images, Images images2, Map map, boolean z4, boolean z5, URL url, URL url2, ColorInformation colorInformation, Map map2, List list2, String str2, k0 k0Var) {
            if (512 != (i4 & 512)) {
                AbstractC0325a0.a(i4, 512, PaywallData$Configuration$$serializer.INSTANCE.getDescriptor());
            }
            this.packageIds = (i4 & 1) == 0 ? AbstractC0769p.g() : list;
            if ((i4 & 2) == 0) {
            ...
            if ((i4 & 32) == 0) {
                ...
                this.blurredBackgroundImage = z4;
            }
            if ((i4 & 64) == 0) {
                this.displayRestorePurchases = true;
            } else {
                this.displayRestorePurchases = z5;
            }
            if ((i4 & UserMetadata.MAX_ROLLOUT_ASSIGNMENTS) == 0) {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        public static /* synthetic */ Configuration copy$default(Configuration configuration, List list, String str, Images images, Images images2, Map map, boolean z4, boolean z5, URL url, URL url2, ColorInformation colorInformation, Map map2, List list2, String str2, int i4, Object obj) {
            if ((i4 & 1) != 0) {
                list = configuration.packageIds;
            }
            return configuration.copy(list, (i4 & 2) != 0 ? configuration.defaultPackage : str, (i4 & 4) != 0 ? configuration.imagesWebp : images, (i4 & 8) != 0 ? configuration.legacyImages : images2, (i4 & 16) != 0 ? configuration.imagesByTier : map, (i4 & 32) != 0 ? configuration.blurredBackgroundImage : z4, (i4 & 64) != 0 ? configuration.displayRestorePurchases : z5, (i4 & UserMetadata.MAX_ROLLOUT_ASSIGNMENTS) != 0 ? configuration.termsOfServiceURL : url, (i4 & 256) != 0 ? configuration.privacyURL : url2, (i4 & 512) != 0 ? configuration.colors : colorInformation, (i4 & UserMetadata.MAX_ATTRIBUTE_SIZE) != 0 ? configuration.colorsByTier : map2, (i4 & 2048) != 0 ? configuration.tiers : list2, (i4 & 4096) != 0 ? configuration.defaultTier : str2);
        }
        ...
        public static final /* synthetic */ void write$Self(Configuration configuration, d dVar, e eVar) {
            b[] bVarArr = $childSerializers;
            if (dVar.j(eVar, 0) || !r.b(configuration.packageIds, AbstractC0769p.g())) {
                dVar.u(eVar, 0, bVarArr[0], configuration.packageIds);
            }
            if (dVar.j(eVar, 1) || configuration.defaultPackage != null) {
                dVar.E(eVar, 1, o0.f952a, configuration.defaultPackage);
            }
            if (dVar.j(eVar, 2) || configuration.imagesWebp != null) {
                dVar.E(eVar, 2, PaywallData$Configuration$Images$$serializer.INSTANCE, configuration.imagesWebp);
            }
            if (dVar.j(eVar, 3) || configuration.legacyImages != null) {
                dVar.E(eVar, 3, PaywallData$Configuration$Images$$serializer.INSTANCE, configuration.legacyImages);
            }
            if (dVar.j(eVar, 4) || configuration.imagesByTier != null) {
                dVar.E(eVar, 4, bVarArr[4], configuration.imagesByTier);
            }
            if (dVar.j(eVar, 5) || configuration.blurredBackgroundImage) {
                dVar.y(eVar, 5, configuration.blurredBackgroundImage);
            }
            if (dVar.j(eVar, 6) || !configuration.displayRestorePurchases) {
                dVar.y(eVar, 6, configuration.displayRestorePurchases);
            }
            if (dVar.j(eVar, 7) || configuration.termsOfServiceURL != null) {
                dVar.E(eVar, 7, OptionalURLSerializer.INSTANCE, configuration.termsOfServiceURL);
            }
            if (dVar.j(eVar, 8) || configuration.privacyURL != null) {
                dVar.E(eVar, 8, OptionalURLSerializer.INSTANCE, configuration.privacyURL);
            }
            dVar.u(eVar, 9, PaywallData$Configuration$ColorInformation$$serializer.INSTANCE, configuration.colors);
            if (dVar.j(eVar, 10) || configuration.colorsByTier != null) {
                dVar.E(eVar, 10, bVarArr[10], configuration.colorsByTier);
            }
            if (dVar.j(eVar, 11) || configuration.tiers != null) {
                dVar.E(eVar, 11, bVarArr[11], configuration.tiers);
            }
            if (!dVar.j(eVar, 12) && configuration.defaultTier == null) {
                return;
            }
            dVar.E(eVar, 12, o0.f952a, configuration.defaultTier);
        }
        ...
        public final Configuration copy(List<String> packageIds, String str, Images images, Images images2, Map<String, Images> map, boolean z4, boolean z5, URL url, URL url2, ColorInformation colors, Map<String, ColorInformation> map2, List<Tier> list, String str2) {
            r.f(packageIds, "packageIds");
            r.f(colors, "colors");
            return new Configuration(packageIds, str, images, images2, map, z4, z5, url, url2, colors, map2, list, str2);
        }
        ...
        public int hashCode() {
            ...
            boolean z4 = this.blurredBackgroundImage;
            ?? r12 = z4;
            if (z4) {
                r12 = 1;
            }
            int i4 = (iHashCode5 + r12) * 31;
            boolean z5 = this.displayRestorePurchases;
            int i5 = (i4 + (z5 ? 1 : z5)) * 31;
            URL url = this.termsOfServiceURL;
            int iHashCode6 = (i5 + (url == null ? 0 : url.hashCode())) * 31;
        ...
        public Configuration(List<String> packageIds, String str, Images images, Images images2, Map<String, Images> map, boolean z4, boolean z5, URL url, URL url2, ColorInformation colors, Map<String, ColorInformation> map2, List<Tier> list, String str2) {
            r.f(packageIds, "packageIds");
            r.f(colors, "colors");
            this.packageIds = packageIds;
            this.defaultPackage = str;
        ...
        public /* synthetic */ Configuration(List list, String str, Images images, Map map, ColorInformation colorInformation, Map map2, List list2, boolean z4, boolean z5, URL url, URL url2, int i4, AbstractC1585j abstractC1585j) {
            this(list, (i4 & 2) != 0 ? null : str, images, (i4 & 8) != 0 ? null : map, colorInformation, (i4 & 32) != 0 ? null : map2, (i4 & 64) != 0 ? null : list2, (i4 & UserMetadata.MAX_ROLLOUT_ASSIGNMENTS) != 0 ? false : z4, (i4 & 256) != 0 ? true : z5, (i4 & 512) != 0 ? null : url, (i4 & UserMetadata.MAX_ATTRIBUTE_SIZE) != 0 ? null : url2);
        }

        /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
        public Configuration(List<String> packageIds, String str, Images images, Map<String, Images> map, ColorInformation colors, Map<String, ColorInformation> map2, List<Tier> list, boolean z4, boolean z5, URL url, URL url2) {
            this(packageIds, str, images, (Images) null, map, z4, z5, url, url2, colors, map2, list, (String) null, 4104, (AbstractC1585j) null);
            r.f(packageIds, "packageIds");
            r.f(images, "images");
            r.f(colors, "colors");
        }
    ...
    public static final class LocalizedConfiguration {
        ...
        public static final Companion Companion = new Companion(null);
        private static final b[] $childSerializers = {null, null, null, null, null, null, null, null, null, new C0332e(PaywallData$LocalizedConfiguration$Feature$$serializer.INSTANCE), null, new K(o0.f952a, PaywallData$LocalizedConfiguration$OfferOverride$$serializer.INSTANCE)};
        ...
        public static final class Feature {
            ...
            public /* synthetic */ Feature(int i4, String str, String str2, String str3, k0 k0Var) {
                if (1 != (i4 & 1)) {
                    AbstractC0325a0.a(i4, 1, PaywallData$LocalizedConfiguration$Feature$$serializer.INSTANCE.getDescriptor());
                }
                this.title = str;
                if ((i4 & 2) == 0) {
                    this.content = null;
            ...
            public static /* synthetic */ Feature copy$default(Feature feature, String str, String str2, String str3, int i4, Object obj) {
                if ((i4 & 1) != 0) {
                    str = feature.title;
                }
                if ((i4 & 2) != 0) {
            ...
            public static final /* synthetic */ void write$Self(Feature feature, d dVar, e eVar) {
                ...
                if (dVar.j(eVar, 1) || feature.content != null) {
                    dVar.E(eVar, 1, o0.f952a, feature.content);
                }
                if (!dVar.j(eVar, 2) && feature.iconID == null) {
                    return;
                }
                dVar.E(eVar, 2, o0.f952a, feature.iconID);
            }
            ...
            public /* synthetic */ Feature(String str, String str2, String str3, int i4, AbstractC1585j abstractC1585j) {
        ...
        public static final class OfferOverride {
            ...
            public /* synthetic */ OfferOverride(int i4, String str, String str2, String str3, String str4, String str5, k0 k0Var) {
                if (3 != (i4 & 3)) {
                    AbstractC0325a0.a(i4, 3, PaywallData$LocalizedConfiguration$OfferOverride$$serializer.INSTANCE.getDescriptor());
                }
                this.offerName = str;
            ...
            public static /* synthetic */ OfferOverride copy$default(OfferOverride offerOverride, String str, String str2, String str3, String str4, String str5, int i4, Object obj) {
                if ((i4 & 1) != 0) {
            ...
            public static final /* synthetic */ void write$Self(OfferOverride offerOverride, d dVar, e eVar) {
                ...
                if (dVar.j(eVar, 2) || offerOverride.offerDetailsWithIntroOffer != null) {
                    dVar.E(eVar, 2, EmptyStringToNullSerializer.INSTANCE, offerOverride.offerDetailsWithIntroOffer);
                }
                if (dVar.j(eVar, 3) || offerOverride.offerDetailsWithMultipleIntroOffers != null) {
                    dVar.E(eVar, 3, EmptyStringToNullSerializer.INSTANCE, offerOverride.offerDetailsWithMultipleIntroOffers);
                }
                if (!dVar.j(eVar, 4) && offerOverride.offerBadge == null) {
                    return;
                }
                dVar.E(eVar, 4, EmptyStringToNullSerializer.INSTANCE, offerOverride.offerBadge);
            }
            ...
            public /* synthetic */ OfferOverride(String str, String str2, String str3, String str4, String str5, int i4, AbstractC1585j abstractC1585j) {
                this(str, str2, (i4 & 4) != 0 ? null : str3, (i4 & 8) != 0 ? null : str4, (i4 & 16) != 0 ? null : str5);
            }
        }

        public /* synthetic */ LocalizedConfiguration(int i4, String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, List list, String str10, Map map, k0 k0Var) {
            if (5 != (i4 & 5)) {
                AbstractC0325a0.a(i4, 5, PaywallData$LocalizedConfiguration$$serializer.INSTANCE.getDescriptor());
            }
            this.title = str;
            if ((i4 & 2) == 0) {
                this.subtitle = null;
            ...
            if ((i4 & 512) == 0) {
                this.features = AbstractC0769p.g();
            } else {
                this.features = list;
            }
            if ((i4 & UserMetadata.MAX_ATTRIBUTE_SIZE) == 0) {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        public static /* synthetic */ LocalizedConfiguration copy$default(LocalizedConfiguration localizedConfiguration, String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, List list, String str10, Map map, int i4, Object obj) {
            if ((i4 & 1) != 0) {
        ...
        public static final /* synthetic */ void write$Self(LocalizedConfiguration localizedConfiguration, d dVar, e eVar) {
            ...
            if (dVar.j(eVar, 1) || localizedConfiguration.subtitle != null) {
                dVar.E(eVar, 1, EmptyStringToNullSerializer.INSTANCE, localizedConfiguration.subtitle);
            }
            dVar.o(eVar, 2, localizedConfiguration.callToAction);
            if (dVar.j(eVar, 3) || localizedConfiguration.callToActionWithIntroOffer != null) {
                dVar.E(eVar, 3, EmptyStringToNullSerializer.INSTANCE, localizedConfiguration.callToActionWithIntroOffer);
            }
            if (dVar.j(eVar, 4) || localizedConfiguration.callToActionWithMultipleIntroOffers != null) {
                dVar.E(eVar, 4, EmptyStringToNullSerializer.INSTANCE, localizedConfiguration.callToActionWithMultipleIntroOffers);
            }
            if (dVar.j(eVar, 5) || localizedConfiguration.offerDetails != null) {
                dVar.E(eVar, 5, EmptyStringToNullSerializer.INSTANCE, localizedConfiguration.offerDetails);
            }
            if (dVar.j(eVar, 6) || localizedConfiguration.offerDetailsWithIntroOffer != null) {
                dVar.E(eVar, 6, EmptyStringToNullSerializer.INSTANCE, localizedConfiguration.offerDetailsWithIntroOffer);
            }
            if (dVar.j(eVar, 7) || localizedConfiguration.offerDetailsWithMultipleIntroOffers != null) {
                dVar.E(eVar, 7, EmptyStringToNullSerializer.INSTANCE, localizedConfiguration.offerDetailsWithMultipleIntroOffers);
            }
            if (dVar.j(eVar, 8) || localizedConfiguration.offerName != null) {
                dVar.E(eVar, 8, EmptyStringToNullSerializer.INSTANCE, localizedConfiguration.offerName);
            }
            if (dVar.j(eVar, 9) || !r.b(localizedConfiguration.features, AbstractC0769p.g())) {
                dVar.u(eVar, 9, bVarArr[9], localizedConfiguration.features);
            }
            if (dVar.j(eVar, 10) || localizedConfiguration.tierName != null) {
                dVar.E(eVar, 10, EmptyStringToNullSerializer.INSTANCE, localizedConfiguration.tierName);
            }
            if (!dVar.j(eVar, 11) && r.b(localizedConfiguration.offerOverrides, L.e())) {
                return;
            }
            dVar.u(eVar, 11, bVarArr[11], localizedConfiguration.offerOverrides);
        }
        ...
        public /* synthetic */ LocalizedConfiguration(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, List list, String str10, Map map, int i4, AbstractC1585j abstractC1585j) {
            this(str, (i4 & 2) != 0 ? null : str2, str3, (i4 & 8) != 0 ? null : str4, (i4 & 16) != 0 ? null : str5, (i4 & 32) != 0 ? null : str6, (i4 & 64) != 0 ? null : str7, (i4 & UserMetadata.MAX_ROLLOUT_ASSIGNMENTS) != 0 ? null : str8, (i4 & 256) != 0 ? null : str9, (i4 & 512) != 0 ? AbstractC0769p.g() : list, (i4 & UserMetadata.MAX_ATTRIBUTE_SIZE) != 0 ? null : str10, (i4 & 2048) != 0 ? L.e() : map);
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public PaywallData(String templateName, Configuration config, URL assetBaseURL, int i4, Map<String, LocalizedConfiguration> localization, Map<String, ? extends Map<String, LocalizedConfiguration>> localizationByTier, List<String> zeroDecimalPlaceCountries, String str) {
        r.f(templateName, "templateName");
        r.f(config, "config");
        r.f(assetBaseURL, "assetBaseURL");
        r.f(localization, "localization");
    ...
    public /* synthetic */ PaywallData(String str, Configuration configuration, URL url, int i4, Map map, Map map2, List list, String str2, int i5, AbstractC1585j abstractC1585j) {
        this(str, configuration, url, (i5 & 8) != 0 ? 0 : i4, map, (i5 & 32) != 0 ? L.e() : map2, (i5 & 64) != 0 ? AbstractC0769p.g() : list, (i5 & UserMetadata.MAX_ROLLOUT_ASSIGNMENTS) != 0 ? null : str2);
    }
}
