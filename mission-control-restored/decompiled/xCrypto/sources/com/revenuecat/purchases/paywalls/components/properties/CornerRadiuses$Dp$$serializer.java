...
public final class CornerRadiuses$Dp$$serializer implements C {
    ...
    static {
        ...
        C0327b0 c0327b0 = new C0327b0("com.revenuecat.purchases.paywalls.components.properties.CornerRadiuses.Dp", cornerRadiuses$Dp$$serializer, 4);
    ...
    public CornerRadiuses.Dp deserialize(e decoder) {
        ...
        cVarD.c(descriptor2);
        return new CornerRadiuses.Dp(i4, d5, d6, d4, dZ, null);
    }
    ...
    public void serialize(f encoder, CornerRadiuses.Dp value) {
        ...
        CornerRadiuses.Dp.write$Self(value, dVarD, descriptor2);
        dVarD.c(descriptor2);
    }
