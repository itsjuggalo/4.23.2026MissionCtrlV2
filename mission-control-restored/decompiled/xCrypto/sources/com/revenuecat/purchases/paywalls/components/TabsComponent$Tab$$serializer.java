...
public final class TabsComponent$Tab$$serializer implements C {
    ...
    static {
        ...
        C0327b0 c0327b0 = new C0327b0("com.revenuecat.purchases.paywalls.components.TabsComponent.Tab", tabsComponent$Tab$$serializer, 1);
    ...
    public TabsComponent.Tab deserialize(e decoder) {
        ...
        cVarD.c(descriptor2);
        return new TabsComponent.Tab(i4, (StackComponent) objM, null);
    }
