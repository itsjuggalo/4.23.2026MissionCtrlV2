...
public final class TabsComponent$TabControl$Buttons$$serializer implements C {
    ...
    static {
        ...
        C0327b0 c0327b0 = new C0327b0("buttons", tabsComponent$TabControl$Buttons$$serializer, 1);
    ...
    public TabsComponent.TabControl.Buttons deserialize(e decoder) {
        ...
        cVarD.c(descriptor2);
        return new TabsComponent.TabControl.Buttons(i4, (StackComponent) objM, null);
    }
