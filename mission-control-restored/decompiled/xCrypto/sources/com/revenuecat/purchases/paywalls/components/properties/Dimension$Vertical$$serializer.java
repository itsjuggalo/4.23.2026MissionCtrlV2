...
public final class Dimension$Vertical$$serializer implements C {
    ...
    static {
        ...
        C0327b0 c0327b0 = new C0327b0("vertical", dimension$Vertical$$serializer, 2);
    ...
    public Dimension.Vertical deserialize(e decoder) {
        ...
        k0 k0Var = null;
        if (cVarD.w()) {
            objM = cVarD.m(descriptor2, 0, HorizontalAlignmentDeserializer.INSTANCE, null);
            ...
            while (z4) {
                ...
                if (i6 == -1) {
                    ...
                    objM = cVarD.m(descriptor2, 0, HorizontalAlignmentDeserializer.INSTANCE, objM);
                    i5 |= 1;
                } else {
                    if (i6 != 1) {
                        throw new j(i6);
        ...
        cVarD.c(descriptor2);
        return new Dimension.Vertical(i4, (HorizontalAlignment) objM, (FlexDistribution) objM2, k0Var);
    }
    ...
    public void serialize(f encoder, Dimension.Vertical value) {
        ...
        Dimension.Vertical.write$Self(value, dVarD, descriptor2);
        dVarD.c(descriptor2);
    }
