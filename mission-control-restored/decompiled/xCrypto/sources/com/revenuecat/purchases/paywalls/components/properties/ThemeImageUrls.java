...
public final class ThemeImageUrls {
    ...
    public /* synthetic */ ThemeImageUrls(int i4, ImageUrls imageUrls, ImageUrls imageUrls2, k0 k0Var) {
        if (1 != (i4 & 1)) {
            AbstractC0325a0.a(i4, 1, ThemeImageUrls$$serializer.INSTANCE.getDescriptor());
        }
    ...
    public static final /* synthetic */ void write$Self(ThemeImageUrls themeImageUrls, d dVar, e eVar) {
        ...
        dVar.u(eVar, 0, imageUrls$$serializer, themeImageUrls.light);
        if (!dVar.j(eVar, 1) && themeImageUrls.dark == null) {
            return;
        }
    ...
    public /* synthetic */ ThemeImageUrls(ImageUrls imageUrls, ImageUrls imageUrls2, int i4, AbstractC1585j abstractC1585j) {
        this(imageUrls, (i4 & 2) != 0 ? null : imageUrls2);
    }
}
