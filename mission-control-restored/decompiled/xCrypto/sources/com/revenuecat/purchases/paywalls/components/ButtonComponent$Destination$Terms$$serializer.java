...
public final class ButtonComponent$Destination$Terms$$serializer implements C {
    ...
    static {
        ...
        C0327b0 c0327b0 = new C0327b0("com.revenuecat.purchases.paywalls.components.ButtonComponent.Destination.Terms", buttonComponent$Destination$Terms$$serializer, 2);
    ...
    public ButtonComponent.Destination.Terms deserialize(e decoder) {
        ...
        return new ButtonComponent.Destination.Terms(i4, localizationKey != null ? localizationKey.m199unboximpl() : null, (ButtonComponent.UrlMethod) objM2, null, null);
    }
    ...
    public void serialize(f encoder, ButtonComponent.Destination.Terms value) {
        ...
        ButtonComponent.Destination.Terms.write$Self(value, dVarD, descriptor2);
        dVarD.c(descriptor2);
    }
