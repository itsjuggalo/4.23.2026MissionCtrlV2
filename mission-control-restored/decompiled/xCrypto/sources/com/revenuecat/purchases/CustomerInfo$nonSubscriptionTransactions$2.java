    ...
    public final List<Transaction> invoke() throws JSONException {
        ...
        while (itKeys.hasNext()) {
            ...
            for (int i4 = 0; i4 < length; i4++) {
                JSONObject transactionJSONObject = jSONArray.getJSONObject(i4);
        ...
        return x.Z(arrayList, new Comparator() { // from class: com.revenuecat.purchases.CustomerInfo$nonSubscriptionTransactions$2$invoke$$inlined$sortedBy$1
            /* JADX WARN: Multi-variable type inference failed */
            @Override // java.util.Comparator
            public final int compare(T t4, T t5) {
                return Y2.a.a(((Transaction) t4).getPurchaseDate(), ((Transaction) t5).getPurchaseDate());
            }
        });
    }
}
