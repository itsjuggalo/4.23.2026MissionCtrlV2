...
public final class GoogleDeviceIdentifiersFetcher implements DeviceIdentifiersFetcher {
    ...
    private final String getAdvertisingID(Application application) {
        ...
        String str2;
        try {
            C1602a.C0210a c0210aA = C1602a.a(application);
            if (!c0210aA.b()) {
                if (!r.b(c0210aA.a(), this.noPermissionAdvertisingIdValue)) {
                    return c0210aA.a();
                }
            ...
            GoogleDeviceIdentifiersFetcher$getAdvertisingID$$inlined$log$5 googleDeviceIdentifiersFetcher$getAdvertisingID$$inlined$log$5 = new GoogleDeviceIdentifiersFetcher$getAdvertisingID$$inlined$log$5(logIntent2, e4);
            ...
            GoogleDeviceIdentifiersFetcher$getAdvertisingID$$inlined$log$6 googleDeviceIdentifiersFetcher$getAdvertisingID$$inlined$log$6 = new GoogleDeviceIdentifiersFetcher$getAdvertisingID$$inlined$log$6(logIntent4, e5);
            ...
            GoogleDeviceIdentifiersFetcher$getAdvertisingID$$inlined$log$4 googleDeviceIdentifiersFetcher$getAdvertisingID$$inlined$log$4 = new GoogleDeviceIdentifiersFetcher$getAdvertisingID$$inlined$log$4(logIntent5, e6);
            ...
            GoogleDeviceIdentifiersFetcher$getAdvertisingID$$inlined$log$2 googleDeviceIdentifiersFetcher$getAdvertisingID$$inlined$log$2 = new GoogleDeviceIdentifiersFetcher$getAdvertisingID$$inlined$log$2(logIntent6, e7);
            ...
            GoogleDeviceIdentifiersFetcher$getAdvertisingID$$inlined$log$3 googleDeviceIdentifiersFetcher$getAdvertisingID$$inlined$log$3 = new GoogleDeviceIdentifiersFetcher$getAdvertisingID$$inlined$log$3(logIntent7, e8);
    ...
    public void getDeviceIdentifiers(final Application applicationContext, final k completion) {
        ...
        Dispatcher.enqueue$default(this.dispatcher, new Runnable() { // from class: com.revenuecat.purchases.google.attribution.a
            ...
            public final void run() {
                GoogleDeviceIdentifiersFetcher.getDeviceIdentifiers$lambda$0(this.f11316a, applicationContext, completion);
            }
        }, null, 2, null);
    }
}
