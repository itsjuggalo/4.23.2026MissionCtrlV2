...
public final class AmazonStoreProduct implements StoreProduct {
    ...
    public AmazonStoreProduct(String id, ProductType type, String name, String title, String description, Period period, Price price, SubscriptionOptions subscriptionOptions, SubscriptionOption subscriptionOption, String iconUrl, Period period2, JSONObject originalProductJSON) {
        ...
        r.f(price, "price");
        r.f(iconUrl, "iconUrl");
        r.f(originalProductJSON, "originalProductJSON");
    }

    public static /* synthetic */ AmazonStoreProduct copy$default(AmazonStoreProduct amazonStoreProduct, String str, ProductType productType, String str2, String str3, String str4, Period period, Price price, SubscriptionOptions subscriptionOptions, SubscriptionOption subscriptionOption, String str5, Period period2, JSONObject jSONObject, PresentedOfferingContext presentedOfferingContext, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            str = amazonStoreProduct.id;
        }
        return amazonStoreProduct.copy(str, (i4 & 2) != 0 ? amazonStoreProduct.type : productType, (i4 & 4) != 0 ? amazonStoreProduct.name : str2, (i4 & 8) != 0 ? amazonStoreProduct.title : str3, (i4 & 16) != 0 ? amazonStoreProduct.description : str4, (i4 & 32) != 0 ? amazonStoreProduct.period : period, (i4 & 64) != 0 ? amazonStoreProduct.price : price, (i4 & UserMetadata.MAX_ROLLOUT_ASSIGNMENTS) != 0 ? amazonStoreProduct.subscriptionOptions : subscriptionOptions, (i4 & 256) != 0 ? amazonStoreProduct.defaultOption : subscriptionOption, (i4 & 512) != 0 ? amazonStoreProduct.iconUrl : str5, (i4 & UserMetadata.MAX_ATTRIBUTE_SIZE) != 0 ? amazonStoreProduct.freeTrialPeriod : period2, (i4 & 2048) != 0 ? amazonStoreProduct.originalProductJSON : jSONObject, (i4 & 4096) != 0 ? amazonStoreProduct.presentedOfferingContext : presentedOfferingContext);
    }
    ...
    public final AmazonStoreProduct copy(String id, ProductType type, String name, String title, String description, Period period, Price price, SubscriptionOptions subscriptionOptions, SubscriptionOption subscriptionOption, String iconUrl, Period period2, JSONObject originalProductJSON, PresentedOfferingContext presentedOfferingContext) {
        r.f(id, "id");
        r.f(type, "type");
        r.f(name, "name");
        r.f(title, "title");
        ...
        r.f(iconUrl, "iconUrl");
        r.f(originalProductJSON, "originalProductJSON");
        return new AmazonStoreProduct(id, type, name, title, description, period, price, subscriptionOptions, subscriptionOption, iconUrl, period2, originalProductJSON, presentedOfferingContext);
    }
    ...
    public /* synthetic */ AmazonStoreProduct(String str, ProductType productType, String str2, String str3, String str4, Period period, Price price, SubscriptionOptions subscriptionOptions, SubscriptionOption subscriptionOption, String str5, Period period2, JSONObject jSONObject, PresentedOfferingContext presentedOfferingContext, int i4, AbstractC1585j abstractC1585j) {
        this(str, productType, str2, str3, str4, period, price, subscriptionOptions, subscriptionOption, str5, period2, jSONObject, (i4 & 4096) != 0 ? null : presentedOfferingContext);
    }

    public /* synthetic */ AmazonStoreProduct(String str, ProductType productType, String str2, String str3, Period period, Price price, SubscriptionOptions subscriptionOptions, SubscriptionOption subscriptionOption, String str4, Period period2, JSONObject jSONObject, String str5, int i4, AbstractC1585j abstractC1585j) {
        this(str, productType, str2, str3, period, price, subscriptionOptions, subscriptionOption, str4, period2, jSONObject, (i4 & 2048) != 0 ? null : str5);
    }
    ...
    public AmazonStoreProduct(String id, ProductType type, String name, String title, String description, Period period, Price price, SubscriptionOptions subscriptionOptions, SubscriptionOption subscriptionOption, String iconUrl, Period period2, JSONObject originalProductJSON, String presentedOfferingIdentifier) {
        ...
        r.f(iconUrl, "iconUrl");
        r.f(originalProductJSON, "originalProductJSON");
        r.f(presentedOfferingIdentifier, "presentedOfferingIdentifier");
    }
}
