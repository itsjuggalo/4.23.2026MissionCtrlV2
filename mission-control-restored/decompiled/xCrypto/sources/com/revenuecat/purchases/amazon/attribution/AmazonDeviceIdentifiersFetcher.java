...
public final class AmazonDeviceIdentifiersFetcher implements DeviceIdentifiersFetcher {
    ...
    public void getDeviceIdentifiers(Application applicationContext, k completion) {
        ...
        try {
            ...
            AmazonDeviceIdentifiersFetcher$getDeviceIdentifiers$$inlined$log$1 amazonDeviceIdentifiersFetcher$getDeviceIdentifiers$$inlined$log$1 = new AmazonDeviceIdentifiersFetcher$getDeviceIdentifiers$$inlined$log$1(logIntent, e4);
        ...
        completion.invoke(MapExtensionsKt.filterNotNullValues(L.g(t.a(SubscriberAttributeKey.DeviceIdentifiers.AmazonAdID.INSTANCE.getBackendKey(), string), t.a(SubscriberAttributeKey.DeviceIdentifiers.IP.INSTANCE.getBackendKey(), b.af), t.a(SubscriberAttributeKey.DeviceIdentifiers.DeviceVersion.INSTANCE.getBackendKey(), b.af))));
    }
}
