...
public final class SharedPreferencesManager$performMigration$$inlined$log$2 extends s implements Function0 {
    ...
    public final String invoke() {
        return x.Q(this.$intent.getEmojiList(), "", null, null, 0, null, null, 62, null) + " Finished shared preferences migration from legacy to RevenueCat-specific preferences";
    }
}
