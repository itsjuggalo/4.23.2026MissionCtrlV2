...
public final class OfferingsCache {
    ...
    public OfferingsCache(DeviceCache deviceCache, DateProvider dateProvider, InMemoryCachedObject<Offerings> offeringsCachedObject, LocaleProvider localeProvider) {
        ...
        r.f(offeringsCachedObject, "offeringsCachedObject");
    ...
    */
    public final synchronized boolean isOfferingsCacheStale(boolean r3) {
        /*
            ...
            boolean r3 = kotlin.jvm.internal.r.b(r3, r0)     // Catch: java.lang.Throwable -> L20
            if (r3 != 0) goto L1e
            goto L22
        L1e:
            r3 = 0
    ...
    public /* synthetic */ OfferingsCache(DeviceCache deviceCache, DateProvider dateProvider, InMemoryCachedObject inMemoryCachedObject, LocaleProvider localeProvider, int i4, AbstractC1585j abstractC1585j) {
        dateProvider = (i4 & 2) != 0 ? new DefaultDateProvider() : dateProvider;
        this(deviceCache, dateProvider, (i4 & 4) != 0 ? new InMemoryCachedObject(null, dateProvider, 1, null) : inMemoryCachedObject, localeProvider);
    }
}
