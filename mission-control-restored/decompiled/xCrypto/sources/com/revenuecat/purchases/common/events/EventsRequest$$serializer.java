...
public final class EventsRequest$$serializer implements C {
    ...
    static {
        ...
        C0327b0 c0327b0 = new C0327b0("com.revenuecat.purchases.common.events.EventsRequest", eventsRequest$$serializer, 1);
        c0327b0.l("events", false);
        descriptor = c0327b0;
    }
    ...
    public EventsRequest deserialize(e decoder) {
        ...
        cVarD.c(descriptor2);
        return new EventsRequest(i4, (List) objM, null);
    }
    ...
    public void serialize(f encoder, EventsRequest value) {
        ...
        dVarD.u(descriptor2, 0, EventsRequest.$childSerializers[0], value.events);
        dVarD.c(descriptor2);
    }
