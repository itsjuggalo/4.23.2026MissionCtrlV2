...
public final class BackendStoredEvent$Paywalls$$serializer implements C {
    ...
    static {
        ...
        C0327b0 c0327b0 = new C0327b0("paywalls", backendStoredEvent$Paywalls$$serializer, 1);
    ...
    public BackendStoredEvent.Paywalls deserialize(e decoder) {
        ...
        int i4 = 1;
        if (cVarD.w()) {
            objM = cVarD.m(descriptor2, 0, BackendEvent$Paywalls$$serializer.INSTANCE, null);
        } else {
            boolean z4 = true;
            int i5 = 0;
            objM = null;
            while (z4) {
                ...
                if (i6 == -1) {
                    ...
                    objM = cVarD.m(descriptor2, 0, BackendEvent$Paywalls$$serializer.INSTANCE, objM);
                    i5 = 1;
                }
            }
            i4 = i5;
        ...
        cVarD.c(descriptor2);
        return new BackendStoredEvent.Paywalls(i4, (BackendEvent.Paywalls) objM, null);
    }
    ...
    public void serialize(f encoder, BackendStoredEvent.Paywalls value) {
        ...
        BackendStoredEvent.Paywalls.write$Self(value, dVarD, descriptor2);
        dVarD.c(descriptor2);
    }
