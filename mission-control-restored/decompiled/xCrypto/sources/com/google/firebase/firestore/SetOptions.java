...
public final class SetOptions {
    ...
    private SetOptions(boolean z4, FieldMask fieldMask) {
        Preconditions.checkArgument(fieldMask == null || z4, "Cannot specify a fieldMask for non-merge sets()", new Object[0]);
        this.merge = z4;
