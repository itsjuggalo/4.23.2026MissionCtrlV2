...
final class EncodedPath {
    ...
    public static FieldPath decodeFieldPath(String str) {
    ...
    public static <B extends BasePath<B>> String encode(B b4) {
        StringBuilder sb = new StringBuilder();
        ...
        for (int i4 = 0; i4 < length; i4++) {
            ...
            encodeSegment(b4.getSegment(i4), sb);
        }
        encodeSeparator(sb);
        return sb.toString();
    }
