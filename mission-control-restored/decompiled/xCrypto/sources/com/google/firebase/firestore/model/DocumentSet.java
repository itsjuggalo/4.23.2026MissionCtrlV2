...
public final class DocumentSet implements Iterable<Document> {
    ...
    public static /* synthetic */ int c(Comparator comparator, Document document, Document document2) {
    ...
    public static DocumentSet emptySet(final Comparator<Document> comparator) {
        return new DocumentSet(DocumentCollections.emptyDocumentMap(), new ImmutableSortedSet(Collections.EMPTY_LIST, new Comparator() { // from class: com.google.firebase.firestore.model.c
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
                return DocumentSet.c(comparator, (Document) obj, (Document) obj2);
            }
        }));
    }
