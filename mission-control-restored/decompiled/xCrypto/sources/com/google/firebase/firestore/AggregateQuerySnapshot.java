...
public class AggregateQuerySnapshot {
    private final Map<String, C1698D> data;
    private final AggregateQuery query;

    public AggregateQuerySnapshot(AggregateQuery aggregateQuery, Map<String, C1698D> map) {
    ...
    public static AggregateQuerySnapshot createWithCount(AggregateQuery aggregateQuery, long j4) {
        return new AggregateQuerySnapshot(aggregateQuery, Collections.singletonMap(AggregateField.count().getAlias(), (C1698D) C1698D.I().m(j4).build()));
    }
