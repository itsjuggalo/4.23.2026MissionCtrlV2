        ...
        if (this.connectivityManager != null) {
            ...
            this.unregisterRunnable = new Runnable() { // from class: com.google.firebase.firestore.remote.g
                ...
                public final void run() {
                    this.f10671a.connectivityManager.unregisterNetworkCallback(defaultNetworkCallback);
                }
            };
        } else {
            ...
            this.unregisterRunnable = new Runnable() { // from class: com.google.firebase.firestore.remote.h
                @Override // java.lang.Runnable
                public final void run() {
                    this.f10673a.context.unregisterReceiver(networkReceiver);
                }
            };
        }
    }
    ...
    public void raiseCallbacks(boolean z4) {
        synchronized (this.callbacks) {
            try {
                ...
                while (it.hasNext()) {
                    it.next().accept(z4 ? ConnectivityMonitor.NetworkStatus.REACHABLE : ConnectivityMonitor.NetworkStatus.UNREACHABLE);
                }
            } catch (Throwable th) {
                throw th;
            }
