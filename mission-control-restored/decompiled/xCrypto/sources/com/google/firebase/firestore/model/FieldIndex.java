...
public abstract class FieldIndex {
    ...
    public static final Comparator<FieldIndex> SEMANTIC_COMPARATOR = new Comparator() { // from class: com.google.firebase.firestore.model.d
    ...
    public static abstract class IndexOffset implements Comparable<IndexOffset> {
        ...
        public static final Comparator<MutableDocument> DOCUMENT_COMPARATOR = new Comparator() { // from class: com.google.firebase.firestore.model.e
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
        ...
        public static IndexOffset createSuccessor(SnapshotVersion snapshotVersion, int i4) {
            ...
            return create(new SnapshotVersion(((double) nanoseconds) == 1.0E9d ? new Timestamp(seconds + 1, 0) : new Timestamp(seconds, nanoseconds)), DocumentKey.empty(), i4);
        }
