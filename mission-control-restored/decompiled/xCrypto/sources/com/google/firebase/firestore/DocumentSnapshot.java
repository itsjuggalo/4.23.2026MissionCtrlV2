...
public class DocumentSnapshot {
    ...
    public DocumentSnapshot(FirebaseFirestore firebaseFirestore, DocumentKey documentKey, Document document, boolean z4, boolean z5) {
        ...
        this.doc = document;
        this.metadata = new SnapshotMetadata(z5, z4);
    }
    ...
    public static DocumentSnapshot fromDocument(FirebaseFirestore firebaseFirestore, Document document, boolean z4, boolean z5) {
        return new DocumentSnapshot(firebaseFirestore, document.getKey(), document, z4, z5);
    }

    public static DocumentSnapshot fromNoDocument(FirebaseFirestore firebaseFirestore, DocumentKey documentKey, boolean z4) {
