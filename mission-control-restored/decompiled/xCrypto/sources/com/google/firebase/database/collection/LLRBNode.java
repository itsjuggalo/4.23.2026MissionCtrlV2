...
public interface LLRBNode<K, V> {
    ...
    public static abstract class NodeVisitor<K, V> implements ShortCircuitingNodeVisitor<K, V> {
        ...
        public boolean shouldContinue(K k4, V v4) {
            visitEntry(k4, v4);
            return true;
        }

        public abstract void visitEntry(K k4, V v4);
    }

    public interface ShortCircuitingNodeVisitor<K, V> {
        boolean shouldContinue(K k4, V v4);
    }

    LLRBNode<K, V> copy(K k4, V v4, Color color, LLRBNode<K, V> lLRBNode, LLRBNode<K, V> lLRBNode2);
    ...
    LLRBNode<K, V> insert(K k4, V v4, Comparator<K> comparator);
