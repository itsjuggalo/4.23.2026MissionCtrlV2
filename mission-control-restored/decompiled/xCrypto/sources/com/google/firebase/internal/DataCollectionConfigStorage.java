...
public class DataCollectionConfigStorage {
    ...
    private static Context directBootSafe(Context context) {
        return AbstractC1909a.createDeviceProtectedStorageContext(context);
    }
    ...
    private synchronized void updateDataCollectionDefaultEnabled(boolean z4) {
        if (this.dataCollectionDefaultEnabled != z4) {
            this.dataCollectionDefaultEnabled = z4;
            this.publisher.publish(new Event<>(DataCollectionDefaultChange.class, new DataCollectionDefaultChange(z4)));
        }
    }
