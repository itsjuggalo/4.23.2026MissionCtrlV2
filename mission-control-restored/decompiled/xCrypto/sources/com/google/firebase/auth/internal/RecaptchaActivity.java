...
public class RecaptchaActivity extends AbstractActivityC0832u implements zzaej {
        ...
        if (!"android.intent.action.VIEW".equals(getIntent().getAction())) {
            ...
            try {
                ...
                if (zzagd.zza(firebaseApp)) {
                    ...
                    recaptchaActivity = this;
                    new zzaeh(packageName, lowerCase, intent, firebaseApp, recaptchaActivity).executeOnExecutor(firebaseAuth.zze(), new Void[0]);
                }
    ...
    private final Uri.Builder zza(Uri.Builder builder, Intent intent, String str, String str2) {
        ...
        builder.appendQueryParameter("apiKey", stringExtra).appendQueryParameter("authType", "verifyApp").appendQueryParameter("apn", str).appendQueryParameter("hl", !TextUtils.isEmpty(firebaseAuth.getLanguageCode()) ? firebaseAuth.getLanguageCode() : zzaev.zza()).appendQueryParameter("eventId", string).appendQueryParameter("v", "X" + stringExtra2).appendQueryParameter("eid", "p").appendQueryParameter(Constants.APP_NAME, stringExtra3).appendQueryParameter("sha1Cert", str2).appendQueryParameter("publicKey", strZza);
        return builder;
    }
    ...
    public static /* synthetic */ void zza(RecaptchaActivity recaptchaActivity, String str, Task task) {
        if (recaptchaActivity.getPackageManager().resolveActivity(new Intent("android.intent.action.VIEW"), 0) != null) {
            ...
            if (listQueryIntentServices != null && !listQueryIntentServices.isEmpty()) {
                c cVarA = new c.d().a();
                cVarA.f14704a.addFlags(1073741824);
                cVarA.f14704a.addFlags(268435456);
