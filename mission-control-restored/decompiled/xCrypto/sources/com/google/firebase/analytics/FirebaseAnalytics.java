...
public final class FirebaseAnalytics {
    ...
    public static InterfaceC0548c5 getScionFrontendApiImplementation(Context context, Bundle bundle) {
    ...
    public void setAnalyticsCollectionEnabled(boolean z4) {
        this.zzb.zzq(Boolean.valueOf(z4));
    }
