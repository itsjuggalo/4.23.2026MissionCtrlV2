...
public class FirebaseMessagingService extends EnhancedIntentService {
    ...
    private C1940c getRpc(Context context) {
        if (this.rpc == null) {
            this.rpc = new C1940c(context.getApplicationContext());
        }
        return this.rpc;
    }
    ...
    private void handleMessageIntent(Intent intent) {
        ...
        getRpc(this).b(new C1938a(intent));
    }
    ...
    public void setRpcForTesting(C1940c c1940c) {
        this.rpc = c1940c;
    }
}
