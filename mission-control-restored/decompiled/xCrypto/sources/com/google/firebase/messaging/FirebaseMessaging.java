...
public class FirebaseMessaging {
    ...
    static Provider<X0.j> transportFactory = new Provider() { // from class: com.google.firebase.messaging.p
    ...
    public class AutoInit {
                ...
                if (enabled == null) {
                    EventHandler<DataCollectionDefaultChange> eventHandler = new EventHandler() { // from class: com.google.firebase.messaging.x
                        ...
                        public final void handle(Event event) {
                            FirebaseMessaging.AutoInit.a(this.f10805a, event);
                        }
                    };
        ...
        public synchronized void setEnabled(boolean z4) {
            try {
                ...
                editorEdit.putBoolean(AUTO_INIT_PREF, z4);
                editorEdit.apply();
                if (z4) {
                    FirebaseMessaging.this.startSyncIfNecessary();
                }
    ...
    public FirebaseMessaging(FirebaseApp firebaseApp, FirebaseInstanceIdInternal firebaseInstanceIdInternal, Provider<UserAgentPublisher> provider, Provider<HeartBeatInfo> provider2, FirebaseInstallationsApi firebaseInstallationsApi, Provider<X0.j> provider3, Subscriber subscriber) {
    ...
    public static X0.j getTransportFactory() {
        return transportFactory.get();
    }

    public static /* synthetic */ X0.j h() {
        return null;
    }

    private void handleProxiedNotificationData() {
        this.gmsRpc.getProxyNotificationData().addOnSuccessListener(this.initExecutor, new OnSuccessListener() { // from class: com.google.firebase.messaging.t
            @Override // com.google.android.gms.tasks.OnSuccessListener
            public final void onSuccess(Object obj) {
                FirebaseMessaging.j(this.f10798a, (C1938a) obj);
            }
        });
    }
    ...
    public static /* synthetic */ void j(FirebaseMessaging firebaseMessaging, C1938a c1938a) {
        firebaseMessaging.getClass();
        if (c1938a != null) {
            MessagingAnalytics.logNotificationReceived(c1938a.i());
    ...
    public String blockingGetToken() throws IOException {
        ...
        try {
            return (String) Tasks.await(this.requestDeduplicator.getOrStartGetTokenRequest(defaultSenderId, new RequestDeduplicator.GetTokenRequest() { // from class: com.google.firebase.messaging.v
                @Override // com.google.firebase.messaging.RequestDeduplicator.GetTokenRequest
                public final Task start() {
                    FirebaseMessaging firebaseMessaging = this.f10800a;
                    return firebaseMessaging.gmsRpc.getToken().onSuccessTask(firebaseMessaging.fileExecutor, new SuccessContinuation() { // from class: com.google.firebase.messaging.q
                        @Override // com.google.android.gms.tasks.SuccessContinuation
                        public final Task then(Object obj) {
                            return FirebaseMessaging.b(this.f10792a, str, token, (String) obj);
                        }
                    });
                }
            }));
    ...
    public Task<Void> deleteToken() {
        if (this.iid != null) {
            ...
            this.initExecutor.execute(new Runnable() { // from class: com.google.firebase.messaging.w
                ...
                public final void run() {
                    FirebaseMessaging.f(this.f10803a, taskCompletionSource);
                }
            });
        ...
        FcmExecutors.newNetworkIOExecutor().execute(new Runnable() { // from class: com.google.firebase.messaging.j
            @Override // java.lang.Runnable
            public final void run() {
                FirebaseMessaging.o(this.f10786a, taskCompletionSource2);
            }
        });
        ...
        synchronized (FirebaseMessaging.class) {
            try {
                if (syncExecutor == null) {
                    syncExecutor = new ScheduledThreadPoolExecutor(1, new H1.b("TAG"));
                }
    ...
    public Task<String> getToken() {
        ...
        this.initExecutor.execute(new Runnable() { // from class: com.google.firebase.messaging.s
            @Override // java.lang.Runnable
            public final void run() {
                FirebaseMessaging.e(this.f10796a, taskCompletionSource);
            }
        });
        return taskCompletionSource.getTask();
    }
    ...
    public Task<Void> setNotificationDelegationEnabled(boolean z4) {
        return ProxyNotificationInitializer.setEnableProxyNotification(this.initExecutor, this.context, z4).addOnSuccessListener(new l0.k(), new OnSuccessListener() { // from class: com.google.firebase.messaging.r
            @Override // com.google.android.gms.tasks.OnSuccessListener
            public final void onSuccess(Object obj) {
                FirebaseMessaging firebaseMessaging = this.f10795a;
    ...
    public static synchronized FirebaseMessaging getInstance(FirebaseApp firebaseApp) {
        ...
        AbstractC0940s.l(firebaseMessaging, "Firebase Messaging component is not present");
        return firebaseMessaging;
    }

    public FirebaseMessaging(FirebaseApp firebaseApp, FirebaseInstanceIdInternal firebaseInstanceIdInternal, Provider<UserAgentPublisher> provider, Provider<HeartBeatInfo> provider2, FirebaseInstallationsApi firebaseInstallationsApi, Provider<X0.j> provider3, Subscriber subscriber, Metadata metadata) {
    ...
    public FirebaseMessaging(FirebaseApp firebaseApp, FirebaseInstanceIdInternal firebaseInstanceIdInternal, Provider<X0.j> provider, Subscriber subscriber, Metadata metadata, GmsRpc gmsRpc, Executor executor, Executor executor2, Executor executor3) {
        ...
        if (firebaseInstanceIdInternal != null) {
            firebaseInstanceIdInternal.addNewTokenListener(new FirebaseInstanceIdInternal.NewTokenListener() { // from class: com.google.firebase.messaging.k
                ...
                public final void onNewToken(String str) {
                    this.f10788a.invokeOnTokenRefresh(str);
                }
            });
        }
        executor2.execute(new Runnable() { // from class: com.google.firebase.messaging.l
            @Override // java.lang.Runnable
            public final void run() {
                FirebaseMessaging.c(this.f10789a);
            }
        });
        ...
        taskCreateInstance.addOnSuccessListener(executor2, new OnSuccessListener() { // from class: com.google.firebase.messaging.m
            @Override // com.google.android.gms.tasks.OnSuccessListener
            public final void onSuccess(Object obj) {
                FirebaseMessaging.m(this.f10790a, (TopicsSubscriber) obj);
            }
        });
        executor2.execute(new Runnable() { // from class: com.google.firebase.messaging.n
            @Override // java.lang.Runnable
            public final void run() {
                this.f10791a.initializeProxyNotifications();
            }
        });
    }
}
