...
class CrashlyticsController {
    ...
    private Task<Void> logAnalyticsAppExceptionEvent(final long j4) {
    ...
    public void openSession(final String str) {
        this.crashlyticsWorkers.common.submit(new Runnable() { // from class: com.google.firebase.crashlytics.internal.common.d
            ...
            public final void run() {
                this.f10309a.doOpenSession(str, Boolean.FALSE);
            }
        });
    }
    ...
    private void doCloseSessions(boolean z4, SettingsProvider settingsProvider, boolean z5) {
        String str;
        CrashlyticsWorkers.checkBackgroundThread();
    ...
    public synchronized void handleUncaughtException(final SettingsProvider settingsProvider, final Thread thread, final Throwable th, final boolean z4) throws Throwable {
        try {
            try {
                ...
                Task taskSubmitTask = this.crashlyticsWorkers.common.submitTask(new Callable<Task<Void>>() { // from class: com.google.firebase.crashlytics.internal.common.CrashlyticsController.2
                    ...
                    public Task<Void> call() {
                        ...
                        CrashlyticsController.this.doOpenSession(new CLSUUID().getSessionId(), Boolean.valueOf(z4));
                        return !CrashlyticsController.this.dataCollectionArbiter.isAutomaticDataCollectionEnabled() ? Tasks.forResult(null) : settingsProvider.getSettingsAsync().onSuccessTask(CrashlyticsController.this.crashlyticsWorkers.common, new SuccessContinuation<Settings, Void>() { // from class: com.google.firebase.crashlytics.internal.common.CrashlyticsController.2.1
                            ...
                            public Task<Void> then(Settings settings) {
                                if (settings != null) {
                                    return Tasks.whenAll((Task<?>[]) new Task[]{CrashlyticsController.this.logAnalyticsAppExceptionEvents(), CrashlyticsController.this.reportingCoordinator.sendReports(CrashlyticsController.this.crashlyticsWorkers.common, z4 ? currentSessionId : null)});
                                }
