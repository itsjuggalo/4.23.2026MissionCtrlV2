...
public abstract class CrashlyticsReport {
    ...
    public static abstract class Session {
            ...
            public static abstract class Application {
                ...
                public static abstract class ProcessDetails {
                    ...
                    public static abstract class Builder {
                        ...
                        public abstract Builder setDefaultProcess(boolean z4);
        ...
        public Session withSessionEndFields(long j4, boolean z4, String str) {
    ...
    public CrashlyticsReport withSessionEndFields(long j4, boolean z4, String str) {
        Builder builder = toBuilder();
        if (getSession() != null) {
            builder.setSession(getSession().withSessionEndFields(j4, z4, str));
        }
        return builder.build();
    }
}
