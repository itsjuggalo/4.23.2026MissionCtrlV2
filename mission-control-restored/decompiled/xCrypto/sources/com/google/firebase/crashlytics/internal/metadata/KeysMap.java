...
class KeysMap {
    ...
    public static String sanitizeString(String str, int i4) {
        if (str == null) {
            return str;
        }
    ...
    public synchronized void setKeys(Map<String, String> map) {
        try {
            ...
            if (i4 > 0) {
                Logger.getLogger().w("Ignored " + i4 + " entries when adding custom keys. Maximum allowable: " + this.maxEntries);
            }
        } catch (Throwable th) {
            throw th;
        }
