...
public class ComponentRuntime implements ComponentContainer, ComponentLoader {
    private static final Provider<Set<Object>> EMPTY_PROVIDER = new Provider() { // from class: com.google.firebase.components.i
        ...
        synchronized (this) {
            ...
            for (final Component<?> component : list) {
                this.components.put(component, new Lazy(new Provider() { // from class: com.google.firebase.components.j
                    @Override // com.google.firebase.inject.Provider
                    public final Object get() {
                        return ComponentRuntime.a(this.f10235a, component);
                    }
                }));
            }
    ...
    private void doInitializeEagerComponents(Map<Component<?>, Provider<?>> map, boolean z4) {
    ...
    public void initializeEagerComponents(boolean z4) {
        HashMap map;
        if (com.amazon.a.a.l.d.a(this.eagerComponentsInitializedWith, null, Boolean.valueOf(z4))) {
            synchronized (this) {
                map = new HashMap(this.components);
            }
            doInitializeEagerComponents(map, z4);
        }
    }
