...
@InterfaceC0868f(c = "com.google.firebase.storage.StorageKt$taskState$1", f = "Storage.kt", l = {173}, m = "invokeSuspend")
public final class StorageKt$taskState$1 extends b3.l implements i3.o {
    final /* synthetic */ StorageTask<T> $this_taskState;
    private /* synthetic */ Object L$0;
    int label;

    /* JADX INFO: renamed from: com.google.firebase.storage.StorageKt$taskState$1$1, reason: invalid class name */
    ...
    public static final void invokeSuspend$lambda$1$lambda$0(v3.s sVar, StorageTask.SnapshotBase snapshotBase) {
        v3.k.b(sVar, new TaskState.InProgress(snapshotBase));
    }
    ...
    public static final void invokeSuspend$lambda$3$lambda$2(v3.s sVar, StorageTask.SnapshotBase snapshotBase) {
        v3.k.b(sVar, new TaskState.Paused(snapshotBase));
    }
