...
public class Util {
    ...
    public static boolean equals(Object obj, Object obj2) {
        return AbstractC0939q.b(obj, obj2);
    }
    ...
    public static Uri normalize(FirebaseApp firebaseApp, String str) {
        ...
        if (iIndexOf == 0 && strSlashize.startsWith(RemoteSettings.FORWARD_SLASH_STRING)) {
            int iIndexOf2 = strSlashize.indexOf("/b/", 0);
            int i4 = iIndexOf2 + 3;
            int iIndexOf3 = strSlashize.indexOf(RemoteSettings.FORWARD_SLASH_STRING, i4);
            ...
            strSubstring = strSlashize.substring(i4, iIndexOf3);
        ...
        AbstractC0940s.f(strSubstring, "No bucket specified");
    ...
    public static long parseDateTime(String str) {
        ...
        try {
            ...
            Log.w(TAG, "unable to parse datetime:" + strReplaceAll, e4);
            return 0L;
        }
    }
}
