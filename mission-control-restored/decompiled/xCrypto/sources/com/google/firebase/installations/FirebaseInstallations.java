...
public class FirebaseInstallations implements FirebaseInstallationsApi {
    ...
    public final void doRegistrationOrRefresh(final boolean z4) {
        ...
        this.networkExecutor.execute(new Runnable() { // from class: com.google.firebase.installations.b
            ...
            public final void run() {
                this.f10748a.doNetworkCallIfNecessary(z4);
            }
        });
    }
    ...
    private PersistedInstallationEntry fetchAuthTokenFromServer(PersistedInstallationEntry persistedInstallationEntry) throws FirebaseInstallationsException {
        ...
        int i4 = AnonymousClass3.$SwitchMap$com$google$firebase$installations$remote$TokenResult$ResponseCode[tokenResultGenerateAuthToken.getResponseCode().ordinal()];
        if (i4 == 1) {
    ...
    private void preConditionChecks() {
        AbstractC0940s.f(getApplicationId(), APP_ID_VALIDATION_MSG);
        AbstractC0940s.f(getProjectIdentifier(), PROJECT_ID_VALIDATION_MSG);
        AbstractC0940s.f(getApiKey(), API_KEY_VALIDATION_MSG);
        AbstractC0940s.b(Utils.isValidAppIdFormat(getApplicationId()), APP_ID_VALIDATION_MSG);
        AbstractC0940s.b(Utils.isValidApiKeyFormat(getApiKey()), API_KEY_VALIDATION_MSG);
    }
    ...
    private PersistedInstallationEntry registerFidWithServer(PersistedInstallationEntry persistedInstallationEntry) throws FirebaseInstallationsException {
        ...
        int i4 = AnonymousClass3.$SwitchMap$com$google$firebase$installations$remote$InstallationResponse$ResponseCode[installationResponseCreateFirebaseInstallation.getResponseCode().ordinal()];
        if (i4 == 1) {
    ...
    public Task<Void> delete() {
        return Tasks.call(this.backgroundExecutor, new Callable() { // from class: com.google.firebase.installations.d
            ...
            public final Object call() {
                return this.f10751a.deleteFirebaseInstallationId();
            }
        });
    }
    ...
    public Task<String> getId() {
        ...
        this.backgroundExecutor.execute(new Runnable() { // from class: com.google.firebase.installations.c
            @Override // java.lang.Runnable
            public final void run() {
                this.f10750a.doRegistrationOrRefresh(false);
            }
        });
    ...
    public Task<InstallationTokenResult> getToken(final boolean z4) {
        ...
        this.backgroundExecutor.execute(new Runnable() { // from class: com.google.firebase.installations.e
            @Override // java.lang.Runnable
            public final void run() {
                this.f10752a.doRegistrationOrRefresh(z4);
            }
        });
    ...
    public static FirebaseInstallations getInstance(FirebaseApp firebaseApp) {
        AbstractC0940s.b(firebaseApp != null, "Null is not a valid value of FirebaseApp.");
