...
final class zzdu {
    public static int zza(byte[] bArr, int i4, zzdt zzdtVar) {
    ...
    public static int zzc(zzgi zzgiVar, byte[] bArr, int i4, int i5, int i6, zzdt zzdtVar) {
    ...
    public static int zzd(zzgi zzgiVar, byte[] bArr, int i4, int i5, zzdt zzdtVar) {
        Object objZzd = zzgiVar.zzd();
    ...
    public static int zze(zzgi zzgiVar, int i4, byte[] bArr, int i5, int i6, zzez zzezVar, zzdt zzdtVar) {
    ...
    public static int zzf(byte[] bArr, int i4, zzez zzezVar, zzdt zzdtVar) {
    ...
    public static int zzg(int i4, byte[] bArr, int i5, int i6, zzha zzhaVar, zzdt zzdtVar) {
        if ((i4 >>> 3) == 0) {
            throw zzfb.zza();
        }
        int i7 = i4 & 7;
    ...
    public static int zzl(Object obj, zzgi zzgiVar, byte[] bArr, int i4, int i5, int i6, zzdt zzdtVar) {
        int iZzb = ((zzga) zzgiVar).zzb(obj, bArr, i4, i5, i6, zzdtVar);
        zzdtVar.zzc = obj;
        return iZzb;
    }

    public static int zzm(Object obj, zzgi zzgiVar, byte[] bArr, int i4, int i5, zzdt zzdtVar) {
        int iZzi = i4 + 1;
        int i6 = bArr[i4];
        if (i6 < 0) {
