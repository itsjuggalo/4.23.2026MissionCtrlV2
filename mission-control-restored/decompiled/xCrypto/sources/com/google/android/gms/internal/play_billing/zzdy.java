...
public abstract class zzdy<V> extends zzfi implements zzeu<V> {
    ...
    static {
        ...
        Throwable th2;
        try {
            z4 = Boolean.parseBoolean(System.getProperty("guava.concurrent.generate_cancellation_cause", b.ag));
        } catch (SecurityException unused) {
            z4 = false;
        }
        zza = z4;
    ...
    public static Object zzr(zzeu zzeuVar) {
        ...
        try {
            ...
            return !zIsCancelled ? new zzc(new IllegalArgumentException("get() threw CancellationException, despite reporting isCancelled() == false: ".concat(String.valueOf(zzeuVar)), e5)) : new zzb(false, e5);
        } catch (ExecutionException e6) {
            return zIsCancelled ? new zzb(false, new IllegalArgumentException("get() did not throw CancellationException, despite reporting isCancelled() == true: ".concat(String.valueOf(zzeuVar)), e6)) : new zzc(e6.getCause());
        }
    }
