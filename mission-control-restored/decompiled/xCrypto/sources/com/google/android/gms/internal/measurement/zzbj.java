    ...
    public final zzao zza(String str, zzg zzgVar, List list) {
        ...
        if (iOrdinal == 14) {
            ...
            while (i4 < list.size() - 1) {
                zzao zzaoVarZza3 = zzgVar.zza((zzao) list.get(i4));
                ...
                zzgVar.zzg(zzaoVarZza3.zzc(), zzgVar.zza((zzao) list.get(i4 + 1)));
                i4 += 2;
            }
            return zzao.zzf;
        }
        if (iOrdinal == 24) {
            ...
            while (i4 < list.size()) {
                zzaoVarZza4 = zzgVar.zza((zzao) list.get(i4));
        ...
        if (iOrdinal == 18) {
            ...
            while (i4 < list.size() - 1) {
                zzao zzaoVarZza10 = zzgVar.zza((zzao) list.get(i4));
                zzao zzaoVarZza11 = zzgVar.zza((zzao) list.get(i4 + 1));
