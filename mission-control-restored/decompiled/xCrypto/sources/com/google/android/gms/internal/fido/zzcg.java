...
class zzcg extends zzch {
    ...
    public final int zzc(int i4) {
        ...
        return zzcdVar.zzc * zzcj.zza(i4, zzcdVar.zzd, RoundingMode.CEILING);
    }
    ...
    public final void zze(Appendable appendable, byte[] bArr, int i4, int i5) {
        zzap.zze(i4, i4 + i5, bArr.length);
        int i6 = 0;
        ...
        while (i6 < i5 * 8) {
            zzcd zzcdVar = this.zzb;
            appendable.append(zzcdVar.zza(zzcdVar.zza & ((int) (j4 >>> (i8 - i6)))));
            i6 += this.zzb.zzb;
        }
        if (this.zzc != null) {
