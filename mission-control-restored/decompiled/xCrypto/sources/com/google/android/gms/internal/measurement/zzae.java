...
public final class zzae implements Iterable, zzao, zzak {
    ...
    public final List zzb() {
        ...
        for (int i4 = 0; i4 < zzh(); i4++) {
            arrayList.add(zzl(i4));
        }
        return arrayList;
    }
    ...
    public final zzao zzl(int i4) {
        zzao zzaoVar;
        if (i4 < zzh()) {
            return (!zzo(i4) || (zzaoVar = (zzao) this.zza.get(Integer.valueOf(i4))) == null) ? zzao.zzf : zzaoVar;
        }
    ...
    public final void zzn(int i4, zzao zzaoVar) {
        if (i4 > 32468) {
        ...
        if (zzaoVar == null) {
            ...
            this.zza.put(Integer.valueOf(i4), zzaoVar);
        }
    }
    ...
    public final void zzq(int i4, zzao zzaoVar) {
        if (i4 < 0) {
            StringBuilder sb = new StringBuilder(String.valueOf(i4).length() + 21);
    ...
    public final void zzr(int i4) {
        ...
        while (true) {
            ...
            if (zzaoVar != null) {
                sortedMap.put(Integer.valueOf(i4 - 1), zzaoVar);
