...
public class zzaiv implements zzaer<zzaiv> {
    ...
    public final zzaiv zza(String str) throws zzaci {
        try {
            ...
            this.zzc = q.a(jSONObject.optString(Constants.ID_TOKEN, null));
            ...
            this.zzf = q.a(jSONObject.optString(Constants.EMAIL, null));
            q.a(jSONObject.optString("displayName", null));
            q.a(jSONObject.optString("photoUrl", null));
            this.zzg = q.a(jSONObject.optString(Constants.PROVIDER_ID, null));
            ...
            this.zzm = q.a(jSONObject.optString(b.f8758f, null));
