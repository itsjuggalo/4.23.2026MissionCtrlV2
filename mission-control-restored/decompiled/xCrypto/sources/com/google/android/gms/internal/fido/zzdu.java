...
public final class zzdu implements Closeable {
    ...
    private final long zzh() throws IOException {
        ...
        if (this.zzb.zza() == 26) {
            ...
            long j4 = bArr2[0];
            long j5 = bArr2[1];
            return (((long) bArr2[3]) & 255) | ((j5 & 255) << 16) | ((j4 & 255) << 24) | ((bArr2[2] & 255) << 8);
        }
        if (this.zzb.zza() != 27) {
        ...
        long j7 = bArr3[1];
        long j8 = bArr3[2];
        return (((long) bArr3[7]) & 255) | ((j8 & 255) << 40) | ((j6 & 255) << 56) | ((j7 & 255) << 48) | ((bArr3[3] & 255) << 32) | ((bArr3[4] & 255) << 24) | ((bArr3[5] & 255) << 16) | ((bArr3[6] & 255) << 8);
    }
    ...
    private final void zzj(byte b4) throws IOException {
        zzd();
        if (this.zzb.zzb() != b4) {
    ...
    private final void zzk(byte[] bArr, int i4) throws IOException {
        int i5 = 0;
        while (i5 != i4) {
            int i6 = this.zza.read(bArr, i5, i4 - i5);
            if (i6 == -1) {
                throw new EOFException();
            }
            i5 += i6;
