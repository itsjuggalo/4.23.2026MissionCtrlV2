...
public final class zzoe extends zzbm {
    ...
    public static class zza extends zzce {
        ...
        public final String toString() {
            String str = this.zza;
            int i4 = zzog.zza[this.zzb.ordinal()];
            return String.format("(typeUrl=%s, outputPrefixType=%s)", str, i4 != 1 ? i4 != 2 ? i4 != 3 ? i4 != 4 ? "UNKNOWN" : "CRUNCHY" : "RAW" : "LEGACY" : "TINK");
        }
    ...
    private static void zza(zzqe zzqeVar, zzck zzckVar) throws GeneralSecurityException {
        int i4 = zzog.zzb[zzqeVar.zza().ordinal()];
        if (i4 == 1 || i4 == 2) {
            zzck.zza(zzckVar);
        }
    }
