...
final class zzafu {
    ...
    private static String zza(String str, String str2) {
        ...
        try {
            ...
            zza.c("NoSuchAlgorithm: " + e4.getMessage(), new Object[0]);
            return null;
        }
    }
    ...
    public final void zza(final String str, zzaeg zzaegVar, long j4, boolean z4) {
        this.zzd.put(str, new zzagb(j4, z4));
        zzb(zzaegVar, str);
        zzagb zzagbVar = this.zzd.get(str);
        if (zzagbVar.zza <= 0) {
        ...
        AbstractC1909a.registerReceiver(this.zzb.getApplicationContext(), zzafyVar, intentFilter, 2);
        AbstractC1765a.a(this.zzb).startSmsRetriever().addOnFailureListener(new zzafw(this));
    }
