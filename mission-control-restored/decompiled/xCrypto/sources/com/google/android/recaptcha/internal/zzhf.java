...
public final class zzhf implements zzgx {
    ...
    public final void zza(int i4, zzgd zzgdVar, zzue... zzueVarArr) throws zzce {
        ...
        Object[] objArrZzg = zzgdVar.zzc().zzg(AbstractC0765l.j0(zzueVarArr).subList(2, length));
        try {
            zzgdVar.zzc().zze(i4, method.invoke(objZza2, Arrays.copyOf(objArrZzg, objArrZzg.length)));
        } catch (Exception e4) {
