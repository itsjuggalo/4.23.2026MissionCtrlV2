...
public final class zzgh implements zzgx {
    ...
    public final void zza(int i4, zzgd zzgdVar, zzue... zzueVarArr) throws zzce {
        ...
        try {
            zzgdVar.zzc().zze(i4, objZza instanceof String ? String.valueOf(((String) objZza).charAt(iIntValue)) : objZza instanceof List ? ((List) objZza).get(iIntValue) : Array.get(objZza, iIntValue));
        } catch (Exception e4) {
