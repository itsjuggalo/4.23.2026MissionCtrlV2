...
public final class o extends AbstractC1548a implements Serializable {

    /* JADX INFO: renamed from: m, reason: collision with root package name */
    public static final o f13161m;
    private static final long serialVersionUID = 3127340209035924785L;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private volatile transient boolean f13162d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private transient int[] f13163e;

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    private transient int f13164f;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    private transient int f13165g;

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    private transient int f13166h;

    /* JADX INFO: renamed from: i, reason: collision with root package name */
    private transient int f13167i;

    /* JADX INFO: renamed from: j, reason: collision with root package name */
    private transient int f13168j;

    /* JADX INFO: renamed from: k, reason: collision with root package name */
    private transient int f13169k;

    /* JADX INFO: renamed from: l, reason: collision with root package name */
    private transient int f13170l;

    static {
        o oVar = new o();
        f13161m = oVar;
        AbstractC1548a.C(oVar, "Hijrah");
        AbstractC1548a.C(oVar, "islamic");
    }
    ...
    private void Z() {
        ...
        try {
            ...
            int[][] iArrH0 = h0();
            int iV = (int) j$.time.g.g0(1882, 11, 12).v();
            for (int i4 = 1300; i4 <= 1600; i4++) {
                int[] iArr = iArrH0[i4 - 1300];
                if (iArr.length != 12) {
            ...
            this.f13166h = 15600;
            this.f13164f = iV;
            int[] iArrB0 = b0(iV, map);
            this.f13163e = iArrB0;
            this.f13165g = iArrB0[3612];
            for (int i5 = 1300; i5 < 1600; i5++) {
                int i6 = (i5 * 12) - this.f13166h;
                int[] iArr2 = this.f13163e;
                int i7 = iArr2[i6 + 12] - iArr2[i6];
                this.f13169k = Math.min(this.f13169k, i7);
                this.f13170l = Math.max(this.f13170l, i7);
            }
            this.f13162d = true;
        } catch (Exception e4) {
            throw new j$.time.c("Unable to initialize HijrahCalendar: Hijrah-umalqura", e4);
        }
    }
    ...
    public final InterfaceC1549b G(int i4, int i5, int i6) {
        return q.Z(this, i4, i5, i6);
    }

    @Override // j$.time.chrono.l
    public final InterfaceC1549b A(int i4, int i5) {
        q qVarZ = q.Z(this, i4, 1, 1);
        if (i5 > qVarZ.W()) {
    ...
    public final InterfaceC1549b L() {
        return q.a0(this, j$.time.g.f0(j$.time.b.c()).g(j$.time.temporal.a.EPOCH_DAY));
    }
    ...
    public final InterfaceC1549b t(TemporalAccessor temporalAccessor) {
        ...
        return q.a0(this, temporalAccessor.g(j$.time.temporal.a.EPOCH_DAY));
    }
    ...
    public final j$.time.temporal.w U(j$.time.temporal.a aVar) {
        Z();
        if (aVar != null) {
            switch (n.f13160a[aVar.ordinal()]) {
                case 1:
                    return j$.time.temporal.w.k(this.f13167i, this.f13168j);
                case 2:
                    return j$.time.temporal.w.j(1L, this.f13170l);
                case 3:
                    return j$.time.temporal.w.j(1L, 5L);
                case 4:
                case 5:
                    int i4 = this.f13166h;
                    return j$.time.temporal.w.j(i4 / 12, (((this.f13163e.length - 1) + i4) / 12) - 1);
                case 6:
    ...
    final int[] e0(int i4) {
        Z();
        if (i4 < this.f13164f || i4 >= this.f13165g) {
            throw new j$.time.c("Hijrah date out of range");
        }
        int iBinarySearch = Arrays.binarySearch(this.f13163e, i4);
        if (iBinarySearch < 0) {
            iBinarySearch = (-iBinarySearch) - 2;
        }
        int i5 = this.f13166h;
        return new int[]{(iBinarySearch + i5) / 12, ((i5 + iBinarySearch) % 12) + 1, (i4 - this.f13163e[iBinarySearch]) + 1};
    }

    final long d0(int i4, int i5, int i6) {
        Z();
        if (i5 < 1 || i5 > 12) {
            throw new j$.time.c("Invalid Hijrah month: " + i5);
        }
        int i7 = (i5 - 1) + ((i4 * 12) - this.f13166h);
        if (i7 < 0 || i7 >= this.f13163e.length) {
            throw new j$.time.c("Invalid Hijrah date, year: " + i4 + ", month: " + i5);
        }
        if (i6 < 1 || i6 > f0(i4, i5)) {
            throw new j$.time.c("Invalid Hijrah day of month: " + i6);
        }
        return (i6 - 1) + this.f13163e[i7];
    }

    final int a0(long j4) {
        int i4 = this.f13166h;
        if (j4 >= i4 / 12 && j4 <= (((this.f13163e.length - 1) + i4) / 12) - 1) {
            return (int) j4;
        }
        throw new j$.time.c("Invalid Hijrah year: " + j4);
    }

    final int c0(int i4, int i5) {
        int i6 = (i4 * 12) - this.f13166h;
        int[] iArr = this.f13163e;
        return iArr[(i5 - 1) + i6] - iArr[i6];
    }

    final int f0(int i4, int i5) {
        int i6 = (i5 - 1) + ((i4 * 12) - this.f13166h);
        if (i6 >= 0) {
            int[] iArr = this.f13163e;
            if (i6 < iArr.length) {
    ...
    private int[] b0(int i4, HashMap map) {
        ...
        for (int i6 = 1300; i6 <= 1600; i6++) {
            ...
            while (i7 < 12) {
                ...
                i4 += i8;
                this.f13167i = Math.min(this.f13167i, i8);
                this.f13168j = Math.max(this.f13168j, i8);
                i7++;
                i5 = i9;
            }
        }
