...
public abstract class b {
    public static final Bundle a(C2489q... c2489qArr) {
        Bundle bundle = new Bundle(c2489qArr.length);
        for (C2489q c2489q : c2489qArr) {
            String str = (String) c2489q.a();
            Object objB = c2489q.b();
            if (objB == null) {
                ...
                AbstractC2304t.c(componentType);
                if (Parcelable.class.isAssignableFrom(componentType)) {
                    AbstractC2304t.d(objB, "null cannot be cast to non-null type kotlin.Array<android.os.Parcelable>");
                    bundle.putParcelableArray(str, (Parcelable[]) objB);
                } else if (String.class.isAssignableFrom(componentType)) {
                    AbstractC2304t.d(objB, "null cannot be cast to non-null type kotlin.Array<kotlin.String>");
                    bundle.putStringArray(str, (String[]) objB);
                } else if (CharSequence.class.isAssignableFrom(componentType)) {
                    AbstractC2304t.d(objB, "null cannot be cast to non-null type kotlin.Array<kotlin.CharSequence>");
