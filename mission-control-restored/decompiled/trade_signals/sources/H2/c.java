...
public class c {
    ...
    public final S3.b f3657a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public final String f3658b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public Integer f3659c = null;
    ...
    public final void a(AnalyticsConnector.ConditionalUserProperty conditionalUserProperty) {
        ((AnalyticsConnector) this.f3657a.get()).setConditionalUserProperty(conditionalUserProperty);
    }
    ...
    public final void b(List list) {
        ...
        while (it.hasNext()) {
            ...
            AnalyticsConnector.ConditionalUserProperty conditionalUserPropertyF = bVar.f(this.f3658b);
    ...
    public final List f() {
        return ((AnalyticsConnector) this.f3657a.get()).getConditionalUserProperties(this.f3658b, "");
    }
    ...
    public final ArrayList h(List list, List list2) {
        ...
        while (it.hasNext()) {
            b bVar = (b) it.next();
            if (!d(list2, bVar)) {
                arrayList.add(bVar.f(this.f3658b));
            }
        }
        return arrayList;
    }
    ...
    public final int i() {
        if (this.f3659c == null) {
            this.f3659c = Integer.valueOf(((AnalyticsConnector) this.f3657a.get()).getMaxUserProperties(this.f3658b));
        }
        return this.f3659c.intValue();
    }
    ...
    public final void k(String str) {
        ((AnalyticsConnector) this.f3657a.get()).clearConditionalUserProperty(str, null, null);
    }
