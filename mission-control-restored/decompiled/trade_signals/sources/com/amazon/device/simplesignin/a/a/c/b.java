...
public class b extends c {
    ...
    private static final String f14607b = "SSI_PublishMetric";

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static final String f14608c = "1.0";

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private static final String f14609d = "b";

    public b(a aVar, SSIEventRequest sSIEventRequest) {
        super(aVar, f14607b, "1.0");
        super.a(com.amazon.device.simplesignin.a.a.a.f14583t, sSIEventRequest.getEvent().toString());
        super.a(com.amazon.device.simplesignin.a.a.a.f14584u, sSIEventRequest.getEpochTimestamp());
        super.a(com.amazon.device.simplesignin.a.a.a.f14585v, sSIEventRequest.getFailureReason() != null ? sSIEventRequest.getFailureReason().toString() : "NA");
    }

    private void b(RequestStatus requestStatus) {
        d dVar = (d) j();
        Log.i(f14609d, "Response for request id: " + dVar.e() + " is: " + requestStatus.toString());
