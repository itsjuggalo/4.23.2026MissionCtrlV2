...
public class a {
                ...
                for (X509Certificate x509Certificate : acceptedIssuers) {
                    if (a(x509Certificate)) {
                        if (com.amazon.a.a.o.c.f14105a) {
                            f14075a.a("Trusted Cert: " + x509Certificate.getSubjectX500Principal().getName());
                        }
                        this.f14081e.add(new TrustAnchor(x509Certificate, null));
                        i8++;
                    }
                }
                if (com.amazon.a.a.o.c.f14105a) {
                    f14075a.a(String.format("loaded %d certs\n", Integer.valueOf(i8)));
                }
            }
        }
        if (this.f14081e.isEmpty()) {
            f14075a.b("TrustManager did not return valid accepted issuers, likely 3P custom TrustManager implementation issue.");
        }
        PKIXParameters pKIXParameters = new PKIXParameters(this.f14081e);
        this.f14079c = pKIXParameters;
        pKIXParameters.setRevocationEnabled(false);
        this.f14080d = CertPathValidator.getInstance(f14076b);
    }

    public boolean a(CertPath certPath) {
        try {
            Date notBefore = ((X509Certificate) certPath.getCertificates().get(0)).getNotBefore();
            f14075a.a("Verifying CertPath with " + notBefore);
            this.f14079c.setDate(notBefore);
            this.f14080d.validate(certPath, this.f14079c);
            return true;
        } catch (Exception e8) {
            if (!com.amazon.a.a.o.c.f14105a) {
                return false;
            }
            f14075a.b("Failed to verify cert path: " + e8, e8);
            return false;
        }
    }
    ...
    public static boolean a(X509Certificate x509Certificate) {
        ...
        try {
            ...
            if (!a(f14077f, bArrDigest)) {
                if (!a(f14078g, bArrDigest)) {
                    return false;
                }
            }
            return true;
