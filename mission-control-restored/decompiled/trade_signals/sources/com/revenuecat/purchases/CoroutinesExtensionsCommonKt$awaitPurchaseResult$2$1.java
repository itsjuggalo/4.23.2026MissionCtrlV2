...
public final class CoroutinesExtensionsCommonKt$awaitPurchaseResult$2$1 extends AbstractC2306v implements o {
    final /* synthetic */ InterfaceC2707e $continuation;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CoroutinesExtensionsCommonKt$awaitPurchaseResult$2$1(InterfaceC2707e interfaceC2707e) {
        super(2);
    ...
    public final void invoke(StoreTransaction storeTransaction, CustomerInfo customerInfo) {
        ...
        interfaceC2707e.resumeWith(C2490r.b(C2490r.a(C2490r.b(new PurchaseResult(storeTransaction, customerInfo)))));
    }
}
