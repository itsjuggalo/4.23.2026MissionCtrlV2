...
public final class BillingStrings {
    ...
    public static final String BILLING_PURCHASE_MORE_THAN_ONE_SKU = "There's more than one sku in the PurchaseRecord, but only one will be used.";
