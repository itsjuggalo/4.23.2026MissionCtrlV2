...
final class TestSubscriptionOption implements SubscriptionOption {
    ...
    public TestSubscriptionOption(List<PricingPhase> pricingPhases, String basePlanId, List<String> tags, PresentedOfferingContext presentedOfferingContext, InstallmentsInfo installmentsInfo, PurchasingData purchasingData) {
        ...
        AbstractC2304t.f(purchasingData, "purchasingData");
    ...
    public /* synthetic */ TestSubscriptionOption(List list, String str, List list2, PresentedOfferingContext presentedOfferingContext, InstallmentsInfo installmentsInfo, PurchasingData purchasingData, int i8, AbstractC2296k abstractC2296k) {
        this(list, (i8 & 2) != 0 ? "testBasePlanId" : str, (i8 & 4) != 0 ? AbstractC2595q.i() : list2, (i8 & 8) != 0 ? new PresentedOfferingContext("offering") : presentedOfferingContext, (i8 & 16) != 0 ? null : installmentsInfo, purchasingData);
    }
}
