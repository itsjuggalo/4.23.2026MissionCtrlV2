...
public final class OfferingsFactory$createOfferings$1$invoke$lambda$3$$inlined$log$1 extends AbstractC2306v implements Function0 {
    ...
    public final String invoke() {
        ...
        sb.append(' ');
        String str = String.format(OfferingStrings.CANNOT_FIND_PRODUCT_CONFIGURATION_ERROR, Arrays.copyOf(new Object[]{z.h0(this.$missingProducts$inlined, ", ", null, null, 0, null, null, 62, null)}, 1));
