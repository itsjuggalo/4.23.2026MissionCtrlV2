...
public final /* data */ class OfferingsResultData {
    ...
    public OfferingsResultData(Offerings offerings, Set<String> requestedProductIds, Set<String> notFoundProductIds) {
        AbstractC2304t.f(offerings, "offerings");
    ...
    public static /* synthetic */ OfferingsResultData copy$default(OfferingsResultData offeringsResultData, Offerings offerings, Set set, Set set2, int i8, Object obj) {
        if ((i8 & 1) != 0) {
    ...
    public boolean equals(Object other) {
        ...
        return AbstractC2304t.b(this.offerings, offeringsResultData.offerings) && AbstractC2304t.b(this.requestedProductIds, offeringsResultData.requestedProductIds) && AbstractC2304t.b(this.notFoundProductIds, offeringsResultData.notFoundProductIds);
    }
