...
public final /* data */ class HTTPRequest {
    ...
    public HTTPRequest(URL fullURL, Map<String, String> headers, JSONObject jSONObject) {
        AbstractC2304t.f(fullURL, "fullURL");
        AbstractC2304t.f(headers, "headers");
    ...
    public boolean equals(Object other) {
        ...
        return AbstractC2304t.b(this.fullURL, hTTPRequest.fullURL) && AbstractC2304t.b(this.headers, hTTPRequest.headers) && AbstractC2304t.b(this.body, hTTPRequest.body);
    }
