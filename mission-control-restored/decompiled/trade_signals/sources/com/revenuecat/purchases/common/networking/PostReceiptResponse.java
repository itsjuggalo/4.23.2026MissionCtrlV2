...
public final /* data */ class PostReceiptResponse {
    ...
    public static /* synthetic */ PostReceiptResponse copy$default(PostReceiptResponse postReceiptResponse, CustomerInfo customerInfo, Map map, JSONObject jSONObject, int i8, Object obj) {
        if ((i8 & 1) != 0) {
    ...
    public boolean equals(Object other) {
        ...
        return AbstractC2304t.b(this.customerInfo, postReceiptResponse.customerInfo) && AbstractC2304t.b(this.productInfoByProductId, postReceiptResponse.productInfoByProductId) && AbstractC2304t.b(this.body, postReceiptResponse.body);
    }
