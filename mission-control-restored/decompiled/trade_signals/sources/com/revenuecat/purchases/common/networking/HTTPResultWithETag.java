...
public final /* data */ class HTTPResultWithETag {
    ...
    public HTTPResultWithETag(ETagData eTagData, HTTPResult httpResult) {
        AbstractC2304t.f(eTagData, "eTagData");
        AbstractC2304t.f(httpResult, "httpResult");
    ...
    public boolean equals(Object other) {
        ...
        return AbstractC2304t.b(this.eTagData, hTTPResultWithETag.eTagData) && AbstractC2304t.b(this.httpResult, hTTPResultWithETag.httpResult);
    }
    ...
    public final String serialize() throws JSONException {
        ...
        AbstractC2304t.e(string, "JSONObject().apply {\n   …e())\n        }.toString()");
        return string;
    }
