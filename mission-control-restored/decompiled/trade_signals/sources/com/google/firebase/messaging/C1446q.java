...
public class C1446q implements Application.ActivityLifecycleCallbacks {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final Queue f15782a = new ArrayDeque(10);
        ...
        try {
            ...
            if (extras != null) {
                ...
                if (!TextUtils.isEmpty(strH)) {
                    if (this.f15782a.contains(strH)) {
                        return;
                    } else {
                        this.f15782a.add(strH);
                    }
                }
