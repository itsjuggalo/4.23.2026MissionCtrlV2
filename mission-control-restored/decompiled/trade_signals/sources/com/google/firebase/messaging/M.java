...
public class M {
    ...
    public M(Bundle bundle) {
        ...
        this.f15628a = new Bundle(bundle);
    }
    ...
    public int[] e() {
        ...
        try {
            ...
            str = "LightSettings is invalid: " + jSONArrayC + ". " + e8.getMessage() + ". Skipping setting LightSettings";
    ...
    public Object[] g(String str) {
        ...
        for (int i8 = 0; i8 < length; i8++) {
            strArr[i8] = jSONArrayC.optString(i8);
        }
        return strArr;
    }
    ...
    public String i(Resources resources, String str, String str2) {
        ...
        try {
            ...
            Log.w("NotificationParams", "Missing format argument for " + z(str2) + ": " + Arrays.toString(objArrG) + " Default value will be used.", e8);
            return null;
        }
    }
    ...
    public String p(String str) {
        return this.f15628a.getString(w(str));
    }
    ...
    public final String w(String str) {
        if (!this.f15628a.containsKey(str) && str.startsWith("gcm.n.")) {
            String strV = v(str);
            if (this.f15628a.containsKey(strV)) {
                return strV;
            }
        }
        return str;
