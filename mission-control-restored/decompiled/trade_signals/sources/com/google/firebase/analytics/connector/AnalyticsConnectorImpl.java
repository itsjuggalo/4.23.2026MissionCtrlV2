...
public class AnalyticsConnectorImpl implements AnalyticsConnector {
    ...
    public AnalyticsConnectorImpl(AppMeasurementSdk appMeasurementSdk) {
        AbstractC1294n.j(appMeasurementSdk);
        this.zza = appMeasurementSdk;
        this.zzb = new ConcurrentHashMap();
    }

    public static AnalyticsConnector getInstance() {
        return getInstance(f.o());
    }

    public static /* synthetic */ void zza(a aVar) {
        boolean z7 = ((b) aVar.a()).f2163a;
        synchronized (AnalyticsConnectorImpl.class) {
            ((AnalyticsConnectorImpl) AbstractC1294n.j(zzc)).zza.zza(z7);
        }
    }
    ...
    public List<AnalyticsConnector.ConditionalUserProperty> getConditionalUserProperties(String str, String str2) {
        ...
        for (Bundle bundle : this.zza.getConditionalUserProperties(str, str2)) {
            ...
            conditionalUserProperty.origin = (String) AbstractC1294n.j((String) zzjh.zzb(bundle, "origin", String.class, null));
            conditionalUserProperty.name = (String) AbstractC1294n.j((String) zzjh.zzb(bundle, "name", String.class, null));
    ...
    public Map<String, Object> getUserProperties(boolean z7) {
        return this.zza.getUserProperties(null, null, z7);
    }
    ...
    public AnalyticsConnector.AnalyticsConnectorHandle registerAnalyticsConnectorListener(final String str, AnalyticsConnector.AnalyticsConnectorListener analyticsConnectorListener) {
        AbstractC1294n.j(analyticsConnectorListener);
    ...
    public static AnalyticsConnector getInstance(f fVar) {
        return (AnalyticsConnector) fVar.k(AnalyticsConnector.class);
    }

    public static AnalyticsConnector getInstance(f fVar, Context context, d dVar) {
        AbstractC1294n.j(fVar);
        AbstractC1294n.j(context);
        AbstractC1294n.j(dVar);
        AbstractC1294n.j(context.getApplicationContext());
        if (zzc == null) {
            synchronized (AnalyticsConnectorImpl.class) {
                try {
                    if (zzc == null) {
                        ...
                        if (fVar.y()) {
                            dVar.c(b.class, zzb.zza, zza.zza);
