...
public final class zzko implements zzjv {
    private static final Map zza = new C2882a();
    ...
    public static synchronized void zzb() {
        try {
            ...
            for (zzko zzkoVar : map.values()) {
                zzkoVar.zzb.unregisterOnSharedPreferenceChangeListener((SharedPreferences.OnSharedPreferenceChangeListener) AbstractC2848n.n(zzkoVar.zzc));
            }
            map.clear();
        } catch (Throwable th) {
            throw th;
