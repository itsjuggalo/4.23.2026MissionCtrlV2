...
public final class zzht extends zzos implements zzak {
    ...
    private final void zzF(String str, com.google.android.gms.internal.measurement.zzgk zzgkVar) {
        ...
        for (int i8 = 0; i8 < zzgkVar.zza(); i8++) {
            com.google.android.gms.internal.measurement.zzgi zzgiVar = (com.google.android.gms.internal.measurement.zzgi) zzgkVar.zzb(i8).zzcl();
            if (zzgiVar.zza().isEmpty()) {
                ...
                if (zzgiVar.zzc() && zzgiVar.zzd()) {
                    c2882a.put(strZza, Boolean.TRUE);
                }
                if (zzgiVar.zze() && zzgiVar.zzf()) {
                    c2882a2.put(zzgiVar.zza(), Boolean.TRUE);
                }
                if (zzgiVar.zzg()) {
                    if (zzgiVar.zzh() < 2 || zzgiVar.zzh() > 65535) {
                        ...
                        c2882a3.put(zzgiVar.zza(), Integer.valueOf(zzgiVar.zzh()));
                    }
                }
            }
        }
        this.zza.put(str, hashSet);
        this.zzb.put(str, c2882a);
        this.zzc.put(str, c2882a2);
        this.zzi.put(str, c2882a3);
    }
    ...
    private static final Map zzI(com.google.android.gms.internal.measurement.zzgl zzglVar) {
        ...
        if (zzglVar != null) {
            for (com.google.android.gms.internal.measurement.zzgt zzgtVar : zzglVar.zze()) {
                c2882a.put(zzgtVar.zza(), zzgtVar.zzb());
            }
        }
        return c2882a;
    }

    private static final zzjk zzJ(int i8) {
        int i9 = i8 - 1;
        if (i9 == 1) {
    ...
    public final boolean zzi(String str, byte[] bArr, String str2, String str3) {
        ...
        try {
            ...
            this.zzu.zzaV().zze().zzc("Unable to serialize reduced-size config. Storing full config instead. appId", zzgu.zzl(str), e8);
        }
        ...
        try {
            ...
            zzavVarZzj.zzu.zzaV().zzb().zzc("Error storing remote config. appId", zzgu.zzl(str), e9);
        }
        zzgkVar.zzf();
        this.zzh.put(str, (com.google.android.gms.internal.measurement.zzgl) zzgkVar.zzbc());
        return true;
