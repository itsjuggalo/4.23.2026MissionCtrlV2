...
public final class zzfb {
    ...
    private final void zzU(String str, String str2, Bundle bundle, boolean z7, boolean z8, Long l8) {
        zzM(new zzep(this, l8, str, str2, bundle, z7, z8));
    }
    ...
    public final void zzD(int i8, String str, Object obj, Object obj2, Object obj3) {
    ...
    public final zzcr zzc(Context context, boolean z7) {
        try {
            return zzcq.asInterface(DynamiteModule.e(context, z7 ? DynamiteModule.f15066e : DynamiteModule.f15064c, ModuleDescriptor.MODULE_ID).d("com.google.android.gms.measurement.internal.AppMeasurementDynamiteService"));
    ...
    public final void zzf(com.google.android.gms.measurement.internal.zzjq zzjqVar) {
        AbstractC1294n.j(zzjqVar);
        List list = this.zzf;
        synchronized (list) {
            for (int i8 = 0; i8 < list.size(); i8++) {
                try {
                    if (zzjqVar.equals(((Pair) list.get(i8)).first)) {
    ...
    public final void zzj(String str, String str2, Bundle bundle, long j8) {
