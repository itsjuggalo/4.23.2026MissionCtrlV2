...
public final class zzmb extends zzg {
    ...
    private final void zzA(zzlu zzluVar, boolean z7, long j8) {
        zzic zzicVar = this.zzu;
        zzicVar.zzw().zzc(zzicVar.zzaZ().b());
        if (!zzicVar.zzh().zzb.zzd(zzluVar != null && zzluVar.zzd, z7, j8) || zzluVar == null) {
            return;
        }
        zzluVar.zzd = false;
    }
    ...
    private final void zzy(String str, zzlu zzluVar, boolean z7) {
        zzlu zzluVar2;
        ...
        this.zzb = zzluVar2;
        zzic zzicVar = this.zzu;
        zzicVar.zzaW().zzj(new zzlw(this, zzluVar2, zzluVar3, zzicVar.zzaZ().b(), z7));
    }
    ...
    */
    ...
    public final zzlu zzh(boolean z7) {
        zzb();
        zzg();
        if (!z7) {
            return this.zza;
    ...
    public final void zzj(Bundle bundle, long j8) {
        synchronized (this.zzj) {
            try {
                ...
                zzlu zzluVar3 = new zzlu(string, string2, zzicVar.zzk().zzd(), true, j8);
                this.zzb = zzluVar3;
                this.zzc = zzluVar2;
                this.zzg = zzluVar3;
                zzicVar.zzaW().zzj(new zzlv(this, bundle, zzluVar3, zzluVar2, zzicVar.zzaZ().b()));
            } catch (Throwable th) {
                throw th;
            }
        }
    ...
    public final void zzm(com.google.android.gms.internal.measurement.zzdf zzdfVar, Bundle bundle) {
        ...
        this.zzd.put(Integer.valueOf(zzdfVar.zza), new zzlu(bundle2.getString("name"), bundle2.getString("referrer_name"), bundle2.getLong(DiagnosticsEntry.ID_KEY)));
    }
    ...
    public final void zzn(com.google.android.gms.internal.measurement.zzdf zzdfVar) {
        ...
        zzicVar3.zzaW().zzj(new zzc(zzdVarZzw, zzicVar3.zzaZ().b()));
    }
    ...
    public final void zzp(com.google.android.gms.internal.measurement.zzdf zzdfVar) {
        ...
        if (!zzicVar.zzc().zzv()) {
            this.zzb = null;
            zzicVar.zzaW().zzj(new zzly(this, jB));
        } else {
            zzlu zzluVarZzB = zzB(zzdfVar);
            this.zzc = this.zzb;
            this.zzb = null;
            zzicVar.zzaW().zzj(new zzlz(this, zzluVarZzB, jB));
        }
    }
    ...
    public final void zzq(com.google.android.gms.internal.measurement.zzdf zzdfVar, Bundle bundle) {
        ...
        bundle2.putLong(DiagnosticsEntry.ID_KEY, zzluVar.zzc);
    ...
    public final /* synthetic */ void zzt(Bundle bundle, zzlu zzluVar, zzlu zzluVar2, long j8) {
        bundle.remove(FirebaseAnalytics.Param.SCREEN_NAME);
        bundle.remove(FirebaseAnalytics.Param.SCREEN_CLASS);
        zzz(zzluVar, zzluVar2, j8, true, this.zzu.zzk().zzF(null, FirebaseAnalytics.Event.SCREEN_VIEW, bundle, null, false));
    }

    public final /* synthetic */ void zzu(zzlu zzluVar, zzlu zzluVar2, long j8, boolean z7, Bundle bundle) {
        zzz(zzluVar, zzluVar2, j8, z7, null);
    }

    public final /* synthetic */ void zzv(zzlu zzluVar, boolean z7, long j8) {
        zzA(zzluVar, false, j8);
    }
