...
public class zzmb<MessageType extends zzmf<MessageType, BuilderType>, BuilderType extends zzmb<MessageType, BuilderType>> extends zzkr<MessageType, BuilderType> {
    ...
    public final /* bridge */ /* synthetic */ zzkr zzaS(byte[] bArr, int i8, int i9) throws zzmr {
        int i10 = zzlr.zzb;
        int i11 = zznu.zza;
        zzbe(bArr, 0, i9, zzlr.zza);
        return this;
    }

    @Override // com.google.android.gms.internal.measurement.zzkr
    public final /* bridge */ /* synthetic */ zzkr zzaT(byte[] bArr, int i8, int i9, zzlr zzlrVar) throws zzmr {
        zzbe(bArr, 0, i9, zzlrVar);
        return this;
    }
    ...
    public final zzmb zzbe(byte[] bArr, int i8, int i9, zzlr zzlrVar) throws zzmr {
        if (!this.zza.zzcf()) {
            zzaY();
        }
        try {
            zznu.zza().zzb(this.zza.getClass()).zzi(this.zza, bArr, 0, i9, new zzkw(zzlrVar));
            return this;
        } catch (zzmr e8) {
            throw e8;
