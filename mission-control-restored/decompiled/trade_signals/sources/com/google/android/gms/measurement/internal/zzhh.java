...
final class zzhh extends zzjf {
    ...
    public final Pair zzb(String str) {
        ...
        L1.a.b(true);
        try {
            a.C0073a c0073aA = L1.a.a(zzicVar.zzaY());
            this.zzx = "";
            String strA = c0073aA.a();
            if (strA != null) {
                this.zzx = strA;
            }
            this.zzy = c0073aA.b();
        } catch (Exception e8) {
            this.zzu.zzaV().zzj().zzb("Unable to get advertising id", e8);
            this.zzx = "";
        }
        L1.a.b(false);
    ...
    public final boolean zzk(int i8) {
        return zzjl.zzu(i8, zzd().getInt("consent_source", 100));
    }
    ...
    public final void zzn(boolean z7) {
        zzg();
        this.zzu.zzaV().zzk().zzb("App measurement setting deferred collection", Boolean.valueOf(z7));
        SharedPreferences.Editor editorEdit = zzd().edit();
    ...
    public final boolean zzp(long j8) {
        return j8 - this.zzf.zza() > this.zzk.zza();
    }
}
