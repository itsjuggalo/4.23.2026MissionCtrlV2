...
public class JobInfoSchedulerService extends JobService {
    ...
    public boolean onStartJob(final JobParameters jobParameters) {
        ...
        int i8 = jobParameters.getExtras().getInt(Constants.PRIORITY);
        int i9 = jobParameters.getExtras().getInt("attemptNumber");
        u.f(getApplicationContext());
        p.a aVarD = p.a().b(string).d(a.b(i8));
        if (string2 != null) {
            aVarD.c(Base64.decode(string2, 0));
        }
        u.c().e().v(aVarD.a(), i9, new Runnable() { // from class: G1.e
            @Override // java.lang.Runnable
            public final void run() {
                this.f2099a.b(jobParameters);
            }
        });
        return true;
    }
