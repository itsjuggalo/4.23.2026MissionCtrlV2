...
public class FlutterFirebaseMessagingBackgroundService extends JobIntentService {
    ...
    public static void enqueueMessageProcessing(Context context, Intent intent, boolean z7) {
        JobIntentService.enqueueWork(context, FlutterFirebaseMessagingBackgroundService.class, 2020, intent, z7);
    }
    ...
    public static void setCallbackDispatcher(long j8) {
        FlutterFirebaseMessagingBackgroundExecutor.setCallbackDispatcher(j8);
    }

    public static void setUserCallbackHandle(long j8) {
        FlutterFirebaseMessagingBackgroundExecutor.setUserCallbackHandle(j8);
    }

    public static void startBackgroundIsolate(long j8, FlutterShellArgs flutterShellArgs) {
        ...
        flutterFirebaseMessagingBackgroundExecutor.startBackgroundIsolate(j8, flutterShellArgs);
    }
        ...
        synchronized (list) {
            try {
                ...
                try {
                    ...
                    Log.i(TAG, "Exception waiting to execute Dart callback", e8);
                }
            } catch (Throwable th) {
                throw th;
            }
