...
public class FlutterFirebaseMessagingStore {
    ...
    private final String DELIMITER = com.amazon.a.a.o.b.f.f14100a;
    ...
    public List<Object> jsonArrayToList(JSONArray jSONArray) throws JSONException {
        ...
        for (int i8 = 0; i8 < jSONArray.length(); i8++) {
            Object objJsonObjectToMap = jSONArray.get(i8);
            if (objJsonObjectToMap instanceof JSONArray) {
                objJsonObjectToMap = jsonArrayToList((JSONArray) objJsonObjectToMap);
            } else if (objJsonObjectToMap instanceof JSONObject) {
                objJsonObjectToMap = jsonObjectToMap((JSONObject) objJsonObjectToMap);
    ...
    public void removeFirebaseMessage(String str) {
        ...
        setPreferencesStringValue(KEY_NOTIFICATION_IDS, preferencesStringValue.replace(str + com.amazon.a.a.o.b.f.f14100a, ""));
    }
    ...
    public void storeFirebaseMessage(V v8) {
        setPreferencesStringValue(v8.f(), new JSONObject(FlutterFirebaseMessagingUtils.remoteMessageToMap(v8)).toString());
        String strReplace = getPreferencesStringValue(KEY_NOTIFICATION_IDS, "") + v8.f() + com.amazon.a.a.o.b.f.f14100a;
        ArrayList arrayList = new ArrayList(Arrays.asList(strReplace.split(com.amazon.a.a.o.b.f.f14100a)));
        if (arrayList.size() > 100) {
            String str = (String) arrayList.get(0);
            getPreferences().edit().remove(str).apply();
            strReplace = strReplace.replace(str + com.amazon.a.a.o.b.f.f14100a, "");
        }
