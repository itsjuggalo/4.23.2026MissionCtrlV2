...
public final class TextEditingDelta {
    ...
    public TextEditingDelta(CharSequence charSequence, int i8, int i9, int i10, int i11) {
        this.newSelectionStart = i8;
        this.newSelectionEnd = i9;
        this.newComposingStart = i10;
        this.newComposingEnd = i11;
        setDeltas(charSequence, "", -1, -1);
    }

    private void setDeltas(CharSequence charSequence, CharSequence charSequence2, int i8, int i9) {
    ...
    public JSONObject toJSON() {
        ...
        try {
            ...
            Log.e(TAG, "unable to create JSONObject: " + e8);
        }
        return jSONObject;
    }

    public TextEditingDelta(CharSequence charSequence, int i8, int i9, CharSequence charSequence2, int i10, int i11, int i12, int i13) {
        this.newSelectionStart = i10;
        this.newSelectionEnd = i11;
        this.newComposingStart = i12;
        this.newComposingEnd = i13;
        setDeltas(charSequence, charSequence2.toString(), i8, i9);
    }
}
