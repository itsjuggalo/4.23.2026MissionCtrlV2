...
public class FlutterEngine implements ViewUtils.DisplayUpdater {
    ...
    public static FlutterEngine engineForId(long j8) {
        return idToEngine.get(Long.valueOf(j8));
    }
    ...
    public FlutterEngine spawn(Context context, DartExecutor.DartEntrypoint dartEntrypoint, String str, List<String> list, PlatformViewsController platformViewsController, boolean z7, boolean z8) {
        if (isAttachedToJni()) {
            return new FlutterEngine(context, null, this.flutterJNI.spawn(dartEntrypoint.dartEntrypointFunctionName, dartEntrypoint.dartEntrypointLibrary, str, list, nextEngineId), platformViewsController, null, z7, z8);
        }
    ...
    public FlutterEngine(Context context, FlutterLoader flutterLoader, FlutterJNI flutterJNI, PlatformViewsController platformViewsController, String[] strArr, boolean z7) {
        this(context, flutterLoader, flutterJNI, platformViewsController, strArr, z7, false);
    }

    public FlutterEngine(Context context, FlutterLoader flutterLoader, FlutterJNI flutterJNI, PlatformViewsController platformViewsController, String[] strArr, boolean z7, boolean z8) {
        this(context, flutterLoader, flutterJNI, platformViewsController, strArr, z7, z8, null);
    }

    public FlutterEngine(Context context, FlutterLoader flutterLoader, FlutterJNI flutterJNI, PlatformViewsController platformViewsController, String[] strArr, boolean z7, boolean z8, FlutterEngineGroup flutterEngineGroup) {
        AssetManager assets;
        ...
        long j8 = nextEngineId;
        nextEngineId = 1 + j8;
        this.engineId = j8;
        idToEngine.put(Long.valueOf(j8), this);
        try {
        ...
        this.restorationChannel = new RestorationChannel(dartExecutor, z8);
        ...
        if (z7 && flutterLoader.automaticallyRegisterPlugins()) {
    ...
    public FlutterEngine(Context context, FlutterLoader flutterLoader, FlutterJNI flutterJNI, String[] strArr, boolean z7) {
        this(context, flutterLoader, flutterJNI, new PlatformViewsController(), strArr, z7);
    }
    ...
    public FlutterEngine(Context context, String[] strArr, boolean z7) {
        this(context, null, null, strArr, z7);
    }

    public FlutterEngine(Context context, String[] strArr, boolean z7, boolean z8) {
        this(context, null, null, new PlatformViewsController(), strArr, z7, z8);
    }
}
