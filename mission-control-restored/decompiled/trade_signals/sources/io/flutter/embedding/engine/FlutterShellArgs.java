...
public class FlutterShellArgs {
    ...
    public static FlutterShellArgs fromIntent(Intent intent) {
        ...
        if (intExtra > 0 || (intExtra = intent.getIntExtra(ARG_KEY_OBSERVATORY_PORT, 0)) > 0) {
        ...
        if (intent.hasExtra(ARG_KEY_TOGGLE_IMPELLER)) {
            arrayList.add(intent.getBooleanExtra(ARG_KEY_TOGGLE_IMPELLER, false) ? ARG_ENABLE_IMPELLER : ARG_DISABLE_IMPELLER);
        }
