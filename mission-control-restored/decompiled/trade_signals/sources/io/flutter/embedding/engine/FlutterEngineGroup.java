...
public class FlutterEngineGroup {
    ...
    public static class Options {
        ...
        public Options setAutomaticallyRegisterPlugins(boolean z7) {
            this.automaticallyRegisterPlugins = z7;
            return this;
        }
        ...
        public Options setWaitForRestorationData(boolean z7) {
    ...
    public FlutterEngine createEngine(Context context, PlatformViewsController platformViewsController, boolean z7, boolean z8) {
