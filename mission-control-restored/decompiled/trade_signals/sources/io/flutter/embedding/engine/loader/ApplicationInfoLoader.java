...
public final class ApplicationInfoLoader {
    ...
    public static final String PUBLIC_AOT_SHARED_LIBRARY_NAME = FlutterLoader.class.getName() + com.amazon.a.a.o.c.a.b.f14112a + "aot-shared-library-name";
    public static final String PUBLIC_VM_SNAPSHOT_DATA_KEY = FlutterLoader.class.getName() + com.amazon.a.a.o.c.a.b.f14112a + "vm-snapshot-data";
    public static final String PUBLIC_ISOLATE_SNAPSHOT_DATA_KEY = FlutterLoader.class.getName() + com.amazon.a.a.o.c.a.b.f14112a + "isolate-snapshot-data";
    public static final String PUBLIC_FLUTTER_ASSETS_DIR_KEY = FlutterLoader.class.getName() + com.amazon.a.a.o.c.a.b.f14112a + "flutter-assets-dir";
    ...
    private static String getNetworkPolicy(ApplicationInfo applicationInfo, Context context) {
        ...
        if (bundle == null || (i8 = bundle.getInt(NETWORK_POLICY_METADATA_KEY, 0)) <= 0) {
            return null;
        }
    ...
    private static void parseDomain(XmlResourceParser xmlResourceParser, JSONArray jSONArray, boolean z7) throws XmlPullParserException, IOException {
    ...
    private static void parseDomainConfig(XmlResourceParser xmlResourceParser, JSONArray jSONArray, boolean z7) throws XmlPullParserException, IOException {
