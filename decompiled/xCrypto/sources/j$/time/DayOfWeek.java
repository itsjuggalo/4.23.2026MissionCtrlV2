...
public final class DayOfWeek implements TemporalAccessor, j$.time.temporal.n {
    ...
    private static final DayOfWeek[] f13106a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final /* synthetic */ DayOfWeek[] f13107b;
    ...
    public static DayOfWeek[] values() {
        return (DayOfWeek[]) f13107b.clone();
    }
    ...
    static {
        ...
        SUNDAY = dayOfWeek7;
        f13107b = new DayOfWeek[]{dayOfWeek, dayOfWeek2, dayOfWeek3, dayOfWeek4, dayOfWeek5, dayOfWeek6, dayOfWeek7};
        f13106a = values();
    }

    public static DayOfWeek r(int i4) {
        if (i4 < 1 || i4 > 7) {
    ...
    public final boolean f(j$.time.temporal.r rVar) {
        return rVar instanceof j$.time.temporal.a ? rVar == j$.time.temporal.a.DAY_OF_WEEK : rVar != null && rVar.W(this);
    }
