...
public abstract class AbstractC0276j {
    ...
    public static Method f561b = null;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public static boolean f562c = false;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public static Field f563d;

    /* JADX INFO: renamed from: H.j$a */
    public interface a {
    ...
    public static boolean a(ActionBar actionBar, KeyEvent keyEvent) {
        if (!f560a) {
            try {
                f561b = actionBar.getClass().getMethod("onMenuKeyEvent", KeyEvent.class);
    ...
    public static boolean e(a aVar, View view, Window.Callback callback, KeyEvent keyEvent) {
        ...
        return Build.VERSION.SDK_INT >= 28 ? aVar.superDispatchKeyEvent(keyEvent) : callback instanceof Activity ? b((Activity) callback, keyEvent) : callback instanceof Dialog ? c((Dialog) callback, keyEvent) : (view != null && E.c(view, keyEvent)) || aVar.superDispatchKeyEvent(keyEvent);
    }
