...
public final class f implements HostnameVerifier {
    ...
    public static final Pattern f3257b = Pattern.compile("([0-9a-fA-F]*:[0-9a-fA-F:.]*)|([\\d.]+)");
    ...
    public static boolean c(String str) {
        return f3257b.matcher(str).matches();
    }
    ...
    public final boolean d(String str, String str2) {
        if (str != null && str.length() != 0 && !str.startsWith(".") && !str.endsWith("..") && str2 != null && str2.length() != 0 && !str2.startsWith(".") && !str2.endsWith("..")) {
            if (!str.endsWith(".")) {
                str = str + com.amazon.a.a.o.c.a.b.f8816a;
            }
            if (!str2.endsWith(".")) {
                str2 = str2 + com.amazon.a.a.o.c.a.b.f8816a;
            }
    ...
    public final boolean e(String str, X509Certificate x509Certificate) {
        ...
        boolean z4 = false;
        while (i4 < size) {
            if (d(lowerCase, (String) listA.get(i4))) {
                return true;
            }
            i4++;
            z4 = true;
        }
        if (z4 || (strB = new d(x509Certificate.getSubjectX500Principal()).b("cn")) == null) {
            return false;
        }
    ...
    public final boolean f(String str, X509Certificate x509Certificate) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            if (str.equalsIgnoreCase((String) listA.get(i4))) {
                return true;
            }
        }
        return false;
