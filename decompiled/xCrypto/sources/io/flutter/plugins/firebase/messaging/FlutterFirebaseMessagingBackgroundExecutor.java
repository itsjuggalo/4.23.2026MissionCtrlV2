...
public class FlutterFirebaseMessagingBackgroundExecutor implements MethodChannel.MethodCallHandler {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$startBackgroundIsolate$0(FlutterLoader flutterLoader, FlutterShellArgs flutterShellArgs, long j4) {
        ...
        if (isNotRunning()) {
            ...
            FlutterCallbackInformation flutterCallbackInformationLookupCallbackInformation = FlutterCallbackInformation.lookupCallbackInformation(j4);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$startBackgroundIsolate$1(final FlutterLoader flutterLoader, Handler handler, final FlutterShellArgs flutterShellArgs, final long j4) {
        ...
        flutterLoader.ensureInitializationCompleteAsync(ContextHolder.getApplicationContext(), null, handler, new Runnable() { // from class: io.flutter.plugins.firebase.messaging.a
            ...
            public final void run() {
                this.f12670a.lambda$startBackgroundIsolate$0(flutterLoader, flutterShellArgs, j4);
            }
        });
    }
    ...
    public static void setCallbackDispatcher(long j4) {
        Context applicationContext = ContextHolder.getApplicationContext();
        if (applicationContext == null) {
            Log.e(TAG, "Context is null, cannot continue.");
        } else {
            applicationContext.getSharedPreferences("io.flutter.firebase.messaging.callback", 0).edit().putLong(CALLBACK_HANDLE_KEY, j4).apply();
        }
    }

    public static void setUserCallbackHandle(long j4) {
        ContextHolder.getApplicationContext().getSharedPreferences("io.flutter.firebase.messaging.callback", 0).edit().putLong(USER_CALLBACK_HANDLE_KEY, j4).apply();
    }
    ...
    public void onMethodCall(MethodCall methodCall, MethodChannel.Result result) {
        ...
        } catch (PluginRegistrantException e4) {
            result.error(com.google.firebase.messaging.Constants.IPC_BUNDLE_KEY_SEND_ERROR, "Flutter FCM error: " + e4.getMessage(), null);
        }
    }
    ...
    public void startBackgroundIsolate(final long j4, final FlutterShellArgs flutterShellArgs) {
        if (this.backgroundFlutterEngine != null) {
        ...
        handler.post(new Runnable() { // from class: io.flutter.plugins.firebase.messaging.b
            @Override // java.lang.Runnable
            public final void run() {
                this.f12674a.lambda$startBackgroundIsolate$1(flutterLoader, handler, flutterShellArgs, j4);
            }
        });
    }
}
