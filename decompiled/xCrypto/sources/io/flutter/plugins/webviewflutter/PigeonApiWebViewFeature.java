...
public abstract class PigeonApiWebViewFeature {
    ...
    public static final class Companion {
        ...
        public static final void setUpMessageHandlers$lambda$1$lambda$0(PigeonApiWebViewFeature pigeonApiWebViewFeature, Object obj, BasicMessageChannel.Reply reply) {
            ...
            try {
                listWrapError = AbstractC0768o.b(Boolean.valueOf(pigeonApiWebViewFeature.isFeatureSupported((String) obj2)));
            } catch (Throwable th) {
        ...
        public final void setUpMessageHandlers(BinaryMessenger binaryMessenger, final PigeonApiWebViewFeature pigeonApiWebViewFeature) {
            ...
            if (pigeonApiWebViewFeature != null) {
                basicMessageChannel.setMessageHandler(new BasicMessageChannel.MessageHandler() { // from class: io.flutter.plugins.webviewflutter.J2
                    @Override // io.flutter.plugin.common.BasicMessageChannel.MessageHandler
                    public final void onMessage(Object obj, BasicMessageChannel.Reply reply) {
                        PigeonApiWebViewFeature.Companion.setUpMessageHandlers$lambda$1$lambda$0(pigeonApiWebViewFeature, obj, reply);
                    }
                });
            } else {
    ...
    public final void pigeon_newInstance(u0.d pigeon_instanceArg, final i3.k callback) {
        ...
        if (getPigeonRegistrar().getIgnoreCallsToDart()) {
            ...
            new BasicMessageChannel(getPigeonRegistrar().getBinaryMessenger(), "dev.flutter.pigeon.webview_flutter_android.WebViewFeature.pigeon_newInstance", getPigeonRegistrar().getCodec()).send(AbstractC0768o.b(Long.valueOf(getPigeonRegistrar().getInstanceManager().addHostCreatedInstance(pigeon_instanceArg))), new BasicMessageChannel.Reply() { // from class: io.flutter.plugins.webviewflutter.I2
