...
public class WebViewActivity extends Activity {
    ...
    public static Intent createIntent(Context context, String str, boolean z4, boolean z5, Bundle bundle) {
        return new Intent(context, (Class<?>) WebViewActivity.class).putExtra(URL_EXTRA, str).putExtra(ENABLE_JS_EXTRA, z4).putExtra(ENABLE_DOM_EXTRA, z5).putExtra("com.android.browser.headers", bundle);
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        AbstractC1909a.registerReceiver(this, this.broadcastReceiver, this.closeIntentFilter, 2);
    }
