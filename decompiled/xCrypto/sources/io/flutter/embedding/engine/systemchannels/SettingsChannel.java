...
public class SettingsChannel {
    ...
    public static class ConfigurationQueue {
        ...
        public SentConfiguration getConfiguration(int i4) {
            ...
            if (sentConfiguration == null) {
                Log.e(SettingsChannel.TAG, "Cannot find config with generation: " + String.valueOf(i4) + ", after exhausting the queue.");
                return null;
            }
            if (sentConfiguration.generationNumber == i4) {
                return sentConfiguration;
            }
            Log.e(SettingsChannel.TAG, "Cannot find config with generation: " + String.valueOf(i4) + ", the oldest config is now: " + String.valueOf(this.currentConfiguration.generationNumber));
            return null;
        }
    }
    ...
    public static DisplayMetrics getPastDisplayMetrics(int i4) {
        ConfigurationQueue.SentConfiguration configuration = CONFIGURATION_QUEUE.getConfiguration(i4);
