...
public abstract class L {
    ...
    public static boolean b(Object obj) {
        return obj instanceof Boolean ? !((Boolean) obj).booleanValue() : obj instanceof Integer ? ((Integer) obj).intValue() == 0 : obj instanceof Float ? Float.floatToRawIntBits(((Float) obj).floatValue()) == 0 : obj instanceof Double ? Double.doubleToRawLongBits(((Double) obj).doubleValue()) == 0 : obj instanceof String ? obj.equals("") : obj instanceof AbstractC0793f ? obj.equals(AbstractC0793f.f6994b) : obj instanceof J ? obj == ((J) obj).getDefaultInstanceForType() : (obj instanceof Enum) && ((Enum) obj).ordinal() == 0;
    }
    ...
    public static void d(StringBuilder sb, int i4, String str, Object obj) {
        ...
        if (obj instanceof AbstractC0793f) {
            sb.append(": \"");
            sb.append(d0.a((AbstractC0793f) obj));
            sb.append('\"');
            return;
        }
        if (obj instanceof AbstractC0806t) {
            sb.append(" {");
            e((AbstractC0806t) obj, sb, i4 + 2);
            sb.append("\n");
            a(i4, sb);
            sb.append("}");
            return;
