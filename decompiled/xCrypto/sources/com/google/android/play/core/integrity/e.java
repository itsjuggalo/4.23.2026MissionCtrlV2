...
final class e extends StandardIntegrityManager.PrepareIntegrityTokenRequest {
    ...
    public /* synthetic */ e(long j4, int i4, d dVar) {
        this.f10171a = j4;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof StandardIntegrityManager.PrepareIntegrityTokenRequest) {
            ...
            if (this.f10171a == prepareIntegrityTokenRequest.b()) {
    ...
    public final int hashCode() {
        long j4 = this.f10171a;
        return (((int) (j4 ^ (j4 >>> 32))) ^ 1000003) * 1000003;
    }

    public final String toString() {
        return "PrepareIntegrityTokenRequest{cloudProjectNumber=" + this.f10171a + ", webViewRequestMode=0}";
    }
}
