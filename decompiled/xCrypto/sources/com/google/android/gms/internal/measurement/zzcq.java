...
public abstract class zzcq extends zzbm implements zzcr {
    ...
    public final boolean zza(int i4, Parcel parcel, Parcel parcel2, int i5) {
        ...
        switch (i4) {
            case 1:
                J1.a aVarB = a.AbstractBinderC0026a.b(parcel.readStrongBinder());
                zzdd zzddVar = (zzdd) zzbn.zzb(parcel, zzdd.CREATOR);
                long j4 = parcel.readLong();
                zzbn.zzf(parcel);
                initialize(aVarB, zzddVar, j4);
                break;
            case 2:
                ...
                zzbn.zzf(parcel);
                logEvent(string, string2, bundle, zZza, zZza2, j5);
                break;
            case 3:
                ...
                zzbn.zzf(parcel);
                logEventAndBundle(string3, string4, bundle2, zzcsVar, j6);
                break;
            case 4:
                String string5 = parcel.readString();
                String string6 = parcel.readString();
                J1.a aVarB2 = a.AbstractBinderC0026a.b(parcel.readStrongBinder());
                boolean zZza3 = zzbn.zza(parcel);
                long j7 = parcel.readLong();
                zzbn.zzf(parcel);
                setUserProperty(string5, string6, aVarB2, zZza3, j7);
                break;
            case 5:
            ...
            case 11:
                ...
                zzbn.zzf(parcel);
                setMeasurementEnabled(zZza5, j10);
                break;
            case 12:
            ...
            case FirestoreIndexValueWriter.INDEX_TYPE_NUMBER /* 15 */:
                J1.a aVarB3 = a.AbstractBinderC0026a.b(parcel.readStrongBinder());
                String string15 = parcel.readString();
                String string16 = parcel.readString();
                long j14 = parcel.readLong();
                zzbn.zzf(parcel);
                setCurrentScreen(aVarB3, string15, string16, j14);
                break;
            case 16:
            ...
            case 24:
                ...
                break;
            case 25:
                J1.a aVarB4 = a.AbstractBinderC0026a.b(parcel.readStrongBinder());
                long j17 = parcel.readLong();
                zzbn.zzf(parcel);
                onActivityStarted(aVarB4, j17);
                break;
            case Build.API_LEVELS.API_26 /* 26 */:
                J1.a aVarB5 = a.AbstractBinderC0026a.b(parcel.readStrongBinder());
                long j18 = parcel.readLong();
                zzbn.zzf(parcel);
                onActivityStopped(aVarB5, j18);
                break;
            case Build.API_LEVELS.API_27 /* 27 */:
                J1.a aVarB6 = a.AbstractBinderC0026a.b(parcel.readStrongBinder());
                Bundle bundle5 = (Bundle) zzbn.zzb(parcel, Bundle.CREATOR);
                long j19 = parcel.readLong();
                zzbn.zzf(parcel);
                onActivityCreated(aVarB6, bundle5, j19);
                break;
            case Build.API_LEVELS.API_28 /* 28 */:
                J1.a aVarB7 = a.AbstractBinderC0026a.b(parcel.readStrongBinder());
                long j20 = parcel.readLong();
                zzbn.zzf(parcel);
                onActivityDestroyed(aVarB7, j20);
                break;
            case Build.API_LEVELS.API_29 /* 29 */:
                J1.a aVarB8 = a.AbstractBinderC0026a.b(parcel.readStrongBinder());
                long j21 = parcel.readLong();
                zzbn.zzf(parcel);
                onActivityPaused(aVarB8, j21);
                break;
            case 30:
                J1.a aVarB9 = a.AbstractBinderC0026a.b(parcel.readStrongBinder());
                long j22 = parcel.readLong();
                zzbn.zzf(parcel);
                onActivityResumed(aVarB9, j22);
                break;
            case Build.API_LEVELS.API_31 /* 31 */:
                J1.a aVarB10 = a.AbstractBinderC0026a.b(parcel.readStrongBinder());
                ...
                zzbn.zzf(parcel);
                onActivitySaveInstanceState(aVarB10, zzcsVar7, j23);
                break;
            case 32:
                ...
                zzbn.zzf(parcel);
                performAction(bundle6, zzcsVar6, j24);
                break;
            case Build.API_LEVELS.API_33 /* 33 */:
                int i6 = parcel.readInt();
                String string19 = parcel.readString();
                J1.a aVarB11 = a.AbstractBinderC0026a.b(parcel.readStrongBinder());
                J1.a aVarB12 = a.AbstractBinderC0026a.b(parcel.readStrongBinder());
                J1.a aVarB13 = a.AbstractBinderC0026a.b(parcel.readStrongBinder());
                zzbn.zzf(parcel);
                logHealthData(i6, string19, aVarB11, aVarB12, aVarB13);
                break;
            ...
            case FirestoreIndexValueWriter.INDEX_TYPE_ARRAY /* 50 */:
                ...
                zzbn.zzf(parcel);
                setCurrentScreenByScionActivityInfo(zzdfVar, string20, string21, j28);
                break;
            case 51:
                zzdf zzdfVar2 = (zzdf) zzbn.zzb(parcel, zzdf.CREATOR);
                long j29 = parcel.readLong();
                zzbn.zzf(parcel);
                onActivityStartedByScionActivityInfo(zzdfVar2, j29);
                break;
            case 52:
                zzdf zzdfVar3 = (zzdf) zzbn.zzb(parcel, zzdf.CREATOR);
                long j30 = parcel.readLong();
                zzbn.zzf(parcel);
                onActivityStoppedByScionActivityInfo(zzdfVar3, j30);
                break;
            ...
            case 57:
                ...
                zzbn.zzf(parcel);
                onActivitySaveInstanceStateByScionActivityInfo(zzdfVar8, zzcsVar2, j35);
                break;
            case 58:
