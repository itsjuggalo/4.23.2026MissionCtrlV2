...
class zzamw<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    public boolean equals(Object obj) {
        ...
        for (int i5 = 0; i5 < i4; i5++) {
            if (!zza(i5).equals(zzamwVar.zza(i5))) {
                return false;
            }
        }
        if (i4 != size) {
    ...
    */
    ...
    public final V zzb(int i4) {
        zzg();
        V v4 = (V) ((zzana) this.zza[i4]).getValue();
    ...
    public final V put(K k4, V v4) {
        ...
        int iZza = zza(k4);
        if (iZza >= 0) {
            return (V) ((zzana) this.zza[iZza]).setValue(v4);
        }
        zzg();
        if (this.zza == null) {
        ...
        this.zza[i4] = new zzana(this, k4, v4);
        this.zzb++;
        return null;
    }
