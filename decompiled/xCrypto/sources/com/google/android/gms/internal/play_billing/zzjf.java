...
class zzjf extends AbstractMap {
    ...
    private final int zzl(Comparable comparable) {
        ...
        int i6 = 0;
        if (i5 >= 0) {
            int iCompareTo = comparable.compareTo(((zzjb) this.zza[i5]).zza());
            if (iCompareTo > 0) {
                return -(i4 + 1);
            }
            if (iCompareTo == 0) {
    ...
    public final Object zzm(int i4) {
        zzo();
        Object value = ((zzjb) this.zza[i4]).getValue();
    ...
    public final boolean equals(Object obj) {
        ...
        for (int i5 = 0; i5 < i4; i5++) {
            if (!zzg(i5).equals(zzjfVar.zzg(i5))) {
                return false;
            }
        }
        if (i4 != size) {
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        this.zza[i4] = new zzjb(this, comparable, obj);
        this.zzb++;
        return null;
    }
