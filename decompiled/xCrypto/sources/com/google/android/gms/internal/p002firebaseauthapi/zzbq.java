...
public final class zzbq implements zzoa {
    ...
    public final zzbq zzb() throws GeneralSecurityException {
        ...
        for (zzbt zzbtVar2 : this.zzb) {
            if (zzbtVar2 == null || !(zzbtVar2.zzb() instanceof zzcd)) {
                zzxc.zza zzaVarZza = this.zza.zza(i4);
    ...
    private static zzbo zza(zzwt zzwtVar) throws GeneralSecurityException {
        int i4 = zzbp.zza[zzwtVar.ordinal()];
        if (i4 == 1) {
            return zzbo.zza;
        }
        if (i4 == 2) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static zzxc.zza zzb(zzbm zzbmVar, zzbo zzboVar, int i4) throws GeneralSecurityException {
        zzwt zzwtVar;
        ...
        return (zzxc.zza) ((zzaky) zzxc.zza.zzd().zza(zzws.zza().zza(zzqeVar.zzf()).zza(zzqeVar.zzd()).zza(zzqeVar.zza())).zza(zzwtVar).zza(i4).zza(zzqeVar.zzc()).zze());
    }

    @Override // com.google.android.gms.internal.p002firebaseauthapi.zzoa
    public final /* synthetic */ zzod zza(int i4) {
        if (i4 >= 0 && i4 < zza()) {
            if (this.zzb.get(i4) != null) {
                return this.zzb.get(i4);
            }
            throw new IllegalStateException("Keyset-Entry at position " + i4 + " has wrong status or key parsing failed");
        }
        throw new IndexOutOfBoundsException("Invalid index " + i4 + " for keyset of size " + zza());
    }
    ...
    public final <P> P zza(zzbf zzbfVar, Class<P> cls) throws GeneralSecurityException {
        if (zzbfVar instanceof zzno) {
            ...
            for (int i4 = 0; i4 < zza(); i4++) {
                if (this.zzb.get(i4) == null) {
                    throw new GeneralSecurityException("Key parsing of key with index " + i4 + " and type_url " + this.zza.zza(i4).zzb().zzf() + " failed, unable to get primitive");
                }
            }
