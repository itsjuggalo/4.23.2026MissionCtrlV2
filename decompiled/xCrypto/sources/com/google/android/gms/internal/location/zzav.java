...
public final class zzav {
    ...
    private final Map<C0909m.a, zzau> zzd = new HashMap();
    private final Map<C0909m.a, zzas> zze = new HashMap();
    private final Map<C0909m.a, zzar> zzf = new HashMap();
    ...
    public final void zzd(LocationRequest locationRequest, C0909m c0909m, zzai zzaiVar) {
        zzau zzauVar;
        zzau zzauVar2;
        ((zzh) this.zza).zza.checkConnected();
        C0909m.a aVarB = c0909m.b();
        if (aVarB == null) {
            zzauVar2 = null;
        } else {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public final void zze(zzba zzbaVar, C0909m c0909m, zzai zzaiVar) {
        zzar zzarVar;
        ((zzh) this.zza).zza.checkConnected();
        C0909m.a aVarB = c0909m.b();
        if (aVarB == null) {
    ...
    public final void zzh(C0909m.a aVar, zzai zzaiVar) {
        ((zzh) this.zza).zza.checkConnected();
        AbstractC0940s.l(aVar, "Invalid null listener key");
        synchronized (this.zzd) {
            try {
    ...
    public final void zzi(C0909m.a aVar, zzai zzaiVar) {
        ((zzh) this.zza).zza.checkConnected();
        AbstractC0940s.l(aVar, "Invalid null listener key");
        synchronized (this.zzf) {
            try {
