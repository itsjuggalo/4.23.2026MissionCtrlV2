...
final class zzhb {
    ...
    public static int zza(zzju zzjuVar, int i4, Object obj) {
        zzgr.zzz(i4 << 3);
        if (zzju.zzj == null) {
            byte[] bArr = zzhp.zzb;
    ...
    public static int zzb(zzha zzhaVar, Object obj) {
        ...
        if (!zzhaVar.zzd()) {
            ...
            for (int i4 = 0; i4 < size; i4++) {
                iZza2 += zza(zzjuVarZzb, iZza, list.get(i4));
            }
            return iZza2;
        }
        if (list.isEmpty()) {
    ...
    private static final int zzk(Map.Entry entry) {
        ...
        return i4 + iZzz + iZzz2 + iZzz3 + iZzk;
    }
    ...
    */
    ...
    public final void zzf() {
        ...
        int iZzc = this.zza.zzc();
        for (int i4 = 0; i4 < iZzc; i4++) {
            Object value = this.zza.zzg(i4).getValue();
