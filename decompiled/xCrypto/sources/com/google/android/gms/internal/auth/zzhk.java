...
final class zzhk {
    public static /* bridge */ /* synthetic */ void zza(byte b4, byte b5, byte b6, byte b7, char[] cArr, int i4) throws zzfb {
    ...
    */
    ...
    public static /* bridge */ /* synthetic */ void zzc(byte b4, byte b5, char[] cArr, int i4) throws zzfb {
        if (b4 < -62 || zze(b5)) {
            throw zzfb.zzb();
        }
