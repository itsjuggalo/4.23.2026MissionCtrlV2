...
public abstract class StaticSessionData {
    ...
    public static abstract class DeviceData {
        public static DeviceData create(int i4, String str, int i5, long j4, long j5, boolean z4, int i6, String str2, String str3) {
            return new AutoValue_StaticSessionData_DeviceData(i4, str, i5, j4, j5, z4, i6, str2, str3);
        }
    ...
    public static abstract class OsData {
        public static OsData create(String str, String str2, boolean z4) {
            return new AutoValue_StaticSessionData_OsData(str, str2, z4);
        }
