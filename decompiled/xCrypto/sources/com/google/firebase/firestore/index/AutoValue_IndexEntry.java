    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof IndexEntry) {
            ...
            if (this.indexId == indexEntry.getIndexId() && this.documentKey.equals(indexEntry.getDocumentKey())) {
                ...
                if (Arrays.equals(this.arrayValue, z4 ? ((AutoValue_IndexEntry) indexEntry).arrayValue : indexEntry.getArrayValue())) {
                    if (Arrays.equals(this.directionalValue, z4 ? ((AutoValue_IndexEntry) indexEntry).directionalValue : indexEntry.getDirectionalValue())) {
                        return true;
                    }
                }
            }
