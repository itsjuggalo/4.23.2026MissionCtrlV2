...
final class MemoryTargetCache implements TargetCache {
    ...
    public void addMatchingKeys(ImmutableSortedSet<DocumentKey> immutableSortedSet, int i4) {
        this.references.addReferences(immutableSortedSet, i4);
    ...
    public ImmutableSortedSet<DocumentKey> getMatchingKeysForTargetId(int i4) {
        return this.references.referencesForId(i4);
    }
    ...
    public void removeMatchingKeys(ImmutableSortedSet<DocumentKey> immutableSortedSet, int i4) {
        this.references.removeReferences(immutableSortedSet, i4);
        ReferenceDelegate referenceDelegate = this.persistence.getReferenceDelegate();
        Iterator<DocumentKey> it = immutableSortedSet.iterator();
        while (it.hasNext()) {
    ...
    public void removeMatchingKeysForTargetId(int i4) {
        this.references.removeReferencesForId(i4);
    }

    public int removeQueries(long j4, SparseArray<?> sparseArray) {
        Iterator<Map.Entry<Target, TargetData>> it = this.targets.entrySet().iterator();
        int i4 = 0;
        while (it.hasNext()) {
