...
public final class MutableDocument implements Document {
    ...
    @Override // com.google.firebase.firestore.model.Document
    public C1698D getField(FieldPath fieldPath) {
    ...
    public MutableDocument mutableCopy() {
        return new MutableDocument(this.key, this.documentType, this.version, this.readTime, this.value.m16clone(), this.documentState);
    }
