...
public class Query {
    ...
    public static /* synthetic */ ListenerRegistration a(Query query, EventManager.ListenOptions listenOptions, final AsyncEventListener asyncEventListener, Activity activity, final FirestoreClient firestoreClient) {
        final QueryListener queryListenerListen = firestoreClient.listen(query.query, listenOptions, asyncEventListener);
        return ActivityScope.bind(activity, new ListenerRegistration() { // from class: com.google.firebase.firestore.T
            @Override // com.google.firebase.firestore.ListenerRegistration
            public final void remove() {
                Query.f(asyncEventListener, firestoreClient, queryListenerListen);
            }
        });
    }
    ...
    private ListenerRegistration addSnapshotListenerInternal(Executor executor, final EventManager.ListenOptions listenOptions, final Activity activity, final EventListener<QuerySnapshot> eventListener) {
        ...
        final AsyncEventListener asyncEventListener = new AsyncEventListener(executor, new EventListener() { // from class: com.google.firebase.firestore.N
            ...
            public final void onEvent(Object obj, FirebaseFirestoreException firebaseFirestoreException) {
                Query.e(this.f10377a, eventListener, (ViewSnapshot) obj, firebaseFirestoreException);
            }
        });
        return (ListenerRegistration) this.firestore.callClient(new Function() { // from class: com.google.firebase.firestore.O
            @Override // com.google.firebase.firestore.util.Function
            public final Object apply(Object obj) {
                return Query.a(this.f10379a, listenOptions, asyncEventListener, activity, (FirestoreClient) obj);
            }
        });
    }

    private Bound boundFromDocumentSnapshot(String str, DocumentSnapshot documentSnapshot, boolean z4) {
        ...
        return new Bound(arrayList, z4);
    }

    private Bound boundFromFields(String str, Object[] objArr, boolean z4) {
    ...
    public static /* synthetic */ QuerySnapshot c(Query query, Task task) {
        return new QuerySnapshot(new Query(query.query, query.firestore), (ViewSnapshot) task.getResult(), query.firestore);
    }

    private List<FieldFilter.Operator> conflictingOps(FieldFilter.Operator operator) {
        int i4 = AnonymousClass2.$SwitchMap$com$google$firebase$firestore$core$FieldFilter$Operator[operator.ordinal()];
        return i4 != 1 ? (i4 == 2 || i4 == 3) ? Arrays.asList(FieldFilter.Operator.NOT_IN) : i4 != 4 ? new ArrayList() : Arrays.asList(FieldFilter.Operator.ARRAY_CONTAINS_ANY, FieldFilter.Operator.IN, FieldFilter.Operator.NOT_IN, FieldFilter.Operator.NOT_EQUAL) : Arrays.asList(FieldFilter.Operator.NOT_EQUAL, FieldFilter.Operator.NOT_IN);
    }

    public static /* synthetic */ void d(TaskCompletionSource taskCompletionSource, TaskCompletionSource taskCompletionSource2, Source source, QuerySnapshot querySnapshot, FirebaseFirestoreException firebaseFirestoreException) {
    ...
    public static /* synthetic */ void e(Query query, EventListener eventListener, ViewSnapshot viewSnapshot, FirebaseFirestoreException firebaseFirestoreException) {
        query.getClass();
        if (firebaseFirestoreException != null) {
    ...
    public static /* synthetic */ void f(AsyncEventListener asyncEventListener, FirestoreClient firestoreClient, QueryListener queryListener) {
    ...
    private Task<QuerySnapshot> getViaSnapshotListener(final Source source) {
        ...
        taskCompletionSource2.setResult(addSnapshotListenerInternal(Executors.DIRECT_EXECUTOR, listenOptions, null, new EventListener() { // from class: com.google.firebase.firestore.P
            @Override // com.google.firebase.firestore.EventListener
            public final void onEvent(Object obj, FirebaseFirestoreException firebaseFirestoreException) {
                Query.d(taskCompletionSource, taskCompletionSource2, source, (QuerySnapshot) obj, firebaseFirestoreException);
            }
        }));
    ...
    private C1698D parseDocumentIdValue(Object obj) {
        if (!(obj instanceof String)) {
    ...
    private FieldFilter parseFieldFilter(Filter.UnaryFilter unaryFilter) {
        ...
        if (!field.getInternalPath().isKeyField()) {
            ...
            if (operator == FieldFilter.Operator.IN || operator == FieldFilter.Operator.NOT_IN) {
                ...
                while (it.hasNext()) {
                    c0224bT.g(parseDocumentIdValue(it.next()));
                }
                queryValue = (C1698D) C1698D.I().g(c0224bT).build();
            } else {
    ...
    private com.google.firebase.firestore.core.Filter parseFilter(Filter filter) {
        ...
        Assert.hardAssert(z4 || (filter instanceof Filter.CompositeFilter), "Parsing is only supported for Filter.UnaryFilter and Filter.CompositeFilter.", new Object[0]);
        return z4 ? parseFieldFilter((Filter.UnaryFilter) filter) : parseCompositeFilter((Filter.CompositeFilter) filter);
    }
    ...
    public Task<QuerySnapshot> get(Source source) {
        validateHasExplicitOrderByForLimitToLast();
        return source == Source.CACHE ? ((Task) this.firestore.callClient(new Function() { // from class: com.google.firebase.firestore.Q
            @Override // com.google.firebase.firestore.util.Function
            public final Object apply(Object obj) {
                return ((FirestoreClient) obj).getDocumentsFromLocalCache(this.f10386a.query);
            }
        })).continueWith(Executors.DIRECT_EXECUTOR, new Continuation() { // from class: com.google.firebase.firestore.S
            @Override // com.google.android.gms.tasks.Continuation
            public final Object then(Task task) {
                return Query.c(this.f10387a, task);
            }
