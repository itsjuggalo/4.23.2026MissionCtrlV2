...
final class JsonValueObjectEncoderContext implements ObjectEncoderContext, ValueEncoderContext {
    ...
    public JsonValueObjectEncoderContext(Writer writer, Map<Class<?>, ObjectEncoder<?>> map, Map<Class<?>, ValueEncoder<?>> map2, ObjectEncoder<Object> objectEncoder, boolean z4) {
    ...
    public JsonValueObjectEncoderContext doEncode(ObjectEncoder<Object> objectEncoder, Object obj, boolean z4) throws IOException {
        if (!z4) {
    ...
    @Override // com.google.firebase.encoders.ObjectEncoderContext
    public JsonValueObjectEncoderContext add(String str, int i4) throws IOException {
        maybeUnNest();
        this.jsonWriter.name(str);
        return add(i4);
    }
    ...
    @Override // com.google.firebase.encoders.ObjectEncoderContext
    public JsonValueObjectEncoderContext add(String str, boolean z4) throws IOException {
        maybeUnNest();
        this.jsonWriter.name(str);
        return add(z4);
    }
    ...
    @Override // com.google.firebase.encoders.ObjectEncoderContext
    public ObjectEncoderContext add(FieldDescriptor fieldDescriptor, int i4) {
        return add(fieldDescriptor.getName(), i4);
    }

    @Override // com.google.firebase.encoders.ObjectEncoderContext
    public ObjectEncoderContext add(FieldDescriptor fieldDescriptor, long j4) {
        return add(fieldDescriptor.getName(), j4);
    }

    @Override // com.google.firebase.encoders.ObjectEncoderContext
    public ObjectEncoderContext add(FieldDescriptor fieldDescriptor, boolean z4) {
        return add(fieldDescriptor.getName(), z4);
    }
    ...
    @Override // com.google.firebase.encoders.ValueEncoderContext
    public JsonValueObjectEncoderContext add(boolean z4) throws IOException {
        maybeUnNest();
    ...
    public JsonValueObjectEncoderContext add(Object obj, boolean z4) {
        if (z4 && cannotBeInline(obj)) {
        ...
        if (objectEncoder != null) {
            return doEncode(objectEncoder, obj, z4);
        }
        ...
        return doEncode(this.fallbackEncoder, obj, z4);
    }
}
