...
public class MessagingAnalytics {
    ...
    public static boolean deliveryMetricsExportToBigQueryEnabled() {
        ...
        try {
            ...
            try {
                ...
                if (packageManager != null && (applicationInfo = packageManager.getApplicationInfo(applicationContext.getPackageName(), UserMetadata.MAX_ROLLOUT_ASSIGNMENTS)) != null && (bundle = applicationInfo.metaData) != null && bundle.containsKey(MANIFEST_DELIVERY_METRICS_EXPORT_TO_BIG_QUERY_ENABLED)) {
    ...
    private static void logToFirelog(MessagingClientEvent.Event event, Intent intent, X0.j jVar) {
        if (jVar == null) {
        ...
        try {
            jVar.a(Constants.FirelogAnalytics.FCM_LOG_SOURCE, MessagingClientEventExtension.class, X0.c.b("proto"), new X0.h() { // from class: com.google.firebase.messaging.B
                @Override // X0.h
                public final Object apply(Object obj) {
                    return ((MessagingClientEventExtension) obj).toByteArray();
                }
            }).a(X0.d.g(MessagingClientEventExtension.newBuilder().setMessagingClientEvent(messagingClientEventEventToProto).build(), X0.g.b(Integer.valueOf(intent.getIntExtra(Constants.MessagePayloadKeys.PRODUCT_ID, DEFAULT_PRODUCT_ID)))));
    ...
    public static void setDeliveryMetricsExportToBigQuery(boolean z4) {
        FirebaseApp.getInstance().getApplicationContext().getSharedPreferences("com.google.firebase.messaging", 0).edit().putBoolean(DELIVERY_METRICS_EXPORT_TO_BIG_QUERY_PREF, z4).apply();
    }
