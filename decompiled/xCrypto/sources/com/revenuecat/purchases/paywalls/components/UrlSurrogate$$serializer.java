...
public final class UrlSurrogate$$serializer implements C {
    ...
    static {
        ...
        C0327b0 c0327b0 = new C0327b0("com.revenuecat.purchases.paywalls.components.UrlSurrogate", urlSurrogate$$serializer, 2);
        c0327b0.l("url_lid", false);
    ...
    public UrlSurrogate deserialize(e decoder) {
        ...
        return new UrlSurrogate(i4, localizationKey != null ? localizationKey.m199unboximpl() : null, (ButtonComponent.UrlMethod) objM2, null, null);
    }
    ...
    public void serialize(f encoder, UrlSurrogate value) {
        ...
        UrlSurrogate.write$Self(value, dVarD, descriptor2);
        dVarD.c(descriptor2);
    }
