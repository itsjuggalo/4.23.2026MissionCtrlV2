...
public final class IconComponent$Formats$$serializer implements C {
    ...
    static {
        ...
        C0327b0 c0327b0 = new C0327b0("com.revenuecat.purchases.paywalls.components.IconComponent.Formats", iconComponent$Formats$$serializer, 1);
    ...
    public IconComponent.Formats deserialize(e decoder) {
        ...
        cVarD.c(descriptor2);
        return new IconComponent.Formats(i4, strV, null);
    }
    ...
    public void serialize(f encoder, IconComponent.Formats value) {
        ...
        dVarD.o(descriptor2, 0, value.webp);
        dVarD.c(descriptor2);
    }
