...
public final class Offering {
    ...
    public static /* synthetic */ Offering copy$default(Offering offering, String str, String str2, Map map, List list, PaywallData paywallData, PaywallComponents paywallComponents, int i4, Object obj) {
        if ((i4 & 1) != 0) {
    ...
    public final Offering copy(PresentedOfferingContext presentedOfferingContext) {
        ...
        return new Offering(str, str2, map, arrayList, this.paywall, this.paywallComponents);
    }
    ...
    public /* synthetic */ Offering(String str, String str2, Map map, List list, PaywallData paywallData, PaywallComponents paywallComponents, int i4, AbstractC1585j abstractC1585j) {
        this(str, str2, map, list, (i4 & 16) != 0 ? null : paywallData, (i4 & 32) != 0 ? null : paywallComponents);
    }
}
