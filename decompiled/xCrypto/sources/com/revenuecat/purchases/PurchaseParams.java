...
public final class PurchaseParams {
    ...
    public static /* synthetic */ PurchaseParams copy$default(PurchaseParams purchaseParams, Builder builder, int i4, Object obj) {
        if ((i4 & 1) != 0) {
    ...
    public static class Builder {
        ...
        public final Builder isPersonalizedPrice(boolean z4) {
            this.isPersonalizedPrice = Boolean.valueOf(z4);
            return this;
        }
