...
public final class UiConfig$AppConfig$$serializer implements C {
    ...
    static {
        ...
        C0327b0 c0327b0 = new C0327b0("com.revenuecat.purchases.UiConfig.AppConfig", uiConfig$AppConfig$$serializer, 2);
        c0327b0.l("colors", true);
        c0327b0.l("fonts", true);
        descriptor = c0327b0;
    }
    ...
    public F3.b[] childSerializers() {
        F3.b[] bVarArr = UiConfig.AppConfig.$childSerializers;
        return new F3.b[]{bVarArr[0], bVarArr[1]};
    }

    @Override // F3.a
    public UiConfig.AppConfig deserialize(I3.e decoder) {
        Object objM;
        Object objM2;
        int i4;
        r.f(decoder, "decoder");
        ...
        cVarD.c(descriptor2);
        return new UiConfig.AppConfig(i4, (Map) objM2, (Map) objM, (k0) null);
    }
    ...
    @Override // F3.h
    public void serialize(I3.f encoder, UiConfig.AppConfig value) {
        r.f(encoder, "encoder");
        r.f(value, "value");
        H3.e descriptor2 = getDescriptor();
        I3.d dVarD = encoder.d(descriptor2);
        UiConfig.AppConfig.write$Self(value, dVarD, descriptor2);
        dVarD.c(descriptor2);
    }
