...
public final class MapConverter {
    ...
    public final JSONObject convertToJSON$purchases_defaultsRelease(Map<String, ? extends Object> inputMap) throws JSONException {
        ...
        LinkedHashMap linkedHashMap = new LinkedHashMap(K.b(inputMap.size()));
        ...
        while (it.hasNext()) {
            ...
            if (value instanceof List) {
                ...
                if ((iterable instanceof Collection) && ((Collection) iterable).isEmpty()) {
                    value = new JSONObject(K.c(t.a("temp_key", new JSONArray((Collection) value)))).getJSONArray("temp_key");
                } else {
