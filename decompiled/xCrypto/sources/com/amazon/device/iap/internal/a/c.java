...
public class c extends com.amazon.a.a.j.a {
    ...
    private static final String f9109c = "c";

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private RequestId f9110d;

    public c(RequestId requestId) {
        this.f9110d = requestId;
    }
    ...
    public void a(final Object obj, final h hVar) {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        if (obj2 instanceof ProductDataResponse) {
                            ...
                            com.amazon.device.iap.internal.util.b.b(c.f9109c, "Unknown response type:" + obj.getClass().getName());
                        }
                        c.this.a().a(com.amazon.a.a.o.b.ao, Boolean.TRUE);
                    } catch (Throwable th) {
                        com.amazon.device.iap.internal.util.b.b(c.f9109c, "Error in sendResponse: " + th);
                    }
                    h hVar2 = hVar;
                    if (hVar2 != null) {
                        hVar2.a(true);
        ...
        com.amazon.device.iap.internal.util.b.a(f9109c, "PurchasingListener is not set. Dropping response: " + obj);
    }
