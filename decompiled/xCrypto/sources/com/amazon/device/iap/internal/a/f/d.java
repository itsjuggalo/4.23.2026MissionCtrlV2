...
public final class d extends com.amazon.device.iap.internal.a.c {
    ...
    public void b() {
        ...
        boolean z4 = receipt != null;
        h cVar = new com.amazon.device.iap.internal.a.g.c(this, z4);
        if (z4 && (ProductType.ENTITLED == receipt.getProductType() || ProductType.SUBSCRIPTION == receipt.getProductType())) {
