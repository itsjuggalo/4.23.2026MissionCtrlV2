...
public class b implements com.amazon.device.simplesignin.a.b {
    ...
    private static final String f9352b = "com.amazon.sdktestclient";

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static final String f9353c = "com.amazon.sdktestclient.command.CommandBroker";
    ...
    private RecordMetricsEventResponse b(Intent intent) {
        ...
        try {
            ...
            recordMetricsEventResponse.setRequestId(new RequestId(jSONObject.getString(com.amazon.a.a.o.b.f8728B)));
            ...
            Log.e(f9351a, "Exception while parsing RecordMetricsEvent response", e4);
            return recordMetricsEventResponse;
        }
    }
    ...
    private LinkUserAccountResponse c(Intent intent) {
        ...
        try {
            ...
            Log.i(f9351a, "SimpleSignInService : linkUserAccountOutput " + stringExtra);
            JSONObject jSONObject = new JSONObject(stringExtra);
            linkUserAccountResponse.setRequestId(new RequestId(jSONObject.getString(com.amazon.a.a.o.b.f8728B)));
            RequestStatus requestStatusValueOf = RequestStatus.valueOf(jSONObject.getString("status"));
            linkUserAccountResponse.setRequestStatus(requestStatusValueOf);
            if (RequestStatus.SUCCESSFUL.equals(requestStatusValueOf)) {
                String string = jSONObject.getString(com.amazon.device.simplesignin.a.a.a.f9280m);
                if (!LinkUserAccountResponse.SuccessCode.ConsentDenied.equals(LinkUserAccountResponse.SuccessCode.valueOf(string))) {
                    linkUserAccountResponse.setLinkId(jSONObject.getString(com.amazon.device.simplesignin.a.a.a.f9278k));
                }
                linkUserAccountResponse.setSuccessCode(LinkUserAccountResponse.SuccessCode.valueOf(string));
                return linkUserAccountResponse;
            }
        } catch (JSONException e4) {
            Log.e(f9351a, "Exception while parsing LinkUserAccount response", e4);
        }
        return linkUserAccountResponse;
    }
    ...
    private ShowLoginSelectionResponse d(Intent intent) {
        ...
        try {
            ...
            Log.i(f9351a, "SimpleSignInService : loginSelectionOutput " + stringExtra);
            JSONObject jSONObject = new JSONObject(stringExtra);
            showLoginSelectionResponse.setRequestId(new RequestId(jSONObject.getString(com.amazon.a.a.o.b.f8728B)));
            RequestStatus requestStatusValueOf = RequestStatus.valueOf(jSONObject.getString("status"));
            showLoginSelectionResponse.setRequestStatus(requestStatusValueOf);
            if (RequestStatus.SUCCESSFUL.equals(requestStatusValueOf)) {
                String string = jSONObject.getString(com.amazon.device.simplesignin.a.a.a.f9284q);
                ...
                String string2 = jSONObject.getString(com.amazon.device.simplesignin.a.a.a.f9285r);
                if (string2 != null) {
    ...
    public void a(RequestId requestId, String str) {
        Log.i(f9351a, "Handling getUserAndLinks sandbox request.");
        ...
        try {
            ...
            jSONObject.put(com.amazon.a.a.o.b.f8735I, SimpleSignInService.SDK_VERSION);
            jSONObject.put(com.amazon.device.simplesignin.a.a.a.f9268a, str);
            ...
            Log.e(f9351a, "Error in preparing getUserAndLinksInput.");
        }
    }

    @Override // com.amazon.device.simplesignin.a.b
    public void a(RequestId requestId, LinkUserAccountRequest linkUserAccountRequest) {
        Log.i(f9351a, "Handling linkUserAccount sandbox request.");
        Context contextC = c.a().c();
        try {
            JSONObject jSONObject = new JSONObject();
            jSONObject.put(com.amazon.a.a.o.b.f8728B, requestId);
            jSONObject.put("packageName", contextC.getPackageName());
            jSONObject.put(com.amazon.a.a.o.b.f8735I, SimpleSignInService.SDK_VERSION);
            jSONObject.put(com.amazon.device.simplesignin.a.a.a.f9271d, linkUserAccountRequest.getPartnerUserId());
            jSONObject.put(com.amazon.device.simplesignin.a.a.a.f9268a, linkUserAccountRequest.getIdentityProviderName());
            jSONObject.put(com.amazon.device.simplesignin.a.a.a.f9272e, linkUserAccountRequest.getUserLoginName());
            JSONObject jSONObject2 = new JSONObject();
            jSONObject2.put("token", linkUserAccountRequest.getLinkToken().getToken());
            jSONObject2.put(com.amazon.device.simplesignin.a.a.a.f9260E, linkUserAccountRequest.getLinkToken().getSchema());
            jSONObject.put(com.amazon.device.simplesignin.a.a.a.f9274g, jSONObject2.toString());
            jSONObject.put(com.amazon.device.simplesignin.a.a.a.f9273f, linkUserAccountRequest.getLinkSigningKey());
            Bundle bundle = new Bundle();
            ...
            Log.e(f9351a, "Unable to create linkToken json");
    ...
    public void a(RequestId requestId, Map<String, String> map) {
        Log.i(f9351a, "Handling showLoginSelection sandbox request.");
        Context contextC = c.a().c();
        try {
            JSONObject jSONObject = new JSONObject();
            jSONObject.put(com.amazon.a.a.o.b.f8728B, requestId);
            ...
            intentA.putExtra(com.amazon.device.simplesignin.a.a.a.f9282o, new HashMap(map));
            intentA.addFlags(268435456);
            contextC.startService(intentA);
        } catch (JSONException e4) {
            Log.e(f9351a, "Unable to create showLoginSelection Input");
            throw new IllegalStateException("Unable to create showLoginSelection input json", e4);
        }
    }
    ...
    public void a(RequestId requestId, SSIEventRequest sSIEventRequest) {
        ...
        try {
            JSONObject jSONObject = new JSONObject();
            jSONObject.put(com.amazon.device.simplesignin.a.a.a.f9287t, sSIEventRequest.getEvent().toString());
            jSONObject.put(com.amazon.device.simplesignin.a.a.a.f9288u, sSIEventRequest.getEpochTimestamp());
            if (sSIEventRequest.getFailureReason() != null) {
                jSONObject.put(com.amazon.device.simplesignin.a.a.a.f9289v, sSIEventRequest.getFailureReason().toString());
            }
            Intent intentA = a("com.amazon.testclient.simplesignin.recordmetricsevent");
            intentA.addFlags(268435456);
            contextC.startService(intentA);
        } catch (JSONException e4) {
            Log.e(f9351a, "Error in preparing recordMetricEventInput for requestId: " + requestId, e4);
        }
    }

    @Override // com.amazon.device.simplesignin.a.b
    public void a(Context context, Intent intent) {
        intent.setComponent(new ComponentName(f9352b, f9353c));
        try {
            ...
            if ("com.amazon.testclient.simplesignin.showLoginSelection".equals(string)) {
                ...
                Log.d(f9351a, "Unknown response type received.");
            }
        } catch (Exception e4) {
            Log.e(f9351a, "Error handling response.", e4);
        }
    }
    ...
    private GetUserAndLinksResponse a(Intent intent) {
        ...
        try {
            ...
            getUserAndLinksResponse.setRequestId(new RequestId(jSONObject.getString(com.amazon.a.a.o.b.f8728B)));
            RequestStatus requestStatusValueOf = RequestStatus.valueOf(jSONObject.getString("status"));
            getUserAndLinksResponse.setRequestStatus(requestStatusValueOf);
            if (RequestStatus.SUCCESSFUL.equals(requestStatusValueOf)) {
                String string = jSONObject.getString(com.amazon.device.simplesignin.a.a.a.f9269b);
                getUserAndLinksResponse.setAmazonUserId(string);
                getUserAndLinksResponse.setLinks(com.amazon.device.simplesignin.a.d.b.a(string, jSONObject.getString(com.amazon.device.simplesignin.a.a.a.f9270c)));
                return getUserAndLinksResponse;
            }
        } catch (JSONException e4) {
            Log.e(f9351a, "Exception while parsing GetUserAndLinks response", e4);
        }
        return getUserAndLinksResponse;
    }
            ...
            new Handler(contextC.getMainLooper()).post(new Runnable() { // from class: com.amazon.device.simplesignin.a.c.b.1
                ...
                public void run() {
                    try {
                        ...
                        Log.e(b.f9351a, "Unknown response type:" + obj.getClass().getName());
                    } catch (Exception e4) {
                        Log.e(b.f9351a, "Error in sendResponse: " + e4);
                    }
                }
            });
            return;
        }
        Log.i(f9351a, "ISimpleSignInResponseHandler is not set. Dropping response: " + obj);
    }
}
