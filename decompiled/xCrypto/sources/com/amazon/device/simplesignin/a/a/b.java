...
public class b implements com.amazon.device.simplesignin.a.b {
    ...
    public void a(Context context, Intent intent) {
        String stringExtra = intent.getStringExtra(a.f9281n);
        if (stringExtra == null) {
            com.amazon.device.simplesignin.a.d.a.b(f9297a, "Invalid response type: null");
            return;
        }
        com.amazon.device.simplesignin.a.d.a.a(f9297a, "Found response type: " + stringExtra);
        if (a.f9290w.equals(stringExtra)) {
            new com.amazon.device.simplesignin.a.a.b.a.b(new RequestId(intent.getStringExtra(com.amazon.a.a.o.b.f8728B))).d();
        }
        if (a.f9291x.equals(stringExtra)) {
            new com.amazon.device.simplesignin.a.a.d.a.a(new RequestId(intent.getStringExtra(com.amazon.a.a.o.b.f8728B))).d();
        }
    }
}
