...
public class b extends c {
    ...
    private static final String f9311b = "SSI_PublishMetric";

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static final String f9312c = "1.0";

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private static final String f9313d = "b";

    public b(a aVar, SSIEventRequest sSIEventRequest) {
        super(aVar, f9311b, "1.0");
        super.a(com.amazon.device.simplesignin.a.a.a.f9287t, sSIEventRequest.getEvent().toString());
        super.a(com.amazon.device.simplesignin.a.a.a.f9288u, sSIEventRequest.getEpochTimestamp());
        if (sSIEventRequest.getFailureReason() != null) {
            super.a(com.amazon.device.simplesignin.a.a.a.f9289v, sSIEventRequest.getFailureReason().toString());
        } else {
            super.a(com.amazon.device.simplesignin.a.a.a.f9289v, "NA");
        }
    }
    ...
    private void b(RequestStatus requestStatus) {
        d dVar = (d) j();
        Log.i(f9313d, "Response for request id: " + dVar.e() + " is: " + requestStatus.toString());
