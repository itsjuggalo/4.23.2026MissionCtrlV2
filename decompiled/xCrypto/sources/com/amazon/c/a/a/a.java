...
public class a {
    ...
    private static final String f8927a = "com.amazon.content.id.";
        ...
        while (enumerationEntries.hasMoreElements()) {
            ...
            try {
                try {
                    ...
                    do {
                    } while (inputStream.read(bArr, 0, UserMetadata.MAX_INTERNAL_KEY_SIZE) != -1);
                    inputStream.close();
                } catch (Exception e4) {
                    throw new b(e4);
                }
    ...
    public static String a(String str) {
        if (str != null && str.length() != 0) {
            int iIndexOf = str.indexOf(f8927a);
