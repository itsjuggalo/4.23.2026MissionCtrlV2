...
public abstract class o {
    ...
    public static class a {
        ...
        public static final s f3799a = new s(o.d().getWebkitToCompatConverter());
    }

    public static class b {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public static final p f3800a = o.a();
    }

    public static p a() {
        try {
            return new q((WebViewProviderFactoryBoundaryInterface) A6.a.a(WebViewProviderFactoryBoundaryInterface.class, b()));
