...
public class b extends c {
    ...
    private static final String f10479b = "SSI_GetUserAndLinks";

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static final String f10480c = "1.0";

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private static final String f10481d = "b";

    public b(a aVar, String str) {
        super(aVar, f10479b, "1.0");
        super.a(com.amazon.device.simplesignin.a.a.a.f10453a, str);
    }
    ...
    public boolean b(j jVar) {
        Map mapB = jVar.b();
        if (!mapB.containsKey(com.amazon.device.simplesignin.a.a.a.f10454b) || !mapB.containsKey(com.amazon.device.simplesignin.a.a.a.f10455c)) {
            a(RequestStatus.FAILURE);
            return false;
        }
        String str = (String) mapB.get(com.amazon.device.simplesignin.a.a.a.f10454b);
        String str2 = (String) mapB.get(com.amazon.device.simplesignin.a.a.a.f10455c);
