...
public class c implements com.amazon.device.drm.a.c {
    ...
    private static final String f10269a = "c";

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final String f10270b = "com.amazon.sdktestclient";

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static final String f10271c = "com.amazon.sdktestclient.command.CommandBroker";

    @Override // com.amazon.device.drm.a.c
    public void a(RequestId requestId) {
        com.amazon.device.drm.a.e.b.a(f10269a, "sendGetLicenseRequest");
        try {
            ...
            jSONObject.put(com.amazon.a.a.o.b.f9920I, LicensingService.SDK_VERSION);
            ...
            com.amazon.device.drm.a.e.b.b(f10269a, "Error in sendGetUserDataRequest.");
        }
    }

    private Intent a(String str) {
        Intent intent = new Intent(str);
        intent.setComponent(new ComponentName(f10270b, f10271c));
        return intent;
    }

    @Override // com.amazon.device.drm.a.c
    public void a(Context context, Intent intent) {
        com.amazon.device.drm.a.e.b.a(f10269a, "handleResponse");
        intent.setComponent(new ComponentName(f10270b, f10271c));
        try {
            ...
            Log.e(f10269a, "Error handling response.", e7);
        }
    }
    ...
    private LicenseResponse a(Intent intent) {
        ...
        try {
            ...
            Log.e(f10269a, "Error parsing getLicense response", e7);
                ...
                public void run() {
                    try {
                        ...
                        if (obj2 instanceof LicenseResponse) {
                            ...
                            com.amazon.device.drm.a.e.b.b(c.f10269a, "Unknown response type:" + obj.getClass().getName());
                        }
                    } catch (Exception e7) {
                        com.amazon.device.drm.a.e.b.b(c.f10269a, "Error in sendResponse: " + e7);
                    }
                }
            });
            return;
        }
        com.amazon.device.drm.a.e.b.a(f10269a, "LicensingListener is not set. Dropping response: " + obj);
    }
}
