...
public final class CustomerCenterConfigData {
    ...
    public static final class Appearance {
        ...
        public static final class ColorInformation {
            ...
            public ColorInformation() {
                this((PaywallColor) null, (PaywallColor) null, (PaywallColor) null, (PaywallColor) null, (PaywallColor) null, 31, (AbstractC2148j) null);
            }
            ...
            public static final /* synthetic */ void write$Self(ColorInformation colorInformation, d dVar, e eVar) {
                if (dVar.C(eVar, 0) || colorInformation.accentColor != null) {
                    dVar.r(eVar, 0, PaywallColor.Serializer.INSTANCE, colorInformation.accentColor);
                }
                if (dVar.C(eVar, 1) || colorInformation.textColor != null) {
                    dVar.r(eVar, 1, PaywallColor.Serializer.INSTANCE, colorInformation.textColor);
                }
                if (dVar.C(eVar, 2) || colorInformation.backgroundColor != null) {
                    dVar.r(eVar, 2, PaywallColor.Serializer.INSTANCE, colorInformation.backgroundColor);
                }
                if (dVar.C(eVar, 3) || colorInformation.buttonTextColor != null) {
                    dVar.r(eVar, 3, PaywallColor.Serializer.INSTANCE, colorInformation.buttonTextColor);
                }
                if (!dVar.C(eVar, 4) && colorInformation.buttonBackgroundColor == null) {
                    return;
                }
                dVar.r(eVar, 4, PaywallColor.Serializer.INSTANCE, colorInformation.buttonBackgroundColor);
            }
            ...
            public /* synthetic */ ColorInformation(PaywallColor paywallColor, PaywallColor paywallColor2, PaywallColor paywallColor3, PaywallColor paywallColor4, PaywallColor paywallColor5, int i7, AbstractC2148j abstractC2148j) {
        ...
        public Appearance() {
            this((ColorInformation) null, (ColorInformation) (0 == true ? 1 : 0), 3, (AbstractC2148j) (0 == true ? 1 : 0));
        }
        ...
        public static final /* synthetic */ void write$Self(Appearance appearance, d dVar, e eVar) {
            if (dVar.C(eVar, 0) || appearance.light != null) {
                dVar.r(eVar, 0, CustomerCenterConfigData$Appearance$ColorInformation$$serializer.INSTANCE, appearance.light);
            }
            if (!dVar.C(eVar, 1) && appearance.dark == null) {
                return;
            }
            dVar.r(eVar, 1, CustomerCenterConfigData$Appearance$ColorInformation$$serializer.INSTANCE, appearance.dark);
        }
        ...
        public /* synthetic */ Appearance(ColorInformation colorInformation, ColorInformation colorInformation2, int i7, AbstractC2148j abstractC2148j) {
    ...
    public static final class HelpPath {
            ...
            public static final class Companion {
                ...
                public static final class AnonymousClass1 extends s implements Function0 {
                    ...
                    public final b invoke() {
                        return AbstractC2637y.b("com.revenuecat.purchases.customercenter.CustomerCenterConfigData.HelpPath.OpenMethod", OpenMethod.values());
                    }
                }
        ...
        public static abstract class PathDetail {
            ...
            public static final class Companion {
                ...
                public static final class AnonymousClass1 extends s implements Function0 {
                    ...
                    @Override // kotlin.jvm.functions.Function0
                    public final b invoke() {
                        return new n6.e("com.revenuecat.purchases.customercenter.CustomerCenterConfigData.HelpPath.PathDetail", H.b(PathDetail.class), new c[]{H.b(FeedbackSurvey.class), H.b(PromotionalOffer.class)}, new b[]{CustomerCenterConfigData$HelpPath$PathDetail$FeedbackSurvey$$serializer.INSTANCE, CustomerCenterConfigData$HelpPath$PathDetail$PromotionalOffer$$serializer.INSTANCE}, new Annotation[0]);
                    }
                }
            ...
            public static final class FeedbackSurvey extends PathDetail {
                ...
                private final String title;
                public static final Companion Companion = new Companion(null);
                private static final b[] $childSerializers = {null, new C2618e(CustomerCenterConfigData$HelpPath$PathDetail$FeedbackSurvey$Option$$serializer.INSTANCE)};
                ...
                public static final class Option {
                    ...
                    public /* synthetic */ Option(int i7, String str, String str2, PromotionalOffer promotionalOffer, k0 k0Var) {
                        if (3 != (i7 & 3)) {
                            AbstractC2611a0.a(i7, 3, CustomerCenterConfigData$HelpPath$PathDetail$FeedbackSurvey$Option$$serializer.INSTANCE.getDescriptor());
                        }
                        this.id = str;
                        this.title = str2;
                        if ((i7 & 4) == 0) {
                    ...
                    public static final /* synthetic */ void write$Self(Option option, d dVar, e eVar) {
                        dVar.m(eVar, 0, option.id);
                        dVar.m(eVar, 1, option.title);
                        if (!dVar.C(eVar, 2) && option.promotionalOffer == null) {
                            return;
                        }
                        dVar.r(eVar, 2, CustomerCenterConfigData$HelpPath$PathDetail$PromotionalOffer$$serializer.INSTANCE, option.promotionalOffer);
                    }
                    ...
                    public /* synthetic */ Option(String str, String str2, PromotionalOffer promotionalOffer, int i7, AbstractC2148j abstractC2148j) {
                ...
                public /* synthetic */ FeedbackSurvey(int i7, String str, List list, k0 k0Var) {
                    super(i7, k0Var);
                    if (3 != (i7 & 3)) {
                        AbstractC2611a0.a(i7, 3, CustomerCenterConfigData$HelpPath$PathDetail$FeedbackSurvey$$serializer.INSTANCE.getDescriptor());
                    }
                    this.title = str;
                    this.options = list;
                }
                ...
                public static final /* synthetic */ void write$Self(FeedbackSurvey feedbackSurvey, d dVar, e eVar) {
                    ...
                    dVar.m(eVar, 0, feedbackSurvey.title);
                    dVar.x(eVar, 1, bVarArr[1], feedbackSurvey.options);
                }
            ...
            public static final class PromotionalOffer extends PathDetail {
                ...
                public static final class CrossProductPromotion {
                    ...
                    public /* synthetic */ CrossProductPromotion(int i7, String str, String str2, k0 k0Var) {
                        if (3 != (i7 & 3)) {
                            AbstractC2611a0.a(i7, 3, CustomerCenterConfigData$HelpPath$PathDetail$PromotionalOffer$CrossProductPromotion$$serializer.INSTANCE.getDescriptor());
                        }
                    ...
                    public static final /* synthetic */ void write$Self(CrossProductPromotion crossProductPromotion, d dVar, e eVar) {
                        dVar.m(eVar, 0, crossProductPromotion.storeOfferIdentifier);
                        dVar.m(eVar, 1, crossProductPromotion.targetProductId);
                    }
                ...
                public /* synthetic */ PromotionalOffer(int i7, String str, boolean z7, String str2, String str3, Map map, Map map2, k0 k0Var) {
                    super(i7, k0Var);
                    if (31 != (i7 & 31)) {
                        AbstractC2611a0.a(i7, 31, CustomerCenterConfigData$HelpPath$PathDetail$PromotionalOffer$$serializer.INSTANCE.getDescriptor());
                    }
                    ...
                    if ((i7 & 32) == 0) {
                        this.crossProductPromotions = J.e();
                    } else {
                ...
                public static final /* synthetic */ void write$Self(PromotionalOffer promotionalOffer, d dVar, e eVar) {
                    ...
                    b[] bVarArr = $childSerializers;
                    dVar.m(eVar, 0, promotionalOffer.androidOfferId);
                    dVar.w(eVar, 1, promotionalOffer.eligible);
                    dVar.m(eVar, 2, promotionalOffer.title);
                    dVar.m(eVar, 3, promotionalOffer.subtitle);
                    dVar.x(eVar, 4, bVarArr[4], promotionalOffer.productMapping);
                    if (!dVar.C(eVar, 5) && r.b(promotionalOffer.crossProductPromotions, J.e())) {
                        return;
                    }
                    dVar.x(eVar, 5, bVarArr[5], promotionalOffer.crossProductPromotions);
                }
                ...
                public final PromotionalOffer copy(String androidOfferId, boolean z7, String title, String subtitle, Map<String, String> productMapping) {
                    ...
                    r.f(subtitle, "subtitle");
                    r.f(productMapping, "productMapping");
                    return copy(androidOfferId, z7, title, subtitle, productMapping, J.e());
                }

                public /* synthetic */ PromotionalOffer(String str, boolean z7, String str2, String str3, Map map, Map map2, int i7, AbstractC2148j abstractC2148j) {
                    this(str, z7, str2, str3, map, (i7 & 32) != 0 ? J.e() : map2);
                }
                ...
                public PromotionalOffer(String androidOfferId, boolean z7, String title, String subtitle, Map<String, String> productMapping) {
                    this(androidOfferId, z7, title, subtitle, productMapping, J.e());
                    r.f(androidOfferId, "androidOfferId");
                    r.f(title, "title");
                    r.f(subtitle, "subtitle");
                    r.f(productMapping, "productMapping");
            ...
            public /* synthetic */ PathDetail(AbstractC2148j abstractC2148j) {
                this();
            }
        ...
        public enum PathType {
            ...
            public static final class Companion {
                ...
                public static final class AnonymousClass1 extends s implements Function0 {
                    ...
                    @Override // kotlin.jvm.functions.Function0
                    public final b invoke() {
                        return AbstractC2637y.b("com.revenuecat.purchases.customercenter.CustomerCenterConfigData.HelpPath.PathType", PathType.values());
                    }
                }
        ...
        public /* synthetic */ HelpPath(int i7, String str, String str2, PathType pathType, PathDetail.PromotionalOffer promotionalOffer, PathDetail.FeedbackSurvey feedbackSurvey, String str3, OpenMethod openMethod, k0 k0Var) {
            if (7 != (i7 & 7)) {
                AbstractC2611a0.a(i7, 7, CustomerCenterConfigData$HelpPath$$serializer.INSTANCE.getDescriptor());
            }
            this.id = str;
            this.title = str2;
            this.type = pathType;
        ...
        public static /* synthetic */ HelpPath copy$default(HelpPath helpPath, String str, String str2, PathType pathType, PathDetail.PromotionalOffer promotionalOffer, PathDetail.FeedbackSurvey feedbackSurvey, String str3, OpenMethod openMethod, int i7, Object obj) {
            if ((i7 & 1) != 0) {
                str = helpPath.id;
            }
            if ((i7 & 2) != 0) {
            ...
            return helpPath.copy(str, str4, pathType2, promotionalOffer2, feedbackSurvey2, str5, openMethod);
        }
        ...
        public static final /* synthetic */ void write$Self(HelpPath helpPath, d dVar, e eVar) {
            b[] bVarArr = $childSerializers;
            dVar.m(eVar, 0, helpPath.id);
            dVar.m(eVar, 1, helpPath.title);
            dVar.x(eVar, 2, bVarArr[2], helpPath.type);
            if (dVar.C(eVar, 3) || helpPath.promotionalOffer != null) {
                dVar.r(eVar, 3, CustomerCenterConfigData$HelpPath$PathDetail$PromotionalOffer$$serializer.INSTANCE, helpPath.promotionalOffer);
            }
            if (dVar.C(eVar, 4) || helpPath.feedbackSurvey != null) {
                dVar.r(eVar, 4, CustomerCenterConfigData$HelpPath$PathDetail$FeedbackSurvey$$serializer.INSTANCE, helpPath.feedbackSurvey);
            }
            if (dVar.C(eVar, 5) || helpPath.url != null) {
                dVar.r(eVar, 5, o0.f22909a, helpPath.url);
            }
            if (!dVar.C(eVar, 6) && helpPath.openMethod == null) {
                return;
            }
            dVar.r(eVar, 6, bVarArr[6], helpPath.openMethod);
        }
        ...
        public boolean equals(Object obj) {
            ...
            return r.b(this.id, helpPath.id) && r.b(this.title, helpPath.title) && this.type == helpPath.type && r.b(this.promotionalOffer, helpPath.promotionalOffer) && r.b(this.feedbackSurvey, helpPath.feedbackSurvey) && r.b(this.url, helpPath.url) && this.openMethod == helpPath.openMethod;
        }
        ...
        public int hashCode() {
            ...
            return iHashCode4 + (openMethod != null ? openMethod.hashCode() : 0);
        }
        ...
        public /* synthetic */ HelpPath(String str, String str2, PathType pathType, PathDetail.PromotionalOffer promotionalOffer, PathDetail.FeedbackSurvey feedbackSurvey, String str3, OpenMethod openMethod, int i7, AbstractC2148j abstractC2148j) {
            this(str, str2, pathType, (i7 & 8) != 0 ? null : promotionalOffer, (i7 & 16) != 0 ? null : feedbackSurvey, (i7 & 32) != 0 ? null : str3, (i7 & 64) != 0 ? null : openMethod);
        }
    }
    ...
    public static final class Localization {
        ...
        public enum CommonLocalizedString {
            ...
            public /* synthetic */ class WhenMappings {
                ...
                static {
                    ...
                    try {
                        iArr[CommonLocalizedString.APP_STORE.ordinal()] = 58;
                    } catch (NoSuchFieldError unused58) {
                    }
                    try {
                        iArr[CommonLocalizedString.MAC_APP_STORE.ordinal()] = 59;
                    } catch (NoSuchFieldError unused59) {
                    }
                    try {
                        iArr[CommonLocalizedString.GOOGLE_PLAY_STORE.ordinal()] = 60;
                    } catch (NoSuchFieldError unused60) {
                    }
                    try {
                        iArr[CommonLocalizedString.AMAZON_STORE.ordinal()] = 61;
                    } catch (NoSuchFieldError unused61) {
                    }
                    try {
                        iArr[CommonLocalizedString.WEB_STORE.ordinal()] = 62;
                    } catch (NoSuchFieldError unused62) {
                    }
                    try {
                        iArr[CommonLocalizedString.UNKNOWN_STORE.ordinal()] = 63;
                    } catch (NoSuchFieldError unused63) {
                    }
                    try {
                        iArr[CommonLocalizedString.CARD_STORE_PROMOTIONAL.ordinal()] = 64;
        ...
        public enum VariableName {
            PRICE(com.amazon.a.a.o.b.f9961x),
        ...
        public /* synthetic */ Localization(int i7, String str, Map map, k0 k0Var) {
            if (3 != (i7 & 3)) {
                AbstractC2611a0.a(i7, 3, CustomerCenterConfigData$Localization$$serializer.INSTANCE.getDescriptor());
            }
            this.locale = str;
        ...
        public static final /* synthetic */ void write$Self(Localization localization, d dVar, e eVar) {
            b[] bVarArr = $childSerializers;
            dVar.m(eVar, 0, localization.locale);
            dVar.x(eVar, 1, bVarArr[1], localization.localizedStrings);
        }
    ...
    public static final class Screen {
        ...
        public enum ScreenType {
            ...
            public static final class Companion {
                ...
                public static final class AnonymousClass1 extends s implements Function0 {
                    ...
                    @Override // kotlin.jvm.functions.Function0
                    public final b invoke() {
                        return AbstractC2637y.b("com.revenuecat.purchases.customercenter.CustomerCenterConfigData.Screen.ScreenType", ScreenType.values());
                    }
                }
        ...
        public /* synthetic */ Screen(int i7, ScreenType screenType, String str, String str2, List list, k0 k0Var) {
            if (11 != (i7 & 11)) {
                AbstractC2611a0.a(i7, 11, CustomerCenterConfigData$Screen$$serializer.INSTANCE.getDescriptor());
            }
        ...
        /* JADX WARN: Multi-variable type inference failed */
        public static /* synthetic */ Screen copy$default(Screen screen, ScreenType screenType, String str, String str2, List list, int i7, Object obj) {
            if ((i7 & 1) != 0) {
        ...
        public static final /* synthetic */ void write$Self(Screen screen, d dVar, e eVar) {
            dVar.x(eVar, 0, $childSerializers[0], screen.type);
            dVar.m(eVar, 1, screen.title);
            if (dVar.C(eVar, 2) || screen.subtitle != null) {
                dVar.r(eVar, 2, EmptyStringToNullSerializer.INSTANCE, screen.subtitle);
            }
            dVar.x(eVar, 3, HelpPathsSerializer.INSTANCE, screen.paths);
        }
        ...
        public /* synthetic */ Screen(ScreenType screenType, String str, String str2, List list, int i7, AbstractC2148j abstractC2148j) {
            this(screenType, str, (i7 & 4) != 0 ? null : str2, list);
        }
    }
    ...
    public static final class Support {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        public Support() {
            this((String) null, (Boolean) (0 == true ? 1 : 0), 3, (AbstractC2148j) (0 == true ? 1 : 0));
        }

        public static /* synthetic */ Support copy$default(Support support, String str, Boolean bool, int i7, Object obj) {
            if ((i7 & 1) != 0) {
                str = support.email;
            }
            if ((i7 & 2) != 0) {
        ...
        public static final /* synthetic */ void write$Self(Support support, d dVar, e eVar) {
            if (dVar.C(eVar, 0) || support.email != null) {
                dVar.r(eVar, 0, EmptyStringToNullSerializer.INSTANCE, support.email);
            }
            if (!dVar.C(eVar, 1) && support.shouldWarnCustomerToUpdate == null) {
                return;
            }
            dVar.r(eVar, 1, C2621h.f22886a, support.shouldWarnCustomerToUpdate);
        }
        ...
        public /* synthetic */ Support(int i7, String str, Boolean bool, k0 k0Var) {
            if ((i7 & 1) == 0) {
                this.email = null;
            } else {
                this.email = str;
        ...
        public /* synthetic */ Support(String str, Boolean bool, int i7, AbstractC2148j abstractC2148j) {
    ...
    public /* synthetic */ CustomerCenterConfigData(int i7, Map map, Appearance appearance, Localization localization, Support support, String str, k0 k0Var) {
        if (15 != (i7 & 15)) {
            AbstractC2611a0.a(i7, 15, CustomerCenterConfigData$$serializer.INSTANCE.getDescriptor());
        }
        this.screens = map;
    ...
    public static final /* synthetic */ void write$Self(CustomerCenterConfigData customerCenterConfigData, d dVar, e eVar) {
        dVar.x(eVar, 0, ScreenMapSerializer.INSTANCE, customerCenterConfigData.screens);
        dVar.x(eVar, 1, CustomerCenterConfigData$Appearance$$serializer.INSTANCE, customerCenterConfigData.appearance);
        dVar.x(eVar, 2, CustomerCenterConfigData$Localization$$serializer.INSTANCE, customerCenterConfigData.localization);
        dVar.x(eVar, 3, CustomerCenterConfigData$Support$$serializer.INSTANCE, customerCenterConfigData.support);
        if (!dVar.C(eVar, 4) && customerCenterConfigData.lastPublishedAppVersion == null) {
            return;
        }
        dVar.r(eVar, 4, EmptyStringToNullSerializer.INSTANCE, customerCenterConfigData.lastPublishedAppVersion);
    }
    ...
    public /* synthetic */ CustomerCenterConfigData(Map map, Appearance appearance, Localization localization, Support support, String str, int i7, AbstractC2148j abstractC2148j) {
