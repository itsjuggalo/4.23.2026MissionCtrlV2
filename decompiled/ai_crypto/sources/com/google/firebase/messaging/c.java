...
public class c {
    ...
    public c(Bundle bundle) {
        ...
        this.f12218a = new Bundle(bundle);
    }
    ...
    public String p(String str) {
        return this.f12218a.getString(w(str));
    }
    ...
    public final String w(String str) {
        if (!this.f12218a.containsKey(str) && str.startsWith("gcm.n.")) {
            String strV = v(str);
            if (this.f12218a.containsKey(strV)) {
                return strV;
            }
        }
        return str;
    ...
    public Bundle x() {
        Bundle bundle = new Bundle(this.f12218a);
        for (String str : this.f12218a.keySet()) {
            if (!s(str)) {
                bundle.remove(str);
            }
        }
