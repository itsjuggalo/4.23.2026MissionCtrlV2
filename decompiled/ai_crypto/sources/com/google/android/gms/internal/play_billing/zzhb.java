...
final class zzhb {
    ...
    public static int zza(zzju zzjuVar, int i7, Object obj) {
        zzgr.zzz(i7 << 3);
        if (zzju.zzj == null) {
            byte[] bArr = zzhp.zzb;
    ...
    public static int zzb(zzha zzhaVar, Object obj) {
        ...
        if (!zzhaVar.zzd()) {
            ...
            for (int i7 = 0; i7 < size; i7++) {
                iZza2 += zza(zzjuVarZzb, iZza, list.get(i7));
            }
            return iZza2;
        }
        if (list.isEmpty()) {
    ...
    private static final int zzk(Map.Entry entry) {
        ...
        return i7 + iZzz + iZzz2 + iZzz3 + iZzk;
    }
