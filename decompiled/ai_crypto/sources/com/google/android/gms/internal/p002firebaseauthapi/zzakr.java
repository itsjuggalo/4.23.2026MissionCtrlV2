...
final class zzakr<T extends zzakt<T>> {
    ...
    private final void zzb(Map.Entry<T, Object> entry) {
        ...
        boolean z7 = value instanceof zzalg;
        if (key.zze()) {
            if (z7) {
    ...
    public static int zza(zzakt<?> zzaktVar, Object obj) {
        ...
        if (zzaktVar.zze()) {
            ...
            if (!zzaktVar.zzd()) {
                int iZza2 = 0;
                while (i7 < size) {
                    iZza2 += zza(zzanwVarZzb, iZza, list.get(i7));
                    i7++;
                }
                return iZza2;
            }
            ...
            int iZza3 = 0;
            while (i7 < size) {
                iZza3 += zza(zzanwVarZzb, list.get(i7));
                i7++;
            }
