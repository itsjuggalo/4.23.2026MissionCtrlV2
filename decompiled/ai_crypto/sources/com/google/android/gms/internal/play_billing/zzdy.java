...
public abstract class zzdy<V> extends zzfi implements zzeu<V> {
    ...
    public static Object zzr(zzeu zzeuVar) {
        ...
        try {
            ...
            return !zIsCancelled ? new zzc(new IllegalArgumentException("get() threw CancellationException, despite reporting isCancelled() == false: ".concat(String.valueOf(zzeuVar)), e8)) : new zzb(false, e8);
        } catch (ExecutionException e9) {
            return zIsCancelled ? new zzb(false, new IllegalArgumentException("get() did not throw CancellationException, despite reporting isCancelled() == true: ".concat(String.valueOf(zzeuVar)), e9)) : new zzc(e9.getCause());
        } catch (Exception e10) {
            e = e10;
            return new zzc(e);
        }
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static void zzw(zzdy zzdyVar, boolean z7) {
        zzd zzdVar;
        zzd zzdVar2 = null;
        while (true) {
    ...
    private static void zzx(Runnable runnable, Executor executor) {
        try {
            ...
            zzb.zza().logp(Level.SEVERE, "com.google.common.util.concurrent.AbstractFuture", "executeListener", "RuntimeException while executing runnable " + String.valueOf(runnable) + " with executor " + String.valueOf(executor), (Throwable) e7);
        }
    }
