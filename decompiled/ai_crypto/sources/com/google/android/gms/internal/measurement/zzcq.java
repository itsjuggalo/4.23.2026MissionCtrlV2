...
public abstract class zzcq extends zzbm implements zzcr {
    ...
    public final boolean zza(int i7, Parcel parcel, Parcel parcel2, int i8) {
        ...
        switch (i7) {
            case 1:
                Z1.a aVarB = a.AbstractBinderC0104a.b(parcel.readStrongBinder());
                zzdd zzddVar = (zzdd) zzbn.zzb(parcel, zzdd.CREATOR);
                long j7 = parcel.readLong();
                zzbn.zzf(parcel);
                initialize(aVarB, zzddVar, j7);
                break;
            case 2:
                ...
                zzbn.zzf(parcel);
                logEvent(string, string2, bundle, zZza, zZza2, j8);
                break;
            case 3:
                ...
                zzbn.zzf(parcel);
                logEventAndBundle(string3, string4, bundle2, zzcsVar, j9);
                break;
            case 4:
                String string5 = parcel.readString();
                String string6 = parcel.readString();
                Z1.a aVarB2 = a.AbstractBinderC0104a.b(parcel.readStrongBinder());
                boolean zZza3 = zzbn.zza(parcel);
                long j10 = parcel.readLong();
                zzbn.zzf(parcel);
                setUserProperty(string5, string6, aVarB2, zZza3, j10);
                break;
            case 5:
            ...
            case 11:
                ...
                zzbn.zzf(parcel);
                setMeasurementEnabled(zZza5, j13);
                break;
            case 12:
            ...
            case 14:
                ...
                break;
            case 15:
                Z1.a aVarB3 = a.AbstractBinderC0104a.b(parcel.readStrongBinder());
                String string15 = parcel.readString();
                String string16 = parcel.readString();
                long j17 = parcel.readLong();
                zzbn.zzf(parcel);
                setCurrentScreen(aVarB3, string15, string16, j17);
                break;
            case c.f10119g /* 16 */:
            ...
            case 24:
                ...
                break;
            case 25:
                Z1.a aVarB4 = a.AbstractBinderC0104a.b(parcel.readStrongBinder());
                long j20 = parcel.readLong();
                zzbn.zzf(parcel);
                onActivityStarted(aVarB4, j20);
                break;
            case 26:
                Z1.a aVarB5 = a.AbstractBinderC0104a.b(parcel.readStrongBinder());
                long j21 = parcel.readLong();
                zzbn.zzf(parcel);
                onActivityStopped(aVarB5, j21);
                break;
            case 27:
                Z1.a aVarB6 = a.AbstractBinderC0104a.b(parcel.readStrongBinder());
                Bundle bundle5 = (Bundle) zzbn.zzb(parcel, Bundle.CREATOR);
                long j22 = parcel.readLong();
                zzbn.zzf(parcel);
                onActivityCreated(aVarB6, bundle5, j22);
                break;
            case 28:
                Z1.a aVarB7 = a.AbstractBinderC0104a.b(parcel.readStrongBinder());
                long j23 = parcel.readLong();
                zzbn.zzf(parcel);
                onActivityDestroyed(aVarB7, j23);
                break;
            case 29:
                Z1.a aVarB8 = a.AbstractBinderC0104a.b(parcel.readStrongBinder());
                long j24 = parcel.readLong();
                zzbn.zzf(parcel);
                onActivityPaused(aVarB8, j24);
                break;
            case 30:
                Z1.a aVarB9 = a.AbstractBinderC0104a.b(parcel.readStrongBinder());
                long j25 = parcel.readLong();
                zzbn.zzf(parcel);
                onActivityResumed(aVarB9, j25);
                break;
            case 31:
                Z1.a aVarB10 = a.AbstractBinderC0104a.b(parcel.readStrongBinder());
                ...
                zzbn.zzf(parcel);
                onActivitySaveInstanceState(aVarB10, zzcsVar8, j26);
                break;
            case c.f10120h /* 32 */:
                ...
                zzbn.zzf(parcel);
                performAction(bundle6, zzcsVar7, j27);
                break;
            case 33:
                int i9 = parcel.readInt();
                String string19 = parcel.readString();
                Z1.a aVarB11 = a.AbstractBinderC0104a.b(parcel.readStrongBinder());
                Z1.a aVarB12 = a.AbstractBinderC0104a.b(parcel.readStrongBinder());
                Z1.a aVarB13 = a.AbstractBinderC0104a.b(parcel.readStrongBinder());
                zzbn.zzf(parcel);
                logHealthData(i9, string19, aVarB11, aVarB12, aVarB13);
                break;
            case 34:
            ...
            case 50:
                ...
                zzbn.zzf(parcel);
                setCurrentScreenByScionActivityInfo(zzdfVar, string20, string21, j31);
                break;
            case 51:
                zzdf zzdfVar2 = (zzdf) zzbn.zzb(parcel, zzdf.CREATOR);
                long j32 = parcel.readLong();
                zzbn.zzf(parcel);
                onActivityStartedByScionActivityInfo(zzdfVar2, j32);
                break;
            case 52:
                zzdf zzdfVar3 = (zzdf) zzbn.zzb(parcel, zzdf.CREATOR);
                long j33 = parcel.readLong();
                zzbn.zzf(parcel);
                onActivityStoppedByScionActivityInfo(zzdfVar3, j33);
                break;
            case 53:
            ...
            case 57:
                ...
                zzbn.zzf(parcel);
                onActivitySaveInstanceStateByScionActivityInfo(zzdfVar8, zzcsVar3, j38);
                break;
            case 58:
