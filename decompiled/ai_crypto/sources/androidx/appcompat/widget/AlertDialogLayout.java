...
public class AlertDialogLayout extends b {
    ...
    public final boolean B(int i7, int i8) {
        ...
        for (int i9 = 0; i9 < childCount; i9++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == AbstractC1660e.f14420B) {
                    view = childAt;
                } else if (id == AbstractC1660e.f14427g) {
                    view2 = childAt;
                } else {
                    if ((id != AbstractC1660e.f14429i && id != AbstractC1660e.f14430j) || view3 != null) {
                        return false;
                    }
                    view3 = childAt;
                }
        ...
        if (view2 != null) {
            int i11 = paddingTop - iA;
            int iMin = Math.min(i10, measuredHeight);
            if (iMin > 0) {
                i10 -= iMin;
                iA += iMin;
            }
            view2.measure(i7, View.MeasureSpec.makeMeasureSpec(iA, 1073741824));
    ...
    */
    public void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L7e:
            int r3 = Q.N.z(r17)
            int r2 = Q.AbstractC0677s.b(r2, r3)
            r2 = r2 & 7
            r3 = 1
            if (r2 == r3) goto L98
            r3 = 5
    ...
    public final void z(View view, int i7, int i8, int i9, int i10) {
