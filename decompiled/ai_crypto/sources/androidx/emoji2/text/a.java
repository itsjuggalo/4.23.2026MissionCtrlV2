...
public abstract class a {
    ...
    public static class C0125a {
        ...
        public final c.AbstractC0127c a(Context context, N.e eVar) {
            if (eVar == null) {
                return null;
            }
        ...
        public c.AbstractC0127c c(Context context) {
            return a(context, h(context));
        }

        public final N.e d(ProviderInfo providerInfo, PackageManager packageManager) {
            String str = providerInfo.authority;
            String str2 = providerInfo.packageName;
            return new N.e(str, str2, "emojicompat-emoji-font", b(this.f7644a.b(packageManager, str2)));
        }
        ...
        public final ProviderInfo g(PackageManager packageManager) {
            Iterator it = this.f7644a.c(packageManager, new Intent("androidx.content.action.LOAD_EMOJI_FONT"), 0).iterator();
            while (it.hasNext()) {
                ProviderInfo providerInfoA = this.f7644a.a((ResolveInfo) it.next());
                if (f(providerInfoA)) {
        ...
        public N.e h(Context context) {
            PackageManager packageManager = context.getPackageManager();
            P.f.h(packageManager, "Package manager required to locate emoji font provider");
    ...
    public static e a(Context context) {
        return (e) new C0125a(null).c(context);
    }
}
