...
public class c {
    ...
    public static final Pattern f8932d = Pattern.compile("[0-9]+s");

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public static final Charset f8933e = Charset.forName("UTF-8");

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final Context f8934a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public final S3.b f8935b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public final e f8936c = new e();
    ...
    public static JSONObject b(String str, String str2) {
        try {
            ...
            jSONObject.put(com.amazon.a.a.o.b.f14031I, "a:19.0.0");
            return jSONObject;
    ...
    public static long m(String str) {
        AbstractC1294n.b(f8932d.matcher(str).matches(), "Invalid Expiration Timestamp.");
    ...
    public static String o(HttpURLConnection httpURLConnection) {
        ...
        BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(errorStream, f8933e));
        try {
            try {
    ...
    public final String f() {
        try {
            ...
            Log.e("ContentValues", "Could not get fingerprint hash for package: " + this.f8934a.getPackageName());
            return null;
        } catch (PackageManager.NameNotFoundException e8) {
            Log.e("ContentValues", "No such package: " + this.f8934a.getPackageName(), e8);
            return null;
        }
    }
    ...
    public final HttpURLConnection l(URL url, String str) throws i {
        try {
            ...
            httpURLConnection.addRequestProperty("X-Android-Package", this.f8934a.getPackageName());
            B3.i iVar = (B3.i) this.f8935b.get();
            if (iVar != null) {
                try {
                    httpURLConnection.addRequestProperty("x-firebase-client", (String) AbstractC2331o.a(iVar.a()));
    ...
    public final d n(HttpURLConnection httpURLConnection) throws IOException {
        ...
        JsonReader jsonReader = new JsonReader(new InputStreamReader(inputStream, f8933e));
        f.a aVarA = f.a();
        d.a aVarA2 = d.a();
