...
public abstract class AbstractC0934p {
    ...
    public static class a {
        ...
        public static MenuItem g(MenuItem menuItem, char c8, int i8) {
        ...
        public static MenuItem k(MenuItem menuItem, char c8, int i8) {
            return menuItem.setNumericShortcut(c8, i8);
        }

        public static MenuItem l(MenuItem menuItem, char c8, char c9, int i8, int i9) {
    ...
    public static void a(MenuItem menuItem, char c8, int i8) {
        if (menuItem instanceof N.b) {
            ((N.b) menuItem).setAlphabeticShortcut(c8, i8);
    ...
    public static void e(MenuItem menuItem, char c8, int i8) {
        if (menuItem instanceof N.b) {
            ((N.b) menuItem).setNumericShortcut(c8, i8);
        } else if (Build.VERSION.SDK_INT >= 26) {
            a.k(menuItem, c8, i8);
        }
    }
