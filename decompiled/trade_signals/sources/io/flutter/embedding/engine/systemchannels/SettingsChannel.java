...
public class SettingsChannel {
    ...
    public static class ConfigurationQueue {
        ...
        public static class SentConfiguration {
            ...
            public SentConfiguration(DisplayMetrics displayMetrics) {
                int i8 = nextConfigGeneration;
                nextConfigGeneration = i8 + 1;
                this.generationNumber = i8;
        ...
        public SentConfiguration getConfiguration(int i8) {
            ...
            while (true) {
                ...
                if (sentConfiguration == null || sentConfiguration.generationNumber >= i8) {
                    break;
                }
                this.currentConfiguration = this.sentQueue.poll();
            }
            if (sentConfiguration == null) {
                ...
                if (sentConfiguration.generationNumber == i8) {
                ...
                strValueOf = String.valueOf(this.currentConfiguration.generationNumber);
            }
            sb.append(strValueOf);
            Log.e(SettingsChannel.TAG, sb.toString());
            return null;
        }
    }
    ...
    public static class MessageBuilder {
        ...
        public MessageBuilder setBrieflyShowPassword(boolean z7) {
            this.message.put(SettingsChannel.BRIEFLY_SHOW_PASSWORD, Boolean.valueOf(z7));
            return this;
        }
        ...
        public MessageBuilder setNativeSpellCheckServiceDefined(boolean z7) {
            this.message.put(SettingsChannel.NATIVE_SPELL_CHECK_SERVICE_DEFINED, Boolean.valueOf(z7));
            return this;
        }
        ...
        public MessageBuilder setTextScaleFactor(float f8) {
            this.message.put(SettingsChannel.TEXT_SCALE_FACTOR, Float.valueOf(f8));
            return this;
        }

        public MessageBuilder setUse24HourFormat(boolean z7) {
            this.message.put(SettingsChannel.ALWAYS_USE_24_HOUR_FORMAT, Boolean.valueOf(z7));
            return this;
        }
    }
    ...
    public static DisplayMetrics getPastDisplayMetrics(int i8) {
        ConfigurationQueue.SentConfiguration configuration = CONFIGURATION_QUEUE.getConfiguration(i8);
