...
public class PlatformChannel {
    ...
    public static class AppSwitcherDescription {
        ...
        public AppSwitcherDescription(int i8, String str) {
            this.color = i8;
            this.label = str;
        }
    }
    ...
    public AppSwitcherDescription decodeAppSwitcherDescription(JSONObject jSONObject) throws JSONException {
        ...
        return new AppSwitcherDescription(i8, jSONObject.getString("label"));
    }
    ...
    */
    ...
    public SystemUiMode decodeSystemUiMode(String str) {
        int i8 = AnonymousClass2.$SwitchMap$io$flutter$embedding$engine$systemchannels$PlatformChannel$SystemUiMode[SystemUiMode.fromValue(str).ordinal()];
        return i8 != 1 ? i8 != 2 ? i8 != 3 ? i8 != 4 ? SystemUiMode.EDGE_TO_EDGE : SystemUiMode.EDGE_TO_EDGE : SystemUiMode.IMMERSIVE_STICKY : SystemUiMode.IMMERSIVE : SystemUiMode.LEAN_BACK;
    }
    ...
    public List<SystemUiOverlay> decodeSystemUiOverlays(JSONArray jSONArray) throws NoSuchFieldException {
        ...
        for (int i8 = 0; i8 < jSONArray.length(); i8++) {
            int i9 = AnonymousClass2.$SwitchMap$io$flutter$embedding$engine$systemchannels$PlatformChannel$SystemUiOverlay[SystemUiOverlay.fromValue(jSONArray.getString(i8)).ordinal()];
            if (i9 == 1) {
    ...
    public void systemChromeChanged(boolean z7) {
        ...
        this.channel.invokeMethod("SystemChrome.systemUIChange", Arrays.asList(Boolean.valueOf(z7)));
    }
}
