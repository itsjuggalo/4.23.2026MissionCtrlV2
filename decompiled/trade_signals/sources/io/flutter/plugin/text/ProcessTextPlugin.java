...
public class ProcessTextPlugin implements FlutterPlugin, ActivityAware, PluginRegistry.ActivityResultListener, ProcessTextChannel.ProcessTextMethodHandler {
    ...
    private void cacheResolveInfos() {
        ...
        for (ResolveInfo resolveInfo : i8 >= 33 ? this.packageManager.queryIntentActivities(type, PackageManager.ResolveInfoFlags.of(0L)) : this.packageManager.queryIntentActivities(type, 0)) {
    ...
    public boolean onActivityResult(int i8, int i9, Intent intent) {
        if (!this.requestsByCode.containsKey(Integer.valueOf(i8))) {
            return false;
        }
        this.requestsByCode.remove(Integer.valueOf(i8)).success(i9 == -1 ? intent.getStringExtra("android.intent.extra.PROCESS_TEXT") : null);
        return true;
    }
    ...
    public void processTextAction(String str, String str2, boolean z7, MethodChannel.Result result) {
