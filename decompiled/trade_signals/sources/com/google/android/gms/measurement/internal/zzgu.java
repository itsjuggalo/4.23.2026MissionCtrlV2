...
public final class zzgu extends zzjf {
    ...
    public static String zzo(boolean z7, String str, Object obj, Object obj2, Object obj3) {
        String strZzp = zzp(z7, obj);
        String strZzp2 = zzp(z7, obj2);
        String strZzp3 = zzp(z7, obj3);
    ...
    public static String zzp(boolean z7, Object obj) {
        String className;
        if (obj == null) {
            return "";
        }
        ...
        if (!(obj instanceof Throwable)) {
            return obj instanceof zzgt ? ((zzgt) obj).zza() : z7 ? "-" : obj.toString();
        }
    ...
    public final void zzm(int i8, boolean z7, boolean z8, String str, Object obj, Object obj2, Object obj3) {
        if (!z7 && Log.isLoggable(zzn(), i8)) {
            Log.println(i8, zzn(), zzo(false, str, obj, obj2, obj3));
        }
        if (z8 || i8 < 5) {
            return;
        }
        ...
        if (zzhzVarZzi == null) {
            ...
            zzhzVarZzi.zzj(new zzgr(this, i8, str, obj, obj2, obj3));
        }
    }
    ...
    public final /* synthetic */ void zzs(char c8) {
        this.zza = c8;
    }
