...
public final class zzjl {
    ...
    public zzjl(Boolean bool, Boolean bool2, int i8) {
    ...
    public static zzjl zza(zzji zzjiVar, zzji zzjiVar2, int i8) {
        EnumMap enumMap = new EnumMap(zzjk.class);
    ...
    public static zzjl zze(Bundle bundle, int i8) {
        if (bundle == null) {
            return new zzjl(null, null, i8);
        }
        EnumMap enumMap = new EnumMap(zzjk.class);
        for (zzjk zzjkVar : zzjj.STORAGE.zzb()) {
            enumMap.put(zzjkVar, zzg(bundle.getString(zzjkVar.zze)));
        }
        return new zzjl(enumMap, i8);
    }

    public static zzjl zzf(String str, int i8) {
        EnumMap enumMap = new EnumMap(zzjk.class);
        zzjk[] zzjkVarArrZza = zzjj.STORAGE.zza();
        for (int i9 = 0; i9 < zzjkVarArrZza.length; i9++) {
            String str2 = str == null ? "" : str;
            int i10 = i9 + 2;
            enumMap.put(zzjkVarArrZza[i9], i10 < str2.length() ? zzj(str2.charAt(i10)) : zzji.UNINITIALIZED);
        }
        return new zzjl(enumMap, i8);
    }
    ...
    public static zzji zzj(char c8) {
        return c8 != '+' ? c8 != '0' ? c8 != '1' ? zzji.UNINITIALIZED : zzji.GRANTED : zzji.DENIED : zzji.POLICY;
    }
    ...
    public static boolean zzu(int i8, int i9) {
        int i10 = -30;
        if (i8 == -20) {
            if (i9 == -30) {
                return true;
    ...
    */
    ...
    private zzjl(EnumMap enumMap, int i8) {
