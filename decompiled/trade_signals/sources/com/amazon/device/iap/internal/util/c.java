...
public class c {
    ...
    private static final String f14541a = "c";
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f14542a[d.LEGACY.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f14542a[d.V2.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f14542a[d.V3.ordinal()] = 4;
    ...
    private static Receipt a(JSONObject jSONObject) throws JSONException {
        ...
        ProductType productTypeValueOf = ProductType.valueOf(jSONObject.getString(com.amazon.a.a.o.b.f14059k).toUpperCase());
        String strOptString2 = jSONObject.optString(com.amazon.a.a.o.b.f14038P);
        Date dateB = a(strOptString2) ? null : b(strOptString2);
        String strOptString3 = jSONObject.optString(com.amazon.a.a.o.b.f14052d);
    ...
    private static d b(JSONObject jSONObject) {
        String strOptString = jSONObject.optString(com.amazon.a.a.o.b.f14048Z);
        String strOptString2 = jSONObject.optString(com.amazon.a.a.o.b.f14027E);
        String strOptString3 = jSONObject.optString(com.amazon.a.a.o.b.f14036N);
        ...
        return !f.a(strOptString2) ? d.V2 : f.a(strOptString) ? d.LEGACY : d.V1;
    }
    ...
    private static Receipt c(JSONObject jSONObject, String str, String str2) {
        ...
        if (f.a(strOptString2)) {
            b.b(f14541a, "a signature was not found in the receipt for request ID " + str2);
    ...
    private static Receipt d(JSONObject jSONObject, String str, String str2) {
        ...
        try {
            String string = jSONObject.getString(com.amazon.a.a.o.b.f14027E);
    ...
    private static Receipt e(JSONObject jSONObject, String str, String str2) {
        ...
        try {
            String string = jSONObject.getString(com.amazon.a.a.o.b.f14027E);
            String string2 = jSONObject.getString("sku");
            String strOptString3 = jSONObject.optString(com.amazon.a.a.o.b.f14034L, null);
            String strOptString4 = jSONObject.optString(com.amazon.a.a.o.b.f14035M, null);
            ProductType productTypeValueOf = ProductType.valueOf(jSONObject.getString(com.amazon.a.a.o.b.f14059k).toUpperCase());
            String strOptString5 = jSONObject.optString(com.amazon.a.a.o.b.f14039Q);
            Date dateB2 = a(strOptString5) ? null : b(strOptString5);
            String strOptString6 = jSONObject.optString(com.amazon.a.a.o.b.f14053e);
            Date dateB3 = a(strOptString6) ? null : b(strOptString6);
            String strOptString7 = jSONObject.optString(com.amazon.a.a.o.b.f14040R);
            if (!a(strOptString7)) {
    ...
    public static Receipt a(JSONObject jSONObject, String str, String str2) {
        int i8 = AnonymousClass1.f14542a[b(jSONObject).ordinal()];
    ...
    private static Receipt b(JSONObject jSONObject, String str, String str2) {
        ...
        try {
            ...
            b.a(f14541a, "stringToVerify/legacy:\n" + str3 + "\nsignature:\n" + strOptString);
            if (zA) {
                return receiptA;
            }
    ...
    public static List<Receipt> a(String str, String str2, String str3) {
        ...
        for (int i8 = 0; i8 < jSONArray.length(); i8++) {
            try {
                ...
                b.b(f14541a, "fail to parse receipt, requestId:" + e8.a());
                throw e8;
            } catch (com.amazon.device.iap.internal.a.f e9) {
                b.b(f14541a, "fail to verify receipt, requestId:" + e9.a());
                throw e9;
            } catch (Throwable th) {
                b.b(f14541a, "fail to verify receipt, requestId:" + th.getMessage());
                throw th;
            }
        }
        return arrayList;
    ...
    public static JSONObject a(Receipt receipt, String str) {
        ...
        if (receipt != null && !f.a(str)) {
            try {
                jSONObject.put(com.amazon.a.a.o.b.f14027E, receipt.getReceiptId());
                jSONObject.put("sku", receipt.getSku());
                jSONObject.put(com.amazon.a.a.o.b.f14059k, receipt.getProductType());
                jSONObject.put(com.amazon.a.a.o.b.f14039Q, receipt.getPurchaseDate());
                jSONObject.put(com.amazon.a.a.o.b.f14052d, receipt.getCancelDate());
                jSONObject.put("signature", str);
            } catch (JSONException unused) {
                b.b(f14541a, "Failure during toJsonInternal: " + receipt + ", signature:" + str);
            }
        }
        return jSONObject;
    }
