...
public class c implements com.amazon.device.drm.a.c {
    ...
    private static final String f14380a = "c";

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final String f14381b = "com.amazon.sdktestclient";

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static final String f14382c = "com.amazon.sdktestclient.command.CommandBroker";

    private Intent a(String str) {
        Intent intent = new Intent(str);
        intent.setComponent(new ComponentName(f14381b, f14382c));
        return intent;
    }
    ...
    private LicenseResponse a(Intent intent) {
        ...
        try {
            ...
            Log.e(f14380a, "Error parsing getLicense response", e8);
    ...
    public void a(Context context, Intent intent) {
        com.amazon.device.drm.a.e.b.a(f14380a, "handleResponse");
        intent.setComponent(new ComponentName(f14381b, f14382c));
        try {
            ...
            Log.e(f14380a, "Error handling response.", e8);
        }
    }

    @Override // com.amazon.device.drm.a.c
    public void a(RequestId requestId) {
        com.amazon.device.drm.a.e.b.a(f14380a, "sendGetLicenseRequest");
        try {
            ...
            jSONObject.put(com.amazon.a.a.o.b.f14031I, LicensingService.SDK_VERSION);
            ...
            com.amazon.device.drm.a.e.b.b(f14380a, "Error in sendGetUserDataRequest.");
        }
    }
                ...
                public void run() {
                    try {
                        ...
                        if (obj2 instanceof LicenseResponse) {
                            ...
                            com.amazon.device.drm.a.e.b.b(c.f14380a, "Unknown response type:" + obj.getClass().getName());
                        }
                    } catch (Exception e8) {
                        com.amazon.device.drm.a.e.b.b(c.f14380a, "Error in sendResponse: " + e8);
                    }
                }
            });
            return;
        }
        com.amazon.device.drm.a.e.b.a(f14380a, "LicensingListener is not set. Dropping response: " + obj);
    }
}
