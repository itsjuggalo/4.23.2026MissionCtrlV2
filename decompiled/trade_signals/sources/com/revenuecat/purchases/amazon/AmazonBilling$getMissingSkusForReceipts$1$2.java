...
public final class AmazonBilling$getMissingSkusForReceipts$1$2 extends AbstractC2306v implements k {
    ...
    public AmazonBilling$getMissingSkusForReceipts$1$2(Map<String, PurchasesError> map, Receipt receipt, L l8, o oVar, Map<String, String> map2) {
        super(1);
        this.$errorMap = map;
        this.$receipt = receipt;
        this.$receiptsLeft = l8;
    ...
    public final void invoke(PurchasesError error) {
        ...
        switch (LogWrapperKt.WhenMappings.$EnumSwitchMapping$0[logIntent.ordinal()]) {
            case 1:
                ...
                if (Config.INSTANCE.getLogLevel().compareTo(logLevel) <= 0) {
                    ...
                    currentLogHandler.d(sb.toString(), (String) amazonBilling$getMissingSkusForReceipts$1$2$invoke$$inlined$log$1.invoke());
                }
                break;
            case 2:
            case 6:
            ...
            case 3:
                ...
                if (Config.INSTANCE.getLogLevel().compareTo(logLevel2) <= 0) {
                    ...
                    currentLogHandler2.w(sb2.toString(), (String) amazonBilling$getMissingSkusForReceipts$1$2$invoke$$inlined$log$1.invoke());
                }
                break;
            case 4:
                ...
                if (Config.INSTANCE.getLogLevel().compareTo(logLevel3) <= 0) {
                    ...
                    currentLogHandler3.i(sb3.toString(), (String) amazonBilling$getMissingSkusForReceipts$1$2$invoke$$inlined$log$1.invoke());
                }
                break;
            case 5:
                logLevel = LogLevel.DEBUG;
        ...
        AbstractC2304t.e(receiptId, "receipt.receiptId");
        map.put(receiptId, error);
        L l8 = this.$receiptsLeft;
        int i8 = l8.f20467a - 1;
        l8.f20467a = i8;
        if (i8 == 0) {
