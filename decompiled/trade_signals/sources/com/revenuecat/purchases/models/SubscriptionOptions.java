...
public final class SubscriptionOptions implements List<SubscriptionOption>, a {
    ...
    public SubscriptionOptions(List<? extends SubscriptionOption> subscriptionOptions) {
        AbstractC2304t.f(subscriptionOptions, "subscriptionOptions");
    ...
    private final SubscriptionOption findLongestFreeTrial(List<? extends SubscriptionOption> offers) {
        ...
        while (true) {
            ...
            C2489q c2489q = freePhase != null ? new C2489q(subscriptionOption, Integer.valueOf(billingPeriodToDays$purchases_defaultsRelease(freePhase.getBillingPeriod()))) : null;
            if (c2489q != null) {
        ...
        if (it2.hasNext()) {
            next = it2.next();
            if (it2.hasNext()) {
                int iIntValue = ((Number) ((C2489q) next).d()).intValue();
                do {
                    Object next2 = it2.next();
                    int iIntValue2 = ((Number) ((C2489q) next2).d()).intValue();
        ...
        C2489q c2489q2 = (C2489q) next;
        if (c2489q2 != null) {
            return (SubscriptionOption) c2489q2.c();
        }
        return null;
    }
    ...
    private final SubscriptionOption findLowestNonFreeOffer(List<? extends SubscriptionOption> offers) {
        ...
        while (true) {
            ...
            C2489q c2489q = introPhase != null ? new C2489q(subscriptionOption, Long.valueOf(introPhase.getPrice().getAmountMicros())) : null;
            if (c2489q != null) {
                arrayList.add(c2489q);
            }
        }
        ...
        if (it2.hasNext()) {
            next = it2.next();
            if (it2.hasNext()) {
                long jLongValue = ((Number) ((C2489q) next).d()).longValue();
                do {
                    Object next2 = it2.next();
                    long jLongValue2 = ((Number) ((C2489q) next2).d()).longValue();
    ...
    public final int billingPeriodToDays$purchases_defaultsRelease(Period period) {
        AbstractC2304t.f(period, "period");
    ...
    public boolean equals(Object other) {
        ...
        if (AbstractC2304t.b(SubscriptionOptions.class, other != null ? other.getClass() : null)) {
            return (other instanceof SubscriptionOptions ? (SubscriptionOptions) other : null) != null && AbstractC2304t.b(AbstractC2594p.e(this.subscriptionOptions), AbstractC2594p.e(((SubscriptionOptions) other).subscriptionOptions));
        }
        return false;
    }
    ...
    @Override // java.util.List, java.util.Collection
    public int hashCode() {
        return AbstractC2594p.e(this.subscriptionOptions).hashCode();
    }
    ...
    public /* bridge */ /* synthetic */ Object m98removeFirst() {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }

    /* JADX INFO: renamed from: removeLast, reason: collision with other method in class */
    public /* bridge */ /* synthetic */ Object m99removeLast() {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public <T> T[] toArray(T[] array) {
        ...
        return (T[]) AbstractC2295j.b(this, array);
    }
