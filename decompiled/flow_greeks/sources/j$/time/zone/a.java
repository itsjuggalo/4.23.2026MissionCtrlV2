...
public final class a implements Externalizable {
    ...
    public final void writeExternal(ObjectOutput objectOutput) throws IOException {
        byte b10 = this.f13777a;
        Object obj = this.f13778b;
        objectOutput.writeByte(b10);
        if (b10 != 1) {
            if (b10 == 2) {
                b bVar = (b) obj;
                c(bVar.f13780a, objectOutput);
                d(bVar.f13782c, objectOutput);
                d(bVar.f13783d, objectOutput);
                return;
            }
            if (b10 == 3) {
                ...
                objectOutput.writeUTF(((f) obj).f13805g.getID());
                return;
            }
        }
        f fVar = (f) obj;
        objectOutput.writeInt(fVar.f13799a.length);
        for (long j10 : fVar.f13799a) {
            c(j10, objectOutput);
        }
        for (ZoneOffset zoneOffset : fVar.f13800b) {
            d(zoneOffset, objectOutput);
        }
        objectOutput.writeInt(fVar.f13801c.length);
        for (long j11 : fVar.f13801c) {
            c(j11, objectOutput);
        }
        for (ZoneOffset zoneOffset2 : fVar.f13803e) {
            d(zoneOffset2, objectOutput);
        }
        objectOutput.writeByte(fVar.f13804f.length);
        for (e eVar : fVar.f13804f) {
            eVar.b(objectOutput);
        }
    }
    ...
    public final void readExternal(ObjectInput objectInput) throws IOException {
        ...
        if (b10 == 1) {
            ...
            e[] eVarArr = i18 == 0 ? f.f13796j : new e[i18];
    ...
    public static ZoneOffset b(DataInput dataInput) throws IOException {
        ...
        return b10 == 127 ? ZoneOffset.Y(dataInput.readInt()) : ZoneOffset.Y(b10 * 900);
    }
