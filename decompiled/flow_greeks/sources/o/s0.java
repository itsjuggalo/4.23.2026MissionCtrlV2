...
public class s0 extends d0 {
    ...
    public static boolean f17363c = false;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public final WeakReference f17364b;

    public s0(Context context, Resources resources) {
        super(resources);
        this.f17364b = new WeakReference(context);
    }
    ...
    @Override // o.d0, android.content.res.Resources
    ...
    public Drawable getDrawable(int i10) {
        Context context = (Context) this.f17364b.get();
        return context != null ? c0.g().r(context, this, i10) : a(i10);
    }
