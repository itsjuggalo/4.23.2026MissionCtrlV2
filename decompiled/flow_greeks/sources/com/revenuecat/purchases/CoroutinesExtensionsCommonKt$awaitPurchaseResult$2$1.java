...
public final class CoroutinesExtensionsCommonKt$awaitPurchaseResult$2$1 extends v implements o {
    final /* synthetic */ gd.e $continuation;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CoroutinesExtensionsCommonKt$awaitPurchaseResult$2$1(gd.e eVar) {
        super(2);
    ...
    public final void invoke(StoreTransaction storeTransaction, CustomerInfo customerInfo) {
        ...
        r.a aVar = r.f3870b;
        eVar.resumeWith(r.b(r.a(r.b(new PurchaseResult(storeTransaction, customerInfo)))));
    }
}
