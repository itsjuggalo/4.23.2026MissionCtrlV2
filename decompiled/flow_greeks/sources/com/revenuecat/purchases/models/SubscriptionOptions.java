...
public final class SubscriptionOptions implements List<SubscriptionOption>, a {
    ...
    public SubscriptionOptions(List<? extends SubscriptionOption> subscriptionOptions) {
        t.f(subscriptionOptions, "subscriptionOptions");
    ...
    private final SubscriptionOption findLongestFreeTrial(List<? extends SubscriptionOption> offers) {
        ...
        if (it2.hasNext()) {
            next = it2.next();
            if (it2.hasNext()) {
                int iIntValue = ((Number) ((q) next).d()).intValue();
                do {
                    Object next2 = it2.next();
                    int iIntValue2 = ((Number) ((q) next2).d()).intValue();
    ...
    private final SubscriptionOption findLowestNonFreeOffer(List<? extends SubscriptionOption> offers) {
        ...
        if (it2.hasNext()) {
            next = it2.next();
            if (it2.hasNext()) {
                long jLongValue = ((Number) ((q) next).d()).longValue();
                do {
                    Object next2 = it2.next();
                    long jLongValue2 = ((Number) ((q) next2).d()).longValue();
    ...
    public boolean equals(Object other) {
        ...
        if (t.b(SubscriptionOptions.class, other != null ? other.getClass() : null)) {
            return (other instanceof SubscriptionOptions ? (SubscriptionOptions) other : null) != null && t.b(dd.q.e(this.subscriptionOptions), dd.q.e(((SubscriptionOptions) other).subscriptionOptions));
        }
        return false;
    }
    ...
    @Override // java.util.List, java.util.Collection
    public int hashCode() {
        return dd.q.e(this.subscriptionOptions).hashCode();
    }
    ...
    public /* bridge */ /* synthetic */ Object m144removeFirst() {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }

    /* JADX INFO: renamed from: removeLast, reason: collision with other method in class */
    public /* bridge */ /* synthetic */ Object m145removeLast() {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
