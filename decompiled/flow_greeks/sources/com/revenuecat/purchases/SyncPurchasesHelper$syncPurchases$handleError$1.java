...
public final class SyncPurchasesHelper$syncPurchases$handleError$1 extends v implements pd.k {
    final /* synthetic */ pd.k $onError;
    final /* synthetic */ Date $startTime;
    final /* synthetic */ SyncPurchasesHelper this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SyncPurchasesHelper$syncPurchases$handleError$1(SyncPurchasesHelper syncPurchasesHelper, Date date, pd.k kVar) {
        super(1);
