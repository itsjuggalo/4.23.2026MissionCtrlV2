...
public final class SyncPurchasesHelper$syncPurchases$2$1$1 extends v implements pd.k {
    ...
    public SyncPurchasesHelper$syncPurchases$2$1$1(StoreTransaction storeTransaction, StoreTransaction storeTransaction2, List<PurchasesError> list, SyncPurchasesHelper syncPurchasesHelper, String str, boolean z10, boolean z11, pd.k kVar, pd.k kVar2) {
        super(1);
