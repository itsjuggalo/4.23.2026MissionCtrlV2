...
public final class IdentityManager$logIn$3$1$invoke$lambda$1$$inlined$log$1 extends v implements Function0 {
    final /* synthetic */ boolean $created$inlined;
    final /* synthetic */ LogIntent $intent;
    final /* synthetic */ String $newAppUserID$inlined;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public IdentityManager$logIn$3$1$invoke$lambda$1$$inlined$log$1(LogIntent logIntent, String str, boolean z10) {
        super(0);
