...
public final class QueryProductDetailsUseCase$onOk$$inlined$log$1 extends v implements Function0 {
    ...
    public final String invoke() {
        ...
        sb2.append(' ');
        String str = String.format(OfferingStrings.FETCHING_PRODUCTS_FINISHED, Arrays.copyOf(new Object[]{a0.i0(this.this$0.useCaseParams.getProductIds(), null, null, null, 0, null, null, 63, null)}, 1));
        t.e(str, "format(...)");
        sb2.append(str);
        return sb2.toString();
    }
