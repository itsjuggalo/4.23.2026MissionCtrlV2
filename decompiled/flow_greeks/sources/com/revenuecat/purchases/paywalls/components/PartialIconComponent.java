...
public final class PartialIconComponent implements PartialComponent {
    ...
    /* JADX INFO: compiled from: r8-map-id-f7c0ba7912e30bee969b60fc55dfe505a38d9b7b2320734346e2a4068d44c6f7 */
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0016\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004HÆ\u0001¢\u0006\u0004\b\u0006\u0010\u0007¨\u0006\b"}, d2 = {"Lcom/revenuecat/purchases/paywalls/components/PartialIconComponent$Companion;", "", "<init>", "()V", "Lzg/b;", "Lcom/revenuecat/purchases/paywalls/components/PartialIconComponent;", "serializer", "()Lzg/b;", "purchases_defaultsBc8Release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    ...
    public static final /* synthetic */ void write$Self$purchases_defaultsBc8Release(PartialIconComponent self, d output, e serialDesc) {
        ...
        if (output.o(serialDesc, 1) || self.baseUrl != null) {
            output.e(serialDesc, 1, w1.f8244a, self.baseUrl);
        }
        if (output.o(serialDesc, 2) || self.iconName != null) {
            output.e(serialDesc, 2, w1.f8244a, self.iconName);
        }
        if (output.o(serialDesc, 3) || self.formats != null) {
            output.e(serialDesc, 3, IconComponent$Formats$$serializer.INSTANCE, self.formats);
        }
        if (output.o(serialDesc, 4) || self.size != null) {
    ...
    public boolean equals(Object obj) {
        ...
        return t.b(this.visible, partialIconComponent.visible) && t.b(this.baseUrl, partialIconComponent.baseUrl) && t.b(this.iconName, partialIconComponent.iconName) && t.b(this.formats, partialIconComponent.formats) && t.b(this.size, partialIconComponent.size) && t.b(this.color, partialIconComponent.color) && t.b(this.padding, partialIconComponent.padding) && t.b(this.margin, partialIconComponent.margin) && t.b(this.iconBackground, partialIconComponent.iconBackground);
    }
    ...
    public /* synthetic */ PartialIconComponent(int i10, Boolean bool, String str, String str2, IconComponent.Formats formats, Size size, ColorScheme colorScheme, Padding padding, Padding padding2, IconComponent.IconBackground iconBackground, s1 s1Var) {
