...
public final class Shadow {
    ...
    /* JADX INFO: compiled from: r8-map-id-f7c0ba7912e30bee969b60fc55dfe505a38d9b7b2320734346e2a4068d44c6f7 */
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0016\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004HÆ\u0001¢\u0006\u0004\b\u0006\u0010\u0007¨\u0006\b"}, d2 = {"Lcom/revenuecat/purchases/paywalls/components/properties/Shadow$Companion;", "", "<init>", "()V", "Lzg/b;", "Lcom/revenuecat/purchases/paywalls/components/properties/Shadow;", "serializer", "()Lzg/b;", "purchases_defaultsBc8Release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    ...
    public /* synthetic */ Shadow(int i10, ColorScheme colorScheme, double d10, double d11, double d12, s1 s1Var) {
        if (15 != (i10 & 15)) {
            e1.a(i10, 15, Shadow$$serializer.INSTANCE.getDescriptor());
        }
    ...
    public static final /* synthetic */ void write$Self$purchases_defaultsBc8Release(Shadow self, d output, e serialDesc) {
        ...
        output.q(serialDesc, 1, self.radius);
        output.q(serialDesc, 2, self.x);
        output.q(serialDesc, 3, self.y);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return t.b(this.color, shadow.color) && Double.compare(this.radius, shadow.radius) == 0 && Double.compare(this.x, shadow.x) == 0 && Double.compare(this.y, shadow.y) == 0;
    }
