...
public final class PaywallData$LocalizedConfiguration$Feature$$serializer implements e0 {
    ...
    static {
        ...
        j1Var.g(b.S, false);
        j1Var.g(FirebaseAnalytics.Param.CONTENT, true);
        j1Var.g("icon_id", true);
        descriptor = j1Var;
    }
    ...
    public zg.b[] childSerializers() {
        w1 w1Var = w1.f8244a;
        return new zg.b[]{w1Var, a.p(w1Var), a.p(w1Var)};
    }
    ...
    public PaywallData.LocalizedConfiguration.Feature deserialize(e decoder) {
        ...
        if (cVarB.z()) {
            ...
            w1 w1Var = w1.f8244a;
            String str4 = (String) cVarB.n(descriptor2, 1, w1Var, null);
            str = strS2;
            str3 = (String) cVarB.n(descriptor2, 2, w1Var, null);
            str2 = str4;
            i10 = 7;
        } else {
            boolean z10 = true;
        ...
        cVarB.c(descriptor2);
        return new PaywallData.LocalizedConfiguration.Feature(i10, str, str2, str3, (s1) null);
    }
