...
public final class PurchaseParamsValidator {
    ...
    private final Result<h0, PurchasesError> validateAddOnProducts(PurchaseParams purchaseParams) {
        ...
        if (subscription == null || (addOnProducts = subscription.getAddOnProducts()) == null) {
            return new Result.Success(h0.f3852a);
        }
        if (!addOnProducts.isEmpty()) {
            ...
            if (iso8601 != null) {
                ...
                while (it2.hasNext()) {
                    if (!t.b(((Period) it2.next()).getIso8601(), iso8601)) {
    ...
    public final Result<h0, PurchasesError> validate(PurchaseParams purchaseParams) {
        t.f(purchaseParams, "purchaseParams");
        if (purchaseParams.getContainsAddOnItems$purchases_defaultsBc8Release()) {
            Result<h0, PurchasesError> resultValidateAddOnProducts = validateAddOnProducts(purchaseParams);
