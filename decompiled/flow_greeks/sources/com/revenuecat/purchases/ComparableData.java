...
final /* data */ class ComparableData {
    ...
    public boolean equals(Object other) {
        ...
        return t.b(this.entitlements, comparableData.entitlements) && t.b(this.allExpirationDatesByProduct, comparableData.allExpirationDatesByProduct) && t.b(this.allPurchaseDatesByProduct, comparableData.allPurchaseDatesByProduct) && this.schemaVersion == comparableData.schemaVersion && t.b(this.firstSeen, comparableData.firstSeen) && t.b(this.originalAppUserId, comparableData.originalAppUserId) && t.b(this.originalPurchaseDate, comparableData.originalPurchaseDate);
    }
