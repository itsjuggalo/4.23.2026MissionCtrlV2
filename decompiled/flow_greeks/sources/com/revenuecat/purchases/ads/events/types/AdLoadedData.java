...
public final class AdLoadedData {
    ...
    public /* synthetic */ AdLoadedData(String str, String str2, String str3, String str4, String str5, k kVar) {
    ...
    public boolean equals(Object obj) {
        ...
        return t.b(this.networkName, adLoadedData.networkName) && AdMediatorName.m79equalsimpl0(this.mediatorName, adLoadedData.mediatorName) && t.b(this.placement, adLoadedData.placement) && t.b(this.adUnitId, adLoadedData.adUnitId) && t.b(this.impressionId, adLoadedData.impressionId);
    }
    ...
    public String toString() {
        return "AdLoadedData(networkName=" + this.networkName + ", mediatorName=" + ((Object) AdMediatorName.m81toStringimpl(this.mediatorName)) + ", placement=" + this.placement + ", adUnitId=" + this.adUnitId + ", impressionId=" + this.impressionId + ')';
    }

    private AdLoadedData(String networkName, String mediatorName, String str, String adUnitId, String impressionId) {
