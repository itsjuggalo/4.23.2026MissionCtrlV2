...
public final class AdDisplayedData {
    ...
    public /* synthetic */ AdDisplayedData(String str, String str2, String str3, String str4, String str5, k kVar) {
    ...
    public boolean equals(Object obj) {
        ...
        return t.b(this.networkName, adDisplayedData.networkName) && AdMediatorName.m79equalsimpl0(this.mediatorName, adDisplayedData.mediatorName) && t.b(this.placement, adDisplayedData.placement) && t.b(this.adUnitId, adDisplayedData.adUnitId) && t.b(this.impressionId, adDisplayedData.impressionId);
    }
    ...
    public String toString() {
        return "AdDisplayedData(networkName=" + this.networkName + ", mediatorName=" + ((Object) AdMediatorName.m81toStringimpl(this.mediatorName)) + ", placement=" + this.placement + ", adUnitId=" + this.adUnitId + ", impressionId=" + this.impressionId + ')';
    }
