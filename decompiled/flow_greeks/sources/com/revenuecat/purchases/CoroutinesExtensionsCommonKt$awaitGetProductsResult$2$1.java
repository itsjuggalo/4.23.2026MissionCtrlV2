...
public final class CoroutinesExtensionsCommonKt$awaitGetProductsResult$2$1 extends v implements pd.k {
    final /* synthetic */ gd.e $continuation;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CoroutinesExtensionsCommonKt$awaitGetProductsResult$2$1(gd.e eVar) {
        super(1);
