...
public final class CoroutinesExtensionsCommonKt$awaitPurchase$2$2 extends v implements o {
    final /* synthetic */ gd.e $continuation;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CoroutinesExtensionsCommonKt$awaitPurchase$2$2(gd.e eVar) {
        super(2);
    ...
    public final void invoke(PurchasesError purchasesError, boolean z10) {
        ...
        r.a aVar = r.f3870b;
        eVar.resumeWith(r.b(s.a(new PurchasesTransactionException(purchasesError, z10))));
    }
}
