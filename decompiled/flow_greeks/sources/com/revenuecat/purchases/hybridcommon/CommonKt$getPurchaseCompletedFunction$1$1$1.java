...
public final class CommonKt$getPurchaseCompletedFunction$1$1$1 extends v implements k {
    ...
    public final void invoke(Map<String, ? extends Object> map) {
        t.f(map, "map");
        this.$onResult.onReceived(o0.l(w.a("productIdentifier", this.$transaction.getProductIds().get(0)), w.a("customerInfo", map), w.a("transaction", StoreTransactionMapperKt.map(this.$transaction))));
    }
}
