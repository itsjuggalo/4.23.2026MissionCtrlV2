...
public final class StoreProductMapperKt {
    ...
    public static final Map<String, Object> map(StoreProduct storeProduct) {
        ...
        ArrayList arrayList;
        t.f(storeProduct, "<this>");
        q qVarA = w.a("identifier", storeProduct.getId());
        q qVarA2 = w.a(b.f4549c, storeProduct.getDescription());
        q qVarA3 = w.a(b.S, storeProduct.getTitle());
        q qVarA4 = w.a("price", Double.valueOf(getPriceAmountMicros(storeProduct) / 1000000.0d));
        q qVarA5 = w.a("priceString", getPriceString(storeProduct));
        q qVarA6 = w.a("currencyCode", getPriceCurrencyCode(storeProduct));
        q qVarA7 = w.a("introPrice", mapIntroPrice(storeProduct));
        q qVarA8 = w.a("discounts", null);
        Price pricePricePerWeek$default = StoreProduct.pricePerWeek$default(storeProduct, null, 1, null);
        q qVarA9 = w.a("pricePerWeek", pricePricePerWeek$default != null ? Long.valueOf(pricePricePerWeek$default.getAmountMicros()) : null);
        Price pricePricePerMonth$default = StoreProduct.pricePerMonth$default(storeProduct, null, 1, null);
        q qVarA10 = w.a("pricePerMonth", pricePricePerMonth$default != null ? Long.valueOf(pricePricePerMonth$default.getAmountMicros()) : null);
        Price pricePricePerYear$default = StoreProduct.pricePerYear$default(storeProduct, null, 1, null);
        q qVarA11 = w.a("pricePerYear", pricePricePerYear$default != null ? Long.valueOf(pricePricePerYear$default.getAmountMicros()) : null);
        Price pricePricePerWeek$default2 = StoreProduct.pricePerWeek$default(storeProduct, null, 1, null);
        q qVarA12 = w.a("pricePerWeekString", pricePricePerWeek$default2 != null ? pricePricePerWeek$default2.getFormatted() : null);
        Price pricePricePerMonth$default2 = StoreProduct.pricePerMonth$default(storeProduct, null, 1, null);
        q qVarA13 = w.a("pricePerMonthString", pricePricePerMonth$default2 != null ? pricePricePerMonth$default2.getFormatted() : null);
        Price pricePricePerYear$default2 = StoreProduct.pricePerYear$default(storeProduct, null, 1, null);
        q qVarA14 = w.a("pricePerYearString", pricePricePerYear$default2 != null ? pricePricePerYear$default2.getFormatted() : null);
        q qVarA15 = w.a("productCategory", mapProductCategory(storeProduct).getValue());
        q qVarA16 = w.a("productType", mapProductType(storeProduct));
        Period period = storeProduct.getPeriod();
        q qVarA17 = w.a(b.f4561o, period != null ? period.getIso8601() : null);
        SubscriptionOption defaultOption = storeProduct.getDefaultOption();
        q qVarA18 = w.a("defaultOption", defaultOption != null ? mapSubscriptionOption(defaultOption, storeProduct) : null);
        SubscriptionOptions subscriptionOptions = storeProduct.getSubscriptionOptions();
        if (subscriptionOptions != null) {
            qVar = qVarA15;
            arrayList = new ArrayList(dd.s.u(subscriptionOptions, 10));
        ...
        q qVarA19 = w.a("subscriptionOptions", arrayList);
        PresentedOfferingContext presentedOfferingContext = storeProduct.getPresentedOfferingContext();
        q qVarA20 = w.a("presentedOfferingIdentifier", presentedOfferingContext != null ? presentedOfferingContext.getOfferingIdentifier() : null);
        PresentedOfferingContext presentedOfferingContext2 = storeProduct.getPresentedOfferingContext();
        return o0.l(qVarA, qVarA2, qVarA3, qVarA4, qVarA5, qVarA6, qVarA7, qVarA8, qVarA9, qVarA10, qVarA11, qVarA12, qVarA13, qVarA14, qVar, qVarA16, qVarA17, qVarA18, qVarA19, qVarA20, w.a("presentedOfferingContext", presentedOfferingContext2 != null ? OfferingsMapperKt.map(presentedOfferingContext2) : null));
    }

    public static final void mapAsync(List<? extends StoreProduct> list, k callback) {
        t.f(list, "<this>");
        t.f(callback, "callback");
        ng.k.d(MappersHelpersKt.getMainScope(), null, null, new AnonymousClass1(callback, list, null), 3, null);
    }
    ...
    public static final Map<String, Object> mapIntroPrice(StoreProduct storeProduct) {
        ...
        if (storeProduct instanceof AmazonStoreProduct) {
            ...
            q qVarA = w.a("price", 0);
            q qVarA2 = w.a("priceString", MappersHelpersKt.formatUsingDeviceLocale(getPriceCurrencyCode(storeProduct), 0L));
            Period freeTrialPeriod2 = amazonStoreProduct.getFreeTrialPeriod();
            return o0.p(o0.l(qVarA, qVarA2, w.a("period", freeTrialPeriod2 != null ? freeTrialPeriod2.getIso8601() : null), w.a("cycles", 1)), mapMapPeriodForStoreProduct3);
        }
        if (getGoogleFreeTrialPeriod(storeProduct) == null) {
            ...
            q qVarA3 = w.a("price", Double.valueOf(getGoogleIntroductoryPriceAmountMicros(storeProduct) / 1000000.0d));
            q qVarA4 = w.a("priceString", getGoogleIntroductoryPrice(storeProduct));
            Period googleIntroductoryPricePeriod2 = getGoogleIntroductoryPricePeriod(storeProduct);
            return o0.p(o0.l(qVarA3, qVarA4, w.a("period", googleIntroductoryPricePeriod2 != null ? googleIntroductoryPricePeriod2.getIso8601() : null), w.a("cycles", Integer.valueOf(getGoogleIntroductoryPriceCycles(storeProduct)))), mapMapPeriodForStoreProduct);
        }
        ...
        q qVarA5 = w.a("price", 0);
        q qVarA6 = w.a("priceString", MappersHelpersKt.formatUsingDeviceLocale(getPriceCurrencyCode(storeProduct), 0L));
        Period googleFreeTrialPeriod2 = getGoogleFreeTrialPeriod(storeProduct);
        q qVarA7 = w.a("period", googleFreeTrialPeriod2 != null ? googleFreeTrialPeriod2.getIso8601() : null);
        Integer googleFreeTrialCycles = getGoogleFreeTrialCycles(storeProduct);
        return o0.p(o0.l(qVarA5, qVarA6, qVarA7, w.a("cycles", Integer.valueOf(googleFreeTrialCycles != null ? googleFreeTrialCycles.intValue() : 1))), mapMapPeriodForStoreProduct2);
    }
    ...
    private static final Map<String, Object> mapPeriod(Period period) {
        ...
        if (i10 == 1) {
            mapL = o0.l(w.a("unit", "DAY"), w.a("value", Integer.valueOf(period.getValue())));
        } else if (i10 == 2) {
            mapL = o0.l(w.a("unit", "DAY"), w.a("value", Integer.valueOf(period.getValue() * 7)));
        } else if (i10 == 3) {
            mapL = o0.l(w.a("unit", "MONTH"), w.a("value", Integer.valueOf(period.getValue())));
        } else if (i10 == 4) {
            mapL = o0.l(w.a("unit", "YEAR"), w.a("value", Integer.valueOf(period.getValue())));
        } else {
            if (i10 != 5) {
                throw new cd.o();
            }
            mapL = o0.l(w.a("unit", "DAY"), w.a("value", 0));
        }
        return o0.p(mapL, dd.n0.e(w.a("iso8601", period.getIso8601())));
    }

    private static final Map<String, Object> mapPeriodForStoreProduct(Period period) {
        int i10 = WhenMappings.$EnumSwitchMapping$1[period.getUnit().ordinal()];
        if (i10 == 1) {
            return o0.l(w.a("periodUnit", "DAY"), w.a("periodNumberOfUnits", Integer.valueOf(period.getValue())));
        }
        if (i10 == 2) {
            return o0.l(w.a("periodUnit", "DAY"), w.a("periodNumberOfUnits", Integer.valueOf(period.getValue() * 7)));
        }
        if (i10 == 3) {
            return o0.l(w.a("periodUnit", "MONTH"), w.a("periodNumberOfUnits", Integer.valueOf(period.getValue())));
        }
        if (i10 == 4) {
            return o0.l(w.a("periodUnit", "YEAR"), w.a("periodNumberOfUnits", Integer.valueOf(period.getValue())));
        }
        if (i10 == 5) {
            return o0.l(w.a("periodUnit", "DAY"), w.a("periodNumberOfUnits", 0));
        }
        throw new cd.o();
    }

    private static final Map<String, Object> mapPrice(Price price) {
        return o0.l(w.a("formatted", price.getFormatted()), w.a("amountMicros", Long.valueOf(price.getAmountMicros())), w.a("currencyCode", price.getCurrencyCode()));
    }
    ...
    private static final Map<String, Object> mapPricingPhase(PricingPhase pricingPhase) {
        ...
        q qVarA = w.a("billingPeriod", billingPeriod != null ? mapPeriod(billingPeriod) : null);
        q qVarA2 = w.a("recurrenceMode", pricingPhase.getRecurrenceMode().getIdentifier());
        q qVarA3 = w.a("billingCycleCount", pricingPhase.getBillingCycleCount());
        q qVarA4 = w.a("price", mapPrice(pricingPhase.getPrice()));
        OfferPaymentMode offerPaymentMode = pricingPhase.getOfferPaymentMode();
        return o0.l(qVarA, qVarA2, qVarA3, qVarA4, w.a("offerPaymentMode", offerPaymentMode != null ? offerPaymentMode.toString() : null));
    }
    ...
    private static final Map<String, Object> mapSubscriptionOption(SubscriptionOption subscriptionOption, StoreProduct storeProduct) {
        q qVarA = w.a(DiagnosticsEntry.ID_KEY, subscriptionOption.getId());
        q qVarA2 = w.a("storeProductId", storeProduct.getId());
        q qVarA3 = w.a("productId", storeProduct.getPurchasingData().getProductId());
        List<PricingPhase> pricingPhases = subscriptionOption.getPricingPhases();
        ArrayList arrayList = new ArrayList(dd.s.u(pricingPhases, 10));
        Iterator<T> it = pricingPhases.iterator();
        while (it.hasNext()) {
            arrayList.add(mapPricingPhase((PricingPhase) it.next()));
        }
        q qVarA4 = w.a("pricingPhases", arrayList);
        q qVarA5 = w.a("tags", subscriptionOption.getTags());
        q qVarA6 = w.a("isBasePlan", Boolean.valueOf(subscriptionOption.isBasePlan()));
        Period billingPeriod = subscriptionOption.getBillingPeriod();
        q qVarA7 = w.a("billingPeriod", billingPeriod != null ? mapPeriod(billingPeriod) : null);
        q qVarA8 = w.a("isPrepaid", Boolean.valueOf(subscriptionOption.isPrepaid()));
        PricingPhase fullPricePhase = subscriptionOption.getFullPricePhase();
        q qVarA9 = w.a("fullPricePhase", fullPricePhase != null ? mapPricingPhase(fullPricePhase) : null);
        PricingPhase freePhase = subscriptionOption.getFreePhase();
        q qVarA10 = w.a("freePhase", freePhase != null ? mapPricingPhase(freePhase) : null);
        PricingPhase introPhase = subscriptionOption.getIntroPhase();
        q qVarA11 = w.a("introPhase", introPhase != null ? mapPricingPhase(introPhase) : null);
        PresentedOfferingContext presentedOfferingContext = subscriptionOption.getPresentedOfferingContext();
        q qVarA12 = w.a("presentedOfferingIdentifier", presentedOfferingContext != null ? presentedOfferingContext.getOfferingIdentifier() : null);
        PresentedOfferingContext presentedOfferingContext2 = subscriptionOption.getPresentedOfferingContext();
        q qVarA13 = w.a("presentedOfferingContext", presentedOfferingContext2 != null ? OfferingsMapperKt.map(presentedOfferingContext2) : null);
        InstallmentsInfo installmentsInfo = subscriptionOption.getInstallmentsInfo();
        return o0.l(qVarA, qVarA2, qVarA3, qVarA4, qVarA5, qVarA6, qVarA7, qVarA8, qVarA9, qVarA10, qVarA11, qVarA12, qVarA13, w.a("installmentsInfo", installmentsInfo != null ? map(installmentsInfo) : null));
    }

    private static final Map<String, Object> map(InstallmentsInfo installmentsInfo) {
        return o0.l(w.a("commitmentPaymentsCount", Integer.valueOf(installmentsInfo.getCommitmentPaymentsCount())), w.a("renewalCommitmentPaymentsCount", Integer.valueOf(installmentsInfo.getRenewalCommitmentPaymentsCount())));
    }
