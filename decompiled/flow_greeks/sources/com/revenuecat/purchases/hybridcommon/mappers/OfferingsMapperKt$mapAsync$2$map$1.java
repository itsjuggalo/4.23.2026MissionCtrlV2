...
public final class OfferingsMapperKt$mapAsync$2$map$1 extends m implements o {
    ...
    public final Object invoke(n0 n0Var, e eVar) {
        return ((OfferingsMapperKt$mapAsync$2$map$1) create(n0Var, eVar)).invokeSuspend(h0.f3852a);
    }
}
