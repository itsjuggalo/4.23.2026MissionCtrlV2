...
public final /* data */ class DiagnosticsEntry implements Event {
    ...
    public boolean equals(Object other) {
        ...
        return t.b(this.id, diagnosticsEntry.id) && this.name == diagnosticsEntry.name && t.b(this.properties, diagnosticsEntry.properties) && t.b(this.appSessionID, diagnosticsEntry.appSessionID) && t.b(this.dateProvider, diagnosticsEntry.dateProvider) && t.b(this.dateTime, diagnosticsEntry.dateTime);
    }
    ...
    public String toString() {
        ...
        t.e(string, "toJSONObject().toString()");
        return string;
    }

    /* JADX WARN: Illegal instructions before constructor call */
    public /* synthetic */ DiagnosticsEntry(UUID uuid, DiagnosticsEntryName diagnosticsEntryName, Map map, UUID uuid2, DateProvider dateProvider, Date date, int i10, k kVar) {
        if ((i10 & 1) != 0) {
