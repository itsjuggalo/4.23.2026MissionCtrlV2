...
public final class DiagnosticsHelper {
    ...
    public DiagnosticsHelper(Context context, DiagnosticsFileHelper diagnosticsFileHelper, k sharedPreferences) {
        t.f(context, "context");
    ...
    public /* synthetic */ DiagnosticsHelper(Context context, DiagnosticsFileHelper diagnosticsFileHelper, k kVar, int i10, kotlin.jvm.internal.k kVar2) {
        this(context, diagnosticsFileHelper, (i10 & 4) != 0 ? l.b(new AnonymousClass1(context)) : kVar);
    }
}
