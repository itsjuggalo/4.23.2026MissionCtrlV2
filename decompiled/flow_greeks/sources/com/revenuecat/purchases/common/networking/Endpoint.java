...
public abstract class Endpoint {
    ...
    public static final /* data */ class AliasUsers extends Endpoint {
        ...
        public boolean equals(Object other) {
            ...
            return (other instanceof AliasUsers) && t.b(this.userId, ((AliasUsers) other).userId);
        }
    ...
    public static final /* data */ class GetAmazonReceipt extends Endpoint {
        ...
        public boolean equals(Object other) {
            ...
            return t.b(this.userId, getAmazonReceipt.userId) && t.b(this.receiptId, getAmazonReceipt.receiptId);
        }
    ...
    public static final /* data */ class GetCustomerCenterConfig extends Endpoint {
        ...
        public boolean equals(Object other) {
            ...
            return (other instanceof GetCustomerCenterConfig) && t.b(this.userId, ((GetCustomerCenterConfig) other).userId);
        }
    ...
    public static final /* data */ class GetCustomerInfo extends Endpoint {
        ...
        public boolean equals(Object other) {
            ...
            return (other instanceof GetCustomerInfo) && t.b(this.userId, ((GetCustomerInfo) other).userId);
        }
    ...
    public static final /* data */ class GetOfferings extends Endpoint {
        ...
        public boolean equals(Object other) {
            ...
            return (other instanceof GetOfferings) && t.b(this.userId, ((GetOfferings) other).userId);
        }
    ...
    public static final /* data */ class GetVirtualCurrencies extends Endpoint {
        ...
        public boolean equals(Object other) {
            ...
            return (other instanceof GetVirtualCurrencies) && t.b(this.userId, ((GetVirtualCurrencies) other).userId);
        }
    ...
    public static final /* data */ class PostAttributes extends Endpoint {
        ...
        public boolean equals(Object other) {
            ...
            return (other instanceof PostAttributes) && t.b(this.userId, ((PostAttributes) other).userId);
        }
    ...
    public static final /* data */ class WebBillingGetProducts extends Endpoint {
        ...
        public boolean equals(Object other) {
            ...
            return t.b(this.userId, webBillingGetProducts.userId) && t.b(this.productIds, webBillingGetProducts.productIds);
        }

        @Override // com.revenuecat.purchases.common.networking.Endpoint
        public String getPath(boolean useFallback) {
            String str = String.format(getPathTemplate(), Arrays.copyOf(new Object[]{Uri.encode(this.userId), a0.i0(this.productIds, "&id=", null, null, 0, null, Endpoint$WebBillingGetProducts$getPath$1.INSTANCE, 30, null)}, 2));
            t.e(str, "format(...)");
            return str;
        }
    ...
    public final boolean getNeedsNonceToPerformSigning() {
        if (this instanceof GetCustomerInfo ? true : t.b(this, LogIn.INSTANCE) ? true : t.b(this, PostReceipt.INSTANCE) ? true : t.b(this, PostRedeemWebPurchase.INSTANCE) ? true : this instanceof GetVirtualCurrencies) {
            return true;
        }
        if (this instanceof GetAmazonReceipt ? true : this instanceof GetOfferings ? true : this instanceof PostAttributes ? true : t.b(this, PostDiagnostics.INSTANCE) ? true : t.b(this, PostEvents.INSTANCE) ? true : t.b(this, GetProductEntitlementMapping.INSTANCE) ? true : this instanceof GetCustomerCenterConfig ? true : t.b(this, PostCreateSupportTicket.INSTANCE) ? true : this instanceof WebBillingGetProducts ? true : this instanceof AliasUsers) {
            return false;
        }
        throw new o();
    }
    ...
    public final boolean getSupportsSignatureVerification() {
        if (this instanceof GetCustomerInfo ? true : t.b(this, LogIn.INSTANCE) ? true : t.b(this, PostReceipt.INSTANCE) ? true : this instanceof GetOfferings ? true : t.b(this, GetProductEntitlementMapping.INSTANCE) ? true : t.b(this, PostRedeemWebPurchase.INSTANCE) ? true : this instanceof GetVirtualCurrencies) {
            return true;
        }
        if (this instanceof GetAmazonReceipt ? true : this instanceof PostAttributes ? true : t.b(this, PostDiagnostics.INSTANCE) ? true : t.b(this, PostEvents.INSTANCE) ? true : this instanceof GetCustomerCenterConfig ? true : t.b(this, PostCreateSupportTicket.INSTANCE) ? true : this instanceof WebBillingGetProducts ? true : this instanceof AliasUsers) {
            return false;
        }
        throw new o();
    }
    ...
    public /* synthetic */ Endpoint(String str, String str2, String str3, int i10, k kVar) {
