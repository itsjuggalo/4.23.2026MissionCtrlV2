...
public final /* data */ class Signature {
    ...
    public static final class Companion {
        ...
        public final Signature fromString$purchases_defaultsBc8Release(String signature) throws InvalidSignatureSizeException {
            ...
            if (signatureBytes.length == totalSize) {
                t.e(signatureBytes, "signatureBytes");
    ...
    public enum Component {
        ...
        public final int getStartByte() {
            int i10 = 0;
            for (Object obj : l.m(values(), 0, ordinal())) {
    ...
    public Signature(byte[] intermediateKey, byte[] intermediateKeyExpiration, byte[] intermediateKeySignature, byte[] salt, byte[] payload) {
        t.f(intermediateKey, "intermediateKey");
        t.f(intermediateKeyExpiration, "intermediateKeyExpiration");
        t.f(intermediateKeySignature, "intermediateKeySignature");
        t.f(salt, "salt");
        t.f(payload, "payload");
    ...
    public boolean equals(Object other) {
        ...
        if (!t.b(Signature.class, other != null ? other.getClass() : null)) {
            return false;
        }
        t.d(other, "null cannot be cast to non-null type com.revenuecat.purchases.common.verification.Signature");
