...
public final class EntitlementInfoFactoriesKt {
    public static final EntitlementInfo buildEntitlementInfo(JSONObject jSONObject, String identifier, JSONObject productData, Date requestDate, VerificationResult verificationResult) throws JSONException {
        ...
        t.e(string, "getString(EntitlementsRe…nKeys.PRODUCT_IDENTIFIER)");
    ...
    public static final EntitlementInfos buildEntitlementInfos(JSONObject jSONObject, JSONObject subscriptions, JSONObject nonSubscriptionsLatestPurchases, Date requestDate, VerificationResult verificationResult) {
        ...
        t.f(nonSubscriptionsLatestPurchases, "nonSubscriptionsLatestPurchases");
        t.f(requestDate, "requestDate");
        t.f(verificationResult, "verificationResult");
        ...
        while (itKeys.hasNext()) {
            ...
            if (it != null) {
                if (subscriptions.has(it)) {
                    t.e(entitlementId, "entitlementId");
                    t.e(entitlement, "entitlement");
                    JSONObject jSONObject2 = subscriptions.getJSONObject(it);
                    t.e(jSONObject2, "subscriptions.getJSONObject(productIdentifier)");
                    ...
                    t.e(jSONObject3, "nonSubscriptionsLatestPu…Object(productIdentifier)");
    ...
    public static final Store getStore(JSONObject jSONObject, String name) throws JSONException {
        ...
        t.e(string, "getString(name)");
        return companion.fromString(string);
    }

    private static final boolean isDateActive(String str, Date date, Date date2) {
        DateActive dateActiveM246isDateActiveSxA4cEA$default = DateHelper.Companion.m246isDateActiveSxA4cEA$default(DateHelper.INSTANCE, date, date2, 0L, 4, null);
        if (!dateActiveM246isDateActiveSxA4cEA$default.isActive() && !dateActiveM246isDateActiveSxA4cEA$default.getInGracePeriod()) {
        ...
        return dateActiveM246isDateActiveSxA4cEA$default.isActive();
    }
    ...
    public static final OwnershipType optOwnershipType(JSONObject jSONObject, String name) {
        ...
        return t.b(strOptString, "PURCHASED") ? OwnershipType.PURCHASED : t.b(strOptString, "FAMILY_SHARED") ? OwnershipType.FAMILY_SHARED : OwnershipType.UNKNOWN;
    }
