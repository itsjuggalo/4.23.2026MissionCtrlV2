...
public final /* data */ class PurchasedProduct {
    ...
    public boolean equals(Object other) {
        ...
        return t.b(this.productIdentifier, purchasedProduct.productIdentifier) && t.b(this.basePlanId, purchasedProduct.basePlanId) && t.b(this.storeTransaction, purchasedProduct.storeTransaction) && t.b(this.entitlements, purchasedProduct.entitlements) && t.b(this.expiresDate, purchasedProduct.expiresDate);
    }
