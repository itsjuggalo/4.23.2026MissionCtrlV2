...
public final class OfferingsFactory$createOfferings$1$invoke$lambda$3$$inlined$log$1 extends v implements Function0 {
    ...
    public final String invoke() {
        ...
        sb2.append(' ');
        String str = String.format(OfferingStrings.CANNOT_FIND_PRODUCT_CONFIGURATION_ERROR, Arrays.copyOf(new Object[]{a0.i0(this.$missingProducts$inlined, ", ", null, null, 0, null, null, 62, null)}, 1));
        t.e(str, "format(...)");
        sb2.append(str);
        return sb2.toString();
    }
