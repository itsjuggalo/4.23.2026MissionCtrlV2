...
public final class GooglePlatformProductId extends PlatformProductId {
    ...
    public /* synthetic */ GooglePlatformProductId(String str, String str2, String str3, int i10, k kVar) {
        this(str, (i10 & 2) != 0 ? null : str2, (i10 & 4) != 0 ? null : str3);
    }

    @Override // com.revenuecat.purchases.common.PlatformProductId
    public Map<String, String> getAsMap() {
        return o0.l(w.a(DiagnosticsTracker.PRODUCT_ID_KEY, getProductId()), w.a("base_plan_id", this.basePlanId), w.a("offer_id", this.offerId));
    }
