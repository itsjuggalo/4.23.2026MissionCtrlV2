...
public final class BackendStoredEvent$CustomerCenter$$serializer implements e0 {
    ...
    static {
        ...
        j1 j1Var = new j1("customer_center", backendStoredEvent$CustomerCenter$$serializer, 1);
        j1Var.g("event", false);
        descriptor = j1Var;
    }
    ...
    public BackendStoredEvent.CustomerCenter deserialize(e decoder) {
        ...
        int i10 = 1;
        if (cVarB.z()) {
            customerCenter = (BackendEvent.CustomerCenter) cVarB.h(descriptor2, 0, BackendEvent$CustomerCenter$$serializer.INSTANCE, null);
        } else {
            boolean z10 = true;
            int i11 = 0;
            customerCenter = null;
            while (z10) {
                ...
                if (iW == -1) {
                    ...
                    customerCenter = (BackendEvent.CustomerCenter) cVarB.h(descriptor2, 0, BackendEvent$CustomerCenter$$serializer.INSTANCE, customerCenter);
                    i11 = 1;
                }
            }
            i10 = i11;
