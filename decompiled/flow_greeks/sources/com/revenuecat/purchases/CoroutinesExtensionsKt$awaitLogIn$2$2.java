...
public final class CoroutinesExtensionsKt$awaitLogIn$2$2 extends v implements o {
    final /* synthetic */ gd.e $continuation;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CoroutinesExtensionsKt$awaitLogIn$2$2(gd.e eVar) {
        super(2);
    ...
    public final void invoke(CustomerInfo customerInfo, boolean z10) {
        ...
        r.a aVar = r.f3870b;
        eVar.resumeWith(r.b(new LogInResult(customerInfo, z10)));
    }
}
