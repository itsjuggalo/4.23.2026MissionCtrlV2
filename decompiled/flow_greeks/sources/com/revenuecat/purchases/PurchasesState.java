...
public final /* data */ class PurchasesState {
    ...
    public final PurchasesState copy(Boolean allowSharingPlayStoreAccount, Map<String, ? extends PurchaseCallback> purchaseCallbacksByProductId, ProductChangeCallback deprecatedProductChangeCallback, boolean appInBackground, boolean firstTimeInForeground) {
        t.f(purchaseCallbacksByProductId, "purchaseCallbacksByProductId");
    ...
    public /* synthetic */ PurchasesState(Boolean bool, Map map, ProductChangeCallback productChangeCallback, boolean z10, boolean z11, int i10, kotlin.jvm.internal.k kVar) {
        this((i10 & 1) != 0 ? null : bool, (i10 & 2) != 0 ? o0.h() : map, (i10 & 4) != 0 ? null : productChangeCallback, (i10 & 8) != 0 ? true : z10, (i10 & 16) != 0 ? true : z11);
    }
}
