...
final /* data */ class ComparableData {
    ...
    public boolean equals(Object other) {
        ...
        return t.b(this.id, comparableData.id) && this.type == comparableData.type && t.b(this.title, comparableData.title) && t.b(this.description, comparableData.description) && t.b(this.period, comparableData.period) && t.b(this.price, comparableData.price) && t.b(this.subscriptionOptions, comparableData.subscriptionOptions) && t.b(this.defaultOption, comparableData.defaultOption) && t.b(this.iconUrl, comparableData.iconUrl) && t.b(this.freeTrialPeriod, comparableData.freeTrialPeriod) && t.b(this.presentedOfferingContext, comparableData.presentedOfferingContext);
    }
    ...
    public ComparableData(AmazonStoreProduct amazonStoreProduct) {
        ...
        t.f(amazonStoreProduct, "amazonStoreProduct");
    }
}
