...
public final class ProductDataHandler$getProductData$$inlined$log$1 extends v implements Function0 {
    ...
    public final String invoke() {
        ...
        sb2.append(' ');
        String str = String.format(AmazonStrings.REQUESTING_PRODUCTS, Arrays.copyOf(new Object[]{a0.i0(this.$skus$inlined, null, null, null, 0, null, null, 63, null)}, 1));
        t.e(str, "format(...)");
        sb2.append(str);
        return sb2.toString();
    }
