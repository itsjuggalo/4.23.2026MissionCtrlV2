...
public class c {
    ...
    private static final String f5021a = "c";
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f5022a[d.LEGACY.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f5022a[d.V2.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f5022a[d.V3.ordinal()] = 4;
    ...
    public static Receipt a(JSONObject jSONObject, String str, String str2) {
        int i10 = AnonymousClass1.f5022a[b(jSONObject).ordinal()];
    ...
    private static Receipt b(JSONObject jSONObject, String str, String str2) {
        ...
        if (f.a(strOptString)) {
            b.b(f5021a, "a signature was not found in the receipt for request ID " + str2);
        ...
        try {
            ...
            b.a(f5021a, "stringToVerify/legacy:\n" + str3 + "\nsignature:\n" + strOptString);
            if (zA) {
                return receiptA;
            }
    ...
    private static Receipt e(JSONObject jSONObject, String str, String str2) {
        ...
        try {
            ...
            String strOptString6 = jSONObject.optString(com.amazon.a.a.o.b.f4551e);
    ...
    private static Receipt a(JSONObject jSONObject) throws JSONException {
        ...
        String strOptString3 = jSONObject.optString(com.amazon.a.a.o.b.f4550d);
    ...
    public static JSONObject a(Receipt receipt, String str) {
        ...
        if (receipt != null && !f.a(str)) {
            try {
                ...
                jSONObject.put(com.amazon.a.a.o.b.f4557k, receipt.getProductType());
                jSONObject.put(com.amazon.a.a.o.b.Q, receipt.getPurchaseDate());
                jSONObject.put(com.amazon.a.a.o.b.f4550d, receipt.getCancelDate());
                jSONObject.put("signature", str);
                return jSONObject;
            } catch (JSONException unused) {
                b.b(f5021a, "Failure during toJsonInternal: " + receipt + ", signature:" + str);
            }
        }
        return jSONObject;
    }
    ...
    public static List<Receipt> a(String str, String str2, String str3) {
        ...
        for (int i10 = 0; i10 < jSONArray.length(); i10++) {
            try {
                ...
                b.b(f5021a, "fail to parse receipt, requestId:" + e10.a());
                throw e10;
            } catch (com.amazon.device.iap.internal.a.f e11) {
                b.b(f5021a, "fail to verify receipt, requestId:" + e11.a());
                throw e11;
            } catch (Throwable th) {
                b.b(f5021a, "fail to verify receipt, requestId:" + th.getMessage());
                throw th;
            }
        }
        return arrayList;
