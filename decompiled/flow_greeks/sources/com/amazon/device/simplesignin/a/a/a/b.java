...
public class b extends c {
    ...
    private static final String f5058b = "SSI_GetUserAndLinks";

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static final String f5059c = "1.0";

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private static final String f5060d = "b";

    public b(a aVar, String str) {
        super(aVar, f5058b, "1.0");
        super.a(com.amazon.device.simplesignin.a.a.a.f5032a, str);
    }
    ...
    public boolean b(j jVar) {
        Map mapB = jVar.b();
        if (!mapB.containsKey(com.amazon.device.simplesignin.a.a.a.f5033b) || !mapB.containsKey(com.amazon.device.simplesignin.a.a.a.f5034c)) {
            a(RequestStatus.FAILURE);
            return false;
        }
        String str = (String) mapB.get(com.amazon.device.simplesignin.a.a.a.f5033b);
        String str2 = (String) mapB.get(com.amazon.device.simplesignin.a.a.a.f5034c);
