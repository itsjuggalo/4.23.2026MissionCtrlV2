...
public class a {
                ...
                for (X509Certificate x509Certificate : acceptedIssuers) {
                    if (a(x509Certificate)) {
                        if (com.amazon.a.a.o.c.f4603a) {
                            f4573a.a("Trusted Cert: " + x509Certificate.getSubjectX500Principal().getName());
                        }
                        this.f4579e.add(new TrustAnchor(x509Certificate, null));
                        i10++;
                    }
                }
                if (com.amazon.a.a.o.c.f4603a) {
                    f4573a.a(String.format("loaded %d certs\n", Integer.valueOf(i10)));
                }
            }
        }
        if (this.f4579e.isEmpty()) {
            f4573a.b("TrustManager did not return valid accepted issuers, likely 3P custom TrustManager implementation issue.");
        }
        PKIXParameters pKIXParameters = new PKIXParameters(this.f4579e);
        this.f4577c = pKIXParameters;
        pKIXParameters.setRevocationEnabled(false);
        this.f4578d = CertPathValidator.getInstance(f4574b);
    }
    ...
    public static boolean a(X509Certificate x509Certificate) {
        try {
            ...
            if (a(f4575f, bArrDigest)) {
                return true;
            }
            return a(f4576g, bArrDigest);
        } catch (NoSuchAlgorithmException e10) {
            f4573a.b("Signature algorithm unrecognized", e10);
            return false;
        } catch (CertificateEncodingException e11) {
            f4573a.b("Cant get fingerprint", e11);
            return false;
        }
    }
    ...
    public boolean a(CertPath certPath) {
        try {
            ...
            f4573a.a("Verifying CertPath with " + notBefore);
            this.f4577c.setDate(notBefore);
            this.f4578d.validate(certPath, this.f4577c);
            return true;
        } catch (Exception e10) {
            if (com.amazon.a.a.o.c.f4603a) {
                f4573a.b("Failed to verify cert path: " + e10, e10);
            }
            return false;
        }
    }
