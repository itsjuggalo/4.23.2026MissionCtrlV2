...
public class FlutterLocalNotificationsPlugin implements MethodChannel.MethodCallHandler, PluginRegistry.NewIntentListener, PluginRegistry.RequestPermissionsResultListener, PluginRegistry.ActivityResultListener, FlutterPlugin, ActivityAware {
    ...
    private com.dexterous.flutterlocalnotifications.h callback;
    private MethodChannel channel;
    private Activity mainActivity;
    private h permissionRequestProgress = h.None;

    /* JADX INFO: compiled from: r8-map-id-f7c0ba7912e30bee969b60fc55dfe505a38d9b7b2320734346e2a4068d44c6f7 */
    public class a extends fb.a<ArrayList<NotificationDetails>> {
    }

    /* JADX INFO: compiled from: r8-map-id-f7c0ba7912e30bee969b60fc55dfe505a38d9b7b2320734346e2a4068d44c6f7 */
    public class b implements com.dexterous.flutterlocalnotifications.h {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public final /* synthetic */ MethodChannel.Result f5315a;
        ...
        public void a(String str) {
            this.f5315a.error(FlutterLocalNotificationsPlugin.PERMISSION_REQUEST_IN_PROGRESS_ERROR_CODE, str, null);
        }

        @Override // com.dexterous.flutterlocalnotifications.h
        public void b(boolean z10) {
            this.f5315a.success(Boolean.valueOf(z10));
        }
    }

    /* JADX INFO: compiled from: r8-map-id-f7c0ba7912e30bee969b60fc55dfe505a38d9b7b2320734346e2a4068d44c6f7 */
    public class c implements com.dexterous.flutterlocalnotifications.h {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public final /* synthetic */ MethodChannel.Result f5317a;
        ...
        @Override // com.dexterous.flutterlocalnotifications.h
        public void a(String str) {
            this.f5317a.error(FlutterLocalNotificationsPlugin.PERMISSION_REQUEST_IN_PROGRESS_ERROR_CODE, str, null);
        }

        @Override // com.dexterous.flutterlocalnotifications.h
        public void b(boolean z10) {
            this.f5317a.success(Boolean.valueOf(z10));
        }
    }

    /* JADX INFO: compiled from: r8-map-id-f7c0ba7912e30bee969b60fc55dfe505a38d9b7b2320734346e2a4068d44c6f7 */
    public class d implements com.dexterous.flutterlocalnotifications.h {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public final /* synthetic */ MethodChannel.Result f5319a;
        ...
        @Override // com.dexterous.flutterlocalnotifications.h
        public void a(String str) {
            this.f5319a.error(FlutterLocalNotificationsPlugin.PERMISSION_REQUEST_IN_PROGRESS_ERROR_CODE, str, null);
        }

        @Override // com.dexterous.flutterlocalnotifications.h
        public void b(boolean z10) {
            this.f5319a.success(Boolean.valueOf(z10));
        }
    }

    /* JADX INFO: compiled from: r8-map-id-f7c0ba7912e30bee969b60fc55dfe505a38d9b7b2320734346e2a4068d44c6f7 */
    public class e implements com.dexterous.flutterlocalnotifications.h {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public final /* synthetic */ MethodChannel.Result f5321a;
        ...
        @Override // com.dexterous.flutterlocalnotifications.h
        public void a(String str) {
            this.f5321a.error(FlutterLocalNotificationsPlugin.PERMISSION_REQUEST_IN_PROGRESS_ERROR_CODE, str, null);
        }

        @Override // com.dexterous.flutterlocalnotifications.h
        public void b(boolean z10) {
            this.f5321a.success(Boolean.valueOf(z10));
        }
    }
    ...
    public static /* synthetic */ class f {
        ...
        public static final /* synthetic */ int[] f5325c;
        ...
        static {
            ...
            try {
                f5325c[NotificationStyle.BigText.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f5325c[NotificationStyle.Inbox.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f5325c[NotificationStyle.Messaging.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f5325c[NotificationStyle.Media.ordinal()] = 5;
            ...
            try {
                f5324b[IconSource.BitmapFilePath.ordinal()] = 2;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f5324b[IconSource.ContentUri.ordinal()] = 3;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f5324b[IconSource.FlutterBitmapAsset.ordinal()] = 4;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f5324b[IconSource.ByteArray.ordinal()] = 5;
            ...
            try {
                f5323a[RepeatInterval.Hourly.ordinal()] = 2;
            } catch (NoSuchFieldError unused12) {
            }
            try {
                f5323a[RepeatInterval.Daily.ordinal()] = 3;
            } catch (NoSuchFieldError unused13) {
            }
            try {
                f5323a[RepeatInterval.Weekly.ordinal()] = 4;
    ...
    private static long calculateRepeatIntervalMilliseconds(NotificationDetails notificationDetails) {
        ...
        int i10 = f.f5323a[notificationDetails.repeatInterval.ordinal()];
        if (i10 == 1) {
            return 60000L;
        }
        if (i10 == 2) {
    ...
    private static Boolean canCreateNotificationChannel(Context context, NotificationChannelDetails notificationChannelDetails) {
        ...
        NotificationChannel notificationChannel = ((NotificationManager) context.getSystemService("notification")).getNotificationChannel(notificationChannelDetails.f5345id);
    ...
    private void cancelAllNotifications(MethodChannel.Result result) {
        ...
        while (it.hasNext()) {
            getAlarmManager(this.applicationContext).cancel(getBroadcastPendingIntent(this.applicationContext, it.next().f5347id.intValue(), intent));
        }
    ...
    private void cancelAllPendingNotifications(MethodChannel.Result result) {
        ...
        Iterator<NotificationDetails> it = arrayListLoadScheduledNotifications.iterator();
        while (it.hasNext()) {
            alarmManager.cancel(getBroadcastPendingIntent(this.applicationContext, it.next().f5347id.intValue(), intent));
        }
        saveScheduledNotifications(this.applicationContext, new ArrayList());
        result.success(null);
    }
    ...
    private static i.C0199i.d createMessage(Context context, MessageDetails messageDetails) {
        String str;
        i.C0199i.d dVar = new i.C0199i.d(messageDetails.text, messageDetails.timestamp.longValue(), buildPerson(context, messageDetails.person));
    ...
    public static Notification createNotification(Context context, NotificationDetails notificationDetails) {
        ...
        if (notificationDetails.actions != null) {
            ...
            for (NotificationAction notificationAction : notificationDetails.actions) {
                ...
                intent.putExtra(NOTIFICATION_ID, notificationDetails.f5347id).putExtra(NOTIFICATION_TAG, notificationDetails.tag).putExtra(ACTION_ID, notificationAction.f5340id).putExtra(CANCEL_NOTIFICATION, notificationAction.cancelNotification).putExtra(PAYLOAD, notificationDetails.payload);
                List<NotificationAction.a> list = notificationAction.actionInputs;
                int i12 = (list == null || list.isEmpty()) ? 201326592 : Build.VERSION.SDK_INT >= 31 ? 167772160 : 134217728;
    ...
    private void createNotificationChannelGroup(MethodCall methodCall, MethodChannel.Result result) {
        ...
        if (i10 >= 26) {
            ...
            com.dexterous.flutterlocalnotifications.c.a();
            NotificationChannelGroup notificationChannelGroupA = com.dexterous.flutterlocalnotifications.b.a(notificationChannelGroupDetailsFrom.f5346id, notificationChannelGroupDetailsFrom.name);
            if (i10 >= 28) {
    ...
    private Map<String, Object> describeIcon(IconCompat iconCompat) {
        ...
        map.put(FirebaseAnalytics.Param.SOURCE, Integer.valueOf(iconSource.ordinal()));
    ...
    private Map<String, Object> describePerson(q qVar) {
        ...
        map.put("name", qVar.e());
        map.put("uri", qVar.f());
        map.put("bot", Boolean.valueOf(qVar.g()));
        map.put("important", Boolean.valueOf(qVar.h()));
        map.put("icon", describeIcon(qVar.c()));
        return map;
    }
    ...
    private void getActiveNotificationMessagingStyle(MethodCall methodCall, MethodChannel.Result result) {
        ...
        try {
            ...
            i.C0199i c0199iO = i.C0199i.o(notification);
            if (c0199iO == null) {
                result.success(null);
                return;
            }
            HashMap map2 = new HashMap();
            map2.put("groupConversation", Boolean.valueOf(c0199iO.s()));
            map2.put("person", describePerson(c0199iO.r()));
            map2.put("conversationTitle", c0199iO.p());
            ArrayList arrayList = new ArrayList();
            for (i.C0199i.d dVar : c0199iO.q()) {
                HashMap map3 = new HashMap();
                map3.put("text", dVar.h());
                map3.put(DiagnosticsEntry.TIMESTAMP_KEY, Long.valueOf(dVar.i()));
    ...
    private void getActiveNotifications(MethodChannel.Result result) {
        try {
            ...
            for (StatusBarNotification statusBarNotification : activeNotifications) {
                ...
                map.put(com.amazon.a.a.o.b.S, notification.extras.getCharSequence("android.title"));
    ...
    private void getCallbackHandle(MethodChannel.Result result) {
        result.success(new e4.a(this.applicationContext).c());
    }
    ...
    private static IconCompat getIconFromSource(Context context, Object obj, IconSource iconSource) {
        int i10 = f.f5324b[iconSource.ordinal()];
        if (i10 == 1) {
    ...
    private HashMap<String, Object> getMappedNotificationChannel(NotificationChannel notificationChannel) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            map.put(com.amazon.a.a.o.b.f4549c, notificationChannel.getDescription());
    ...
    private void getNotificationChannels(MethodChannel.Result result) {
        try {
            ...
            while (it.hasNext()) {
                arrayList.add(getMappedNotificationChannel(com.dexterous.flutterlocalnotifications.f.a(it.next())));
            }
            result.success(arrayList);
        } catch (Throwable th) {
    ...
    private void initialize(MethodCall methodCall, MethodChannel.Result result) {
        ...
        if (isValidDrawableResource(this.applicationContext, str, result, INVALID_ICON_ERROR_CODE)) {
            Long lA = f4.a.a(methodCall.argument(DISPATCHER_HANDLE));
            Long lA2 = f4.a.a(methodCall.argument(CALLBACK_HANDLE));
            if (lA != null && lA2 != null) {
                new e4.a(this.applicationContext).e(lA, lA2);
            }
    ...
    private void pendingNotificationRequests(MethodChannel.Result result) {
        ...
        for (NotificationDetails notificationDetails : arrayListLoadScheduledNotifications) {
            HashMap map = new HashMap();
            map.put("id", notificationDetails.f5347id);
            map.put(com.amazon.a.a.o.b.S, notificationDetails.title);
    ...
    private void processForegroundNotificationAction(Intent intent, Map<String, Object> map) {
        if (intent.getBooleanExtra(CANCEL_NOTIFICATION, false)) {
            m.e(this.applicationContext).b(((Integer) map.get(NOTIFICATION_ID)).intValue());
        }
    }
    ...
    public static void removeNotificationFromCache(Context context, Integer num) {
        ...
        while (true) {
            if (!it.hasNext()) {
                break;
            } else if (it.next().f5347id.equals(num)) {
                it.remove();
                break;
            }
        }
    ...
    private void repeat(MethodCall methodCall, MethodChannel.Result result) {
        ...
        if (notificationDetailsExtractNotificationDetails != null) {
            try {
                ...
                result.error(e10.f5332a, e10.getMessage(), null);
            }
        }
    }
    ...
    private static void repeatNotification(Context context, NotificationDetails notificationDetails, Boolean bool) {
        ...
        PendingIntent broadcastPendingIntent = getBroadcastPendingIntent(context, notificationDetails.f5347id.intValue(), intent);
    ...
    public static void rescheduleNotifications(Context context) {
        for (NotificationDetails notificationDetails : loadScheduledNotifications(context)) {
            try {
                ...
                removeNotificationFromCache(context, notificationDetails.f5347id);
            }
        }
    }
    ...
    private static void saveScheduledNotification(Context context, NotificationDetails notificationDetails) {
        ...
        for (NotificationDetails notificationDetails2 : arrayListLoadScheduledNotifications) {
            if (!notificationDetails2.f5347id.equals(notificationDetails.f5347id)) {
    ...
    private static void scheduleNotification(Context context, NotificationDetails notificationDetails, Boolean bool) {
        ...
        Intent intent = new Intent(context, (Class<?>) ScheduledNotificationReceiver.class);
        intent.putExtra(NOTIFICATION_DETAILS, strR);
        setupAlarm(notificationDetails, getAlarmManager(context), notificationDetails.millisecondsSinceEpoch.longValue(), getBroadcastPendingIntent(context, notificationDetails.f5347id.intValue(), intent));
        if (bool.booleanValue()) {
            saveScheduledNotification(context, notificationDetails);
        }
    }
    ...
    /* JADX WARN: Type inference failed for: r0v0, types: [h0.i$h, h0.i$j] */
    /* JADX WARN: Type inference failed for: r2v2, types: [java.lang.String] */
    /* JADX WARN: Type inference failed for: r2v3, types: [java.lang.CharSequence] */
    /* JADX WARN: Type inference failed for: r2v4, types: [android.text.Spanned] */
    /* JADX WARN: Type inference failed for: r5v0, types: [h0.i$e] */
    ...
    private static void setMessagingStyle(Context context, NotificationDetails notificationDetails, i.e eVar) {
        ...
        i.C0199i c0199i = new i.C0199i(buildPerson(context, messagingStyleInformation.person));
        c0199i.u(BooleanUtils.getValue(messagingStyleInformation.groupConversation));
        ...
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            while (it.hasNext()) {
                c0199i.n(createMessage(context, it.next()));
            }
        }
        eVar.J(c0199i);
    }
    ...
    private static void setStyle(Context context, NotificationDetails notificationDetails, i.e eVar) {
        int i10 = f.f5325c[notificationDetails.style.ordinal()];
        if (i10 == 1) {
    ...
    private static void setupAlarm(NotificationDetails notificationDetails, AlarmManager alarmManager, long j10, PendingIntent pendingIntent) {
        ...
        if (notificationDetails.scheduleMode.useExactAlarm()) {
            ...
            h0.c.c(alarmManager, 0, j10, pendingIntent);
        } else if (!notificationDetails.scheduleMode.useAlarmClock()) {
            alarmManager.set(0, j10, pendingIntent);
        } else {
            checkCanScheduleExactAlarms(alarmManager);
            h0.c.a(alarmManager, j10, pendingIntent, pendingIntent);
        }
    }
    ...
    private static void setupAllowWhileIdleAlarm(NotificationDetails notificationDetails, AlarmManager alarmManager, long j10, PendingIntent pendingIntent) {
        if (notificationDetails.scheduleMode.useExactAlarm()) {
            checkCanScheduleExactAlarms(alarmManager);
            h0.c.d(alarmManager, 0, j10, pendingIntent);
        } else if (!notificationDetails.scheduleMode.useAlarmClock()) {
            h0.c.b(alarmManager, 0, j10, pendingIntent);
        } else {
            checkCanScheduleExactAlarms(alarmManager);
            h0.c.a(alarmManager, j10, pendingIntent, pendingIntent);
        }
    ...
    private static void setupNotificationChannel(Context context, NotificationChannelDetails notificationChannelDetails) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            com.dexterous.flutterlocalnotifications.e.a();
            NotificationChannel notificationChannelA = com.dexterous.flutterlocalnotifications.d.a(notificationChannelDetails.f5345id, notificationChannelDetails.name, notificationChannelDetails.importance.intValue());
    ...
    public static void showNotification(Context context, NotificationDetails notificationDetails) {
        ...
        if (str != null) {
            notificationManager.i(str, notificationDetails.f5347id.intValue(), notificationCreateNotification);
        } else {
            notificationManager.h(notificationDetails.f5347id.intValue(), notificationCreateNotification);
        }
    }
    ...
    private void startForegroundService(MethodCall methodCall, MethodChannel.Result result) {
        ...
        if (notificationDetailsExtractNotificationDetails != null) {
            if (notificationDetailsExtractNotificationDetails.f5347id.intValue() == 0) {
                result.error("ARGUMENT_ERROR", "The id of the notification for a foreground service must not be 0!", null);
                return;
            }
            com.dexterous.flutterlocalnotifications.g gVar = new com.dexterous.flutterlocalnotifications.g(notificationDetailsExtractNotificationDetails, num.intValue(), arrayList);
            ...
            i0.a.o(this.applicationContext, intent);
            result.success(null);
        }
    }
    ...
    private static void zonedScheduleNotification(Context context, NotificationDetails notificationDetails, Boolean bool) {
        ...
        Intent intent = new Intent(context, (Class<?>) ScheduledNotificationReceiver.class);
        intent.putExtra(NOTIFICATION_DETAILS, strR);
        setupAlarm(notificationDetails, getAlarmManager(context), ZonedDateTime.of(LocalDateTime.parse(notificationDetails.scheduledDateTime), ZoneId.of(notificationDetails.timeZoneName)).toInstant().toEpochMilli(), getBroadcastPendingIntent(context, notificationDetails.f5347id.intValue(), intent));
        if (bool.booleanValue()) {
            saveScheduledNotification(context, notificationDetails);
        }
    }
    ...
    public void requestExactAlarmsPermission(com.dexterous.flutterlocalnotifications.h hVar) {
        h hVar2 = this.permissionRequestProgress;
        h hVar3 = h.None;
        if (hVar2 != hVar3) {
            hVar.a(PERMISSION_REQUEST_IN_PROGRESS_ERROR_MESSAGE);
            return;
        }
        this.callback = hVar;
        if (Build.VERSION.SDK_INT < 31) {
    ...
    public void requestFullScreenIntentPermission(com.dexterous.flutterlocalnotifications.h hVar) {
        h hVar2 = this.permissionRequestProgress;
        h hVar3 = h.None;
        if (hVar2 != hVar3) {
            hVar.a(PERMISSION_REQUEST_IN_PROGRESS_ERROR_MESSAGE);
    ...
    public void requestNotificationPolicyAccess(com.dexterous.flutterlocalnotifications.h hVar) {
        h hVar2 = this.permissionRequestProgress;
        h hVar3 = h.None;
        if (hVar2 != hVar3) {
            hVar.a(PERMISSION_REQUEST_IN_PROGRESS_ERROR_MESSAGE);
    ...
    public void requestNotificationsPermission(com.dexterous.flutterlocalnotifications.h hVar) {
        h hVar2 = this.permissionRequestProgress;
        h hVar3 = h.None;
        if (hVar2 != hVar3) {
            hVar.a(PERMISSION_REQUEST_IN_PROGRESS_ERROR_MESSAGE);
        ...
        if (Build.VERSION.SDK_INT < 33) {
            this.callback.b(m.e(this.mainActivity).a());
        } else if (i0.a.a(this.mainActivity, "android.permission.POST_NOTIFICATIONS") == 0) {
            this.callback.b(true);
            this.permissionRequestProgress = hVar3;
        } else {
            this.permissionRequestProgress = h.RequestingNotificationPermission;
            h0.a.r(this.mainActivity, new String[]{"android.permission.POST_NOTIFICATIONS"}, 1);
        }
    }
}
