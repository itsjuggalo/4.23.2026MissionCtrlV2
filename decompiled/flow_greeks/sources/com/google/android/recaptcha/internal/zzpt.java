...
final class zzpt {
    public static /* bridge */ /* synthetic */ void zza(byte b10, byte b11, byte b12, byte b13, char[] cArr, int i10) throws zznn {
    ...
    */
    ...
    public static /* bridge */ /* synthetic */ void zzc(byte b10, byte b11, char[] cArr, int i10) throws zznn {
        if (b10 < -62 || zze(b11)) {
            throw new zznn("Protocol message had invalid UTF-8.");
        }
