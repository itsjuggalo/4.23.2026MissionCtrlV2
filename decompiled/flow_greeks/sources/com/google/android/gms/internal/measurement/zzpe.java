...
public final class zzpe implements zzpd {
    ...
    static {
        ...
        zzQ = zzkgVarZzb.zzc("measurement.sgtm.upload.min_delay_after_background", HTTPTimeoutManager.TIMEOUT_RESET_INTERVAL_MS);
        ...
        zzT = zzkgVarZzb.zzc("measurement.sgtm.upload.retry_interval", HTTPTimeoutManager.TIMEOUT_RESET_INTERVAL_MS);
