...
public abstract class zzkm {
    ...
    static {
        new AtomicReference();
        n.o(zzkk.zza, "BuildInfo must be non-null");
    ...
    */
    public static void zzb(final android.content.Context r3) {
        ...
        L2e:
            ...
            p6.s r1 = p6.t.a(r1)     // Catch: java.lang.Throwable -> L21
    ...
    /* JADX WARN: Removed duplicated region for block: B:16:0x004a A[PHI: r2
      0x004a: PHI (r2v1 p6.k) = (r2v0 p6.k), (r2v0 p6.k), (r2v7 p6.k) binds: [B:8:0x0016, B:10:0x001c, B:12:0x0032] A[DONT_GENERATE, DONT_INLINE]] */
