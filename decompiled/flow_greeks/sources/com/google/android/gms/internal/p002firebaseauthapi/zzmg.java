        ...
        if (zzkgVar.zze().equals(zzkg.zzf.zzd)) {
            ...
            if (iOrdinal != 0) {
                if (iOrdinal == 1) {
                    int i10 = iZza + 1;
                    bArr = new byte[i10];
                    byte[] bArrZza2 = zzne.zza(w10.getAffineX());
                ...
                int i12 = (iZza * 2) + 1;
                bArr = new byte[i12];
                byte[] bArrZza5 = zzne.zza(w10.getAffineX());
                byte[] bArrZza6 = zzne.zza(w10.getAffineY());
