...
public final class zzaen {
    ...
    */
    public static a7.m zza(com.google.android.gms.common.api.Status r3) {
        /*
            Method dump skipped, instruction units count: 556
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p002firebaseauthapi.zzaen.zza(com.google.android.gms.common.api.Status):a7.m");
    }
    ...
    public static m zza(Status status, h hVar, String str, String str2) {
        int iS = status.S();
        if (iS != 17012 && iS != 17007 && iS != 17025) {
            return zza(status);
        }
        return new x(zza(iS), zza(zzb(iS), status)).e(hVar).d(str);
    }

    public static u zza(FirebaseAuth firebaseAuth, zzaas zzaasVar, a0 a0Var) {
        zzu.zza(firebaseAuth);
        zzu.zza(zzaasVar);
        Pair<String, String> pair = zza.get(17078);
        return new u((String) pair.first, (String) pair.second, o.W(zzaasVar, firebaseAuth, a0Var));
    }
    ...
    private static String zza(String str, Status status) {
        if (TextUtils.isEmpty(status.T())) {
            return str;
        }
        return String.format(str + " [ %s ]", status.T());
    }
