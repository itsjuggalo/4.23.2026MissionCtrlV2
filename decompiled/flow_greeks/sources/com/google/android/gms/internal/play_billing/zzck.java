...
abstract class zzck<V> extends zzdf implements zzcz<V> {
    ...
    static {
        ...
        zza zzcVar;
        try {
            z10 = Boolean.parseBoolean(System.getProperty("guava.concurrent.generate_cancellation_cause", b.f4546ag));
        } catch (SecurityException unused) {
            z10 = false;
        }
        zzc = z10;
    ...
    public final Object zzm(long j10, TimeUnit timeUnit) throws InterruptedException, TimeoutException {
        ...
        if (nanos + 1000 < 0) {
            ...
            if (jConvert > 0) {
                ...
                if (z10) {
                    strConcat3 = strConcat3.concat(f.f4598a);
                }
