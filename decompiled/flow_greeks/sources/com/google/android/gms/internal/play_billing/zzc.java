...
public final class zzc {
    ...
    public static Bundle zzf(String str, String str2, ArrayList arrayList, String str3, String str4, zza zzaVar, long j10) {
        ...
        bundle.putBoolean(b.f4542ac, true);
        ...
        for (int i10 = 0; i10 < size; i10++) {
            t.b bVar = (t.b) arrayList.get(i10);
            arrayList2.add(null);
    ...
    public static com.android.billingclient.api.a zzh(Intent intent, String str) {
        if (intent != null) {
            a.C0091a c0091aD = com.android.billingclient.api.a.d();
            c0091aD.d(zzb(intent.getExtras(), str));
            c0091aD.b(zzj(intent.getExtras(), str));
            return c0091aD.a();
        }
        zzn("BillingHelper", "Got null intent!");
        a.C0091a c0091aD2 = com.android.billingclient.api.a.d();
        c0091aD2.d(6);
        c0091aD2.b("An internal error occurred.");
        return c0091aD2.a();
    }

    public static n zzi(Bundle bundle, String str) {
        return bundle == null ? new n(0, null) : new n(zzp(bundle, "BillingClient"), bundle.getString("IN_APP_MESSAGE_PURCHASE_TOKEN"));
    }
