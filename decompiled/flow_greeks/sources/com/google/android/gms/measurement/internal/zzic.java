...
public final class zzic implements zzjg {
    ...
    public zzic(zzjs zzjsVar) {
        ...
        this.zza = l10 != null ? l10.longValue() : eVarD.a();
    ...
    public final boolean zzH() {
        ...
        if (bool == null || this.zzz == 0 || (!bool.booleanValue() && Math.abs(this.zzm.b() - this.zzz) > 1000)) {
            this.zzz = this.zzm.b();
            ...
            if (zzppVar.zzY("android.permission.INTERNET")) {
                ...
                if (zzppVar.zzY("android.permission.ACCESS_NETWORK_STATE")) {
                    ...
                    if (d.a(context).f() || this.zzf.zzE() || (zzpp.zzau(context) && zzpp.zzQ(context, false))) {
                        z10 = true;
                    }
                }
            }
