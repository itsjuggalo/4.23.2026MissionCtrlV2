...
public final class zzjd extends zzga {
    ...
    private final void zzO(String str, boolean z10) {
            ...
            try {
                if (this.zzb == null) {
                    ...
                    if (!"com.google.android.gms".equals(this.zzc)) {
                        zzpg zzpgVar = this.zza;
                        if (!q.a(zzpgVar.zzaY(), Binder.getCallingUid()) && !l.a(zzpgVar.zzaY()).c(Binder.getCallingUid())) {
                            z11 = false;
                        }
                    }
        ...
        if (this.zzc == null && j.k(this.zza.zzaY(), Binder.getCallingUid(), str)) {
            this.zzc = str;
        }
    ...
    public final void zzB(zzr zzrVar, final zzoo zzooVar, final zzgh zzghVar) {
        zzN(zzrVar, false);
        final String str = (String) s.k(zzrVar.zza);
            ...
            if (zzpgVar.zzO(str, zzpjVar.zze())) {
                ...
                if (iZzi > 0) {
                    if (iZzi <= ((Integer) zzfy.zzy.zzb(null)).intValue()) {
                        if (zzpgVar.zzaZ().a() >= zzpjVar.zzh() + Math.min(((Long) zzfy.zzw.zzb(null)).longValue() * (1 << (iZzi - 1)), ((Long) zzfy.zzx.zzb(null)).longValue())) {
                        }
                    }
    ...
    public final /* synthetic */ void zzJ(zzr zzrVar, zzaf zzafVar) {
        zzpg zzpgVar = this.zza;
        zzpgVar.zzZ();
        zzpgVar.zzar((String) s.k(zzrVar.zza), zzafVar);
    }
    ...
    public final /* synthetic */ void zzK(Bundle bundle, String str, zzr zzrVar) {
        ...
        if (bundle.isEmpty() && zZzp) {
            ...
            try {
                ...
                zzavVarZzj.zzu.zzaV().zzb().zzb("Error clearing default event params", e10);
                return;
            }
        }
        ...
        try {
            ...
            zzavVarZzj2.zzu.zzaV().zzb().zzc("Error storing default event parameters. appId", zzgu.zzl(str), e11);
        }
        zzpg zzpgVar2 = this.zza;
        zzav zzavVarZzj3 = zzpgVar2.zzj();
        long j10 = zzrVar.zzD;
        if (zzavVarZzj3.zzV(str, j10)) {
    ...
    public final byte[] zzk(zzbg zzbgVar, String str) {
        ...
        long jC = zzpgVar.zzaZ().c() / 1000000;
        try {
            ...
            zzpgVar.zzaV().zzj().zzd("Log and bundle processed. event, size, time_ms", zzpgVar.zzs().zza(str2), Integer.valueOf(bArr.length), Long.valueOf((zzpgVar.zzaZ().c() / 1000000) - jC));
            return bArr;
        } catch (InterruptedException e10) {
            e = e10;
            zzpg zzpgVar2 = this.zza;
