...
public final class zzlq extends zzg {
    ...
    public final void zzh(long j10) {
        ...
        zzicVar.zzaV().zzk().zzb("[sgtm] Scion upload job scheduled with result", ((JobScheduler) s.k(this.zza)).schedule(new JobInfo.Builder(zzi(), new ComponentName(zzicVar.zzaY(), "com.google.android.gms.measurement.AppMeasurementJobService")).setRequiredNetworkType(1).setMinimumLatency(j10).setOverrideDeadline(j10 + j10).setExtras(persistableBundle).build()) == 1 ? "SUCCESS" : "FAILURE");
    }
