...
final class zzav extends zzos {
    ...
    */
    ...
    private final void zzaB(String str, String str2, ContentValues contentValues) {
        try {
            ...
            sb2.append("app_id");
            sb2.append(" = ?");
            if (sQLiteDatabaseZze.update("consent_settings", contentValues, sb2.toString(), new String[]{r2}) == 0 && sQLiteDatabaseZze.insertWithOnConflict("consent_settings", null, contentValues, 5) == -1) {
    ...
    */
        ...
        try {
            ...
            if (str3 != null) {
                ...
                while (true) {
                    ...
                    String[] strArrSplit2 = str4.split(f.f4599b, 2);
    ...
    public final long zzA(String str, com.google.android.gms.internal.measurement.zzib zzibVar, String str2, Map map, zzls zzlsVar, Long l10) {
        ...
        if (zzag()) {
            ...
            long jAbs = Math.abs(jB - jZza);
            zzicVar.zzc();
            if (jAbs > zzal.zzJ()) {
                zzpgVar.zzq().zzb.zzb(jB);
                zzg();
                zzaw();
        ...
        contentValues.put(AppMeasurementSdk.ConditionalUserProperty.CREATION_TIMESTAMP, Long.valueOf(zzicVar2.zzaZ().a()));
    ...
    */
    public final com.google.android.gms.measurement.internal.zzpj zzB(long r19) throws java.lang.Throwable {
        ...
        L42:
            ...
            java.lang.Object r0 = com.google.android.gms.common.internal.s.k(r0)     // Catch: java.lang.Throwable -> L84 android.database.sqlite.SQLiteException -> L86
            r4 = r0
    ...
    */
    ...
    public final void zzI() {
        ...
        if (zzag()) {
            ...
            zzicVar.zzc();
            if (jAbs > zzal.zzJ()) {
                zzpgVar.zzq().zza.zzb(jB);
                zzg();
                zzaw();
                if (zzag()) {
                    SQLiteDatabase sQLiteDatabaseZze = zze();
                    String strValueOf = String.valueOf(zzicVar.zzaZ().a());
                    zzicVar.zzc();
    ...
    public final void zzJ(List list) {
        ...
        s.m(list.size());
        if (zzag()) {
            String strJoin = TextUtils.join(f.f4598a, list);
    ...
    */
    ...
    public final boolean zzY(String str, zzoh zzohVar) {
        ...
        long jLongValue = jA - ((Long) zzfxVar.zzb(null)).longValue();
        long j10 = zzohVar.zzb;
        if (j10 < jLongValue || j10 > ((Long) zzfxVar.zzb(null)).longValue() + jA) {
            zzicVar.zzaV().zze().zzd("Storing trigger URI outside of the max retention time span. appId, now, timestamp", zzgu.zzl(str), Long.valueOf(jA), Long.valueOf(j10));
        }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:114:0x037e, code lost:
        ...
        zzaw();
        zzg();
        com.google.android.gms.common.internal.s.e(r23);
        r0 = zze();
                    ...
                    if (cursorQuery.moveToFirst()) {
                        while (true) {
                            ...
                            if (objZzL == null) {
                                ...
                                str2 = str;
                                try {
                                    arrayList.add(new zzpn(str2, str3, string, j10, objZzL));
                                } catch (SQLiteException e10) {
                                    e = e10;
    ...
    */
    ...
    public final boolean zzp(zzah zzahVar) {
        ...
        zzau(contentValues, "value", s.k(zzahVar.zzc.zza()));
    ...
    public final void zzv(zzh zzhVar, boolean z10, boolean z11) {
        ...
        if (listZzag != null) {
            if (listZzag.isEmpty()) {
                ...
                contentValues.put("safelisted_events", TextUtils.join(f.f4598a, listZzag));
            }
        }
        zzpr.zza();
