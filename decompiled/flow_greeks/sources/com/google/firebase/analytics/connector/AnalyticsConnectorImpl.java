...
public class AnalyticsConnectorImpl implements AnalyticsConnector {
    ...
    public static /* synthetic */ void zza(a aVar) {
        boolean z10 = ((b) aVar.a()).f306a;
        synchronized (AnalyticsConnectorImpl.class) {
            ((AnalyticsConnectorImpl) s.k(zzc)).zza.zza(z10);
        }
    }
    ...
    public List<AnalyticsConnector.ConditionalUserProperty> getConditionalUserProperties(String str, String str2) {
        ...
        for (Bundle bundle : this.zza.getConditionalUserProperties(str, str2)) {
            ...
            conditionalUserProperty.origin = (String) s.k((String) zzjh.zzb(bundle, "origin", String.class, null));
            conditionalUserProperty.name = (String) s.k((String) zzjh.zzb(bundle, "name", String.class, null));
    ...
    public static AnalyticsConnector getInstance(g gVar) {
        return (AnalyticsConnector) gVar.k(AnalyticsConnector.class);
    }
            ...
            synchronized (AnalyticsConnectorImpl.class) {
                try {
                    if (zzc == null) {
                        ...
                        if (gVar.y()) {
                            dVar.d(b.class, zzb.zza, zza.zza);
