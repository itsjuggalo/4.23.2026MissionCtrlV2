...
public class m0 {
    ...
    public final Bundle f6373a;

    public m0(Bundle bundle) {
        if (bundle == null) {
            throw new NullPointerException("data");
        }
        this.f6373a = new Bundle(bundle);
    }
    ...
    public String p(String str) {
        return this.f6373a.getString(w(str));
    }
    ...
    public final String w(String str) {
        if (!this.f6373a.containsKey(str) && str.startsWith("gcm.n.")) {
            String strV = v(str);
            if (this.f6373a.containsKey(strV)) {
                return strV;
            }
        }
        return str;
    ...
    public Bundle x() {
        Bundle bundle = new Bundle(this.f6373a);
