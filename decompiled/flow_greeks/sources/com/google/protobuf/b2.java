...
public interface b2 {
    ...
    void J(int i10, List list, m1 m1Var);

    void K(int i10, List list, m1 m1Var);

    void L(int i10, Object obj, m1 m1Var);

    void M(int i10, Object obj, m1 m1Var);

    void N(int i10, i iVar);

    void O(int i10, n0.a aVar, Map map);
