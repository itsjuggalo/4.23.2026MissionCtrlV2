...
public abstract class f {
    ...
    public static final int[] f24249a = {0, 3, 6, 9, 12, 16, 19, 22, 25, 28};

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static final int[] f24250b = {0, 2, 3, 5, 6, 0, 1, 3, 4, 6};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public static final int[] f24251c = {67108863, 33554431};

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public static final int[] f24252d = {26, 25};
    ...
    public static byte[] a(long[] jArr) {
        ...
        for (int i17 = 0; i17 < 2; i17++) {
            ...
            while (i18 < 9) {
                ...
                int i19 = i18 & 1;
                int i20 = (int) (j13 >> f24252d[i19]);
                jArrCopyOf[i18] = j13 & ((long) f24251c[i19]);
                i18++;
        ...
        for (int i21 = 1; i21 < 10; i21++) {
            iD &= b((int) jArrCopyOf[i21], f24251c[i21 & 1]);
        }
        ...
        for (int i23 = 0; i23 < 10; i23++) {
            jArrCopyOf[i23] = jArrCopyOf[i23] << f24250b[i23];
        }
    ...
    public static long[] c(byte[] bArr) {
        ...
        for (int i10 = 0; i10 < 10; i10++) {
            int i11 = f24249a[i10];
            jArr[i10] = ((((((long) (bArr[i11] & 255)) | (((long) (bArr[i11 + 1] & 255)) << 8)) | (((long) (bArr[i11 + 2] & 255)) << 16)) | (((long) (bArr[i11 + 3] & 255)) << 24)) >> f24250b[i10]) & ((long) f24251c[i10 & 1]);
        }
        return jArr;
    }
