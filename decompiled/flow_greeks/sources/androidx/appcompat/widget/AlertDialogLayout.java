    ...
    */
    public final void g(int r10, int r11) {
        ...
        L3b:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.widget.AlertDialogLayout.g(int, int):void");
    }
    ...
    public final boolean x(int i10, int i11) {
        ...
        for (int i12 = 0; i12 < childCount; i12++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id2 == e.f9735r) {
                    view = childAt;
                } else if (id2 == e.f9724g) {
                    view2 = childAt;
                } else {
                    if ((id2 != e.f9726i && id2 != e.f9727j) || view3 != null) {
                        return false;
                    }
                    view3 = childAt;
                }
        ...
        if (view2 != null) {
            int i14 = paddingTop - iW;
            int iMin = Math.min(i13, measuredHeight);
            if (iMin > 0) {
                i13 -= iMin;
                iW += iMin;
            }
            view2.measure(i10, View.MeasureSpec.makeMeasureSpec(iW, 1073741824));
