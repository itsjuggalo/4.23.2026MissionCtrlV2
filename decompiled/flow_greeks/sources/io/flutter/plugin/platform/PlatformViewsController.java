...
public class PlatformViewsController implements PlatformViewsAccessibilityDelegate {
            ...
            if (PlatformViewsController.this.usesVirtualDisplay(i10)) {
                ...
                virtualDisplayController.resize(physicalPixels, physicalPixels2, new Runnable() { // from class: io.flutter.plugin.platform.h
                    ...
                    public final void run() {
                        PlatformViewsController.AnonymousClass1.a(this.f12581a, virtualDisplayController, displayDensity, platformViewBufferResized);
                    }
                });
                return;
            }
    ...
    private static PlatformViewRenderTarget makePlatformViewRenderTarget(TextureRegistry textureRegistry) {
        ...
        if (enableSurfaceProducerRenderTarget && (i10 = Build.VERSION.SDK_INT) >= 29) {
            TextureRegistry.SurfaceProducer surfaceProducerCreateSurfaceProducer = textureRegistry.createSurfaceProducer(i10 <= 34 ? TextureRegistry.SurfaceLifecycle.resetInBackground : TextureRegistry.SurfaceLifecycle.manual);
    ...
    public long configureForTextureLayerComposition(PlatformView platformView, final PlatformViewCreationRequest platformViewCreationRequest) {
        ...
        platformViewWrapper.setOnDescendantFocusChangeListener(new View.OnFocusChangeListener() { // from class: io.flutter.plugin.platform.e
            ...
            public final void onFocusChange(View view2, boolean z10) {
                PlatformViewsController.a(this.f12576a, platformViewCreationRequest, view2, z10);
            }
        });
    ...
    public boolean initializePlatformViewIfNeeded(final int i10) {
        ...
        flutterMutatorView.setOnDescendantFocusChangeListener(new View.OnFocusChangeListener() { // from class: io.flutter.plugin.platform.d
            @Override // android.view.View.OnFocusChangeListener
            public final void onFocusChange(View view2, boolean z10) {
                PlatformViewsController.d(this.f12574a, i10, view2, z10);
            }
        });
    ...
    public void onEndFrame() {
        ...
        if (this.flutterViewConvertedToImageView && this.currentFrameUsedPlatformViewIds.isEmpty()) {
            ...
            this.flutterView.revertImageView(new Runnable() { // from class: io.flutter.plugin.platform.g
                @Override // java.lang.Runnable
                public final void run() {
                    this.f12580a.finishFrame(false);
                }
            });
        } else {
