...
public class TextInputPlugin implements ListenableEditingState.EditingStateWatcher {
    ...
    public TextInputPlugin(View view, TextInputChannel textInputChannel, ScribeChannel scribeChannel, PlatformViewsController platformViewsController, PlatformViewsController2 platformViewsController2) {
        ...
        if (i10 >= 26) {
            this.afm = d.a(view.getContext().getSystemService(c.a()));
        } else {
            this.afm = null;
        }
        if (i10 >= 30) {
    ...
    */
    ...
    public void autofill(SparseArray<AutofillValue> sparseArray) {
        ...
        for (int i10 = 0; i10 < sparseArray.size(); i10++) {
            ...
            if (configuration2 != null && (autofill2 = configuration2.autofill) != null) {
                String string = e.a(sparseArray.valueAt(i10)).getTextValue().toString();
        ...
        this.textInputChannel.updateEditingStateWithTag(this.inputTarget.f12571id, map);
    }
    ...
    public void clearPlatformViewClient(int i10) {
        ...
        if ((type == InputTarget.Type.VIRTUAL_DISPLAY_PLATFORM_VIEW || type == InputTarget.Type.PHYSICAL_DISPLAY_PLATFORM_VIEW) && inputTarget.f12571id == i10) {
    ...
    public void clearTextInputClient() {
        ...
        j0 j0VarT = c0.t(this.mView);
        if (j0VarT == null || j0VarT.o(j0.n.c())) {
            return;
        }
        this.mImm.restartInput(this.mView);
    }
    ...
    public InputConnection createInputConnection(View view, KeyboardManager keyboardManager, EditorInfo editorInfo) {
        ...
        if (type == InputTarget.Type.VIRTUAL_DISPLAY_PLATFORM_VIEW) {
            ...
            InputConnection inputConnectionOnCreateInputConnection = this.platformViewsController.getPlatformViewById(inputTarget.f12571id).onCreateInputConnection(editorInfo);
        ...
        if (strArr != null) {
            v0.a.c(editorInfo, strArr);
        }
        if (i10 >= 34) {
            v0.a.f(editorInfo, true);
        }
        InputConnectionAdaptor inputConnectionAdaptor = new InputConnectionAdaptor(view, this.inputTarget.f12571id, this.textInputChannel, this.scribeChannel, keyboardManager, this.mEditable, editorInfo);
