...
public class FlutterFirebaseMessagingPlugin implements FlutterFirebasePlugin, MethodChannel.MethodCallHandler, PluginRegistry.NewIntentListener, FlutterPlugin, ActivityAware {
    ...
    private final androidx.lifecycle.p liveDataRemoteMessage = FlutterFirebaseRemoteMessageLiveData.getInstance();
    private final androidx.lifecycle.p liveDataToken = FlutterFirebaseTokenLiveData.getInstance();

    public static /* synthetic */ void a(Map map, TaskCompletionSource taskCompletionSource) {
        try {
            FlutterFirebaseMessagingUtils.getFirebaseMessagingForArguments(map).C(FlutterFirebaseMessagingUtils.getRemoteMessageForArguments(map));
    ...
    public static /* synthetic */ void c(Map map, TaskCompletionSource taskCompletionSource) {
        try {
            ...
            Tasks.await(firebaseMessagingForArguments.J((String) obj));
            taskCompletionSource.setResult(null);
        } catch (Exception e10) {
            taskCompletionSource.setException(e10);
        }
    ...
    public static /* synthetic */ void e(Map map, TaskCompletionSource taskCompletionSource) {
        try {
            ...
            Object obj = map.get("topic");
            Objects.requireNonNull(obj);
            Tasks.await(firebaseMessagingForArguments.M((String) obj));
            taskCompletionSource.setResult(null);
        } catch (Exception e10) {
            taskCompletionSource.setException(e10);
        }
    ...
    private Task<Map<String, Object>> getInitialMessage() {
        ...
        FlutterFirebasePlugin.cachedThreadPool.execute(new Runnable() { // from class: io.flutter.plugins.firebase.messaging.u
            @Override // java.lang.Runnable
            public final void run() {
                this.f13115a.lambda$getInitialMessage$9(taskCompletionSource);
            }
        });
        return taskCompletionSource.getTask();
    }
    ...
    private Task<Map<String, Integer>> getPermissions() {
        ...
        FlutterFirebasePlugin.cachedThreadPool.execute(new Runnable() { // from class: io.flutter.plugins.firebase.messaging.s
            @Override // java.lang.Runnable
            public final void run() {
                this.f13111a.lambda$getPermissions$13(taskCompletionSource);
            }
        });
        return taskCompletionSource.getTask();
    }
    ...
    private Task<Map<String, Object>> getToken() {
        ...
        FlutterFirebasePlugin.cachedThreadPool.execute(new Runnable() { // from class: io.flutter.plugins.firebase.messaging.n
            @Override // java.lang.Runnable
            public final void run() {
                this.f13106a.lambda$getToken$3(taskCompletionSource);
            }
        });
        return taskCompletionSource.getTask();
    }
    ...
    public static /* synthetic */ void k(a7.g gVar, TaskCompletionSource taskCompletionSource) {
        try {
            HashMap map = new HashMap();
            if (gVar.q().equals("[DEFAULT]")) {
                map.put("AUTO_INIT_ENABLED", Boolean.valueOf(FirebaseMessaging.r().A()));
            }
    ...
    /* JADX WARN: Removed duplicated region for block: B:35:0x007c A[PHI: r0
      0x007c: PHI (r0v11 com.google.firebase.messaging.s0) = (r0v8 com.google.firebase.messaging.s0), (r0v13 com.google.firebase.messaging.s0) binds: [B:31:0x0067, B:33:0x0071] A[DONT_GENERATE, DONT_INLINE]] */
    /*
    ...
    */
    public /* synthetic */ void lambda$getInitialMessage$9(com.google.android.gms.tasks.TaskCompletionSource r7) {
        /*
            r6 = this;
            com.google.firebase.messaging.s0 r0 = r6.initialMessage     // Catch: java.lang.Exception -> L13
        ...
        L4a:
            ...
            goto La6
        L55:
            java.util.HashMap<java.lang.String, com.google.firebase.messaging.s0> r0 = io.flutter.plugins.firebase.messaging.FlutterFirebaseMessagingReceiver.notifications     // Catch: java.lang.Exception -> L13
            java.lang.Object r0 = r0.get(r3)     // Catch: java.lang.Exception -> L13
            com.google.firebase.messaging.s0 r0 = (com.google.firebase.messaging.s0) r0     // Catch: java.lang.Exception -> L13
            if (r0 != 0) goto L85
            ...
            if (r4 == 0) goto L7c
            com.google.firebase.messaging.s0 r0 = io.flutter.plugins.firebase.messaging.FlutterFirebaseMessagingUtils.getRemoteMessageForArguments(r4)     // Catch: java.lang.Exception -> L13
        ...
        L8c:
            ...
            com.google.firebase.messaging.s0$c r0 = r0.X()     // Catch: java.lang.Exception -> L13
            if (r0 != 0) goto La2
            if (r4 == 0) goto La2
    ...
    public /* synthetic */ void lambda$getPermissions$13(TaskCompletionSource taskCompletionSource) {
        try {
            HashMap map = new HashMap();
            map.put("authorizationStatus", Integer.valueOf(Build.VERSION.SDK_INT >= 33 ? checkPermissions().booleanValue() : h0.m.e(this.mainActivity).a()));
            taskCompletionSource.setResult(map);
        } catch (Exception e10) {
            taskCompletionSource.setException(e10);
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$initInstance$0(s0 s0Var) {
        this.channel.invokeMethod("Messaging#onMessage", FlutterFirebaseMessagingUtils.remoteMessageToMap(s0Var));
    }
            ...
            if (!checkPermissions().booleanValue()) {
                this.permissionManager.requestPermissions(this.mainActivity, new FlutterFirebasePermissionManager.RequestPermissionsSuccessCallback() { // from class: io.flutter.plugins.firebase.messaging.g
                    ...
                    public final void onSuccess(int i10) {
                        FlutterFirebaseMessagingPlugin.o(map, taskCompletionSource, i10);
                    }
    ...
    public /* synthetic */ void lambda$setAutoInitEnabled$7(Map map, TaskCompletionSource taskCompletionSource) {
        try {
            FirebaseMessaging firebaseMessagingForArguments = FlutterFirebaseMessagingUtils.getFirebaseMessagingForArguments(map);
            Object obj = map.get(io.flutter.plugins.firebase.analytics.Constants.ENABLED);
            Objects.requireNonNull(obj);
            firebaseMessagingForArguments.D(((Boolean) obj).booleanValue());
    ...
    public static /* synthetic */ void m(Map map, TaskCompletionSource taskCompletionSource) {
        try {
            ...
            Object obj = map.get(io.flutter.plugins.firebase.analytics.Constants.ENABLED);
            Objects.requireNonNull(obj);
            firebaseMessagingForArguments.E(((Boolean) obj).booleanValue());
            taskCompletionSource.setResult(null);
        } catch (Exception e10) {
            taskCompletionSource.setException(e10);
        }
    ...
    private Task<Map<String, Integer>> requestPermissions() {
        ...
        FlutterFirebasePlugin.cachedThreadPool.execute(new Runnable() { // from class: io.flutter.plugins.firebase.messaging.l
            @Override // java.lang.Runnable
            public final void run() {
                this.f13102a.lambda$requestPermissions$12(taskCompletionSource);
            }
        });
        return taskCompletionSource.getTask();
    }
    ...
    private Task<Map<String, Object>> setAutoInitEnabled(final Map<String, Object> map) {
        ...
        FlutterFirebasePlugin.cachedThreadPool.execute(new Runnable() { // from class: io.flutter.plugins.firebase.messaging.i
            @Override // java.lang.Runnable
            public final void run() {
                this.f13096a.lambda$setAutoInitEnabled$7(map, taskCompletionSource);
            }
        });
        return taskCompletionSource.getTask();
    }
    ...
    public Task<Map<String, Object>> getPluginConstantsForFirebaseApp(final a7.g gVar) {
        ...
        FlutterFirebasePlugin.cachedThreadPool.execute(new Runnable() { // from class: io.flutter.plugins.firebase.messaging.d
            @Override // java.lang.Runnable
            public final void run() {
                FlutterFirebaseMessagingPlugin.k(gVar, taskCompletionSource);
            }
        });
        return taskCompletionSource.getTask();
    }
    ...
    public void onMethodCall(MethodCall methodCall, final MethodChannel.Result result) {
        ...
        initialMessage.addOnCompleteListener(new OnCompleteListener() { // from class: io.flutter.plugins.firebase.messaging.t
            @Override // com.google.android.gms.tasks.OnCompleteListener
            public final void onComplete(Task task) {
                this.f13113a.lambda$onMethodCall$14(result, task);
            }
        });
    }
    ...
    public boolean onNewIntent(Intent intent) {
        ...
        s0 remoteMessageForArguments = FlutterFirebaseMessagingReceiver.notifications.get(string);
        ...
        if (remoteMessageForArguments.X() == null && (map = this.initialMessageNotification) != null) {
