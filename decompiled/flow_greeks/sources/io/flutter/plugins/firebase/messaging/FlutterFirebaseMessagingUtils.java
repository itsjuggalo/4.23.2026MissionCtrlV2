...
class FlutterFirebaseMessagingUtils {
    ...
    public static s0 getRemoteMessageForArguments(Map<String, Object> map) {
        Object obj = map.get(Constants.ERROR_MESSAGE);
        Objects.requireNonNull(obj);
        Map map2 = (Map) obj;
        Object obj2 = map2.get(KEY_TO);
        Objects.requireNonNull(obj2);
        s0.b bVar = new s0.b((String) obj2);
    ...
    private static Map<String, Object> remoteMessageNotificationToMap(s0.c cVar) {
        HashMap map = new HashMap();
        HashMap map2 = new HashMap();
        if (cVar.p() != null) {
            map.put(com.amazon.a.a.o.b.S, cVar.p());
        }
        if (cVar.r() != null) {
    ...
    public static Map<String, Object> remoteMessageToMap(s0 s0Var) {
        HashMap map = new HashMap();
        HashMap map2 = new HashMap();
        if (s0Var.R() != null) {
            map.put(KEY_COLLAPSE_KEY, s0Var.R());
        }
        if (s0Var.T() != null) {
            map.put(KEY_FROM, s0Var.T());
        }
        if (s0Var.a0() != null) {
            map.put(KEY_TO, s0Var.a0());
        }
        if (s0Var.U() != null) {
            map.put(KEY_MESSAGE_ID, s0Var.U());
        }
        if (s0Var.W() != null) {
            map.put(KEY_MESSAGE_TYPE, s0Var.W());
        }
        if (!s0Var.S().isEmpty()) {
        ...
        map.put(KEY_TTL, Integer.valueOf(s0Var.b0()));
        map.put(KEY_SENT_TIME, Long.valueOf(s0Var.Z()));
        if (s0Var.X() != null) {
            map.put(EXTRA_REMOTE_MESSAGE, remoteMessageNotificationToMap(s0Var.X()));
        }
        return map;
    }
}
