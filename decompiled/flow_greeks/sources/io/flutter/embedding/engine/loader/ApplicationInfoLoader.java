...
public final class ApplicationInfoLoader {
    ...
    public static final String PUBLIC_AOT_SHARED_LIBRARY_NAME = FlutterLoader.class.getName() + com.amazon.a.a.o.c.a.b.f4610a + "aot-shared-library-name";
    public static final String PUBLIC_VM_SNAPSHOT_DATA_KEY = FlutterLoader.class.getName() + com.amazon.a.a.o.c.a.b.f4610a + "vm-snapshot-data";
    public static final String PUBLIC_ISOLATE_SNAPSHOT_DATA_KEY = FlutterLoader.class.getName() + com.amazon.a.a.o.c.a.b.f4610a + "isolate-snapshot-data";
    public static final String PUBLIC_FLUTTER_ASSETS_DIR_KEY = FlutterLoader.class.getName() + com.amazon.a.a.o.c.a.b.f4610a + "flutter-assets-dir";
