    ...
    public final class ImageReaderSurfaceProducer implements TextureRegistry.SurfaceProducer, TextureRegistry.ImageConsumer, TextureRegistry.OnTrimMemoryListener {
            ...
            public PerImageReader(ImageReader imageReader) {
                ...
                imageReader.setOnImageAvailableListener(new ImageReader.OnImageAvailableListener() { // from class: io.flutter.embedding.engine.renderer.d
                    ...
                    public final void onImageAvailable(ImageReader imageReader2) {
                        FlutterRenderer.ImageReaderSurfaceProducer.PerImageReader.a(this.f12566a, imageReader2);
                    }
            ...
            if (z10) {
                FlutterRenderer.this.handler.post(new Runnable() { // from class: io.flutter.embedding.engine.renderer.c
                    ...
                    public final void run() {
                        FlutterRenderer.ImageReaderSurfaceProducer.a(this.f12565a);
                    }
                });
            }
            return perImage;
        ...
        public void finalize() throws Throwable {
            try {
                ...
                releaseInternal();
                FlutterRenderer.this.handler.post(new TextureFinalizerRunnable(this.f12560id, FlutterRenderer.this.flutterJNI));
            } finally {
                super.finalize();
            }
        }
        ...
        public void release() {
            ...
            releaseInternal();
            FlutterRenderer.this.unregisterTexture(this.f12560id);
        }
    ...
    public final class ImageTextureRegistryEntry implements TextureRegistry.ImageTextureEntry, TextureRegistry.ImageConsumer {
        ...
        public void finalize() throws Throwable {
            try {
                ...
                this.released = true;
                FlutterRenderer.this.handler.post(new TextureFinalizerRunnable(this.f12561id, FlutterRenderer.this.flutterJNI));
                super.finalize();
            } catch (Throwable th) {
                super.finalize();
                throw th;
        ...
        public void release() {
            ...
            FlutterRenderer.this.unregisterTexture(this.f12561id);
        }
    }
    ...
    public final class SurfaceTextureRegistryEntry implements TextureRegistry.SurfaceTextureEntry, TextureRegistry.OnTrimMemoryListener {
        ...
        public SurfaceTextureRegistryEntry(long j10, SurfaceTexture surfaceTexture) {
            ...
            this.textureWrapper = new SurfaceTextureWrapper(surfaceTexture, new Runnable() { // from class: io.flutter.embedding.engine.renderer.e
                @Override // java.lang.Runnable
                public final void run() {
                    FlutterRenderer.SurfaceTextureRegistryEntry.b(this.f12567a);
                }
            });
            surfaceTexture().setOnFrameAvailableListener(new SurfaceTexture.OnFrameAvailableListener() { // from class: io.flutter.embedding.engine.renderer.f
                ...
                public final void onFrameAvailable(SurfaceTexture surfaceTexture2) {
                    FlutterRenderer.SurfaceTextureRegistryEntry.a(this.f12568a, surfaceTexture2);
                }
            }, new Handler());
        }
        ...
        public void finalize() throws Throwable {
            try {
                ...
                FlutterRenderer.this.handler.post(new TextureFinalizerRunnable(this.f12562id, FlutterRenderer.this.flutterJNI));
            } finally {
                super.finalize();
            }
        }
        ...
        public void release() {
            ...
            Log.v(FlutterRenderer.TAG, "Releasing a SurfaceTexture (" + this.f12562id + ").");
            this.textureWrapper.release();
            FlutterRenderer.this.unregisterTexture(this.f12562id);
            removeListener();
            this.released = true;
        }
    ...
    public static final class TextureFinalizerRunnable implements Runnable {
        ...
        public void run() {
            if (this.flutterJNI.isAttached()) {
                Log.v(FlutterRenderer.TAG, "Releasing a Texture (" + this.f12563id + ").");
                this.flutterJNI.unregisterTexture(this.f12563id);
            }
        }
    }
