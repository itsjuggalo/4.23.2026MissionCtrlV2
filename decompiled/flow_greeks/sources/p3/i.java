...
public final class i implements ImageHeaderParser {
    ...
    public static final byte[] f18233a = "Exif\u0000\u0000".getBytes(Charset.forName("UTF-8"));

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static final byte[] f18234b = "MPF".getBytes(Charset.forName("UTF-8"));

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public static final int[] f18235c = {0, 1, 1, 2, 4, 8, 1, 1, 2, 4, 8, 4, 8};
    ...
    public static final class a implements c {
        ...
        public int b(byte[] bArr, int i10) {
            int iMin = Math.min(i10, this.f18236a.remaining());
            if (iMin == 0) {
                return -1;
            }
            this.f18236a.get(bArr, 0, iMin);
            return iMin;
        }

        @Override // p3.i.c
        public short c() throws c.a {
            if (this.f18236a.remaining() >= 1) {
                return (short) (this.f18236a.get() & 255);
            }
            throw new c.a();
        }
        ...
        public long skip(long j10) {
            int iMin = (int) Math.min(this.f18236a.remaining(), j10);
            ByteBuffer byteBuffer = this.f18236a;
    ...
    public static final class b {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public final ByteBuffer f18237a;

        public b(byte[] bArr, int i10) {
            this.f18237a = (ByteBuffer) ByteBuffer.wrap(bArr).order(ByteOrder.BIG_ENDIAN).limit(i10);
        }

        public short a(int i10) {
            if (c(i10, 2)) {
                return this.f18237a.getShort(i10);
            }
            return (short) -1;
        }
        ...
        public int b(int i10) {
            if (c(i10, 4)) {
                return this.f18237a.getInt(i10);
            }
            return -1;
        }

        public final boolean c(int i10, int i11) {
            return this.f18237a.remaining() - i10 >= i11;
        }

        public int d() {
            return this.f18237a.remaining();
        }

        public void e(ByteOrder byteOrder) {
            this.f18237a.order(byteOrder);
        }
    }
    ...
    public static final class d implements c {
        ...
        public int b(byte[] bArr, int i10) throws c.a {
            int i11 = 0;
            int i12 = 0;
            while (i11 < i10 && (i12 = this.f18238a.read(bArr, i11, i10 - i11)) != -1) {
                i11 += i12;
            }
            if (i11 == 0 && i12 == -1) {
                throw new c.a();
        ...
        public long skip(long j10) throws IOException {
            ...
            long j11 = j10;
            while (j11 > 0) {
                long jSkip = this.f18238a.skip(j11);
                if (jSkip <= 0) {
                    if (this.f18238a.read() == -1) {
                        break;
                    }
                    jSkip = 1;
                }
    ...
    public ImageHeaderParser.ImageType a(ByteBuffer byteBuffer) {
        return i(new a((ByteBuffer) c4.k.e(byteBuffer)));
    }

    @Override // com.bumptech.glide.load.ImageHeaderParser
    public boolean b(ByteBuffer byteBuffer, j3.b bVar) {
        return l(new a((ByteBuffer) c4.k.e(byteBuffer)), (j3.b) c4.k.e(bVar));
    }

    @Override // com.bumptech.glide.load.ImageHeaderParser
    public int c(ByteBuffer byteBuffer, j3.b bVar) {
        return h(new a((ByteBuffer) c4.k.e(byteBuffer)), (j3.b) c4.k.e(bVar));
    }

    @Override // com.bumptech.glide.load.ImageHeaderParser
    public int d(InputStream inputStream, j3.b bVar) {
        return h(new d((InputStream) c4.k.e(inputStream)), (j3.b) c4.k.e(bVar));
    }

    @Override // com.bumptech.glide.load.ImageHeaderParser
    public ImageHeaderParser.ImageType e(InputStream inputStream) {
        return i(new d((InputStream) c4.k.e(inputStream)));
    }

    @Override // com.bumptech.glide.load.ImageHeaderParser
    public boolean f(InputStream inputStream, j3.b bVar) {
        return l(new d((InputStream) c4.k.e(inputStream)), (j3.b) c4.k.e(bVar));
    }

    public final int h(c cVar, j3.b bVar) {
        try {
            int iA = cVar.a();
            if (!j(iA)) {
                if (Log.isLoggable("DfltImageHeaderParser", 3)) {
    ...
    public final boolean k(byte[] bArr, int i10) {
        return n(bArr, i10, f18233a);
    }

    public final boolean l(c cVar, j3.b bVar) {
    ...
    public final boolean m(c cVar, byte[] bArr, int i10) {
        int iB = cVar.b(bArr, i10);
        if (iB == i10) {
            return n(bArr, i10, f18234b);
        }
        if (!Log.isLoggable("DfltImageHeaderParser", 3)) {
            return false;
        }
    ...
    public final int q(c cVar, int i10) {
        short sC;
        int iA;
        long j10;
        long jSkip;
    ...
    public final int s(c cVar, byte[] bArr, int i10) {
        int iB = cVar.b(bArr, i10);
        if (iB == i10) {
            if (k(bArr, i10)) {
    ...
    public final ImageHeaderParser.ImageType t(c cVar, int i10) {
