...
public abstract class j {
    ...
    public static final Object[] f14941a = new Object[0];
        ...
        if (size != 0) {
            ...
            if (it.hasNext()) {
                if (size <= objArr.length) {
                    ...
                    t.d(objNewInstance, "null cannot be cast to non-null type kotlin.Array<kotlin.Any?>");
