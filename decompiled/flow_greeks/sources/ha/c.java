...
public class c {
    ...
    public final File a() {
        if (this.f11273a == null) {
            synchronized (this) {
                try {
                    if (this.f11273a == null) {
                        this.f11273a = new File(this.f11274b.m().getFilesDir(), "PersistedInstallation." + this.f11274b.s() + ".json");
                    }
                } finally {
                }
            }
    ...
    public d b(d dVar) {
        try {
            ...
            File fileCreateTempFile = File.createTempFile("PersistedInstallation", "tmp", this.f11274b.m().getFilesDir());
