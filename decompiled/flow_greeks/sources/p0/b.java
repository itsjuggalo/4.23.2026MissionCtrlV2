        ...
        for (q qVar : qVarArr) {
            ...
            if (objB == null) {
                ...
                if (Parcelable.class.isAssignableFrom(componentType)) {
                    t.d(objB, "null cannot be cast to non-null type kotlin.Array<android.os.Parcelable>");
                    bundle.putParcelableArray(str, (Parcelable[]) objB);
                } else if (String.class.isAssignableFrom(componentType)) {
                    t.d(objB, "null cannot be cast to non-null type kotlin.Array<kotlin.String>");
                    bundle.putStringArray(str, (String[]) objB);
                } else if (CharSequence.class.isAssignableFrom(componentType)) {
                    t.d(objB, "null cannot be cast to non-null type kotlin.Array<kotlin.CharSequence>");
