...
public final class f {
    ...
    public final OutputStream f10654e;
    ...
    public f(OutputStream outputStream, byte[] bArr) {
        this.f10654e = outputStream;
        this.f10650a = bArr;
        this.f10651b = bArr.length;
    }
    ...
    public final void J() throws IOException {
        OutputStream outputStream = this.f10654e;
        if (outputStream == null) {
            throw new a();
        }
        outputStream.write(this.f10650a, 0, this.f10652c);
        this.f10652c = 0;
    }
    ...
    public void i0(d dVar, int i10, int i11) throws IOException {
        ...
        int i13 = this.f10652c;
        if (i12 - i13 >= i11) {
            dVar.p(this.f10650a, i10, i13, i11);
            this.f10652c += i11;
            this.f10653d += i11;
            return;
        }
        int i14 = i12 - i13;
        dVar.p(this.f10650a, i10, i13, i14);
        int i15 = i10 + i14;
        int i16 = i11 - i14;
        ...
        J();
        if (i16 <= this.f10651b) {
            dVar.p(this.f10650a, i15, 0, i16);
            this.f10652c = i16;
        } else {
            dVar.R(this.f10654e, i15, i16);
        }
        this.f10653d += i16;
    }
    ...
    public void k0(byte[] bArr, int i10, int i11) throws IOException {
        ...
        int i13 = this.f10652c;
        if (i12 - i13 >= i11) {
            System.arraycopy(bArr, i10, this.f10650a, i13, i11);
            this.f10652c += i11;
            this.f10653d += i11;
            return;
        }
        int i14 = i12 - i13;
        System.arraycopy(bArr, i10, this.f10650a, i13, i14);
        int i15 = i10 + i14;
        int i16 = i11 - i14;
        this.f10652c = this.f10651b;
        this.f10653d += i14;
        J();
        if (i16 <= this.f10651b) {
            System.arraycopy(bArr, i15, this.f10650a, 0, i16);
            this.f10652c = i16;
        } else {
            this.f10654e.write(bArr, i15, i16);
        }
        this.f10653d += i16;
    }
