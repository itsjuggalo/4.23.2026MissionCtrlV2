...
# virtual methods
.method public final A(Lj$/time/temporal/TemporalAccessor;)Lj$/time/temporal/u;
    .locals 9
    ...
    invoke-static {v0, v1}, Lj$/time/chrono/s;->X(J)Z
    ...
    .line 323
    :cond_3
    invoke-virtual {p0}, Lj$/time/temporal/d;->I()Lj$/time/temporal/u;
...
.method public final F(Ljava/util/Map;Lj$/time/format/w;Lj$/time/format/x;)Lj$/time/temporal/TemporalAccessor;
    .locals 16
    ...
    .line 736
    invoke-static/range {p2 .. p2}, Lj$/time/chrono/l;->r(Lj$/time/temporal/TemporalAccessor;)Lj$/time/chrono/l;
    ...
    .line 359
    :cond_1
    invoke-interface {v5}, Lj$/time/temporal/q;->I()Lj$/time/temporal/u;
    ...
    .line 363
    invoke-virtual {v0, v4}, Lj$/time/temporal/d;->A(Lj$/time/temporal/TemporalAccessor;)Lj$/time/temporal/u;
    ...
    .line 365
    :cond_3
    invoke-virtual {v0}, Lj$/time/temporal/d;->I()Lj$/time/temporal/u;
...
.method public final I()Lj$/time/temporal/u;
    .locals 4
...
.method public final P(Lj$/time/temporal/TemporalAccessor;)J
    ...
    invoke-interface {p1, v0}, Lj$/time/temporal/TemporalAccessor;->g(Lj$/time/temporal/q;)I
    ...
    invoke-interface {p1, v1}, Lj$/time/temporal/TemporalAccessor;->g(Lj$/time/temporal/q;)I
    ...
    invoke-static {v2, v3}, Lj$/time/chrono/s;->X(J)Z
...
.method public final V(Lj$/time/temporal/m;J)Lj$/time/temporal/m;
    ...
    .line 339
    invoke-virtual {p0, p1}, Lj$/time/temporal/d;->P(Lj$/time/temporal/TemporalAccessor;)J
...
.method public final s(Lj$/time/temporal/TemporalAccessor;)Z
    ...
    invoke-interface {p1, v0}, Lj$/time/temporal/TemporalAccessor;->h(Lj$/time/temporal/q;)Z
