...
.method public i(Landroid/net/Uri;Landroid/content/ContentResolver;)Ljava/io/InputStream;
    .locals 2

    .line 1
    invoke-virtual {p0, p1, p2}, Lcom/bumptech/glide/load/data/n;->j(Landroid/net/Uri;Landroid/content/ContentResolver;)Ljava/io/InputStream;
...
.method public final j(Landroid/net/Uri;Landroid/content/ContentResolver;)Ljava/io/InputStream;
    .locals 2
    ...
    .line 31
    .line 32
    invoke-virtual {p0, p1, p2}, Lcom/bumptech/glide/load/data/n;->l(Landroid/net/Uri;Landroid/content/ContentResolver;)Ljava/io/InputStream;
    ...
    .line 42
    :cond_1
    invoke-virtual {p0, p2, p1}, Lcom/bumptech/glide/load/data/n;->k(Landroid/content/ContentResolver;Landroid/net/Uri;)Ljava/io/InputStream;
...
.method public final k(Landroid/content/ContentResolver;Landroid/net/Uri;)Ljava/io/InputStream;
    .locals 1
...
.method public final l(Landroid/net/Uri;Landroid/content/ContentResolver;)Ljava/io/InputStream;
    .locals 2

    .line 1
    invoke-static {p1, p2}, Lh3/b;->h(Landroid/net/Uri;Landroid/content/ContentResolver;)Landroid/content/res/AssetFileDescriptor;
