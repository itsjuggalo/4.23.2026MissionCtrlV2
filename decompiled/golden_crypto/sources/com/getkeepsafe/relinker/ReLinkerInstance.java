...
public class ReLinkerInstance {
    ...
    public void loadLibrary(final Context context, final String library, final String version) throws Throwable {
        loadLibrary(context, library, version, null);
    }

    public void loadLibrary(final Context context, final String library, final ReLinker.LoadListener listener) throws Throwable {
        loadLibrary(context, library, null, listener);
    }

    public void loadLibrary(final Context context, final String library, final String version, final ReLinker.LoadListener listener) throws Throwable {
        if (context == null) {
