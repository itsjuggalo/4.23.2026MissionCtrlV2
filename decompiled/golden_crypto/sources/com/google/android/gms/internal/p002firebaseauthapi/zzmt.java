...
public final class zzmt {
    ...
    private static zzms zza(zzms zzmsVar, zzms zzmsVar2, BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        BigInteger bigIntegerMod = zzmsVar.zzd.multiply(zzmsVar.zzd).mod(bigInteger2);
        BigInteger bigIntegerMod2 = zzmsVar2.zzd.multiply(zzmsVar2.zzd).mod(bigInteger2);
    ...
    private static zzms zza(zzms zzmsVar, BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        BigInteger bigIntegerMod = zzmsVar.zzb.multiply(zzmsVar.zzb).mod(bigInteger2);
        BigInteger bigIntegerMod2 = zzmsVar.zzc.multiply(zzmsVar.zzc).mod(bigInteger2);
        BigInteger bigIntegerMod3 = bigIntegerMod2.multiply(bigIntegerMod2).mod(bigInteger2);
        BigInteger bigIntegerMod4 = zzmsVar.zzd.multiply(zzmsVar.zzd).mod(bigInteger2);
    ...
    public static ECPoint zza(BigInteger bigInteger, ECParameterSpec eCParameterSpec) throws GeneralSecurityException {
        ...
        for (int iBitLength = bigInteger.bitLength(); iBitLength >= 0; iBitLength--) {
            if (bigInteger.testBit(iBitLength)) {
                zzmsVarZza = zza(zzmsVarZza, zzmsVarZza2, a, bigIntegerZza);
                zzmsVarZza2 = zza(zzmsVarZza2, a, bigIntegerZza);
            } else {
                zzmsVarZza2 = zza(zzmsVarZza, zzmsVarZza2, a, bigIntegerZza);
                zzmsVarZza = zza(zzmsVarZza, a, bigIntegerZza);
            }
        }
        if (zzmsVarZza.zza()) {
