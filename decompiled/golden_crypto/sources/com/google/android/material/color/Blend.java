...
final class Blend {
    ...
    private static float rotationDirection(float f, float f2) {
        ...
        return (fAbs > fAbs2 || fAbs > fAbs3) ? (fAbs2 > fAbs || fAbs2 > fAbs3) ? ((double) f5) >= FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE ? 1.0f : -1.0f : ((double) f4) >= FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE ? 1.0f : -1.0f : ((double) f3) >= FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE ? 1.0f : -1.0f;
    }
}
