...
import androidx.heifwriter.HeifWriter$$ExternalSyntheticApiModelOutline0;
...
public class AudioFocusRequestCompat {
    ...
    AudioFocusRequestCompat(int i, AudioManager.OnAudioFocusChangeListener onAudioFocusChangeListener, Handler handler, AudioAttributesCompat audioAttributesCompat, boolean z) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            HeifWriter$$ExternalSyntheticApiModelOutline0.m$3();
            this.mFrameworkAudioFocusRequest = HeifWriter$$ExternalSyntheticApiModelOutline0.m(i).setAudioAttributes(getAudioAttributes()).setWillPauseWhenDucked(z).setOnAudioFocusChangeListener(this.mOnAudioFocusChangeListener, handler).build();
        } else {
    ...
    AudioFocusRequest getAudioFocusRequest() {
        return HeifWriter$$ExternalSyntheticApiModelOutline0.m228m(this.mFrameworkAudioFocusRequest);
    }
