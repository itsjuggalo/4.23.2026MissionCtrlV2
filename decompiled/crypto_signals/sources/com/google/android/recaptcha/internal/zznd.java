...
public abstract class zznd<MessageType extends zznd<MessageType, BuilderType>, BuilderType extends zzmx<MessageType, BuilderType>> extends zzko<MessageType, BuilderType> {
    ...
    public static final boolean zzK(zznd zzndVar, boolean z6) {
    ...
    public static zznd zzi(zznd zzndVar, byte[] bArr, int i, int i6, zzmo zzmoVar) throws zznn {
        if (i6 == 0) {
            return zzndVar;
        }
        ...
        try {
            ...
            zzowVarZzb.zzi(zzndVarZzv, bArr, 0, i6, new zzkt(zzmoVar));
    ...
    public final int zza(zzow zzowVar) {
        if (zzL()) {
            ...
            throw new IllegalStateException(d.f(iZza, "serialized size must be non-negative, was "));
        }
        ...
        if (iZza2 < 0) {
            throw new IllegalStateException(d.f(iZza2, "serialized size must be non-negative, was "));
        }
    ...
    public final int zzo() {
        if (zzL()) {
            ...
            throw new IllegalStateException(d.f(iZzf, "serialized size must be non-negative, was "));
        }
        int i = this.zzd & f.API_PRIORITY_OTHER;
        if (i != Integer.MAX_VALUE) {
            return i;
        ...
        int iZzf2 = zzf(null);
        if (iZzf2 < 0) {
            throw new IllegalStateException(d.f(iZzf2, "serialized size must be non-negative, was "));
        }
