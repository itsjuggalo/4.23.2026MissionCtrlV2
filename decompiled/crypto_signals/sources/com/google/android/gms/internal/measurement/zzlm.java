...
public abstract class zzlm extends zzkz {
    ...
    public abstract void zza(int i, int i6);

    public abstract void zzb(int i, int i6);

    public abstract void zzc(int i, int i6);

    public abstract void zzd(int i, int i6);

    public abstract void zze(int i, long j4);

    public abstract void zzf(int i, long j4);

    public abstract void zzg(int i, boolean z6);
    ...
    public abstract void zzk(byte[] bArr, int i, int i6);
    ...
    public abstract void zzp(byte b3);
    ...
    public abstract void zzw(byte[] bArr, int i, int i6);
