...
final class zzoq {
    public static /* synthetic */ boolean zza(byte b3) {
        return b3 >= 0;
    }

    public static /* synthetic */ void zzb(byte b3, byte b6, char[] cArr, int i) throws zzmr {
        if (b3 < -62 || zze(b6)) {
    ...
    */
    ...
    public static /* synthetic */ void zzd(byte b3, byte b6, byte b7, byte b8, char[] cArr, int i) throws zzmr {
        if (!zze(b6)) {
            if ((((b6 + 112) + (b3 << 28)) >> 30) == 0 && !zze(b7) && !zze(b8)) {
