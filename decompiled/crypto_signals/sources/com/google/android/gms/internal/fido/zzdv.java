...
final class zzdv {
    ...
    public final void zzc() throws IOException {
        long jZzh = zzh();
        if (jZzh >= 0) {
            throw new IOException(a.f("expected indefinite length scope but found ", jZzh));
        }
        if (jZzh == -5) {
    ...
    public final void zzd() throws IOException {
        ...
        throw new IOException(a.f("expected non-string scope but found ", jZzh));
    }
    ...
    public final void zze(long j4) throws IOException {
        ...
        if (jZzh != j4) {
            ...
            throw new IOException("expected non-string scope or scope " + j4 + " but found " + jZzh);
        }
    }
