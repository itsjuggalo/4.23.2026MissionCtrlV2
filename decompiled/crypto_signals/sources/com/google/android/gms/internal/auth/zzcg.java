...
public final class zzcg implements zzcl {
    ...
    private static final Map zzb = new C0910b();
    ...
    public final /* synthetic */ Map zzc() {
        ...
        try {
            ...
            Map c0910b = count <= 256 ? new C0910b(count) : new HashMap(count, 1.0f);
            while (cursorQuery.moveToNext()) {
                c0910b.put(cursorQuery.getString(0), cursorQuery.getString(1));
            }
            return c0910b;
        } finally {
            cursorQuery.close();
