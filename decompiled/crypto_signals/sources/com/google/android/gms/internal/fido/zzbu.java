...
final class zzbu extends zzbi {
    ...
    @Override // com.google.android.gms.internal.fido.zzbi
    public final zzbi zzm(Object obj, boolean z6) {
        return zzu(0, zzs(obj, z6));
    }

    @Override // com.google.android.gms.internal.fido.zzbi
    public final zzbi zzo(Object obj, boolean z6, Object obj2, boolean z7) {
        return zzp(obj, z6).zzm(obj2, z7);
    }

    @Override // com.google.android.gms.internal.fido.zzbi
    public final zzbi zzp(Object obj, boolean z6) {
        return zzu(zzt(obj, z6), this.zzd.size());
    }
    ...
    public final int zzs(Object obj, boolean z6) {
    ...
    public final int zzt(Object obj, boolean z6) {
        zzaz zzazVar = this.zzd;
        obj.getClass();
        int iBinarySearch = Collections.binarySearch(zzazVar, obj, ((zzbi) this).zza);
    ...
    public final zzbu zzu(int i, int i6) {
        if (i == 0) {
            if (i6 == this.zzd.size()) {
                return this;
            }
        ...
        return i < i6 ? new zzbu(this.zzd.subList(i, i6), ((zzbi) this).zza) : zzbi.zzq(((zzbi) this).zza);
    }
}
