...
public class NotificationDetails implements Serializable {
    ...
    @InterfaceC1217b(alternate = {"allowWhileIdle"}, value = SCHEDULE_MODE)
    ...
    private static ArrayList<MessageDetails> readMessages(ArrayList<Map<String, Object>> arrayList) {
        ...
        if (arrayList != null) {
            for (Map<String, Object> map : arrayList) {
                arrayList2.add(new MessageDetails((String) map.get(TEXT), AbstractC0284a.v(map.get(TIMESTAMP)), readPersonDetails((Map) map.get(PERSON)), (String) map.get(DATA_MIME_TYPE), (String) map.get(DATA_URI)));
            }
        }
        return arrayList2;
    }
    ...
    private static void readPlatformSpecifics(Map<String, Object> map, NotificationDetails notificationDetails) {
        ...
        if (map2 != null) {
            ...
            notificationDetails.when = AbstractC0284a.v(map2.get(WHEN));
            ...
            notificationDetails.timeoutAfter = AbstractC0284a.v(map2.get(TIMEOUT_AFTER));
