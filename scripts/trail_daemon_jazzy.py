...
Forked from trail_daemon.py for JazzyHazzy R1 paper account (PA3AZU6NZNLZ).
...
# DAEMON ACCOUNT LOCK: this daemon is hardcoded to JazzyHazzy R1 (PA3AZU6NZNLZ).
# Do not change to alpaca-key-id (R2) or alpaca-r1-* (Boba R1 hold).
EXPECTED_ACCOUNT = "PA3AZU6NZNLZ"  # JazzyHazzy R1 paper
